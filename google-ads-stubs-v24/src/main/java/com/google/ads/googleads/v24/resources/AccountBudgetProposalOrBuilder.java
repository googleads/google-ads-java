...
public interface AccountBudgetProposalOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v24.resources.AccountBudgetProposal)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v24.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType proposal_type = 4 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v24.enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus status = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v24.enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus getStatus();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v24.enums.TimeTypeEnum.TimeType proposed_start_time_type = 7 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v24.enums.TimeTypeEnum.TimeType getProposedStartTimeType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v24.enums.TimeTypeEnum.TimeType proposed_end_time_type = 9 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v24.enums.TimeTypeEnum.TimeType getProposedEndTimeType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v24.enums.TimeTypeEnum.TimeType approved_end_time_type = 22 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v24.enums.TimeTypeEnum.TimeType getApprovedEndTimeType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v24.enums.SpendingLimitTypeEnum.SpendingLimitType proposed_spending_limit_type = 11 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v24.enums.SpendingLimitTypeEnum.SpendingLimitType getProposedSpendingLimitType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v24.enums.SpendingLimitTypeEnum.SpendingLimitType approved_spending_limit_type = 24 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v24.enums.SpendingLimitTypeEnum.SpendingLimitType getApprovedSpendingLimitType();

  com.google.ads.googleads.v24.resources.AccountBudgetProposal.ProposedStartTimeCase getProposedStartTimeCase();

  com.google.ads.googleads.v24.resources.AccountBudgetProposal.ProposedEndTimeCase getProposedEndTimeCase();

  com.google.ads.googleads.v24.resources.AccountBudgetProposal.ApprovedEndTimeCase getApprovedEndTimeCase();

  com.google.ads.googleads.v24.resources.AccountBudgetProposal.ProposedSpendingLimitCase getProposedSpendingLimitCase();

  com.google.ads.googleads.v24.resources.AccountBudgetProposal.ApprovedSpendingLimitCase getApprovedSpendingLimitCase();
}
