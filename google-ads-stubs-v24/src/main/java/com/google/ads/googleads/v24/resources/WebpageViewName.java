...
public class WebpageViewName implements ResourceName {
  ...
  @Deprecated
  protected WebpageViewName() {
    customerId = null;
    adGroupId = null;
    criterionId = null;
  }

  private WebpageViewName(Builder builder) {
  ...
  public static WebpageViewName of(String customerId, String adGroupId, String criterionId) {
    return newBuilder()
  ...
  public static WebpageViewName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        CUSTOMER_ID_AD_GROUP_ID_CRITERION_ID.validatedMatch(
            formattedString, "WebpageViewName.parse: formattedString not in valid format");
    return of(
        matchMap.get("customer_id"), matchMap.get("ad_group_id"), matchMap.get("criterion_id"));
  }

  public static List<WebpageViewName> parseList(List<String> formattedStrings) {
    List<WebpageViewName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<WebpageViewName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (WebpageViewName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      WebpageViewName that = ((WebpageViewName) o);
  ...
  public static class Builder {
    ...
    public WebpageViewName build() {
      return new WebpageViewName(this);
    }
  }
}
