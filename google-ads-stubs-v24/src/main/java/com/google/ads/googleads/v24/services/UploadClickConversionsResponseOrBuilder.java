...
public interface UploadClickConversionsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v24.services.UploadClickConversionsResponse)
   ...
   */
  java.util.List<com.google.ads.googleads.v24.services.ClickConversionResult> 
      getResultsList();
  /**
   * <pre>
   * Returned for successfully processed conversions. Proto will be empty for
   ...
   * <code>repeated .google.ads.googleads.v24.services.ClickConversionResult results = 2;</code>
   */
  com.google.ads.googleads.v24.services.ClickConversionResult getResults(int index);
  /**
   * <pre>
   * Returned for successfully processed conversions. Proto will be empty for
   * rows that received an error. Results are not returned when `validate_only`
   ...
   * <code>repeated .google.ads.googleads.v24.services.ClickConversionResult results = 2;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v24.services.ClickConversionResultOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v24.services.ClickConversionResult results = 2;</code>
   */
  com.google.ads.googleads.v24.services.ClickConversionResultOrBuilder getResultsOrBuilder(
      int index);
