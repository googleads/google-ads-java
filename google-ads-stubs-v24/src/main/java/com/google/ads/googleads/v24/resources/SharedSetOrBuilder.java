...
public interface SharedSetOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v24.resources.SharedSet)
   ...
   * @return The type.
   */
  com.google.ads.googleads.v24.enums.SharedSetTypeEnum.SharedSetType getType();
   ...
   * @return The status.
   */
  com.google.ads.googleads.v24.enums.SharedSetStatusEnum.SharedSetStatus getStatus();
   ...
   */
  boolean hasVerticalAdsItemVerticalType();
  /**
   * <pre>
   * Immutable. Shared sets of type VERTICAL_ADS_ITEM_GROUP_RULE_LIST are
   * associated with a particular vertical (e.g. hotels, things to do, flights,
   ...
   */
  int getVerticalAdsItemVerticalTypeValue();
  /**
   * <pre>
   * Immutable. Shared sets of type VERTICAL_ADS_ITEM_GROUP_RULE_LIST are
   * associated with a particular vertical (e.g. hotels, things to do, flights,
   ...
   */
  com.google.ads.googleads.v24.enums.VerticalAdsItemVerticalTypeEnum.VerticalAdsItemVerticalType getVerticalAdsItemVerticalType();
}
