...
public class MultiPartyAuthReviewName implements ResourceName {
  ...
  @Deprecated
  protected MultiPartyAuthReviewName() {
    customerId = null;
    customerInvitationId = null;
  }

  private MultiPartyAuthReviewName(Builder builder) {
  ...
  public static MultiPartyAuthReviewName of(String customerId, String customerInvitationId) {
    return newBuilder()
  ...
  public static MultiPartyAuthReviewName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        CUSTOMER_ID_CUSTOMER_INVITATION_ID.validatedMatch(
            formattedString, "MultiPartyAuthReviewName.parse: formattedString not in valid format");
    return of(matchMap.get("customer_id"), matchMap.get("customer_invitation_id"));
  }

  public static List<MultiPartyAuthReviewName> parseList(List<String> formattedStrings) {
    List<MultiPartyAuthReviewName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<MultiPartyAuthReviewName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (MultiPartyAuthReviewName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      MultiPartyAuthReviewName that = ((MultiPartyAuthReviewName) o);
  ...
  /** Builder for customers/{customer_id}/multiPartyAuthReviews/{customer_invitation_id}. */
  public static class Builder {
    ...
    private Builder(MultiPartyAuthReviewName multiPartyAuthReviewName) {
      this.customerId = multiPartyAuthReviewName.customerId;
      this.customerInvitationId = multiPartyAuthReviewName.customerInvitationId;
    }

    public MultiPartyAuthReviewName build() {
      return new MultiPartyAuthReviewName(this);
    }
  }
}
