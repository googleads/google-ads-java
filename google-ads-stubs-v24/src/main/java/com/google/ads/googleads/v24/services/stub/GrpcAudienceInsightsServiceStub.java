...
import com.google.ads.googleads.v24.services.GenerateAudienceCompositionInsightsRequest;
import com.google.ads.googleads.v24.services.GenerateAudienceCompositionInsightsResponse;
import com.google.ads.googleads.v24.services.GenerateAudienceDefinitionRequest;
import com.google.ads.googleads.v24.services.GenerateAudienceDefinitionResponse;
import com.google.ads.googleads.v24.services.GenerateAudienceOverlapInsightsRequest;
import com.google.ads.googleads.v24.services.GenerateAudienceOverlapInsightsResponse;
import com.google.ads.googleads.v24.services.GenerateInsightsFinderReportRequest;
import com.google.ads.googleads.v24.services.GenerateInsightsFinderReportResponse;
import com.google.ads.googleads.v24.services.GenerateSuggestedTargetingInsightsRequest;
import com.google.ads.googleads.v24.services.GenerateSuggestedTargetingInsightsResponse;
import com.google.ads.googleads.v24.services.GenerateTargetingSuggestionMetricsRequest;
import com.google.ads.googleads.v24.services.GenerateTargetingSuggestionMetricsResponse;
import com.google.ads.googleads.v24.services.ListAudienceInsightsAttributesRequest;
import com.google.ads.googleads.v24.services.ListAudienceInsightsAttributesResponse;
import com.google.ads.googleads.v24.services.ListInsightsEligibleDatesRequest;
import com.google.ads.googleads.v24.services.ListInsightsEligibleDatesResponse;
...
public class GrpcAudienceInsightsServiceStub extends AudienceInsightsServiceStub {
  ...
  private static final MethodDescriptor<
      ...
      generateAudienceDefinitionMethodDescriptor =
          MethodDescriptor
              .<GenerateAudienceDefinitionRequest, GenerateAudienceDefinitionResponse>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.ads.googleads.v24.services.AudienceInsightsService/GenerateAudienceDefinition")
              .setRequestMarshaller(
                  ProtoUtils.marshaller(GenerateAudienceDefinitionRequest.getDefaultInstance()))
              .setResponseMarshaller(
                  ProtoUtils.marshaller(GenerateAudienceDefinitionResponse.getDefaultInstance()))
              .setSampledToLocalTracing(true)
              .build();
  ...
  private final UnaryCallable<GenerateAudienceDefinitionRequest, GenerateAudienceDefinitionResponse>
  ...
  protected GrpcAudienceInsightsServiceStub(
    ...
    GrpcCallSettings<
        ...
        generateAudienceCompositionInsightsTransportSettings =
            GrpcCallSettings
                ...
                .build();
    GrpcCallSettings<GenerateAudienceDefinitionRequest, GenerateAudienceDefinitionResponse>
        generateAudienceDefinitionTransportSettings =
            GrpcCallSettings
                .<GenerateAudienceDefinitionRequest, GenerateAudienceDefinitionResponse>newBuilder()
                .setMethodDescriptor(generateAudienceDefinitionMethodDescriptor)
                .setParamsExtractor(
                    request -> {
                      RequestParamsBuilder builder = RequestParamsBuilder.create();
                      builder.add("customer_id", String.valueOf(request.getCustomerId()));
    ...
    this.generateAudienceCompositionInsightsCallable =
        callableFactory.createUnaryCallable(
            ...
            clientContext);
    this.generateAudienceDefinitionCallable =
        callableFactory.createUnaryCallable(
            generateAudienceDefinitionTransportSettings,
            settings.generateAudienceDefinitionSettings(),
            clientContext);
  ...
  @Override
  public UnaryCallable<GenerateAudienceDefinitionRequest, GenerateAudienceDefinitionResponse>
      generateAudienceDefinitionCallable() {
    return generateAudienceDefinitionCallable;
  }
