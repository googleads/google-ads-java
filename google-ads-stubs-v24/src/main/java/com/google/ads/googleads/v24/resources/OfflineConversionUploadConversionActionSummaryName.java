...
public class OfflineConversionUploadConversionActionSummaryName implements ResourceName {
  ...
  private OfflineConversionUploadConversionActionSummaryName(Builder builder) {
    ...
    conversionTypeId = Preconditions.checkNotNull(builder.getConversionTypeId());
  ...
  public static OfflineConversionUploadConversionActionSummaryName of(
      String customerId, String conversionTypeId, String client) {
    return newBuilder()
  ...
  public static OfflineConversionUploadConversionActionSummaryName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_ID_CONVERSION_TYPE_ID_CLIENT.validatedMatch(
            formattedString,
            "OfflineConversionUploadConversionActionSummaryName.parse: formattedString not in valid format");
    return of(
        matchMap.get("customer_id"), matchMap.get("conversion_type_id"), matchMap.get("client"));
  }

  public static List<OfflineConversionUploadConversionActionSummaryName> parseList(
      List<String> formattedStrings) {
    List<OfflineConversionUploadConversionActionSummaryName> list =
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (conversionTypeId != null) {
            fieldMapBuilder.put("conversion_type_id", conversionTypeId);
          }
          if (client != null) {
  ...
  public String toString() {
    return CUSTOMER_ID_CONVERSION_TYPE_ID_CLIENT.instantiate(
        "customer_id", customerId, "conversion_type_id", conversionTypeId, "client", client);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      OfflineConversionUploadConversionActionSummaryName that =
          ((OfflineConversionUploadConversionActionSummaryName) o);
      return Objects.equals(this.customerId, that.customerId)
          && Objects.equals(this.conversionTypeId, that.conversionTypeId)
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(conversionTypeId);
    h *= 1000003;
