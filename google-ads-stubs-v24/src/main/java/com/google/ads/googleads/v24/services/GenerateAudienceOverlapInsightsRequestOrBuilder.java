...
public interface GenerateAudienceOverlapInsightsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v24.services.GenerateAudienceOverlapInsightsRequest)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v24.common.LocationInfo country_location = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v24.common.AudienceInsightsAttribute primary_attribute = 6 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   */
  com.google.ads.googleads.v24.common.AudienceInsightsAttribute getPrimaryAttribute();
  /**
   * <pre>
   * Required. The audience attribute that should be intersected with all other
   * eligible audiences.  This must be an Affinity or In-Market UserInterest, an
   ...
   * <code>.google.ads.googleads.v24.common.AudienceInsightsAttribute primary_attribute = 6 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v24.common.AudienceInsightsAttributeOrBuilder getPrimaryAttributeOrBuilder();
   ...
   */
  java.util.List<com.google.ads.googleads.v24.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension> getDimensionsList();
  /**
   * <pre>
   * Required. The types of attributes of which to calculate the overlap with
   * the primary_attribute. The values must be a subset of
   ...
   */
  com.google.ads.googleads.v24.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension getDimensions(int index);
  /**
   * <pre>
   * Required. The types of attributes of which to calculate the overlap with
   * the primary_attribute. The values must be a subset of
   ...
   */
  com.google.ads.googleads.v24.common.AdditionalApplicationInfo getInsightsApplicationInfo();
  /**
   * <pre>
   * Optional. Additional information on the application issuing the request.
   * </pre>
   ...
   * <code>.google.ads.googleads.v24.common.AdditionalApplicationInfo insights_application_info = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.ads.googleads.v24.common.AdditionalApplicationInfoOrBuilder getInsightsApplicationInfoOrBuilder();
}
