...
public class LocationInterestViewName implements ResourceName {
  private static final PathTemplate CUSTOMER_ID_CAMPAIGN_ID_AD_GROUP_ID_CRITERION_ID =
  ...
  public static LocationInterestViewName of(
      String customerId, String campaignId, String adGroupId, String criterionId) {
    return newBuilder()
  ...
  public static LocationInterestViewName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_ID_CAMPAIGN_ID_AD_GROUP_ID_CRITERION_ID.validatedMatch(
            formattedString, "LocationInterestViewName.parse: formattedString not in valid format");
    return of(
  ...
  public static List<LocationInterestViewName> parseList(List<String> formattedStrings) {
    List<LocationInterestViewName> list = new ArrayList<>(formattedStrings.size());
  ...
  public String toString() {
    return CUSTOMER_ID_CAMPAIGN_ID_AD_GROUP_ID_CRITERION_ID.instantiate(
        "customer_id",
        customerId,
        "campaign_id",
        campaignId,
