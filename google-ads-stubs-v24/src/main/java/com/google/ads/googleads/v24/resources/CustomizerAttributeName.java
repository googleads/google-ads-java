...
public class CustomizerAttributeName implements ResourceName {
  ...
  @Deprecated
  protected CustomizerAttributeName() {
    customerId = null;
    customizerAttributeId = null;
  }

  private CustomizerAttributeName(Builder builder) {
  ...
  public static CustomizerAttributeName of(String customerId, String customizerAttributeId) {
    return newBuilder()
  ...
  public static CustomizerAttributeName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_ID_CUSTOMIZER_ATTRIBUTE_ID.validatedMatch(
            formattedString, "CustomizerAttributeName.parse: formattedString not in valid format");
    return of(matchMap.get("customer_id"), matchMap.get("customizer_attribute_id"));
  }

  public static List<CustomizerAttributeName> parseList(List<String> formattedStrings) {
    List<CustomizerAttributeName> list = new ArrayList<>(formattedStrings.size());
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      CustomizerAttributeName that = ((CustomizerAttributeName) o);
  ...
  public static class Builder {
    ...
    private Builder(CustomizerAttributeName customizerAttributeName) {
      this.customerId = customizerAttributeName.customerId;
      this.customizerAttributeId = customizerAttributeName.customizerAttributeId;
    }

    public CustomizerAttributeName build() {
      return new CustomizerAttributeName(this);
    }
  }
}
