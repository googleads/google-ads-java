...
public class ConversionGoalCampaignConfigName implements ResourceName {
  ...
  @Deprecated
  protected ConversionGoalCampaignConfigName() {
    customerId = null;
    campaignId = null;
  }

  private ConversionGoalCampaignConfigName(Builder builder) {
  ...
  public static ConversionGoalCampaignConfigName of(String customerId, String campaignId) {
  ...
  public static ConversionGoalCampaignConfigName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_ID_CAMPAIGN_ID.validatedMatch(
            formattedString,
            "ConversionGoalCampaignConfigName.parse: formattedString not in valid format");
    return of(matchMap.get("customer_id"), matchMap.get("campaign_id"));
  }

  public static List<ConversionGoalCampaignConfigName> parseList(List<String> formattedStrings) {
    List<ConversionGoalCampaignConfigName> list = new ArrayList<>(formattedStrings.size());
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ConversionGoalCampaignConfigName that = ((ConversionGoalCampaignConfigName) o);
  ...
  public static class Builder {
    ...
    private Builder(ConversionGoalCampaignConfigName conversionGoalCampaignConfigName) {
      this.customerId = conversionGoalCampaignConfigName.customerId;
      this.campaignId = conversionGoalCampaignConfigName.campaignId;
    }

    public ConversionGoalCampaignConfigName build() {
      return new ConversionGoalCampaignConfigName(this);
    }
  }
}
