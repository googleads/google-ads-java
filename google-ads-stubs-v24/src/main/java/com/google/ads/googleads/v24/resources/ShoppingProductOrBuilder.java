...
public interface ShoppingProductOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v24.resources.ShoppingProduct)
   ...
   */
  com.google.ads.googleads.v24.enums.ProductChannelExclusivityEnum.ProductChannelExclusivity getChannelExclusivity();
   ...
   */
  com.google.ads.googleads.v24.enums.ProductConditionEnum.ProductCondition getCondition();
   ...
   */
  com.google.ads.googleads.v24.enums.ProductAvailabilityEnum.ProductAvailability getAvailability();
   ...
   * @return The status.
   */
  com.google.ads.googleads.v24.enums.ProductStatusEnum.ProductStatus getStatus();
   ...
   */
  java.util.List<com.google.ads.googleads.v24.resources.ShoppingProduct.ProductIssue> 
      getIssuesList();
  /**
   * <pre>
   * Output only. The list of issues affecting whether the product can show in
   ...
   * <code>repeated .google.ads.googleads.v24.resources.ShoppingProduct.ProductIssue issues = 33 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v24.resources.ShoppingProduct.ProductIssue getIssues(int index);
  /**
   * <pre>
   * Output only. The list of issues affecting whether the product can show in
   * ads. The value of this field is restricted to the scope specified in the
   ...
   * <code>repeated .google.ads.googleads.v24.resources.ShoppingProduct.ProductIssue issues = 33 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v24.resources.ShoppingProduct.ProductIssueOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v24.resources.ShoppingProduct.ProductIssue issues = 33 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v24.resources.ShoppingProduct.ProductIssueOrBuilder getIssuesOrBuilder(
      int index);
