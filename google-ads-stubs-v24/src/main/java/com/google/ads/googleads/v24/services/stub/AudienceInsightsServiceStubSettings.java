...
public class AudienceInsightsServiceStubSettings
  ...
  private final UnaryCallSettings<
      ...
      generateAudienceDefinitionSettings;
  private final UnaryCallSettings<
  ...
  /** Returns the object with the settings used for calls to generateAudienceDefinition. */
  public UnaryCallSettings<GenerateAudienceDefinitionRequest, GenerateAudienceDefinitionResponse>
      generateAudienceDefinitionSettings() {
    return generateAudienceDefinitionSettings;
  }
  ...
  protected AudienceInsightsServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    generateAudienceDefinitionSettings =
        settingsBuilder.generateAudienceDefinitionSettings().build();
    generateSuggestedTargetingInsightsSettings =
  ...
  public static class Builder
    ...
    protected Builder(ClientContext clientContext) {
      ...
      generateAudienceDefinitionSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
    ...
    protected Builder(AudienceInsightsServiceStubSettings settings) {
      ...
      generateAudienceDefinitionSettings = settings.generateAudienceDefinitionSettings.toBuilder();
      generateSuggestedTargetingInsightsSettings =
    ...
    /** Returns the builder for the settings used for calls to generateAudienceDefinition. */
    public UnaryCallSettings.Builder<
            GenerateAudienceDefinitionRequest, GenerateAudienceDefinitionResponse>
        generateAudienceDefinitionSettings() {
      return generateAudienceDefinitionSettings;
