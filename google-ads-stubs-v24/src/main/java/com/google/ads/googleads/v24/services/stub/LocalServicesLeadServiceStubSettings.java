...
import com.google.ads.googleads.v24.services.AppendLeadConversationRequest;
import com.google.ads.googleads.v24.services.AppendLeadConversationResponse;
import com.google.ads.googleads.v24.services.ProvideLeadFeedbackRequest;
import com.google.ads.googleads.v24.services.ProvideLeadFeedbackResponse;
...
/**
 * Settings class to configure an instance of {@link LocalServicesLeadServiceStub}.
 *
 ...
 * LocalServicesLeadServiceStubSettings.Builder localServicesLeadServiceSettingsBuilder =
 *     LocalServicesLeadServiceStubSettings.newBuilder();
 * localServicesLeadServiceSettingsBuilder
 ...
 *             .build());
 * LocalServicesLeadServiceStubSettings localServicesLeadServiceSettings =
 *     localServicesLeadServiceSettingsBuilder.build();
 * }</pre>
 *
...
public class LocalServicesLeadServiceStubSettings
    extends StubSettings<LocalServicesLeadServiceStubSettings> {
  ...
  public LocalServicesLeadServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return GrpcLocalServicesLeadServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(LocalServicesLeadServiceStubSettings.class))
        .setTransportToken(
  ...
  protected LocalServicesLeadServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder
      extends StubSettings.Builder<LocalServicesLeadServiceStubSettings, Builder> {
    ...
    protected Builder(LocalServicesLeadServiceStubSettings settings) {
      super(settings);
    ...
    /** Returns the builder for the settings used for calls to appendLeadConversation. */
    ...
    @Override
    public LocalServicesLeadServiceStubSettings build() throws IOException {
      return new LocalServicesLeadServiceStubSettings(this);
    }
  }
}
