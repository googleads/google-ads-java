...
import com.google.ads.googleads.v24.services.CreateProductLinkInvitationRequest;
import com.google.ads.googleads.v24.services.CreateProductLinkInvitationResponse;
import com.google.ads.googleads.v24.services.RemoveProductLinkInvitationRequest;
import com.google.ads.googleads.v24.services.RemoveProductLinkInvitationResponse;
import com.google.ads.googleads.v24.services.UpdateProductLinkInvitationRequest;
import com.google.ads.googleads.v24.services.UpdateProductLinkInvitationResponse;
...
/**
 * Settings class to configure an instance of {@link ProductLinkInvitationServiceStub}.
 *
 ...
 * ProductLinkInvitationServiceStubSettings.Builder productLinkInvitationServiceSettingsBuilder =
 *     ProductLinkInvitationServiceStubSettings.newBuilder();
 ...
 *             .build());
 * ProductLinkInvitationServiceStubSettings productLinkInvitationServiceSettings =
...
public class ProductLinkInvitationServiceStubSettings
  ...
  public UnaryCallSettings<CreateProductLinkInvitationRequest, CreateProductLinkInvitationResponse>
      createProductLinkInvitationSettings() {
    return createProductLinkInvitationSettings;
  }
  ...
  public UnaryCallSettings<UpdateProductLinkInvitationRequest, UpdateProductLinkInvitationResponse>
      updateProductLinkInvitationSettings() {
    return updateProductLinkInvitationSettings;
  }
  ...
  public UnaryCallSettings<RemoveProductLinkInvitationRequest, RemoveProductLinkInvitationResponse>
      removeProductLinkInvitationSettings() {
    return removeProductLinkInvitationSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic",
            GaxProperties.getLibraryVersion(ProductLinkInvitationServiceStubSettings.class))
        .setTransportToken(
  ...
  protected ProductLinkInvitationServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    createProductLinkInvitationSettings =
        settingsBuilder.createProductLinkInvitationSettings().build();
    updateProductLinkInvitationSettings =
        settingsBuilder.updateProductLinkInvitationSettings().build();
    removeProductLinkInvitationSettings =
        settingsBuilder.removeProductLinkInvitationSettings().build();
  }
  ...
  public static class Builder
    ...
    protected Builder(ClientContext clientContext) {
      ...
      createProductLinkInvitationSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      updateProductLinkInvitationSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      removeProductLinkInvitationSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
    ...
    protected Builder(ProductLinkInvitationServiceStubSettings settings) {
      ...
      createProductLinkInvitationSettings =
          settings.createProductLinkInvitationSettings.toBuilder();
      updateProductLinkInvitationSettings =
          settings.updateProductLinkInvitationSettings.toBuilder();
      removeProductLinkInvitationSettings =
          settings.removeProductLinkInvitationSettings.toBuilder();
