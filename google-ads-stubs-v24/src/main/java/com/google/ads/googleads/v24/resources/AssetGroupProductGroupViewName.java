...
public class AssetGroupProductGroupViewName implements ResourceName {
  ...
  @Deprecated
  protected AssetGroupProductGroupViewName() {
    customerId = null;
    assetGroupId = null;
    listingGroupFilterId = null;
  }

  private AssetGroupProductGroupViewName(Builder builder) {
  ...
  public static AssetGroupProductGroupViewName of(
  ...
  public static AssetGroupProductGroupViewName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_ID_ASSET_GROUP_ID_LISTING_GROUP_FILTER_ID.validatedMatch(
            formattedString,
            "AssetGroupProductGroupViewName.parse: formattedString not in valid format");
    return of(
  ...
  public static List<AssetGroupProductGroupViewName> parseList(List<String> formattedStrings) {
    List<AssetGroupProductGroupViewName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<AssetGroupProductGroupViewName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (AssetGroupProductGroupViewName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      AssetGroupProductGroupViewName that = ((AssetGroupProductGroupViewName) o);
  ...
  public static class Builder {
    ...
    private Builder(AssetGroupProductGroupViewName assetGroupProductGroupViewName) {
      this.customerId = assetGroupProductGroupViewName.customerId;
      this.assetGroupId = assetGroupProductGroupViewName.assetGroupId;
      this.listingGroupFilterId = assetGroupProductGroupViewName.listingGroupFilterId;
    }

    public AssetGroupProductGroupViewName build() {
      return new AssetGroupProductGroupViewName(this);
    }
  }
}
