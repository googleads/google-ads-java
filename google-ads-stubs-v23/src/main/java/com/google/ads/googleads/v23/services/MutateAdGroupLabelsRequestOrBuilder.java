...
public interface MutateAdGroupLabelsRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v23.services.AdGroupLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.ads.googleads.v23.services.AdGroupLabelOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on ad group labels.
   ...
   * <code>repeated .google.ads.googleads.v23.services.AdGroupLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.AdGroupLabelOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on ad group labels.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v23.services.AdGroupLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v23.services.AdGroupLabelOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v23.services.AdGroupLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.AdGroupLabelOperationOrBuilder getOperationsOrBuilder(
      int index);
