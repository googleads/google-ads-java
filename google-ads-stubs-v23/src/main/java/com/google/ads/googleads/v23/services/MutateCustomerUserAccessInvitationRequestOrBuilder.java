...
public interface MutateCustomerUserAccessInvitationRequestOrBuilder extends
   ...
   */
  com.google.ads.googleads.v23.services.CustomerUserAccessInvitationOperation getOperation();
  /**
   * <pre>
   * Required. The operation to perform on the access invitation
   * </pre>
   ...
   * <code>.google.ads.googleads.v23.services.CustomerUserAccessInvitationOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.CustomerUserAccessInvitationOperationOrBuilder getOperationOrBuilder();
}
