...
public interface MutateUserListCustomerTypesRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.ads.googleads.v23.services.UserListCustomerTypeOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on the user list customer
   ...
   * <code>repeated .google.ads.googleads.v23.services.UserListCustomerTypeOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.UserListCustomerTypeOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on the user list customer
   * types.
   ...
   * <code>repeated .google.ads.googleads.v23.services.UserListCustomerTypeOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v23.services.UserListCustomerTypeOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v23.services.UserListCustomerTypeOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.UserListCustomerTypeOperationOrBuilder getOperationsOrBuilder(
      int index);
