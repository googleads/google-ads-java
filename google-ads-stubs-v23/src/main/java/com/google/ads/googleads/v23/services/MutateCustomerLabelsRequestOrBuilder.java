...
public interface MutateCustomerLabelsRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.ads.googleads.v23.services.CustomerLabelOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on customer-label
   ...
   * <code>repeated .google.ads.googleads.v23.services.CustomerLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.CustomerLabelOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on customer-label
   * relationships.
   ...
   * <code>repeated .google.ads.googleads.v23.services.CustomerLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v23.services.CustomerLabelOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v23.services.CustomerLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.CustomerLabelOperationOrBuilder getOperationsOrBuilder(
      int index);
