...
public interface EnablePMaxBrandGuidelinesRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v23.services.EnableOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.ads.googleads.v23.services.EnableOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of individual campaign operations. A maximum of 10
   ...
   * <code>repeated .google.ads.googleads.v23.services.EnableOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.EnableOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of individual campaign operations. A maximum of 10
   * enable operations can be executed in a request.
   ...
   * <code>repeated .google.ads.googleads.v23.services.EnableOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v23.services.EnableOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v23.services.EnableOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.EnableOperationOrBuilder getOperationsOrBuilder(
      int index);
}
