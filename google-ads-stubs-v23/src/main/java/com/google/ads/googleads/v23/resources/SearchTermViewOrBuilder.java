...
public interface SearchTermViewOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v23.enums.SearchTermTargetingStatusEnum.SearchTermTargetingStatus status = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v23.enums.SearchTermTargetingStatusEnum.SearchTermTargetingStatus getStatus();
}
