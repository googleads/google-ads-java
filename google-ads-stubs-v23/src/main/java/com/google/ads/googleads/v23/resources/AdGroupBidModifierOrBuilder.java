...
public interface AdGroupBidModifierOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v23.enums.BidModifierSourceEnum.BidModifierSource bid_modifier_source = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v23.enums.BidModifierSourceEnum.BidModifierSource getBidModifierSource();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v23.common.HotelDateSelectionTypeInfo hotel_date_selection_type = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v23.common.HotelDateSelectionTypeInfo getHotelDateSelectionType();
  /**
   * <pre>
   * Immutable. Criterion for hotel date selection (default dates versus user
   * selected).
   ...
   * <code>.google.ads.googleads.v23.common.HotelDateSelectionTypeInfo hotel_date_selection_type = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.ads.googleads.v23.common.HotelDateSelectionTypeInfoOrBuilder getHotelDateSelectionTypeOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v23.common.HotelAdvanceBookingWindowInfo hotel_advance_booking_window = 6 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v23.common.HotelAdvanceBookingWindowInfo getHotelAdvanceBookingWindow();
  /**
   * <pre>
   * Immutable. Criterion for number of days prior to the stay the booking is
   * being made.
   ...
   * <code>.google.ads.googleads.v23.common.HotelAdvanceBookingWindowInfo hotel_advance_booking_window = 6 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.ads.googleads.v23.common.HotelAdvanceBookingWindowInfoOrBuilder getHotelAdvanceBookingWindowOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v23.common.HotelLengthOfStayInfo hotel_length_of_stay = 7 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v23.common.HotelLengthOfStayInfo getHotelLengthOfStay();
  /**
   * <pre>
   * Immutable. Criterion for length of hotel stay in nights.
   * </pre>
   ...
   * <code>.google.ads.googleads.v23.common.HotelLengthOfStayInfo hotel_length_of_stay = 7 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.ads.googleads.v23.common.HotelLengthOfStayInfoOrBuilder getHotelLengthOfStayOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v23.common.HotelCheckInDayInfo hotel_check_in_day = 8 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v23.common.HotelCheckInDayInfo getHotelCheckInDay();
  /**
   * <pre>
   * Immutable. Criterion for day of the week the booking is for.
   * </pre>
   ...
   * <code>.google.ads.googleads.v23.common.HotelCheckInDayInfo hotel_check_in_day = 8 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.ads.googleads.v23.common.HotelCheckInDayInfoOrBuilder getHotelCheckInDayOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v23.common.DeviceInfo device = 11 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v23.common.HotelCheckInDateRangeInfo hotel_check_in_date_range = 17 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v23.common.HotelCheckInDateRangeInfo getHotelCheckInDateRange();
  /**
   * <pre>
   * Immutable. Criterion for a hotel check-in date range.
   * </pre>
   ...
   * <code>.google.ads.googleads.v23.common.HotelCheckInDateRangeInfo hotel_check_in_date_range = 17 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.ads.googleads.v23.common.HotelCheckInDateRangeInfoOrBuilder getHotelCheckInDateRangeOrBuilder();

  com.google.ads.googleads.v23.resources.AdGroupBidModifier.CriterionCase getCriterionCase();
}
