...
public interface MutateCustomizerAttributeResultOrBuilder extends
   ...
   */
  com.google.ads.googleads.v23.resources.CustomizerAttribute getCustomizerAttribute();
  /**
   * <pre>
   * The mutated CustomizerAttribute with only mutable fields after mutate.
   * The field will only be returned when response_content_type is set to
   ...
   * <code>.google.ads.googleads.v23.resources.CustomizerAttribute customizer_attribute = 2;</code>
   */
  com.google.ads.googleads.v23.resources.CustomizerAttributeOrBuilder getCustomizerAttributeOrBuilder();
}
