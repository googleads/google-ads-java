...
import com.google.ads.googleads.v23.services.stub.LocalServicesLeadServiceStubSettings;
...
/**
 * Settings class to configure an instance of {@link LocalServicesLeadServiceClient}.
 *
 ...
 * LocalServicesLeadServiceSettings.Builder localServicesLeadServiceSettingsBuilder =
...
public class LocalServicesLeadServiceSettings
    extends ClientSettings<LocalServicesLeadServiceSettings> {
  ...
  public UnaryCallSettings<AppendLeadConversationRequest, AppendLeadConversationResponse>
      appendLeadConversationSettings() {
    return ((LocalServicesLeadServiceStubSettings) getStubSettings())
        .appendLeadConversationSettings();
  }
  ...
  protected LocalServicesLeadServiceSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);
  }

  /** Builder for LocalServicesLeadServiceSettings. */
  public static class Builder
      extends ClientSettings.Builder<LocalServicesLeadServiceSettings, Builder> {
    ...
    protected Builder(LocalServicesLeadServiceSettings settings) {
      super(settings.getStubSettings().toBuilder());
    }

    protected Builder(LocalServicesLeadServiceStubSettings.Builder stubSettings) {
      super(stubSettings);
    }
    ...
    @Override
    public LocalServicesLeadServiceSettings build() throws IOException {
