...
public interface MutateUserListsRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.ads.googleads.v23.services.UserListOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual user lists.
   ...
   * <code>repeated .google.ads.googleads.v23.services.UserListOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.UserListOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual user lists.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v23.services.UserListOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v23.services.UserListOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v23.services.UserListOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.UserListOperationOrBuilder getOperationsOrBuilder(
      int index);
