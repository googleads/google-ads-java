...
public interface MutateExperimentArmResultOrBuilder extends
   ...
   */
  com.google.ads.googleads.v23.resources.ExperimentArm getExperimentArm();
  /**
   * <pre>
   * The mutated experiment arm with only mutable fields after mutate. The
   * field will only be returned when response_content_type is set to
   ...
   * <code>.google.ads.googleads.v23.resources.ExperimentArm experiment_arm = 2;</code>
   */
  com.google.ads.googleads.v23.resources.ExperimentArmOrBuilder getExperimentArmOrBuilder();
}
