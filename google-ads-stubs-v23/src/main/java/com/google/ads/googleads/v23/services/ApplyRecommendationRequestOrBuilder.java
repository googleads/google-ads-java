...
public interface ApplyRecommendationRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.ads.googleads.v23.services.ApplyRecommendationOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to apply recommendations.
   ...
   * <code>repeated .google.ads.googleads.v23.services.ApplyRecommendationOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.ApplyRecommendationOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to apply recommendations.
   * If partial_failure=false all recommendations should be of the same type
   ...
   * <code>repeated .google.ads.googleads.v23.services.ApplyRecommendationOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v23.services.ApplyRecommendationOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v23.services.ApplyRecommendationOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.ApplyRecommendationOperationOrBuilder getOperationsOrBuilder(
      int index);
