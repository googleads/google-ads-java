...
public interface MutateCustomerResultOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v23.resources.Customer customer = 2;</code>
   ...
   * @return The customer.
   */
  com.google.ads.googleads.v23.resources.Customer getCustomer();
  /**
   * <pre>
   * The mutated customer with only mutable fields after mutate. The fields will
   * only be returned when response_content_type is set to "MUTABLE_RESOURCE".
   ...
   * <code>.google.ads.googleads.v23.resources.Customer customer = 2;</code>
   */
  com.google.ads.googleads.v23.resources.CustomerOrBuilder getCustomerOrBuilder();
}
