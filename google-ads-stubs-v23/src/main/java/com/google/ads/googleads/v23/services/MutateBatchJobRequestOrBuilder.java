...
public interface MutateBatchJobRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v23.services.BatchJobOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   */
  com.google.ads.googleads.v23.services.BatchJobOperation getOperation();
  /**
   * <pre>
   * Required. The operation to perform on an individual batch job.
   * </pre>
   ...
   * <code>.google.ads.googleads.v23.services.BatchJobOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.BatchJobOperationOrBuilder getOperationOrBuilder();
}
