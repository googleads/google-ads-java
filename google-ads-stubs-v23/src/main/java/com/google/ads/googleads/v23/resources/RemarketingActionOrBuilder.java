...
public interface RemarketingActionOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v23.common.TagSnippet tag_snippets = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.ads.googleads.v23.common.TagSnippet> 
      getTagSnippetsList();
  /**
   * <pre>
   * Output only. The snippets used for tracking remarketing actions.
   ...
   * <code>repeated .google.ads.googleads.v23.common.TagSnippet tag_snippets = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v23.common.TagSnippet getTagSnippets(int index);
  /**
   * <pre>
   * Output only. The snippets used for tracking remarketing actions.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v23.common.TagSnippet tag_snippets = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v23.common.TagSnippetOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v23.common.TagSnippet tag_snippets = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v23.common.TagSnippetOrBuilder getTagSnippetsOrBuilder(
      int index);
}
