...
public interface MutateBiddingDataExclusionsResultOrBuilder extends
   ...
   */
  com.google.ads.googleads.v23.resources.BiddingDataExclusion getBiddingDataExclusion();
  /**
   * <pre>
   * The mutated bidding data exclusion with only mutable fields after mutate.
   * The field will only be returned when response_content_type is set
   ...
   * <code>.google.ads.googleads.v23.resources.BiddingDataExclusion bidding_data_exclusion = 2;</code>
   */
  com.google.ads.googleads.v23.resources.BiddingDataExclusionOrBuilder getBiddingDataExclusionOrBuilder();
}
