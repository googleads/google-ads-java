...
public interface ParentalStatusDimensionOrBuilder extends
   ...
   */
  java.util.List<com.google.ads.googleads.v23.enums.ParentalStatusTypeEnum.ParentalStatusType> getParentalStatusesList();
  /**
   * <pre>
   * Included parental status demographic segments.
   * </pre>
   ...
   */
  com.google.ads.googleads.v23.enums.ParentalStatusTypeEnum.ParentalStatusType getParentalStatuses(int index);
  /**
   * <pre>
   * Included parental status demographic segments.
   * </pre>
