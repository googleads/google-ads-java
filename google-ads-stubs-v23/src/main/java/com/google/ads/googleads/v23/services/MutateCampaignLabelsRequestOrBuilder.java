...
public interface MutateCampaignLabelsRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.ads.googleads.v23.services.CampaignLabelOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on campaign-label
   ...
   * <code>repeated .google.ads.googleads.v23.services.CampaignLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.CampaignLabelOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on campaign-label
   * relationships.
   ...
   * <code>repeated .google.ads.googleads.v23.services.CampaignLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v23.services.CampaignLabelOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v23.services.CampaignLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.CampaignLabelOperationOrBuilder getOperationsOrBuilder(
      int index);
