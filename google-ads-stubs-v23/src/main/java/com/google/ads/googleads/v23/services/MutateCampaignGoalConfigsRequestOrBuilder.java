...
public interface MutateCampaignGoalConfigsRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.ads.googleads.v23.services.CampaignGoalConfigOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on the campaign goal configs.
   ...
   * <code>repeated .google.ads.googleads.v23.services.CampaignGoalConfigOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.CampaignGoalConfigOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on the campaign goal configs.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v23.services.CampaignGoalConfigOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v23.services.CampaignGoalConfigOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v23.services.CampaignGoalConfigOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.CampaignGoalConfigOperationOrBuilder getOperationsOrBuilder(
      int index);
