...
public interface MutateRecommendationSubscriptionRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.ads.googleads.v23.services.RecommendationSubscriptionOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of create or update operations.
   ...
   * <code>repeated .google.ads.googleads.v23.services.RecommendationSubscriptionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.RecommendationSubscriptionOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of create or update operations.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v23.services.RecommendationSubscriptionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v23.services.RecommendationSubscriptionOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v23.services.RecommendationSubscriptionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.RecommendationSubscriptionOperationOrBuilder getOperationsOrBuilder(
      int index);
