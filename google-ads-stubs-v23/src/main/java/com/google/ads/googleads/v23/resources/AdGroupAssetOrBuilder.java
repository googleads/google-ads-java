...
public interface AdGroupAssetOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v23.enums.AssetFieldTypeEnum.AssetFieldType field_type = 4 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v23.enums.AssetFieldTypeEnum.AssetFieldType getFieldType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v23.enums.AssetSourceEnum.AssetSource source = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The source.
   */
  com.google.ads.googleads.v23.enums.AssetSourceEnum.AssetSource getSource();
   ...
   * @return The status.
   */
  com.google.ads.googleads.v23.enums.AssetLinkStatusEnum.AssetLinkStatus getStatus();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v23.enums.AssetLinkPrimaryStatusEnum.AssetLinkPrimaryStatus primary_status = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v23.enums.AssetLinkPrimaryStatusEnum.AssetLinkPrimaryStatus getPrimaryStatus();
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v23.common.AssetLinkPrimaryStatusDetails primary_status_details = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.ads.googleads.v23.common.AssetLinkPrimaryStatusDetails> 
   ...
   * <code>repeated .google.ads.googleads.v23.common.AssetLinkPrimaryStatusDetails primary_status_details = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v23.common.AssetLinkPrimaryStatusDetails getPrimaryStatusDetails(int index);
  /**
   * <pre>
   * Output only. Provides the details of the primary status and its associated
   * reasons.
   ...
   * <code>repeated .google.ads.googleads.v23.common.AssetLinkPrimaryStatusDetails primary_status_details = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v23.common.AssetLinkPrimaryStatusDetailsOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v23.common.AssetLinkPrimaryStatusDetails primary_status_details = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v23.common.AssetLinkPrimaryStatusDetailsOrBuilder getPrimaryStatusDetailsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.ads.googleads.v23.enums.AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason> getPrimaryStatusReasonsList();
  /**
   * <pre>
   * Output only. Provides a list of reasons for why an asset is not serving or
   * not serving at full capacity.
   ...
   */
  com.google.ads.googleads.v23.enums.AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason getPrimaryStatusReasons(int index);
  /**
   * <pre>
   * Output only. Provides a list of reasons for why an asset is not serving or
   * not serving at full capacity.
