...
public interface CreateOfflineUserDataJobRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v23.resources.OfflineUserDataJob job = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * @return The job.
   */
  com.google.ads.googleads.v23.resources.OfflineUserDataJob getJob();
  /**
   * <pre>
   * Required. The offline user data job to be created.
   * </pre>
   ...
   * <code>.google.ads.googleads.v23.resources.OfflineUserDataJob job = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.resources.OfflineUserDataJobOrBuilder getJobOrBuilder();
