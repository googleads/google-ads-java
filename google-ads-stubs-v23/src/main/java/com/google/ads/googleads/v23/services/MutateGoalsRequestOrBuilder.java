...
public interface MutateGoalsRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.ads.googleads.v23.services.GoalOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on the goals.
   ...
   * <code>repeated .google.ads.googleads.v23.services.GoalOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.GoalOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on the goals.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v23.services.GoalOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v23.services.GoalOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v23.services.GoalOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.GoalOperationOrBuilder getOperationsOrBuilder(
      int index);
