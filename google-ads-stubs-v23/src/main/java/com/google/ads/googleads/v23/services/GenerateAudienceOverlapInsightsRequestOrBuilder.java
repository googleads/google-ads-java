...
public interface GenerateAudienceOverlapInsightsRequestOrBuilder extends
   ...
   */
  com.google.ads.googleads.v23.common.AudienceInsightsAttribute getPrimaryAttribute();
  /**
   * <pre>
   * Required. The audience attribute that should be intersected with all other
   * eligible audiences.  This must be an Affinity or In-Market UserInterest, an
   ...
   * <code>.google.ads.googleads.v23.common.AudienceInsightsAttribute primary_attribute = 6 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.common.AudienceInsightsAttributeOrBuilder getPrimaryAttributeOrBuilder();
