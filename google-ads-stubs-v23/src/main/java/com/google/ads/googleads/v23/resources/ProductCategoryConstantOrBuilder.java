...
public interface ProductCategoryConstantOrBuilder extends
   ...
   * @return The state.
   */
  com.google.ads.googleads.v23.enums.ProductCategoryStateEnum.ProductCategoryState getState();
   ...
   */
  java.util.List<com.google.ads.googleads.v23.resources.ProductCategoryConstant.ProductCategoryLocalization> 
   ...
   * <code>repeated .google.ads.googleads.v23.resources.ProductCategoryConstant.ProductCategoryLocalization localizations = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v23.resources.ProductCategoryConstant.ProductCategoryLocalization getLocalizations(int index);
  /**
   * <pre>
   * Output only. List of all available localizations of the product category.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v23.resources.ProductCategoryConstant.ProductCategoryLocalization localizations = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v23.resources.ProductCategoryConstant.ProductCategoryLocalizationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v23.resources.ProductCategoryConstant.ProductCategoryLocalization localizations = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v23.resources.ProductCategoryConstant.ProductCategoryLocalizationOrBuilder getLocalizationsOrBuilder(
      int index);
}
