...
import com.google.ads.googleads.v23.services.stub.KeywordPlanIdeaServiceStubSettings;
...
public class KeywordPlanIdeaServiceSettings extends ClientSettings<KeywordPlanIdeaServiceSettings> {
  ...
  public UnaryCallSettings<GenerateAdGroupThemesRequest, GenerateAdGroupThemesResponse>
    ...
    return ((KeywordPlanIdeaServiceStubSettings) getStubSettings()).generateAdGroupThemesSettings();
  }
  ...
  public static class Builder
    ...
    public UnaryCallSettings.Builder<GenerateAdGroupThemesRequest, GenerateAdGroupThemesResponse>
        generateAdGroupThemesSettings() {
      return getStubSettingsBuilder().generateAdGroupThemesSettings();
    }
    ...
    public UnaryCallSettings.Builder<
            GenerateKeywordForecastMetricsRequest, GenerateKeywordForecastMetricsResponse>
        generateKeywordForecastMetricsSettings() {
      return getStubSettingsBuilder().generateKeywordForecastMetricsSettings();
    }
