...
public interface MutateKeywordPlanAdGroupsRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.ads.googleads.v23.services.KeywordPlanAdGroupOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual Keyword Plan ad
   ...
   * <code>repeated .google.ads.googleads.v23.services.KeywordPlanAdGroupOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.KeywordPlanAdGroupOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual Keyword Plan ad
   * groups.
   ...
   * <code>repeated .google.ads.googleads.v23.services.KeywordPlanAdGroupOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v23.services.KeywordPlanAdGroupOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v23.services.KeywordPlanAdGroupOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.KeywordPlanAdGroupOperationOrBuilder getOperationsOrBuilder(
      int index);
