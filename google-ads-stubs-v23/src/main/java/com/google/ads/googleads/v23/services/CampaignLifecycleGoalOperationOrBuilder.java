...
public interface CampaignLifecycleGoalOperationOrBuilder extends
   ...
   * @return The create.
   */
  com.google.ads.googleads.v23.resources.CampaignLifecycleGoal getCreate();
  /**
   * <pre>
   * Create operation: Create a new campaign lifecycle goal. The campaign
   * field should be set for this operation.
   ...
   * <code>.google.ads.googleads.v23.resources.CampaignLifecycleGoal create = 1;</code>
   */
  com.google.ads.googleads.v23.resources.CampaignLifecycleGoalOrBuilder getCreateOrBuilder();
   ...
   * @return The update.
   */
  com.google.ads.googleads.v23.resources.CampaignLifecycleGoal getUpdate();
  /**
   * <pre>
   * Update operation: Update an existing campaign lifecycle goal. The
   * campaign field should not be set for this operation.
   ...
   * <code>.google.ads.googleads.v23.resources.CampaignLifecycleGoal update = 3;</code>
   */
  com.google.ads.googleads.v23.resources.CampaignLifecycleGoalOrBuilder getUpdateOrBuilder();

  com.google.ads.googleads.v23.services.CampaignLifecycleGoalOperation.OperationCase getOperationCase();
}
