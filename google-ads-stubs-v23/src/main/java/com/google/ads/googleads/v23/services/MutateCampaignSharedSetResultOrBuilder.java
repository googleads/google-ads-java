...
public interface MutateCampaignSharedSetResultOrBuilder extends
   ...
   */
  com.google.ads.googleads.v23.resources.CampaignSharedSet getCampaignSharedSet();
  /**
   * <pre>
   * The mutated campaign shared set with only mutable fields after mutate. The
   * field will only be returned when response_content_type is set to
   ...
   * <code>.google.ads.googleads.v23.resources.CampaignSharedSet campaign_shared_set = 2;</code>
   */
  com.google.ads.googleads.v23.resources.CampaignSharedSetOrBuilder getCampaignSharedSetOrBuilder();
}
