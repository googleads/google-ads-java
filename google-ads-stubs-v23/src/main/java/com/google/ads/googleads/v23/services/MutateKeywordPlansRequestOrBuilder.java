...
public interface MutateKeywordPlansRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v23.services.KeywordPlanOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.ads.googleads.v23.services.KeywordPlanOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual keyword plans.
   ...
   * <code>repeated .google.ads.googleads.v23.services.KeywordPlanOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.KeywordPlanOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual keyword plans.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v23.services.KeywordPlanOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v23.services.KeywordPlanOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v23.services.KeywordPlanOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.KeywordPlanOperationOrBuilder getOperationsOrBuilder(
      int index);
