...
public interface MutateCustomerCustomizerResultOrBuilder extends
   ...
   */
  com.google.ads.googleads.v23.resources.CustomerCustomizer getCustomerCustomizer();
  /**
   * <pre>
   * The mutated CustomerCustomizer with only mutable fields after mutate.
   * The field will only be returned when response_content_type is set to
   ...
   * <code>.google.ads.googleads.v23.resources.CustomerCustomizer customer_customizer = 2;</code>
   */
  com.google.ads.googleads.v23.resources.CustomerCustomizerOrBuilder getCustomerCustomizerOrBuilder();
}
