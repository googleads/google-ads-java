...
public interface AccountBudgetProposalOperationOrBuilder extends
   ...
   * @return The create.
   */
  com.google.ads.googleads.v23.resources.AccountBudgetProposal getCreate();
  /**
   * <pre>
   * Create operation: A new proposal to create a new budget, edit an
   * existing budget, end an actively running budget, or remove an approved
   ...
   * <code>.google.ads.googleads.v23.resources.AccountBudgetProposal create = 2;</code>
   */
  com.google.ads.googleads.v23.resources.AccountBudgetProposalOrBuilder getCreateOrBuilder();
  ...
  com.google.ads.googleads.v23.services.AccountBudgetProposalOperation.OperationCase getOperationCase();
}
