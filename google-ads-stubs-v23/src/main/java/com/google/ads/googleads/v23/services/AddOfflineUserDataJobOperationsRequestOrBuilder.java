...
public interface AddOfflineUserDataJobOperationsRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v23.services.OfflineUserDataJobOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.ads.googleads.v23.services.OfflineUserDataJobOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to be done.
   ...
   * <code>repeated .google.ads.googleads.v23.services.OfflineUserDataJobOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.OfflineUserDataJobOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to be done.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v23.services.OfflineUserDataJobOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v23.services.OfflineUserDataJobOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v23.services.OfflineUserDataJobOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.OfflineUserDataJobOperationOrBuilder getOperationsOrBuilder(
      int index);
