...
public interface OfflineConversionAlertOrBuilder extends
   ...
   * @return The error.
   */
  com.google.ads.googleads.v23.resources.OfflineConversionError getError();
  /**
   * <pre>
   * Output only. Error for offline conversion client alert.
   * </pre>
   ...
   * <code>.google.ads.googleads.v23.resources.OfflineConversionError error = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v23.resources.OfflineConversionErrorOrBuilder getErrorOrBuilder();
