...
public interface MutateAccountBudgetProposalRequestOrBuilder extends
   ...
   */
  com.google.ads.googleads.v23.services.AccountBudgetProposalOperation getOperation();
  /**
   * <pre>
   * Required. The operation to perform on an individual account-level budget
   * proposal.
   ...
   * <code>.google.ads.googleads.v23.services.AccountBudgetProposalOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v23.services.AccountBudgetProposalOperationOrBuilder getOperationOrBuilder();
