...
import com.google.ads.googleads.v23.common.AudienceInsightsAttribute;
import com.google.ads.googleads.v23.common.AudienceInsightsAttributeMetadata;
import com.google.ads.googleads.v23.common.DateRange;
import com.google.ads.googleads.v23.common.LocationInfo;
import com.google.ads.googleads.v23.enums.AudienceInsightsDimensionEnum;
...
public class AudienceInsightsServiceClientTest {
  ...
  @Test
  public void generateAudienceDefinitionTest() throws Exception {
    GenerateAudienceDefinitionResponse expectedResponse =
        GenerateAudienceDefinitionResponse.newBuilder()
            .addAllHighRelevanceAttributes(new ArrayList<AudienceInsightsAttributeMetadata>())
            .addAllMediumRelevanceAttributes(new ArrayList<AudienceInsightsAttributeMetadata>())
            .build();
    mockAudienceInsightsService.addResponse(expectedResponse);
    ...
    GenerateAudienceDefinitionResponse actualResponse =
        client.generateAudienceDefinition(customerId, audienceDescription);
    Assert.assertEquals(expectedResponse, actualResponse);

    List<AbstractMessage> actualRequests = mockAudienceInsightsService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    GenerateAudienceDefinitionRequest actualRequest =
        ((GenerateAudienceDefinitionRequest) actualRequests.get(0));

    Assert.assertEquals(customerId, actualRequest.getCustomerId());
    Assert.assertEquals(audienceDescription, actualRequest.getAudienceDescription());
    Assert.assertTrue(
        channelProvider.isHeaderSent(
            ApiClientHeaderProvider.getDefaultApiClientHeaderKey(),
            GaxGrpcProperties.getDefaultApiClientHeaderPattern()));
  ...
  @Test
  public void generateAudienceDefinitionExceptionTest() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockAudienceInsightsService.addException(exception);
