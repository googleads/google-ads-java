...
import static com.google.ads.googleads.v23.services.KeywordPlanIdeaServiceClient.GenerateKeywordIdeasPagedResponse;

import com.google.ads.googleads.v23.common.HistoricalMetricsOptions;
import com.google.ads.googleads.v23.common.KeywordPlanAggregateMetricResults;
import com.google.ads.googleads.v23.common.KeywordPlanAggregateMetrics;
import com.google.ads.googleads.v23.enums.KeywordPlanKeywordAnnotationEnum;
...
public class KeywordPlanIdeaServiceClientTest {
  ...
  public void generateAdGroupThemesTest() throws Exception {
    ...
    GenerateAdGroupThemesResponse actualResponse =
    ...
    Assert.assertEquals(keywords, actualRequest.getKeywordsList());
    Assert.assertEquals(adGroups, actualRequest.getAdGroupsList());
    Assert.assertTrue(
        channelProvider.isHeaderSent(
            ApiClientHeaderProvider.getDefaultApiClientHeaderKey(),
            GaxGrpcProperties.getDefaultApiClientHeaderPattern()));
  ...
  public void generateKeywordForecastMetricsTest() throws Exception {
    ...
    GenerateKeywordForecastMetricsResponse actualResponse =
        client.generateKeywordForecastMetrics(campaign);
    Assert.assertEquals(expectedResponse, actualResponse);
    ...
    Assert.assertEquals(campaign, actualRequest.getCampaign());
    Assert.assertTrue(
        channelProvider.isHeaderSent(
            ApiClientHeaderProvider.getDefaultApiClientHeaderKey(),
            GaxGrpcProperties.getDefaultApiClientHeaderPattern()));
