...
public class GetAdGroupBidModifiers {
  ...
  public static void main(String[] args) throws IOException {
    ...
    try {
      new GetAdGroupBidModifiers().runExample(googleAdsClient, params);
   ...
   */
  public void runExample(GoogleAdsClient googleAdsClient, GetAdGroupBidModifiersParams params) {
    try (GoogleAdsServiceClient googleAdsServiceClient =
      ...
      if (params.adGroupId != null) {
        searchQuery += String.format(" WHERE ad_group.id = %d", params.adGroupId);
      }
