...
import com.google.ads.googleads.v2.resources.CampaignCriterion.CriterionCase;
...
public class GetCampaignTargetingCriteria {
  ...
  private static class GetCampaignTargetingCriteriaParams extends CodeSampleParams {
  ...
  public static void main(String[] args) {
    GetCampaignTargetingCriteriaParams params = new GetCampaignTargetingCriteriaParams();
    ...
    try {
      new GetCampaignTargetingCriteria().runExample(googleAdsClient, params);
  ...
  public void runExample(
      GoogleAdsClient googleAdsClient, GetCampaignTargetingCriteriaParams params) {
              ...
              .setQuery(
                  String.format(
                      "SELECT campaign.id, campaign_criterion.campaign, "
                          ...
                          + " WHERE campaign.id = %s",
                      Long.toString(params.campaignId)))
              .build();
