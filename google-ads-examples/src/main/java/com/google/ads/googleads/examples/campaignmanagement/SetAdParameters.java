...
import com.google.ads.googleads.v2.services.MutateAdParameterResult;
...
public class SetAdParameters {
  ...
  public static void main(String[] args) {
    ...
    try {
      new SetAdParameters().runExample(googleAdsClient, params);
   ...
   */
  public void runExample(GoogleAdsClient googleAdsClient, SetAdParameterParams params) {
    ...
    try (AdParameterServiceClient adParameterServiceClient =
      ...
      MutateAdParametersResponse response =
          adParameterServiceClient.mutateAdParameters(Long.toString(params.customerId), operations);
