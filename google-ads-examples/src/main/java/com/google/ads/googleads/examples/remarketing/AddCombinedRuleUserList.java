...
public class AddCombinedRuleUserList {
  ...
  private void runExample(GoogleAdsClient googleAdsClient, long customerId) {
    ...
    // Creates an ExpressionRuleUserListInfo object specifying that both rule1 and rule2 must be
    // satisfied for a user to be added to this list.
    ExpressionRuleUserListInfo expressionRuleUserListInfo =
        ExpressionRuleUserListInfo.newBuilder()
            .setRule(
                // The default rule_type for a UserListRuleInfo object is OR of ANDs (disjunctive
                // normal form). That is, rule items will be ANDed together within rule item groups
                // and the groups themselves will be ORed together.
