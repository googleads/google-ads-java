...
public class GetTextAdRecommendations {
  ...
  public static void main(String[] args) {
    ...
    try {
      new GetTextAdRecommendations().runExample(googleAdsClient, params);
   ...
   */
  public void runExample(GoogleAdsClient googleAdsClient, GetTextAdRecommendationsParams params) {
