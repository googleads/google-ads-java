...
import com.google.ads.googleads.v3.common.TargetRestriction;
import com.google.ads.googleads.v3.common.TargetingSetting;
import com.google.ads.googleads.v3.enums.TargetingDimensionEnum.TargetingDimension;
...
public class UpdateAudienceTargetRestriction {
  ...
  public static void main(String[] args) {
    ...
    try {
      new UpdateAudienceTargetRestriction().runExample(
        googleAdsClient,
        params.customerId,
        params.adGroupId);
  ...
  private void runExample(GoogleAdsClient googleAdsClient, long customerId, long adGroupId) {
    ...
    if (shouldUpdateTargetingSetting) {
      updateTargetingSetting(googleAdsClient,
        customerId,
        adGroupId,
        targetingSettingBuilder.build());
    } else {
