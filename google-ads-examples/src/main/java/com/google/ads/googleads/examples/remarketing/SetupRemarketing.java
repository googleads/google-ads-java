...
/**
 * Demonstrates various operations involved in remarketing, including (a) creating a user list
 * based on visitors to a website, (b) targeting a user list with an ad group criterion, (c)
 * updating the bid modifier on an ad group criterion, (d) finding and removing all ad group
 * criteria under a given campaign, (e) targeting a user list with a campaign criterion, and (f)
 * updating the bid modifier on a campaign criterion. It is unlikely that users will need to
 * perform all of these operations consecutively, and all of the operations contained herein are
 * meant of for illustrative purposes.
 */
public class SetupRemarketing {
  ...
  public static void main(String[] args) {
    ...
    try {
      new SetupRemarketing().runExample(
          googleAdsClient,
          params.customerId,
          params.adGroupId,
          params.campaignId,
  ...
  private void runExample(
    ...
    removeExistingListCriteriaFromAdGroup(
        googleAdsClient, customerId, campaignId);
  ...
  private String createUserList(GoogleAdsClient googleAdsClient, long customerId) {
    ...
    UserListRuleItemInfo rule = UserListRuleItemInfo.newBuilder()
    ...
    ExpressionRuleUserListInfo expressionRuleUserListInfo = ExpressionRuleUserListInfo.newBuilder()
        .setRule(UserListRuleInfo.newBuilder()
            .addRuleItemGroups(UserListRuleItemGroupInfo.newBuilder().addRuleItems(rule).build())
            .build())
        .build();
    ...
    try (UserListServiceClient userListServiceClient =
      ...
      // Adds the user list.
      MutateUserListsResponse response = userListServiceClient
          .mutateUserLists(Long.toString(customerId), ImmutableList.of(operation));
  ...
  private String targetAdsInAdGroupToUserList(
    ...
    try (AdGroupCriterionServiceClient adGroupCriterionServiceClient =
      ...
      System.out.printf("Successfully created ad group criterion with resource name '%s' "
  ...
  private void modifyAdGroupBids(
      ...
      String adGroupCriterionResourceName,
      double bidModifier) {
    // Creates the ad group criterion with a bid modifier of 1.25. You may alternatively set the
    // bid for the ad group criterion directly.
    AdGroupCriterion adGroupCriterion = AdGroupCriterion.newBuilder()
    ...
    try (GoogleAdsServiceClient googleAdsServiceClient =
      ...
      SearchGoogleAdsRequest request =
          SearchGoogleAdsRequest.newBuilder()
              ...
              .setQuery("SELECT ad_group_criterion.criterion_id"
  ...
  private String targetAdsInCampaignToUserList(
    ...
    try (CampaignCriterionServiceClient campaignCriterionServiceClient =
      ...
      System.out.printf("Successfully created campaign criterion with resource name '%s' "
