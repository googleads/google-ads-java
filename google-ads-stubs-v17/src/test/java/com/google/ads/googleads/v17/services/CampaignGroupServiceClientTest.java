...
public class CampaignGroupServiceClientTest {
  ...
  public static void startStaticServer() {
    ...
    mockServiceHelper =
        new MockServiceHelper(
            UUID.randomUUID().toString(), Arrays.<MockGrpcService>asList(mockCampaignGroupService));
  ...
  @Test
  public void mutateCampaignGroupsTest() throws Exception {
    MutateCampaignGroupsResponse expectedResponse =
        MutateCampaignGroupsResponse.newBuilder()
            .addAllResults(new ArrayList<MutateCampaignGroupResult>())
    ...
    List<AbstractMessage> actualRequests = mockCampaignGroupService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    MutateCampaignGroupsRequest actualRequest =
        ((MutateCampaignGroupsRequest) actualRequests.get(0));
