...
public interface ParentalStatusDimensionOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v17.common.ParentalStatusDimension)
   ...
   */
  java.util.List<com.google.ads.googleads.v17.enums.ParentalStatusTypeEnum.ParentalStatusType> getParentalStatusesList();
  /**
   * <pre>
   * Included parental status demographic segments.
   * </pre>
   ...
   */
  com.google.ads.googleads.v17.enums.ParentalStatusTypeEnum.ParentalStatusType getParentalStatuses(int index);
  /**
   * <pre>
   * Included parental status demographic segments.
   * </pre>
