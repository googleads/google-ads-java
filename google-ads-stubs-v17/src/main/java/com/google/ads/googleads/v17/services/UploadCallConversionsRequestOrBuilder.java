...
public interface UploadCallConversionsRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v17.services.CallConversion conversions = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.ads.googleads.v17.services.CallConversion> 
      getConversionsList();
  /**
   * <pre>
   * Required. The conversions that are being uploaded.
