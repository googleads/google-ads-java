...
public interface AdGroupAdOrBuilder extends
   ...
   * @return The status.
   */
  com.google.ads.googleads.v17.enums.AdGroupAdStatusEnum.AdGroupAdStatus getStatus();
   ...
   */
  com.google.ads.googleads.v17.resources.AdGroupAdPolicySummary getPolicySummary();
  /**
   * <pre>
   * Output only. Policy information for the ad.
   * </pre>
   ...
   * <code>.google.ads.googleads.v17.resources.AdGroupAdPolicySummary policy_summary = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v17.resources.AdGroupAdPolicySummaryOrBuilder getPolicySummaryOrBuilder();
   ...
   */
  com.google.ads.googleads.v17.enums.AdGroupAdPrimaryStatusEnum.AdGroupAdPrimaryStatus getPrimaryStatus();
   ...
   */
  java.util.List<com.google.ads.googleads.v17.enums.AdGroupAdPrimaryStatusReasonEnum.AdGroupAdPrimaryStatusReason> getPrimaryStatusReasonsList();
  /**
   * <pre>
   * Output only. Provides reasons for why an ad group ad is not serving or not
   * serving optimally.
   ...
   */
  com.google.ads.googleads.v17.enums.AdGroupAdPrimaryStatusReasonEnum.AdGroupAdPrimaryStatusReason getPrimaryStatusReasons(int index);
  /**
   * <pre>
   * Output only. Provides reasons for why an ad group ad is not serving or not
   * serving optimally.
