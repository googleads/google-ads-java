...
public interface CampaignLifecycleGoalOrBuilder extends
   ...
   */
  com.google.ads.googleads.v17.resources.CustomerAcquisitionGoalSettings getCustomerAcquisitionGoalSettings();
  /**
   * <pre>
   * Output only. The customer acquisition goal settings for the campaign. The
   * customer acquisition goal is described in this article:
   ...
   * <code>.google.ads.googleads.v17.resources.CustomerAcquisitionGoalSettings customer_acquisition_goal_settings = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v17.resources.CustomerAcquisitionGoalSettingsOrBuilder getCustomerAcquisitionGoalSettingsOrBuilder();
}
