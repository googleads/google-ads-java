...
public interface CustomerOrBuilder extends
   ...
   */
  com.google.ads.googleads.v17.resources.CallReportingSetting getCallReportingSetting();
  /**
   * <pre>
   * Call reporting setting for a customer. Only mutable in an `update`
   * operation.
   ...
   * <code>.google.ads.googleads.v17.resources.CallReportingSetting call_reporting_setting = 10;</code>
   */
  com.google.ads.googleads.v17.resources.CallReportingSettingOrBuilder getCallReportingSettingOrBuilder();
   ...
   */
  com.google.ads.googleads.v17.resources.ConversionTrackingSetting getConversionTrackingSetting();
  /**
   * <pre>
   * Output only. Conversion tracking setting for a customer.
   * </pre>
   ...
   * <code>.google.ads.googleads.v17.resources.ConversionTrackingSetting conversion_tracking_setting = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v17.resources.ConversionTrackingSettingOrBuilder getConversionTrackingSettingOrBuilder();
   ...
   */
  com.google.ads.googleads.v17.resources.RemarketingSetting getRemarketingSetting();
  /**
   * <pre>
   * Output only. Remarketing setting for a customer.
   * </pre>
   ...
   * <code>.google.ads.googleads.v17.resources.RemarketingSetting remarketing_setting = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v17.resources.RemarketingSettingOrBuilder getRemarketingSettingOrBuilder();
   ...
   */
  java.util.List<com.google.ads.googleads.v17.enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason> getPayPerConversionEligibilityFailureReasonsList();
  /**
   * <pre>
   * Output only. Reasons why the customer is not eligible to use
   * PaymentMode.CONVERSIONS. If the list is empty, the customer is eligible.
   ...
   */
  com.google.ads.googleads.v17.enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason getPayPerConversionEligibilityFailureReasons(int index);
  /**
   * <pre>
   * Output only. Reasons why the customer is not eligible to use
   * PaymentMode.CONVERSIONS. If the list is empty, the customer is eligible.
   ...
   * @return The status.
   */
  com.google.ads.googleads.v17.enums.CustomerStatusEnum.CustomerStatus getStatus();
   ...
   */
  com.google.ads.googleads.v17.resources.CustomerAgreementSetting getCustomerAgreementSetting();
  /**
   * <pre>
   * Output only. Customer Agreement Setting for a customer.
   * </pre>
   ...
   * <code>.google.ads.googleads.v17.resources.CustomerAgreementSetting customer_agreement_setting = 44 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v17.resources.CustomerAgreementSettingOrBuilder getCustomerAgreementSettingOrBuilder();
   ...
   */
  com.google.ads.googleads.v17.resources.LocalServicesSettings getLocalServicesSettings();
  /**
   * <pre>
   * Output only. Settings for Local Services customer.
   * </pre>
   ...
   * <code>.google.ads.googleads.v17.resources.LocalServicesSettings local_services_settings = 45 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v17.resources.LocalServicesSettingsOrBuilder getLocalServicesSettingsOrBuilder();
