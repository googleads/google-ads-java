...
public interface OfflineConversionErrorOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v17.resources.OfflineConversionError)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v17.errors.CollectionSizeErrorEnum.CollectionSizeError collection_size_error = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v17.errors.ConversionAdjustmentUploadErrorEnum.ConversionAdjustmentUploadError conversion_adjustment_upload_error = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v17.errors.ConversionUploadErrorEnum.ConversionUploadError conversion_upload_error = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v17.errors.DateErrorEnum.DateError date_error = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v17.errors.DistinctErrorEnum.DistinctError distinct_error = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v17.errors.FieldErrorEnum.FieldError field_error = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v17.errors.MutateErrorEnum.MutateError mutate_error = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v17.errors.NotAllowlistedErrorEnum.NotAllowlistedError not_allowlisted_error = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v17.errors.StringFormatErrorEnum.StringFormatError string_format_error = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v17.errors.StringLengthErrorEnum.StringLengthError string_length_error = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
  ...
  com.google.ads.googleads.v17.resources.OfflineConversionError.ErrorCodeCase getErrorCodeCase();
}
