...
public interface LocalServicesEmployeeOrBuilder extends
   ...
   */
  java.util.List<com.google.ads.googleads.v17.resources.UniversityDegree> 
   ...
   */
  java.util.List<com.google.ads.googleads.v17.resources.Residency> 
      getResidenciesList();
  /**
   * <pre>
   * Output only. The institutions where the employee has completed their
   ...
   */
  java.util.List<com.google.ads.googleads.v17.resources.Fellowship> 
      getFellowshipsList();
  /**
   * <pre>
   * Output only. The institutions where the employee has completed their
