...
public interface GenerateRecommendationsRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.ads.googleads.v17.enums.RecommendationTypeEnum.RecommendationType> getRecommendationTypesList();
  /**
   * <pre>
   * Required. List of eligible recommendation_types to generate. If the
   * uploaded criteria isn't sufficient to make a recommendation, or the
   ...
   */
  java.util.List<com.google.ads.googleads.v17.services.GenerateRecommendationsRequest.AdGroupInfo> 
      getAdGroupInfoList();
  /**
   * <pre>
   * Optional. Current AdGroup Information.
