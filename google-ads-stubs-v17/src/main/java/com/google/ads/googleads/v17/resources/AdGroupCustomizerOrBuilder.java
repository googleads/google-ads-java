...
public interface AdGroupCustomizerOrBuilder extends
   ...
   * @return The status.
   */
  com.google.ads.googleads.v17.enums.CustomizerValueStatusEnum.CustomizerValueStatus getStatus();
   ...
   * @return The value.
   */
  com.google.ads.googleads.v17.common.CustomizerValue getValue();
  /**
   * <pre>
   * Required. The value to associate with the customizer attribute at this
   * level. The value must be of the type specified for the CustomizerAttribute.
   ...
   * <code>.google.ads.googleads.v17.common.CustomizerValue value = 5 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v17.common.CustomizerValueOrBuilder getValueOrBuilder();
}
