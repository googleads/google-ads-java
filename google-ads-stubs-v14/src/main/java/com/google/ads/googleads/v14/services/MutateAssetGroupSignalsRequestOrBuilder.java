...
public interface MutateAssetGroupSignalsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v14.services.MutateAssetGroupSignalsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v14.services.AssetGroupSignalOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual asset group
   ...
   * <code>repeated .google.ads.googleads.v14.services.AssetGroupSignalOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v14.services.AssetGroupSignalOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual asset group
   * signals.
   ...
   * <code>repeated .google.ads.googleads.v14.services.AssetGroupSignalOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v14.services.AssetGroupSignalOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v14.services.AssetGroupSignalOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v14.services.AssetGroupSignalOperationOrBuilder getOperationsOrBuilder(
      int index);
