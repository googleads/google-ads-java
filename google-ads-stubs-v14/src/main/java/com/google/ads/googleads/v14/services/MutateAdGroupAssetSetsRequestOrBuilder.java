...
public interface MutateAdGroupAssetSetsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v14.services.MutateAdGroupAssetSetsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v14.services.AdGroupAssetSetOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual ad group asset
   ...
   * <code>repeated .google.ads.googleads.v14.services.AdGroupAssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v14.services.AdGroupAssetSetOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual ad group asset
   * sets.
   ...
   * <code>repeated .google.ads.googleads.v14.services.AdGroupAssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v14.services.AdGroupAssetSetOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v14.services.AdGroupAssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v14.services.AdGroupAssetSetOperationOrBuilder getOperationsOrBuilder(
      int index);
