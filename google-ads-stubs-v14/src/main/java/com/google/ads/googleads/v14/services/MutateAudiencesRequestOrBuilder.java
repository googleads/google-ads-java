...
public interface MutateAudiencesRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v14.services.MutateAudiencesRequest)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v14.services.AudienceOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.ads.googleads.v14.services.AudienceOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual audiences.
   ...
   * <code>repeated .google.ads.googleads.v14.services.AudienceOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v14.services.AudienceOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual audiences.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v14.services.AudienceOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v14.services.AudienceOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v14.services.AudienceOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v14.services.AudienceOperationOrBuilder getOperationsOrBuilder(
      int index);
