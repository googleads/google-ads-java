...
public interface MutateAssetGroupSignalResultOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v14.services.MutateAssetGroupSignalResult)
   ...
   */
  com.google.ads.googleads.v14.resources.AssetGroupSignal getAssetGroupSignal();
  /**
   * <pre>
   * The mutated AssetGroupSignal with only mutable fields after mutate. The
   * field will only be returned when response_content_type is set to
   ...
   * <code>.google.ads.googleads.v14.resources.AssetGroupSignal asset_group_signal = 2;</code>
   */
  com.google.ads.googleads.v14.resources.AssetGroupSignalOrBuilder getAssetGroupSignalOrBuilder();
}
