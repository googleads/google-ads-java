...
public interface MutateCustomerFeedsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v14.services.MutateCustomerFeedsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v14.services.CustomerFeedOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual customer feeds.
   ...
   * <code>repeated .google.ads.googleads.v14.services.CustomerFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v14.services.CustomerFeedOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual customer feeds.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v14.services.CustomerFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v14.services.CustomerFeedOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v14.services.CustomerFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v14.services.CustomerFeedOperationOrBuilder getOperationsOrBuilder(
      int index);
