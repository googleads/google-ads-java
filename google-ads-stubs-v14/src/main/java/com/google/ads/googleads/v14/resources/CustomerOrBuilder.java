...
public interface CustomerOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v14.resources.Customer)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v14.resources.CallReportingSetting call_reporting_setting = 10;</code>
   ...
   */
  com.google.ads.googleads.v14.resources.CallReportingSetting getCallReportingSetting();
  /**
   * <pre>
   * Call reporting setting for a customer. Only mutable in an `update`
   * operation.
   ...
   * <code>.google.ads.googleads.v14.resources.CallReportingSetting call_reporting_setting = 10;</code>
   */
  com.google.ads.googleads.v14.resources.CallReportingSettingOrBuilder getCallReportingSettingOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v14.resources.ConversionTrackingSetting conversion_tracking_setting = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v14.resources.ConversionTrackingSetting getConversionTrackingSetting();
  /**
   * <pre>
   * Output only. Conversion tracking setting for a customer.
   * </pre>
   ...
   * <code>.google.ads.googleads.v14.resources.ConversionTrackingSetting conversion_tracking_setting = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v14.resources.ConversionTrackingSettingOrBuilder getConversionTrackingSettingOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v14.resources.RemarketingSetting remarketing_setting = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v14.resources.RemarketingSetting getRemarketingSetting();
  /**
   * <pre>
   * Output only. Remarketing setting for a customer.
   * </pre>
   ...
   * <code>.google.ads.googleads.v14.resources.RemarketingSetting remarketing_setting = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v14.resources.RemarketingSettingOrBuilder getRemarketingSettingOrBuilder();
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v14.enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason pay_per_conversion_eligibility_failure_reasons = 16 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   * @return A list containing the payPerConversionEligibilityFailureReasons.
   */
  java.util.List<com.google.ads.googleads.v14.enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason> getPayPerConversionEligibilityFailureReasonsList();
  /**
   * <pre>
   * Output only. Reasons why the customer is not eligible to use
   * PaymentMode.CONVERSIONS. If the list is empty, the customer is eligible.
   ...
   */
  com.google.ads.googleads.v14.enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason getPayPerConversionEligibilityFailureReasons(int index);
  /**
   * <pre>
   * Output only. Reasons why the customer is not eligible to use
   * PaymentMode.CONVERSIONS. If the list is empty, the customer is eligible.
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v14.enums.CustomerStatusEnum.CustomerStatus status = 36 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v14.enums.CustomerStatusEnum.CustomerStatus getStatus();
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v14.resources.OfflineConversionClientSummary offline_conversion_client_summaries = 43 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.ads.googleads.v14.resources.OfflineConversionClientSummary> 
   ...
   * <code>repeated .google.ads.googleads.v14.resources.OfflineConversionClientSummary offline_conversion_client_summaries = 43 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v14.resources.OfflineConversionClientSummary getOfflineConversionClientSummaries(int index);
  /**
   * <pre>
   * Output only. Offline conversion upload diagnostics.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v14.resources.OfflineConversionClientSummary offline_conversion_client_summaries = 43 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  int getOfflineConversionClientSummariesCount();
  /**
   * <pre>
   * Output only. Offline conversion upload diagnostics.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v14.resources.OfflineConversionClientSummary offline_conversion_client_summaries = 43 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v14.resources.OfflineConversionClientSummaryOrBuilder> 
