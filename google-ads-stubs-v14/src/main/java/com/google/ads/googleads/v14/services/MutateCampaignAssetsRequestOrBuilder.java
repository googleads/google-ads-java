...
public interface MutateCampaignAssetsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v14.services.MutateCampaignAssetsRequest)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v14.services.CampaignAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.ads.googleads.v14.services.CampaignAssetOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign assets.
   ...
   * <code>repeated .google.ads.googleads.v14.services.CampaignAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v14.services.CampaignAssetOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign assets.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v14.services.CampaignAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v14.services.CampaignAssetOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v14.services.CampaignAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v14.services.CampaignAssetOperationOrBuilder getOperationsOrBuilder(
      int index);
