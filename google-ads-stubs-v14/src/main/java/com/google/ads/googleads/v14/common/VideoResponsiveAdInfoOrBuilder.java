...
public interface VideoResponsiveAdInfoOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v14.common.VideoResponsiveAdInfo)
   ...
   * <code>repeated .google.ads.googleads.v14.common.AdTextAsset call_to_actions = 4;</code>
   */
  com.google.ads.googleads.v14.common.AdTextAsset getCallToActions(int index);
  /**
   * <pre>
   * List of text assets used for the button, for example, the "Call To Action"
   * button. Currently, only a single value for the button is supported.
   ...
   * <code>repeated .google.ads.googleads.v14.common.AdTextAsset call_to_actions = 4;</code>
   */
  com.google.ads.googleads.v14.common.AdTextAssetOrBuilder getCallToActionsOrBuilder(
      int index);
   ...
   * <code>repeated .google.ads.googleads.v14.common.AdImageAsset companion_banners = 6;</code>
   */
  com.google.ads.googleads.v14.common.AdImageAsset getCompanionBanners(int index);
  /**
   * <pre>
   * List of image assets used for the companion banner.
   * Currently, only a single value for the companion banner asset is supported.
   ...
   * <code>repeated .google.ads.googleads.v14.common.AdImageAsset companion_banners = 6;</code>
   */
  com.google.ads.googleads.v14.common.AdImageAssetOrBuilder getCompanionBannersOrBuilder(
      int index);
