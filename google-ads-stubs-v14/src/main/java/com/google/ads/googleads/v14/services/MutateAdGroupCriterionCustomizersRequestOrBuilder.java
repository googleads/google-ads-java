...
public interface MutateAdGroupCriterionCustomizersRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v14.services.MutateAdGroupCriterionCustomizersRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v14.services.AdGroupCriterionCustomizerOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual ad group
   ...
   * <code>repeated .google.ads.googleads.v14.services.AdGroupCriterionCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v14.services.AdGroupCriterionCustomizerOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual ad group
   * criterion customizers.
   ...
   * <code>repeated .google.ads.googleads.v14.services.AdGroupCriterionCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v14.services.AdGroupCriterionCustomizerOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v14.services.AdGroupCriterionCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v14.services.AdGroupCriterionCustomizerOperationOrBuilder getOperationsOrBuilder(
      int index);
