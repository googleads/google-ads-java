...
public interface GenerateAudienceCompositionInsightsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v14.services.GenerateAudienceCompositionInsightsRequest)
   ...
   * @return The audience.
   */
  com.google.ads.googleads.v14.services.InsightsAudience getAudience();
  /**
   * <pre>
   * Required. The audience of interest for which insights are being requested.
   * </pre>
   ...
   * <code>.google.ads.googleads.v14.services.InsightsAudience audience = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v14.services.InsightsAudienceOrBuilder getAudienceOrBuilder();
   ...
   */
  com.google.ads.googleads.v14.services.InsightsAudience getBaselineAudience();
  /**
   * <pre>
   * The baseline audience to which the audience of interest is being
   * compared.
   ...
   * <code>.google.ads.googleads.v14.services.InsightsAudience baseline_audience = 6;</code>
   */
  com.google.ads.googleads.v14.services.InsightsAudienceOrBuilder getBaselineAudienceOrBuilder();
   ...
   */
  java.util.List<com.google.ads.googleads.v14.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension> getDimensionsList();
  /**
   * <pre>
   * Required. The audience dimensions for which composition insights should be
   * returned.
   ...
   */
  com.google.ads.googleads.v14.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension getDimensions(int index);
  /**
   * <pre>
   * Required. The audience dimensions for which composition insights should be
   * returned.
