...
public interface CustomerFeedOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v14.resources.CustomerFeed)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v14.enums.PlaceholderTypeEnum.PlaceholderType placeholder_types = 3;</code>
   * @return A list containing the placeholderTypes.
   */
  java.util.List<com.google.ads.googleads.v14.enums.PlaceholderTypeEnum.PlaceholderType> getPlaceholderTypesList();
  /**
   * <pre>
   * Indicates which placeholder types the feed may populate under the connected
   * customer. Required.
   ...
   */
  com.google.ads.googleads.v14.enums.PlaceholderTypeEnum.PlaceholderType getPlaceholderTypes(int index);
  /**
   * <pre>
   * Indicates which placeholder types the feed may populate under the connected
   * customer. Required.
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v14.common.MatchingFunction matching_function = 4;</code>
   ...
   */
  com.google.ads.googleads.v14.common.MatchingFunction getMatchingFunction();
  /**
   * <pre>
   * Matching function associated with the CustomerFeed.
   * The matching function is used to filter the set of feed items selected.
   ...
   * <code>.google.ads.googleads.v14.common.MatchingFunction matching_function = 4;</code>
   */
  com.google.ads.googleads.v14.common.MatchingFunctionOrBuilder getMatchingFunctionOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v14.enums.FeedLinkStatusEnum.FeedLinkStatus status = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v14.enums.FeedLinkStatusEnum.FeedLinkStatus getStatus();
}
