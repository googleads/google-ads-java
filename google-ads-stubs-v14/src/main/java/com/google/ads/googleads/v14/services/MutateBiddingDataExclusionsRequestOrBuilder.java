...
public interface MutateBiddingDataExclusionsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v14.services.MutateBiddingDataExclusionsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v14.services.BiddingDataExclusionOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual data exclusions.
   ...
   * <code>repeated .google.ads.googleads.v14.services.BiddingDataExclusionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v14.services.BiddingDataExclusionOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual data exclusions.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v14.services.BiddingDataExclusionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v14.services.BiddingDataExclusionOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v14.services.BiddingDataExclusionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v14.services.BiddingDataExclusionOperationOrBuilder getOperationsOrBuilder(
      int index);
