...
public interface MutateSmartCampaignSettingsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v14.services.MutateSmartCampaignSettingsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v14.services.SmartCampaignSettingOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual Smart campaign
   ...
   * <code>repeated .google.ads.googleads.v14.services.SmartCampaignSettingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v14.services.SmartCampaignSettingOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual Smart campaign
   * settings.
   ...
   * <code>repeated .google.ads.googleads.v14.services.SmartCampaignSettingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v14.services.SmartCampaignSettingOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v14.services.SmartCampaignSettingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v14.services.SmartCampaignSettingOperationOrBuilder getOperationsOrBuilder(
      int index);
