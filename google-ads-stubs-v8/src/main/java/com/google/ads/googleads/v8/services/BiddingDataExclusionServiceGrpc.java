...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v8/services/bidding_data_exclusion_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class BiddingDataExclusionServiceGrpc {

  private BiddingDataExclusionServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v8.services.BiddingDataExclusionService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetBiddingDataExclusionRequest,
      com.google.ads.googleads.v8.resources.BiddingDataExclusion> getGetBiddingDataExclusionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetBiddingDataExclusion",
      requestType = com.google.ads.googleads.v8.services.GetBiddingDataExclusionRequest.class,
      responseType = com.google.ads.googleads.v8.resources.BiddingDataExclusion.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetBiddingDataExclusionRequest,
      com.google.ads.googleads.v8.resources.BiddingDataExclusion> getGetBiddingDataExclusionMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetBiddingDataExclusionRequest, com.google.ads.googleads.v8.resources.BiddingDataExclusion> getGetBiddingDataExclusionMethod;
      ...
      synchronized (BiddingDataExclusionServiceGrpc.class) {
        if ((getGetBiddingDataExclusionMethod = BiddingDataExclusionServiceGrpc.getGetBiddingDataExclusionMethod) == null) {
          BiddingDataExclusionServiceGrpc.getGetBiddingDataExclusionMethod = getGetBiddingDataExclusionMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v8.services.GetBiddingDataExclusionRequest, com.google.ads.googleads.v8.resources.BiddingDataExclusion>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetBiddingDataExclusion"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.GetBiddingDataExclusionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.resources.BiddingDataExclusion.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsRequest,
      com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsResponse> getMutateBiddingDataExclusionsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateBiddingDataExclusions",
      requestType = com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsRequest.class,
      responseType = com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsRequest,
      com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsResponse> getMutateBiddingDataExclusionsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsRequest, com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsResponse> getMutateBiddingDataExclusionsMethod;
      ...
      synchronized (BiddingDataExclusionServiceGrpc.class) {
        if ((getMutateBiddingDataExclusionsMethod = BiddingDataExclusionServiceGrpc.getMutateBiddingDataExclusionsMethod) == null) {
          BiddingDataExclusionServiceGrpc.getMutateBiddingDataExclusionsMethod = getMutateBiddingDataExclusionsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsRequest, com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateBiddingDataExclusions"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsResponse.getDefaultInstance()))
  ...
  public static abstract class BiddingDataExclusionServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getBiddingDataExclusion(com.google.ads.googleads.v8.services.GetBiddingDataExclusionRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.BiddingDataExclusion> responseObserver) {
     ...
     * </pre>
     */
    public void mutateBiddingDataExclusions(com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v8.services.GetBiddingDataExclusionRequest,
                com.google.ads.googleads.v8.resources.BiddingDataExclusion>(
                  this, METHODID_GET_BIDDING_DATA_EXCLUSION)))
          .addMethod(
            getMutateBiddingDataExclusionsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsRequest,
                com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsResponse>(
  ...
  public static final class BiddingDataExclusionServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<BiddingDataExclusionServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v8.resources.BiddingDataExclusion getBiddingDataExclusion(com.google.ads.googleads.v8.services.GetBiddingDataExclusionRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsResponse mutateBiddingDataExclusions(com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class BiddingDataExclusionServiceFutureStub extends io.grpc.stub.AbstractFutureStub<BiddingDataExclusionServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v8.resources.BiddingDataExclusion> getBiddingDataExclusion(
        com.google.ads.googleads.v8.services.GetBiddingDataExclusionRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsResponse> mutateBiddingDataExclusions(
        com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BIDDING_DATA_EXCLUSION:
          serviceImpl.getBiddingDataExclusion((com.google.ads.googleads.v8.services.GetBiddingDataExclusionRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.BiddingDataExclusion>) responseObserver);
          break;
        case METHODID_MUTATE_BIDDING_DATA_EXCLUSIONS:
          serviceImpl.mutateBiddingDataExclusions((com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.services.MutateBiddingDataExclusionsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BiddingDataExclusionServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v8.services.BiddingDataExclusionServiceProto.getDescriptor();
    }
