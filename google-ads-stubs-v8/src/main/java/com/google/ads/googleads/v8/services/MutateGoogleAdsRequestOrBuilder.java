...
public interface MutateGoogleAdsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v8.services.MutateGoogleAdsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v8.services.MutateOperation> 
   ...
   * <code>repeated .google.ads.googleads.v8.services.MutateOperation mutate_operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.MutateOperation getMutateOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual resources.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v8.services.MutateOperation mutate_operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v8.services.MutateOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v8.services.MutateOperation mutate_operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.MutateOperationOrBuilder getMutateOperationsOrBuilder(
      int index);
