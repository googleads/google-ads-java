...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v8/services/conversion_value_rule_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class ConversionValueRuleServiceGrpc {

  private ConversionValueRuleServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v8.services.ConversionValueRuleService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetConversionValueRuleRequest,
      com.google.ads.googleads.v8.resources.ConversionValueRule> getGetConversionValueRuleMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetConversionValueRule",
      requestType = com.google.ads.googleads.v8.services.GetConversionValueRuleRequest.class,
      responseType = com.google.ads.googleads.v8.resources.ConversionValueRule.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetConversionValueRuleRequest,
      com.google.ads.googleads.v8.resources.ConversionValueRule> getGetConversionValueRuleMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetConversionValueRuleRequest, com.google.ads.googleads.v8.resources.ConversionValueRule> getGetConversionValueRuleMethod;
      ...
      synchronized (ConversionValueRuleServiceGrpc.class) {
        if ((getGetConversionValueRuleMethod = ConversionValueRuleServiceGrpc.getGetConversionValueRuleMethod) == null) {
          ConversionValueRuleServiceGrpc.getGetConversionValueRuleMethod = getGetConversionValueRuleMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v8.services.GetConversionValueRuleRequest, com.google.ads.googleads.v8.resources.ConversionValueRule>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetConversionValueRule"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.GetConversionValueRuleRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.resources.ConversionValueRule.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateConversionValueRulesRequest,
      com.google.ads.googleads.v8.services.MutateConversionValueRulesResponse> getMutateConversionValueRulesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateConversionValueRules",
      requestType = com.google.ads.googleads.v8.services.MutateConversionValueRulesRequest.class,
      responseType = com.google.ads.googleads.v8.services.MutateConversionValueRulesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateConversionValueRulesRequest,
      com.google.ads.googleads.v8.services.MutateConversionValueRulesResponse> getMutateConversionValueRulesMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateConversionValueRulesRequest, com.google.ads.googleads.v8.services.MutateConversionValueRulesResponse> getMutateConversionValueRulesMethod;
      ...
      synchronized (ConversionValueRuleServiceGrpc.class) {
        if ((getMutateConversionValueRulesMethod = ConversionValueRuleServiceGrpc.getMutateConversionValueRulesMethod) == null) {
          ConversionValueRuleServiceGrpc.getMutateConversionValueRulesMethod = getMutateConversionValueRulesMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v8.services.MutateConversionValueRulesRequest, com.google.ads.googleads.v8.services.MutateConversionValueRulesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateConversionValueRules"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.MutateConversionValueRulesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.MutateConversionValueRulesResponse.getDefaultInstance()))
  ...
  public static abstract class ConversionValueRuleServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getConversionValueRule(com.google.ads.googleads.v8.services.GetConversionValueRuleRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.ConversionValueRule> responseObserver) {
     ...
     * </pre>
     */
    public void mutateConversionValueRules(com.google.ads.googleads.v8.services.MutateConversionValueRulesRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.services.MutateConversionValueRulesResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v8.services.GetConversionValueRuleRequest,
                com.google.ads.googleads.v8.resources.ConversionValueRule>(
                  this, METHODID_GET_CONVERSION_VALUE_RULE)))
          .addMethod(
            getMutateConversionValueRulesMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v8.services.MutateConversionValueRulesRequest,
                com.google.ads.googleads.v8.services.MutateConversionValueRulesResponse>(
  ...
  public static final class ConversionValueRuleServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ConversionValueRuleServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v8.resources.ConversionValueRule getConversionValueRule(com.google.ads.googleads.v8.services.GetConversionValueRuleRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v8.services.MutateConversionValueRulesResponse mutateConversionValueRules(com.google.ads.googleads.v8.services.MutateConversionValueRulesRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ConversionValueRuleServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ConversionValueRuleServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v8.resources.ConversionValueRule> getConversionValueRule(
        com.google.ads.googleads.v8.services.GetConversionValueRuleRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v8.services.MutateConversionValueRulesResponse> mutateConversionValueRules(
        com.google.ads.googleads.v8.services.MutateConversionValueRulesRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CONVERSION_VALUE_RULE:
          serviceImpl.getConversionValueRule((com.google.ads.googleads.v8.services.GetConversionValueRuleRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.ConversionValueRule>) responseObserver);
          break;
        case METHODID_MUTATE_CONVERSION_VALUE_RULES:
          serviceImpl.mutateConversionValueRules((com.google.ads.googleads.v8.services.MutateConversionValueRulesRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.services.MutateConversionValueRulesResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ConversionValueRuleServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v8.services.ConversionValueRuleServiceProto.getDescriptor();
    }
