...
public interface MutateCampaignFeedsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v8.services.MutateCampaignFeedsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v8.services.CampaignFeedOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign feeds.
   ...
   * <code>repeated .google.ads.googleads.v8.services.CampaignFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.CampaignFeedOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign feeds.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v8.services.CampaignFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v8.services.CampaignFeedOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v8.services.CampaignFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.CampaignFeedOperationOrBuilder getOperationsOrBuilder(
      int index);
