...
public interface FeedMappingOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v8.resources.FeedMapping)
   ...
   */
  java.util.List<com.google.ads.googleads.v8.resources.AttributeFieldMapping> 
   ...
   * <code>repeated .google.ads.googleads.v8.resources.AttributeFieldMapping attribute_field_mappings = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.ads.googleads.v8.resources.AttributeFieldMapping getAttributeFieldMappings(int index);
  /**
   * <pre>
   * Immutable. Feed attributes to field mappings. These mappings are a one-to-many
   * relationship meaning that 1 feed attribute can be used to populate
   ...
   * <code>repeated .google.ads.googleads.v8.resources.AttributeFieldMapping attribute_field_mappings = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v8.resources.AttributeFieldMappingOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v8.resources.AttributeFieldMapping attribute_field_mappings = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.ads.googleads.v8.resources.AttributeFieldMappingOrBuilder getAttributeFieldMappingsOrBuilder(
      int index);
   ...
   * @return The status.
   */
  com.google.ads.googleads.v8.enums.FeedMappingStatusEnum.FeedMappingStatus getStatus();
   ...
   */
  com.google.ads.googleads.v8.enums.FeedMappingCriterionTypeEnum.FeedMappingCriterionType getCriterionType();

  public com.google.ads.googleads.v8.resources.FeedMapping.TargetCase getTargetCase();
}
