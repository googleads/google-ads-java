...
import com.google.ads.googleads.v8.services.stub.FeedItemSetServiceStub;
import com.google.ads.googleads.v8.services.stub.FeedItemSetServiceStubSettings;
...
public class FeedItemSetServiceClient implements BackgroundResource {
  ...
  public final FeedItemSet getFeedItemSet(String resourceName) {
    GetFeedItemSetRequest request =
        GetFeedItemSetRequest.newBuilder().setResourceName(resourceName).build();
    return getFeedItemSet(request);
  }
  ...
  public final FeedItemSet getFeedItemSet(GetFeedItemSetRequest request) {
    return getFeedItemSetCallable().call(request);
  }
