...
public interface CustomerFeedOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v8.resources.CustomerFeed)
   ...
   */
  java.util.List<com.google.ads.googleads.v8.enums.PlaceholderTypeEnum.PlaceholderType> getPlaceholderTypesList();
  /**
   * <pre>
   * Indicates which placeholder types the feed may populate under the connected
   * customer. Required.
   ...
   */
  com.google.ads.googleads.v8.enums.PlaceholderTypeEnum.PlaceholderType getPlaceholderTypes(int index);
  /**
   * <pre>
   * Indicates which placeholder types the feed may populate under the connected
   * customer. Required.
   ...
   * @return The status.
   */
  com.google.ads.googleads.v8.enums.FeedLinkStatusEnum.FeedLinkStatus getStatus();
}
