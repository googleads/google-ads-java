...
public interface MutateAdGroupsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v8.services.MutateAdGroupsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v8.services.AdGroupOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual ad groups.
   ...
   * <code>repeated .google.ads.googleads.v8.services.AdGroupOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.AdGroupOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual ad groups.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v8.services.AdGroupOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v8.services.AdGroupOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v8.services.AdGroupOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.AdGroupOperationOrBuilder getOperationsOrBuilder(
      int index);
