...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v8/services/label_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class LabelServiceGrpc {

  private LabelServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v8.services.LabelService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetLabelRequest,
      com.google.ads.googleads.v8.resources.Label> getGetLabelMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetLabel",
      requestType = com.google.ads.googleads.v8.services.GetLabelRequest.class,
      responseType = com.google.ads.googleads.v8.resources.Label.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetLabelRequest,
      com.google.ads.googleads.v8.resources.Label> getGetLabelMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetLabelRequest, com.google.ads.googleads.v8.resources.Label> getGetLabelMethod;
      ...
      synchronized (LabelServiceGrpc.class) {
        if ((getGetLabelMethod = LabelServiceGrpc.getGetLabelMethod) == null) {
          LabelServiceGrpc.getGetLabelMethod = getGetLabelMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v8.services.GetLabelRequest, com.google.ads.googleads.v8.resources.Label>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetLabel"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.GetLabelRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.resources.Label.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateLabelsRequest,
      com.google.ads.googleads.v8.services.MutateLabelsResponse> getMutateLabelsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateLabels",
      requestType = com.google.ads.googleads.v8.services.MutateLabelsRequest.class,
      responseType = com.google.ads.googleads.v8.services.MutateLabelsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateLabelsRequest,
      com.google.ads.googleads.v8.services.MutateLabelsResponse> getMutateLabelsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateLabelsRequest, com.google.ads.googleads.v8.services.MutateLabelsResponse> getMutateLabelsMethod;
      ...
      synchronized (LabelServiceGrpc.class) {
        if ((getMutateLabelsMethod = LabelServiceGrpc.getMutateLabelsMethod) == null) {
          LabelServiceGrpc.getMutateLabelsMethod = getMutateLabelsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v8.services.MutateLabelsRequest, com.google.ads.googleads.v8.services.MutateLabelsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateLabels"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.MutateLabelsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.MutateLabelsResponse.getDefaultInstance()))
  ...
  public static abstract class LabelServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getLabel(com.google.ads.googleads.v8.services.GetLabelRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.Label> responseObserver) {
     ...
     * </pre>
     */
    public void mutateLabels(com.google.ads.googleads.v8.services.MutateLabelsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.services.MutateLabelsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v8.services.GetLabelRequest,
                com.google.ads.googleads.v8.resources.Label>(
                  this, METHODID_GET_LABEL)))
          .addMethod(
            getMutateLabelsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v8.services.MutateLabelsRequest,
                com.google.ads.googleads.v8.services.MutateLabelsResponse>(
  ...
  public static final class LabelServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<LabelServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v8.resources.Label getLabel(com.google.ads.googleads.v8.services.GetLabelRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v8.services.MutateLabelsResponse mutateLabels(com.google.ads.googleads.v8.services.MutateLabelsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class LabelServiceFutureStub extends io.grpc.stub.AbstractFutureStub<LabelServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v8.resources.Label> getLabel(
        com.google.ads.googleads.v8.services.GetLabelRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v8.services.MutateLabelsResponse> mutateLabels(
        com.google.ads.googleads.v8.services.MutateLabelsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_LABEL:
          serviceImpl.getLabel((com.google.ads.googleads.v8.services.GetLabelRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.Label>) responseObserver);
          break;
        case METHODID_MUTATE_LABELS:
          serviceImpl.mutateLabels((com.google.ads.googleads.v8.services.MutateLabelsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.services.MutateLabelsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class LabelServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v8.services.LabelServiceProto.getDescriptor();
    }
