...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v8/services/custom_audience_service.proto")
public final class CustomAudienceServiceGrpc {

  private CustomAudienceServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v8.services.CustomAudienceService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetCustomAudienceRequest,
      com.google.ads.googleads.v8.resources.CustomAudience> getGetCustomAudienceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCustomAudience",
      requestType = com.google.ads.googleads.v8.services.GetCustomAudienceRequest.class,
      responseType = com.google.ads.googleads.v8.resources.CustomAudience.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetCustomAudienceRequest,
      com.google.ads.googleads.v8.resources.CustomAudience> getGetCustomAudienceMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetCustomAudienceRequest, com.google.ads.googleads.v8.resources.CustomAudience> getGetCustomAudienceMethod;
      ...
      synchronized (CustomAudienceServiceGrpc.class) {
        if ((getGetCustomAudienceMethod = CustomAudienceServiceGrpc.getGetCustomAudienceMethod) == null) {
          CustomAudienceServiceGrpc.getGetCustomAudienceMethod = getGetCustomAudienceMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v8.services.GetCustomAudienceRequest, com.google.ads.googleads.v8.resources.CustomAudience>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCustomAudience"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.GetCustomAudienceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.resources.CustomAudience.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateCustomAudiencesRequest,
      com.google.ads.googleads.v8.services.MutateCustomAudiencesResponse> getMutateCustomAudiencesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCustomAudiences",
      requestType = com.google.ads.googleads.v8.services.MutateCustomAudiencesRequest.class,
      responseType = com.google.ads.googleads.v8.services.MutateCustomAudiencesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateCustomAudiencesRequest,
      com.google.ads.googleads.v8.services.MutateCustomAudiencesResponse> getMutateCustomAudiencesMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateCustomAudiencesRequest, com.google.ads.googleads.v8.services.MutateCustomAudiencesResponse> getMutateCustomAudiencesMethod;
      ...
      synchronized (CustomAudienceServiceGrpc.class) {
        if ((getMutateCustomAudiencesMethod = CustomAudienceServiceGrpc.getMutateCustomAudiencesMethod) == null) {
          CustomAudienceServiceGrpc.getMutateCustomAudiencesMethod = getMutateCustomAudiencesMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v8.services.MutateCustomAudiencesRequest, com.google.ads.googleads.v8.services.MutateCustomAudiencesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCustomAudiences"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.MutateCustomAudiencesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.MutateCustomAudiencesResponse.getDefaultInstance()))
  ...
  public static abstract class CustomAudienceServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCustomAudience(com.google.ads.googleads.v8.services.GetCustomAudienceRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.CustomAudience> responseObserver) {
     ...
     * </pre>
     */
    public void mutateCustomAudiences(com.google.ads.googleads.v8.services.MutateCustomAudiencesRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.services.MutateCustomAudiencesResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v8.services.GetCustomAudienceRequest,
                com.google.ads.googleads.v8.resources.CustomAudience>(
                  this, METHODID_GET_CUSTOM_AUDIENCE)))
          .addMethod(
            getMutateCustomAudiencesMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v8.services.MutateCustomAudiencesRequest,
                com.google.ads.googleads.v8.services.MutateCustomAudiencesResponse>(
  ...
  public static final class CustomAudienceServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CustomAudienceServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v8.resources.CustomAudience getCustomAudience(com.google.ads.googleads.v8.services.GetCustomAudienceRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v8.services.MutateCustomAudiencesResponse mutateCustomAudiences(com.google.ads.googleads.v8.services.MutateCustomAudiencesRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CustomAudienceServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CustomAudienceServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v8.resources.CustomAudience> getCustomAudience(
        com.google.ads.googleads.v8.services.GetCustomAudienceRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v8.services.MutateCustomAudiencesResponse> mutateCustomAudiences(
        com.google.ads.googleads.v8.services.MutateCustomAudiencesRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CUSTOM_AUDIENCE:
          serviceImpl.getCustomAudience((com.google.ads.googleads.v8.services.GetCustomAudienceRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.CustomAudience>) responseObserver);
          break;
        case METHODID_MUTATE_CUSTOM_AUDIENCES:
          serviceImpl.mutateCustomAudiences((com.google.ads.googleads.v8.services.MutateCustomAudiencesRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.services.MutateCustomAudiencesResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CustomAudienceServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v8.services.CustomAudienceServiceProto.getDescriptor();
    }
