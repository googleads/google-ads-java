...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v8/services/expanded_landing_page_view_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class ExpandedLandingPageViewServiceGrpc {

  private ExpandedLandingPageViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v8.services.ExpandedLandingPageViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetExpandedLandingPageViewRequest,
      com.google.ads.googleads.v8.resources.ExpandedLandingPageView> getGetExpandedLandingPageViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetExpandedLandingPageView",
      requestType = com.google.ads.googleads.v8.services.GetExpandedLandingPageViewRequest.class,
      responseType = com.google.ads.googleads.v8.resources.ExpandedLandingPageView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetExpandedLandingPageViewRequest,
      com.google.ads.googleads.v8.resources.ExpandedLandingPageView> getGetExpandedLandingPageViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetExpandedLandingPageViewRequest, com.google.ads.googleads.v8.resources.ExpandedLandingPageView> getGetExpandedLandingPageViewMethod;
      ...
      synchronized (ExpandedLandingPageViewServiceGrpc.class) {
        if ((getGetExpandedLandingPageViewMethod = ExpandedLandingPageViewServiceGrpc.getGetExpandedLandingPageViewMethod) == null) {
          ExpandedLandingPageViewServiceGrpc.getGetExpandedLandingPageViewMethod = getGetExpandedLandingPageViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v8.services.GetExpandedLandingPageViewRequest, com.google.ads.googleads.v8.resources.ExpandedLandingPageView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetExpandedLandingPageView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.GetExpandedLandingPageViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.resources.ExpandedLandingPageView.getDefaultInstance()))
  ...
  public static abstract class ExpandedLandingPageViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getExpandedLandingPageView(com.google.ads.googleads.v8.services.GetExpandedLandingPageViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.ExpandedLandingPageView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v8.services.GetExpandedLandingPageViewRequest,
                com.google.ads.googleads.v8.resources.ExpandedLandingPageView>(
  ...
  public static final class ExpandedLandingPageViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ExpandedLandingPageViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v8.resources.ExpandedLandingPageView getExpandedLandingPageView(com.google.ads.googleads.v8.services.GetExpandedLandingPageViewRequest request) {
  ...
  public static final class ExpandedLandingPageViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ExpandedLandingPageViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v8.resources.ExpandedLandingPageView> getExpandedLandingPageView(
        com.google.ads.googleads.v8.services.GetExpandedLandingPageViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_EXPANDED_LANDING_PAGE_VIEW:
          serviceImpl.getExpandedLandingPageView((com.google.ads.googleads.v8.services.GetExpandedLandingPageViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.ExpandedLandingPageView>) responseObserver);
          break;
        default:
  ...
  private static abstract class ExpandedLandingPageViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v8.services.ExpandedLandingPageViewServiceProto.getDescriptor();
    }
