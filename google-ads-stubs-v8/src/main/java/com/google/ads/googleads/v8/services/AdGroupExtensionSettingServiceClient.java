...
import com.google.ads.googleads.v8.services.stub.AdGroupExtensionSettingServiceStub;
import com.google.ads.googleads.v8.services.stub.AdGroupExtensionSettingServiceStubSettings;
...
public class AdGroupExtensionSettingServiceClient implements BackgroundResource {
   ...
   *       GetAdGroupExtensionSettingRequest.newBuilder()
   *           .setResourceName(
   *               AdGroupExtensionSettingName.of(
   *                       "[CUSTOMER_ID]", "[AD_GROUP_ID]", "[EXTENSION_TYPE]")
   *                   .toString())
   *           .build();
   *   AdGroupExtensionSetting response =
   *       adGroupExtensionSettingServiceClient.getAdGroupExtensionSetting(request);
   * }
   * }</pre>
   *
   ...
   *                   .toString())
   *           .build();
   *   ApiFuture<AdGroupExtensionSetting> future =
