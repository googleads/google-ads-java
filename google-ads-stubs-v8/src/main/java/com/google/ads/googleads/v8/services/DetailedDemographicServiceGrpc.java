...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v8/services/detailed_demographic_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class DetailedDemographicServiceGrpc {

  private DetailedDemographicServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v8.services.DetailedDemographicService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetDetailedDemographicRequest,
      com.google.ads.googleads.v8.resources.DetailedDemographic> getGetDetailedDemographicMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetDetailedDemographic",
      requestType = com.google.ads.googleads.v8.services.GetDetailedDemographicRequest.class,
      responseType = com.google.ads.googleads.v8.resources.DetailedDemographic.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetDetailedDemographicRequest,
      com.google.ads.googleads.v8.resources.DetailedDemographic> getGetDetailedDemographicMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetDetailedDemographicRequest, com.google.ads.googleads.v8.resources.DetailedDemographic> getGetDetailedDemographicMethod;
      ...
      synchronized (DetailedDemographicServiceGrpc.class) {
        if ((getGetDetailedDemographicMethod = DetailedDemographicServiceGrpc.getGetDetailedDemographicMethod) == null) {
          DetailedDemographicServiceGrpc.getGetDetailedDemographicMethod = getGetDetailedDemographicMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v8.services.GetDetailedDemographicRequest, com.google.ads.googleads.v8.resources.DetailedDemographic>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetDetailedDemographic"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.GetDetailedDemographicRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.resources.DetailedDemographic.getDefaultInstance()))
  ...
  public static abstract class DetailedDemographicServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getDetailedDemographic(com.google.ads.googleads.v8.services.GetDetailedDemographicRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.DetailedDemographic> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v8.services.GetDetailedDemographicRequest,
                com.google.ads.googleads.v8.resources.DetailedDemographic>(
  ...
  public static final class DetailedDemographicServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<DetailedDemographicServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v8.resources.DetailedDemographic getDetailedDemographic(com.google.ads.googleads.v8.services.GetDetailedDemographicRequest request) {
  ...
  public static final class DetailedDemographicServiceFutureStub extends io.grpc.stub.AbstractFutureStub<DetailedDemographicServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v8.resources.DetailedDemographic> getDetailedDemographic(
        com.google.ads.googleads.v8.services.GetDetailedDemographicRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DETAILED_DEMOGRAPHIC:
          serviceImpl.getDetailedDemographic((com.google.ads.googleads.v8.services.GetDetailedDemographicRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.DetailedDemographic>) responseObserver);
          break;
        default:
  ...
  private static abstract class DetailedDemographicServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v8.services.DetailedDemographicServiceProto.getDescriptor();
    }
