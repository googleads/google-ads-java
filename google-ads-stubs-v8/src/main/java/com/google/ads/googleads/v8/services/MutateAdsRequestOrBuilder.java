...
public interface MutateAdsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v8.services.MutateAdsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v8.services.AdOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual ads.
   ...
   * <code>repeated .google.ads.googleads.v8.services.AdOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.AdOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual ads.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v8.services.AdOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v8.services.AdOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v8.services.AdOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.AdOperationOrBuilder getOperationsOrBuilder(
      int index);
