...
public interface MutateAdGroupAssetsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v8.services.MutateAdGroupAssetsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v8.services.AdGroupAssetOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual ad group assets.
   ...
   * <code>repeated .google.ads.googleads.v8.services.AdGroupAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.AdGroupAssetOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual ad group assets.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v8.services.AdGroupAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v8.services.AdGroupAssetOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v8.services.AdGroupAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.AdGroupAssetOperationOrBuilder getOperationsOrBuilder(
      int index);
