...
public interface GenerateKeywordIdeasRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v8.services.GenerateKeywordIdeasRequest)
   ...
   */
  com.google.ads.googleads.v8.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork getKeywordPlanNetwork();
   ...
   */
  java.util.List<com.google.ads.googleads.v8.enums.KeywordPlanKeywordAnnotationEnum.KeywordPlanKeywordAnnotation> getKeywordAnnotationList();
  /**
   * <pre>
   * The keyword annotations to include in response.
   * </pre>
   ...
   */
  com.google.ads.googleads.v8.enums.KeywordPlanKeywordAnnotationEnum.KeywordPlanKeywordAnnotation getKeywordAnnotation(int index);
  /**
   * <pre>
   * The keyword annotations to include in response.
   * </pre>
   ...
   */
  com.google.ads.googleads.v8.common.KeywordPlanAggregateMetrics getAggregateMetrics();
  /**
   * <pre>
   * The aggregate fields to include in response.
   * </pre>
   ...
   * <code>.google.ads.googleads.v8.common.KeywordPlanAggregateMetrics aggregate_metrics = 16;</code>
   */
  com.google.ads.googleads.v8.common.KeywordPlanAggregateMetricsOrBuilder getAggregateMetricsOrBuilder();
   ...
   */
  com.google.ads.googleads.v8.common.HistoricalMetricsOptions getHistoricalMetricsOptions();
  /**
   * <pre>
   * The options for historical metrics data.
   * </pre>
   ...
   * <code>.google.ads.googleads.v8.common.HistoricalMetricsOptions historical_metrics_options = 18;</code>
   */
  com.google.ads.googleads.v8.common.HistoricalMetricsOptionsOrBuilder getHistoricalMetricsOptionsOrBuilder();
   ...
   */
  com.google.ads.googleads.v8.services.KeywordAndUrlSeed getKeywordAndUrlSeed();
  /**
   * <pre>
   * A Keyword and a specific Url to generate ideas from
   * e.g. cars, www.example.com/cars.
   ...
   * <code>.google.ads.googleads.v8.services.KeywordAndUrlSeed keyword_and_url_seed = 2;</code>
   */
  com.google.ads.googleads.v8.services.KeywordAndUrlSeedOrBuilder getKeywordAndUrlSeedOrBuilder();
   ...
   */
  com.google.ads.googleads.v8.services.KeywordSeed getKeywordSeed();
  /**
   * <pre>
   * A Keyword or phrase to generate ideas from, e.g. cars.
   * </pre>
   ...
   * <code>.google.ads.googleads.v8.services.KeywordSeed keyword_seed = 3;</code>
   */
  com.google.ads.googleads.v8.services.KeywordSeedOrBuilder getKeywordSeedOrBuilder();
   ...
   * @return The urlSeed.
   */
  com.google.ads.googleads.v8.services.UrlSeed getUrlSeed();
  /**
   * <pre>
   * A specific url to generate ideas from, e.g. www.example.com/cars.
   * </pre>
   ...
   * <code>.google.ads.googleads.v8.services.UrlSeed url_seed = 5;</code>
   */
  com.google.ads.googleads.v8.services.UrlSeedOrBuilder getUrlSeedOrBuilder();
   ...
   * @return The siteSeed.
   */
  com.google.ads.googleads.v8.services.SiteSeed getSiteSeed();
  /**
   * <pre>
   * The site to generate ideas from, e.g. www.example.com.
   * </pre>
   ...
   * <code>.google.ads.googleads.v8.services.SiteSeed site_seed = 11;</code>
   */
  com.google.ads.googleads.v8.services.SiteSeedOrBuilder getSiteSeedOrBuilder();

  public com.google.ads.googleads.v8.services.GenerateKeywordIdeasRequest.SeedCase getSeedCase();
}
