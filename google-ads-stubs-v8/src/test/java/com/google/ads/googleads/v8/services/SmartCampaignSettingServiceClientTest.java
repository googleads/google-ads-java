...
public class SmartCampaignSettingServiceClientTest {
  ...
  @Test
  public void getSmartCampaignSettingTest() throws Exception {
    SmartCampaignSetting expectedResponse =
        SmartCampaignSetting.newBuilder()
            ...
            .setPhoneNumber(SmartCampaignSetting.PhoneNumber.newBuilder().build())
            .setFinalUrl("finalUrl-681275367")
            .setAdvertisingLanguageCode("advertisingLanguageCode1487330985")
            .build();
    ...
    SmartCampaignSetting actualResponse = client.getSmartCampaignSetting(resourceName);
    Assert.assertEquals(expectedResponse, actualResponse);

    List<AbstractMessage> actualRequests = mockSmartCampaignSettingService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    GetSmartCampaignSettingRequest actualRequest =
        ((GetSmartCampaignSettingRequest) actualRequests.get(0));
  ...
  @Test
  public void getSmartCampaignSettingExceptionTest() throws Exception {
    ...
    try {
      SmartCampaignSettingName resourceName =
          SmartCampaignSettingName.of("[CUSTOMER_ID]", "[CAMPAIGN_ID]");
      client.getSmartCampaignSetting(resourceName);
  ...
  @Test
  public void getSmartCampaignSettingTest2() throws Exception {
    SmartCampaignSetting expectedResponse =
        SmartCampaignSetting.newBuilder()
            .setResourceName(
                SmartCampaignSettingName.of("[CUSTOMER_ID]", "[CAMPAIGN_ID]").toString())
  ...
  @Test
  public void getSmartCampaignSettingExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockSmartCampaignSettingService.addException(exception);
