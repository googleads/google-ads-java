...
public class CampaignBidModifierName implements ResourceName {
  ...
  public static @Nullable CampaignBidModifierName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CampaignBidModifierName> values) {
