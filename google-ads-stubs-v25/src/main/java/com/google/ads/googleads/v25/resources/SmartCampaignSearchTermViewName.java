...
public class SmartCampaignSearchTermViewName implements ResourceName {
  ...
  public static @Nullable SmartCampaignSearchTermViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable SmartCampaignSearchTermViewName> values) {
