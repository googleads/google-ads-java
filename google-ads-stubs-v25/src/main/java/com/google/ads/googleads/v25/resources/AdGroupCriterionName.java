...
public class AdGroupCriterionName implements ResourceName {
  ...
  public static @Nullable AdGroupCriterionName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AdGroupCriterionName> values) {
