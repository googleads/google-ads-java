...
public class ProductGroupViewName implements ResourceName {
  ...
  public static @Nullable ProductGroupViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ProductGroupViewName> values) {
