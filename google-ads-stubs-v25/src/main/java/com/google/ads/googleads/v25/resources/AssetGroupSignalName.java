...
public class AssetGroupSignalName implements ResourceName {
  ...
  public static @Nullable AssetGroupSignalName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AssetGroupSignalName> values) {
