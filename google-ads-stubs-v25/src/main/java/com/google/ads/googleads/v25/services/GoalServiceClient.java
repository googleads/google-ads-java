...
import com.google.ads.googleads.v25.services.stub.GoalServiceStub;
import com.google.ads.googleads.v25.services.stub.GoalServiceStubSettings;
 ...
 * <p>  List of thrown errors:   [AuthenticationError]()   [AuthorizationError]()   [HeaderError]()   [InternalError]()   [QuotaError]()   [RequestError]()   [GoalError]()</td>
 *      <td>
...
public class GoalServiceClient implements BackgroundResource {
   ...
   * [InternalError]() [QuotaError]() [RequestError]() [GoalError]()
   *
   * <p>Sample code:
   *
   * <pre>{@code
