...
public class CampaignCustomizerName implements ResourceName {
  ...
  public static @Nullable CampaignCustomizerName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CampaignCustomizerName> values) {
