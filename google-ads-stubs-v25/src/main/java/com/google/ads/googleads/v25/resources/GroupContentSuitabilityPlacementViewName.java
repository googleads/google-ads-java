...
public class GroupContentSuitabilityPlacementViewName implements ResourceName {
  ...
  public static GroupContentSuitabilityPlacementViewName of(
  ...
  public static @Nullable GroupContentSuitabilityPlacementViewName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_ID_PLACEMENT_FINGERPRINT.validatedMatch(
            formattedString,
            "GroupContentSuitabilityPlacementViewName.parse: formattedString not in valid format");
    return of(matchMap.get("customer_id"), matchMap.get("placement_fingerprint"));
  }

  public static List<GroupContentSuitabilityPlacementViewName> parseList(
      List<String> formattedStrings) {
    List<GroupContentSuitabilityPlacementViewName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(
      List<@Nullable GroupContentSuitabilityPlacementViewName> values) {
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      GroupContentSuitabilityPlacementViewName that =
          ((GroupContentSuitabilityPlacementViewName) o);
  ...
  public static class Builder {
    ...
    private Builder(
        GroupContentSuitabilityPlacementViewName groupContentSuitabilityPlacementViewName) {
