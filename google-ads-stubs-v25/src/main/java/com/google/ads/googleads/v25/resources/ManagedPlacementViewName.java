...
public class ManagedPlacementViewName implements ResourceName {
  ...
  public static ManagedPlacementViewName of(
  ...
  public static @Nullable ManagedPlacementViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ManagedPlacementViewName> values) {
