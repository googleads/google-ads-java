...
public class CombinedAudienceName implements ResourceName {
  ...
  public static @Nullable CombinedAudienceName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CombinedAudienceName> values) {
