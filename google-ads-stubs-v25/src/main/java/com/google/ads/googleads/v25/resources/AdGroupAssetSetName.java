...
public class AdGroupAssetSetName implements ResourceName {
  ...
  public static @Nullable AdGroupAssetSetName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AdGroupAssetSetName> values) {
