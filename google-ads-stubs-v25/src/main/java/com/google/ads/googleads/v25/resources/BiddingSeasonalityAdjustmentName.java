...
public class BiddingSeasonalityAdjustmentName implements ResourceName {
  ...
  @Deprecated
  protected BiddingSeasonalityAdjustmentName() {
    customerId = null;
    seasonalityEventId = null;
  }

  private BiddingSeasonalityAdjustmentName(Builder builder) {
  ...
  public static BiddingSeasonalityAdjustmentName of(String customerId, String seasonalityEventId) {
  ...
  public static @Nullable BiddingSeasonalityAdjustmentName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_ID_SEASONALITY_EVENT_ID.validatedMatch(
            formattedString,
            "BiddingSeasonalityAdjustmentName.parse: formattedString not in valid format");
    return of(matchMap.get("customer_id"), matchMap.get("seasonality_event_id"));
  }

  public static List<BiddingSeasonalityAdjustmentName> parseList(List<String> formattedStrings) {
    List<BiddingSeasonalityAdjustmentName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable BiddingSeasonalityAdjustmentName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (BiddingSeasonalityAdjustmentName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      BiddingSeasonalityAdjustmentName that = ((BiddingSeasonalityAdjustmentName) o);
  ...
  public static class Builder {
    ...
    private Builder(BiddingSeasonalityAdjustmentName biddingSeasonalityAdjustmentName) {
      this.customerId = biddingSeasonalityAdjustmentName.customerId;
      this.seasonalityEventId = biddingSeasonalityAdjustmentName.seasonalityEventId;
    }

    public BiddingSeasonalityAdjustmentName build() {
      return new BiddingSeasonalityAdjustmentName(this);
    }
  }
}
