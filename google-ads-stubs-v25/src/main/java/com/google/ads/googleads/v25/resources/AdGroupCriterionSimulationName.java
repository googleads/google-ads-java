...
public class AdGroupCriterionSimulationName implements ResourceName {
  ...
  public static @Nullable AdGroupCriterionSimulationName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AdGroupCriterionSimulationName> values) {
