...
import com.google.ads.googleads.v25.services.stub.ShareablePreviewServiceStub;
import com.google.ads.googleads.v25.services.stub.ShareablePreviewServiceStubSettings;
 ...
 *      <ul>
 *           <li><p> generateShareablePreviews(String customerId)
 *      </ul>
...
public class ShareablePreviewServiceClient implements BackgroundResource {
   ...
   */
  public final GenerateShareablePreviewsResponse generateShareablePreviews(String customerId) {
    GenerateShareablePreviewsRequest request =
        GenerateShareablePreviewsRequest.newBuilder().setCustomerId(customerId).build();
   ...
   *           .setOperation(GenerateShareablePreviewsOperation.newBuilder().build())
   *           .build();
   *   GenerateShareablePreviewsResponse response =
