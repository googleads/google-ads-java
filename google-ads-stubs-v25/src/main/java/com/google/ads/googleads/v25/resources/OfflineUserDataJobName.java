...
public class OfflineUserDataJobName implements ResourceName {
  ...
  public static @Nullable OfflineUserDataJobName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable OfflineUserDataJobName> values) {
