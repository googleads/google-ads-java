...
public class CustomerManagerLinkName implements ResourceName {
  ...
  public static @Nullable CustomerManagerLinkName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CustomerManagerLinkName> values) {
