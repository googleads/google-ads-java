...
public class AssetGroupAssetName implements ResourceName {
  ...
  public static @Nullable AssetGroupAssetName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AssetGroupAssetName> values) {
