...
public class LiftMeasurementDeviceName implements ResourceName {
  ...
  @Deprecated
  protected LiftMeasurementDeviceName() {
    customerId = null;
  ...
  private LiftMeasurementDeviceName(Builder builder) {
  ...
  public static LiftMeasurementDeviceName of(
      String customerId,
  ...
  public static @Nullable LiftMeasurementDeviceName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_ID_LIFT_MEASUREMENT_CONFIGURATION_ID_CAMPAIGN_ID_CRITERION_ID.validatedMatch(
            formattedString,
            "LiftMeasurementDeviceName.parse: formattedString not in valid format");
    return of(
  ...
  public static List<LiftMeasurementDeviceName> parseList(List<String> formattedStrings) {
    List<LiftMeasurementDeviceName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable LiftMeasurementDeviceName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (LiftMeasurementDeviceName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      LiftMeasurementDeviceName that = ((LiftMeasurementDeviceName) o);
  ...
  public static class Builder {
    ...
    private Builder(LiftMeasurementDeviceName liftMeasurementDeviceName) {
      this.customerId = liftMeasurementDeviceName.customerId;
      this.liftMeasurementConfigurationId =
          liftMeasurementDeviceName.liftMeasurementConfigurationId;
      this.campaignId = liftMeasurementDeviceName.campaignId;
      this.criterionId = liftMeasurementDeviceName.criterionId;
    }

    public LiftMeasurementDeviceName build() {
      return new LiftMeasurementDeviceName(this);
    }
  }
}
