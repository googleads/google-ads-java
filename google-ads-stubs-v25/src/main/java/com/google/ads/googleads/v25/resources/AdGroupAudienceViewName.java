...
public class AdGroupAudienceViewName implements ResourceName {
  ...
  public static AdGroupAudienceViewName of(
  ...
  public static @Nullable AdGroupAudienceViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AdGroupAudienceViewName> values) {
  ...
  public static class Builder {
    ...
    private Builder(AdGroupAudienceViewName adGroupAudienceViewName) {
      this.customerId = adGroupAudienceViewName.customerId;
      this.adGroupId = adGroupAudienceViewName.adGroupId;
      this.criterionId = adGroupAudienceViewName.criterionId;
    }
