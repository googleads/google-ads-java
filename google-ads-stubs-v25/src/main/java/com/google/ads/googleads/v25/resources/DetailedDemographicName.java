...
public class DetailedDemographicName implements ResourceName {
  ...
  public static @Nullable DetailedDemographicName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable DetailedDemographicName> values) {
