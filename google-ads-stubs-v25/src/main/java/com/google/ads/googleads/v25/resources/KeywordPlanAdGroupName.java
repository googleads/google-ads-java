...
public class KeywordPlanAdGroupName implements ResourceName {
  ...
  public static @Nullable KeywordPlanAdGroupName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable KeywordPlanAdGroupName> values) {
