...
public class AdGroupCustomizerName implements ResourceName {
  private static final PathTemplate CUSTOMER_ID_AD_GROUP_ID_CUSTOMIZER_ATTRIBUTE_ID =
  ...
  public static AdGroupCustomizerName of(
      String customerId, String adGroupId, String customizerAttributeId) {
    return newBuilder()
  ...
  public static @Nullable AdGroupCustomizerName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        CUSTOMER_ID_AD_GROUP_ID_CUSTOMIZER_ATTRIBUTE_ID.validatedMatch(
            formattedString, "AdGroupCustomizerName.parse: formattedString not in valid format");
    return of(
  ...
  public static List<AdGroupCustomizerName> parseList(List<String> formattedStrings) {
    List<AdGroupCustomizerName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable AdGroupCustomizerName> values) {
  ...
  public String toString() {
    return CUSTOMER_ID_AD_GROUP_ID_CUSTOMIZER_ATTRIBUTE_ID.instantiate(
        "customer_id",
        customerId,
        "ad_group_id",
        adGroupId,
