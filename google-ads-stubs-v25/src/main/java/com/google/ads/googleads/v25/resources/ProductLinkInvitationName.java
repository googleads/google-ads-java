...
public class ProductLinkInvitationName implements ResourceName {
  ...
  public static @Nullable ProductLinkInvitationName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ProductLinkInvitationName> values) {
