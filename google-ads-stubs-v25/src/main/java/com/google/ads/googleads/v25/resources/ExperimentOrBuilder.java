...
public interface ExperimentOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v25.resources.Experiment)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v25.enums.ExperimentTypeEnum.ExperimentType type = 13 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * @return The type.
   */
  com.google.ads.googleads.v25.enums.ExperimentTypeEnum.ExperimentType getType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v25.enums.ExperimentStatusEnum.ExperimentStatus status = 14;</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v25.enums.ExperimentStatusEnum.ExperimentStatus getStatus();
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v25.common.MetricGoal goals = 17;</code>
   */
  java.util.List<com.google.ads.googleads.v25.common.MetricGoal> 
      getGoalsList();
  /**
   * <pre>
   * The goals of this experiment.
   ...
   * <code>repeated .google.ads.googleads.v25.common.MetricGoal goals = 17;</code>
   */
  com.google.ads.googleads.v25.common.MetricGoal getGoals(int index);
  /**
   * <pre>
   * The goals of this experiment.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v25.common.MetricGoal goals = 17;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v25.common.MetricGoalOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v25.common.MetricGoal goals = 17;</code>
   */
  com.google.ads.googleads.v25.common.MetricGoalOrBuilder getGoalsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v25.enums.AsyncActionStatusEnum.AsyncActionStatus promote_status = 19 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v25.enums.AsyncActionStatusEnum.AsyncActionStatus getPromoteStatus();
   ...
   * </pre>
   *
   * <code>optional string lift_measurement_config = 23 [(.google.api.field_behavior) = OUTPUT_ONLY, (.google.api.resource_reference) = { ... }</code>
   ...
   */
  java.lang.String getLiftMeasurementConfig();
  /**
   * <pre>
   * Output only. The lift measurement configuration.
   * </pre>
   *
   * <code>optional string lift_measurement_config = 23 [(.google.api.field_behavior) = OUTPUT_ONLY, (.google.api.resource_reference) = { ... }</code>
   * @return The bytes for liftMeasurementConfig.
   */
  com.google.protobuf.ByteString
      getLiftMeasurementConfigBytes();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v25.common.VideoExperimentInfo video_experiment = 21 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v25.common.VideoExperimentInfo getVideoExperiment();
  /**
   * <pre>
   * Immutable. Details of the video experiment. Applies for experiment types:
   * YOUTUBE_CUSTOM.
   ...
   * <code>.google.ads.googleads.v25.common.VideoExperimentInfo video_experiment = 21 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.ads.googleads.v25.common.VideoExperimentInfoOrBuilder getVideoExperimentOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v25.common.OptimizeAssetsExperimentInfo optimize_assets_experiment = 22 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v25.common.OptimizeAssetsExperimentInfo getOptimizeAssetsExperiment();
  /**
   * <pre>
   * Immutable. Details of the optimize assets experiment. Applies for
   * experiment types: OPTIMIZE_ASSETS.
   ...
   * <code>.google.ads.googleads.v25.common.OptimizeAssetsExperimentInfo optimize_assets_experiment = 22 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.ads.googleads.v25.common.OptimizeAssetsExperimentInfoOrBuilder getOptimizeAssetsExperimentOrBuilder();

  com.google.ads.googleads.v25.resources.Experiment.ExperimentInfoCase getExperimentInfoCase();
}
