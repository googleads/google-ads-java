...
public class LiftMeasurementAgeRangeName implements ResourceName {
  private static final PathTemplate
      CUSTOMER_ID_LIFT_MEASUREMENT_CONFIGURATION_ID_CAMPAIGN_ID_CRITERION_ID =
  ...
  @Deprecated
  protected LiftMeasurementAgeRangeName() {
    customerId = null;
  ...
  private LiftMeasurementAgeRangeName(Builder builder) {
  ...
  public static LiftMeasurementAgeRangeName of(
      String customerId,
  ...
  public static @Nullable LiftMeasurementAgeRangeName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        CUSTOMER_ID_LIFT_MEASUREMENT_CONFIGURATION_ID_CAMPAIGN_ID_CRITERION_ID.validatedMatch(
            formattedString,
            "LiftMeasurementAgeRangeName.parse: formattedString not in valid format");
    return of(
  ...
  public static List<LiftMeasurementAgeRangeName> parseList(List<String> formattedStrings) {
    List<LiftMeasurementAgeRangeName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable LiftMeasurementAgeRangeName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (LiftMeasurementAgeRangeName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public static boolean isParsableFrom(String formattedString) {
    return CUSTOMER_ID_LIFT_MEASUREMENT_CONFIGURATION_ID_CAMPAIGN_ID_CRITERION_ID.matches(
        formattedString);
  }
  ...
  public String toString() {
    return CUSTOMER_ID_LIFT_MEASUREMENT_CONFIGURATION_ID_CAMPAIGN_ID_CRITERION_ID.instantiate(
        "customer_id",
        customerId,
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      LiftMeasurementAgeRangeName that = ((LiftMeasurementAgeRangeName) o);
  ...
  public static class Builder {
    ...
    private Builder(LiftMeasurementAgeRangeName liftMeasurementAgeRangeName) {
      this.customerId = liftMeasurementAgeRangeName.customerId;
      this.liftMeasurementConfigurationId =
          liftMeasurementAgeRangeName.liftMeasurementConfigurationId;
      this.campaignId = liftMeasurementAgeRangeName.campaignId;
      this.criterionId = liftMeasurementAgeRangeName.criterionId;
    }

    public LiftMeasurementAgeRangeName build() {
      return new LiftMeasurementAgeRangeName(this);
    }
  }
}
