...
public class CustomerConversionGoalName implements ResourceName {
  ...
  public static @Nullable CustomerConversionGoalName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CustomerConversionGoalName> values) {
