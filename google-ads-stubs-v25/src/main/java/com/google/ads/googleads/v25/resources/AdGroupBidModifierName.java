...
public class AdGroupBidModifierName implements ResourceName {
  ...
  public static @Nullable AdGroupBidModifierName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AdGroupBidModifierName> values) {
