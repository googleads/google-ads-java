...
public class AdGroupSimulationName implements ResourceName {
  ...
  public static @Nullable AdGroupSimulationName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AdGroupSimulationName> values) {
