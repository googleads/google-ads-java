...
public class PerStoreViewName implements ResourceName {
  private static final PathTemplate CUSTOMER_ID_PLACE_ID =
      PathTemplate.createWithoutUrlEncoding("customers/{customer_id}/perStoreViews/{place_id}");
  ...
  public static PerStoreViewName of(String customerId, String placeId) {
    return newBuilder().setCustomerId(customerId).setPlaceId(placeId).build();
  }

  public static String format(String customerId, String placeId) {
    return newBuilder().setCustomerId(customerId).setPlaceId(placeId).build().toString();
  }

  public static @Nullable PerStoreViewName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        CUSTOMER_ID_PLACE_ID.validatedMatch(
            formattedString, "PerStoreViewName.parse: formattedString not in valid format");
    return of(matchMap.get("customer_id"), matchMap.get("place_id"));
  }

  public static List<PerStoreViewName> parseList(List<String> formattedStrings) {
    List<PerStoreViewName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable PerStoreViewName> values) {
  ...
  public String toString() {
    return CUSTOMER_ID_PLACE_ID.instantiate("customer_id", customerId, "place_id", placeId);
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.customerId, that.customerId)
          && Objects.equals(this.placeId, that.placeId);
    }
    return false;
  }
