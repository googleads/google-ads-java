...
public interface ShoppingProductOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v25.resources.ShoppingProduct)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v25.enums.ProductChannelEnum.ProductChannel channel = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The channel.
   */
  com.google.ads.googleads.v25.enums.ProductChannelEnum.ProductChannel getChannel();
   ...
   * </pre>
   *
   * <code>optional string product_image_uri = 36 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   * @return Whether the productImageUri field is set.
   */
  boolean hasProductImageUri();
  /**
   * <pre>
   * Output only. The URI of the product image as provided by the merchant.
   * </pre>
   *
   * <code>optional string product_image_uri = 36 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   * @return The productImageUri.
   */
  java.lang.String getProductImageUri();
  /**
   * <pre>
   * Output only. The URI of the product image as provided by the merchant.
   * </pre>
   *
   * <code>optional string product_image_uri = 36 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   * @return The bytes for productImageUri.
   */
  com.google.protobuf.ByteString
      getProductImageUriBytes();
   ...
   * </pre>
   *
   * <code>optional .google.ads.googleads.v25.enums.ProductChannelExclusivityEnum.ProductChannelExclusivity channel_exclusivity = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v25.enums.ProductChannelExclusivityEnum.ProductChannelExclusivity getChannelExclusivity();
   ...
   * </pre>
   *
   * <code>optional .google.ads.googleads.v25.enums.ProductConditionEnum.ProductCondition condition = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v25.enums.ProductConditionEnum.ProductCondition getCondition();
   ...
   * </pre>
   *
   * <code>optional .google.ads.googleads.v25.enums.ProductAvailabilityEnum.ProductAvailability availability = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v25.enums.ProductAvailabilityEnum.ProductAvailability getAvailability();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v25.enums.ProductStatusEnum.ProductStatus status = 32 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v25.enums.ProductStatusEnum.ProductStatus getStatus();
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v25.resources.ShoppingProduct.ProductIssue issues = 33 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.ads.googleads.v25.resources.ShoppingProduct.ProductIssue> 
      getIssuesList();
  /**
   * <pre>
   * Output only. The list of issues affecting whether the product can show in
   ...
   * <code>repeated .google.ads.googleads.v25.resources.ShoppingProduct.ProductIssue issues = 33 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v25.resources.ShoppingProduct.ProductIssue getIssues(int index);
  /**
   * <pre>
   * Output only. The list of issues affecting whether the product can show in
   * ads. The value of this field is restricted to the scope specified in the
   ...
   * <code>repeated .google.ads.googleads.v25.resources.ShoppingProduct.ProductIssue issues = 33 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v25.resources.ShoppingProduct.ProductIssueOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v25.resources.ShoppingProduct.ProductIssue issues = 33 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v25.resources.ShoppingProduct.ProductIssueOrBuilder getIssuesOrBuilder(
      int index);
