...
public interface CampaignToForecastOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v25.services.CampaignToForecast)
   ...
   */
  com.google.ads.googleads.v25.services.CampaignToForecast.CampaignBiddingStrategy getBiddingStrategy();
  /**
   * <pre>
   * Required. The bidding strategy for the campaign.
   * </pre>
   ...
   * <code>.google.ads.googleads.v25.services.CampaignToForecast.CampaignBiddingStrategy bidding_strategy = 5 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v25.services.CampaignToForecast.CampaignBiddingStrategyOrBuilder getBiddingStrategyOrBuilder();
   ...
   */
  java.util.List<com.google.ads.googleads.v25.services.ForecastAdGroup> 
      getAdGroupsList();
  /**
   * <pre>
   * The ad groups in the new campaign to forecast.
   ...
   * <code>repeated .google.ads.googleads.v25.services.ForecastAdGroup ad_groups = 7;</code>
   */
  com.google.ads.googleads.v25.services.ForecastAdGroup getAdGroups(int index);
  /**
   * <pre>
   * The ad groups in the new campaign to forecast.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v25.services.ForecastAdGroup ad_groups = 7;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v25.services.ForecastAdGroupOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v25.services.ForecastAdGroup ad_groups = 7;</code>
   */
  com.google.ads.googleads.v25.services.ForecastAdGroupOrBuilder getAdGroupsOrBuilder(
      int index);
}
