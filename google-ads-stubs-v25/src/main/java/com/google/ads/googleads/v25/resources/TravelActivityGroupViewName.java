...
public class TravelActivityGroupViewName implements ResourceName {
  ...
  public static @Nullable TravelActivityGroupViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable TravelActivityGroupViewName> values) {
