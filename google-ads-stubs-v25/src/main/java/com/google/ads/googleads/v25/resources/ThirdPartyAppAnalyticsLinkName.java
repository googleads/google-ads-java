...
public class ThirdPartyAppAnalyticsLinkName implements ResourceName {
  ...
  public static @Nullable ThirdPartyAppAnalyticsLinkName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ThirdPartyAppAnalyticsLinkName> values) {
