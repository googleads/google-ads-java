...
public class AndroidPrivacySharedKeyGoogleCampaignName implements ResourceName {
  ...
  public static @Nullable AndroidPrivacySharedKeyGoogleCampaignName parse(String formattedString) {
  ...
  public static List<String> toStringList(
      List<@Nullable AndroidPrivacySharedKeyGoogleCampaignName> values) {
