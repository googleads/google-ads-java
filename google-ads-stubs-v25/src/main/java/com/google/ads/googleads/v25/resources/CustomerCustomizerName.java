...
public class CustomerCustomizerName implements ResourceName {
  ...
  public static @Nullable CustomerCustomizerName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CustomerCustomizerName> values) {
