  ...
  private static final MethodDescriptor<
      ...
      generateConversionRatesMethodDescriptor =
          MethodDescriptor
              ...
              .setFullMethodName(
                  "google.ads.googleads.v25.services.ReachPlanService/GenerateConversionRates")
  ...
  private static final MethodDescriptor<
      ...
      listPlannableLocationsMethodDescriptor =
          MethodDescriptor
              ...
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.ads.googleads.v25.services.ReachPlanService/ListPlannableLocations")
              .setRequestMarshaller(
  ...
  private static final MethodDescriptor<ListPlannableProductsRequest, ListPlannableProductsResponse>
      listPlannableProductsMethodDescriptor =
          MethodDescriptor.<ListPlannableProductsRequest, ListPlannableProductsResponse>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.ads.googleads.v25.services.ReachPlanService/ListPlannableProducts")
              .setRequestMarshaller(
  ...
  private static final MethodDescriptor<GenerateReachForecastRequest, GenerateReachForecastResponse>
      generateReachForecastMethodDescriptor =
          MethodDescriptor.<GenerateReachForecastRequest, GenerateReachForecastResponse>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.ads.googleads.v25.services.ReachPlanService/GenerateReachForecast")
              .setRequestMarshaller(
  ...
  private static final MethodDescriptor<
      ...
      listPlannableUserListsMethodDescriptor =
          MethodDescriptor
              ...
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.ads.googleads.v25.services.ReachPlanService/ListPlannableUserLists")
              .setRequestMarshaller(
  ...
  private static final MethodDescriptor<
      ...
      listPlannableUserInterestsMethodDescriptor =
          MethodDescriptor
              ...
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.ads.googleads.v25.services.ReachPlanService/ListPlannableUserInterests")
              .setRequestMarshaller(
