...
import com.google.ads.googleads.v25.services.stub.CustomAudienceServiceStub;
...
public class CustomAudienceServiceClient implements BackgroundResource {
  private final @Nullable CustomAudienceServiceSettings settings;
  ...
  public final @Nullable CustomAudienceServiceSettings getSettings() {
    return settings;
  }
