...
import com.google.ads.googleads.v25.services.stub.UserListCustomerTypeServiceStub;
...
public class UserListCustomerTypeServiceClient implements BackgroundResource {
  private final @Nullable UserListCustomerTypeServiceSettings settings;
  ...
  public final @Nullable UserListCustomerTypeServiceSettings getSettings() {
    return settings;
  }
