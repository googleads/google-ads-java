...
public class CampaignConversionGoalName implements ResourceName {
  ...
  public static @Nullable CampaignConversionGoalName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CampaignConversionGoalName> values) {
