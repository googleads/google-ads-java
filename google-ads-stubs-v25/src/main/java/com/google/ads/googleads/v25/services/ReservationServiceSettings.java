...
import com.google.ads.googleads.v25.services.stub.ReservationServiceStubSettings;
...
public class ReservationServiceSettings extends ClientSettings<ReservationServiceSettings> {
  ...
  public UnaryCallSettings<QuoteCampaignsRequest, QuoteCampaignsResponse> quoteCampaignsSettings() {
    return ((ReservationServiceStubSettings) getStubSettings()).quoteCampaignsSettings();
  }
  ...
  public UnaryCallSettings<BookCampaignsRequest, BookCampaignsResponse> bookCampaignsSettings() {
    return ((ReservationServiceStubSettings) getStubSettings()).bookCampaignsSettings();
  }
  ...
  public static class Builder extends ClientSettings.Builder<ReservationServiceSettings, Builder> {
    ...
    public UnaryCallSettings.Builder<QuoteCampaignsRequest, QuoteCampaignsResponse>
        quoteCampaignsSettings() {
      return getStubSettingsBuilder().quoteCampaignsSettings();
    }
    ...
    public UnaryCallSettings.Builder<BookCampaignsRequest, BookCampaignsResponse>
      ...
      return getStubSettingsBuilder().bookCampaignsSettings();
    }
