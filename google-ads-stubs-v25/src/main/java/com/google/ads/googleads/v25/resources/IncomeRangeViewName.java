...
public class IncomeRangeViewName implements ResourceName {
  ...
  public static IncomeRangeViewName of(String customerId, String adGroupId, String criterionId) {
    return newBuilder()
  ...
  public static @Nullable IncomeRangeViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable IncomeRangeViewName> values) {
