...
public class ConversionActionName implements ResourceName {
  ...
  public static @Nullable ConversionActionName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ConversionActionName> values) {
