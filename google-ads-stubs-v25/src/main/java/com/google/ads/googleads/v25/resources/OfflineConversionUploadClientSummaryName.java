...
public class OfflineConversionUploadClientSummaryName implements ResourceName {
  ...
  public static @Nullable OfflineConversionUploadClientSummaryName parse(String formattedString) {
  ...
  public static List<String> toStringList(
      List<@Nullable OfflineConversionUploadClientSummaryName> values) {
