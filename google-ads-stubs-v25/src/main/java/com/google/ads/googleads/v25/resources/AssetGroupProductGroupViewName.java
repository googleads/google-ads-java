...
public class AssetGroupProductGroupViewName implements ResourceName {
  ...
  public static @Nullable AssetGroupProductGroupViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AssetGroupProductGroupViewName> values) {
