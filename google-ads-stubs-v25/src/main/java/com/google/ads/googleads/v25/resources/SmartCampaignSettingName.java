...
public class SmartCampaignSettingName implements ResourceName {
  ...
  public static @Nullable SmartCampaignSettingName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable SmartCampaignSettingName> values) {
