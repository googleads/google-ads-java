...
public class ShoppingPerformanceViewName implements ResourceName {
  ...
  public static @Nullable ShoppingPerformanceViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ShoppingPerformanceViewName> values) {
