...
public class AdGroupCriterionLabelName implements ResourceName {
  ...
  public static @Nullable AdGroupCriterionLabelName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AdGroupCriterionLabelName> values) {
