...
public class CurrencyConstantName implements ResourceName {
  ...
  public static @Nullable CurrencyConstantName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CurrencyConstantName> values) {
