...
import com.google.ads.googleads.v25.services.stub.CampaignServiceStub;
import com.google.ads.googleads.v25.services.stub.CampaignServiceStubSettings;
 ...
 *    </tr>
 *    <tr>
 *      <td><p> EnablePMaxBrandGuidelines</td>
 *      <td><p> Enables Brand Guidelines for Performance Max campaigns.
 * <p>  List of thrown errors:   [AuthenticationError]()   [AssetError]()   [AssetLinkError]()   [AuthorizationError]()   [BrandGuidelinesMigrationError]()   [CampaignError]()   [HeaderError]()   [InternalError]()   [MutateError]()   [QuotaError]()   [RequestError]()   [ResourceCountLimitExceededError]()</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> enablePMaxBrandGuidelines(EnablePMaxBrandGuidelinesRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> enablePMaxBrandGuidelines(String customerId, List&lt;EnableOperation&gt; operations)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> enablePMaxBrandGuidelinesCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *  </table>
...
public class CampaignServiceClient implements BackgroundResource {
  private final @Nullable CampaignServiceSettings settings;
  ...
  public final @Nullable CampaignServiceSettings getSettings() {
    return settings;
  }
   ...
   *
   * <p>List of thrown errors: [AuthenticationError]() [AssetError]() [AssetLinkError]()
   * [AuthorizationError]() [BrandGuidelinesMigrationError]() [CampaignError]() [HeaderError]()
   ...
   *   EnablePMaxBrandGuidelinesResponse response =
   *       campaignServiceClient.enablePMaxBrandGuidelines(customerId, operations);
   * }
   * }</pre>
   *
   * @param customerId Required. The ID of the customer whose campaigns are being enabled.
   * @param operations Required. The list of individual campaign operations. A maximum of 10 enable
   *     operations can be executed in a request.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final EnablePMaxBrandGuidelinesResponse enablePMaxBrandGuidelines(
      String customerId, List<EnableOperation> operations) {
    EnablePMaxBrandGuidelinesRequest request =
        EnablePMaxBrandGuidelinesRequest.newBuilder()
            .setCustomerId(customerId)
            .addAllOperations(operations)
            .build();
    return enablePMaxBrandGuidelines(request);
  }
   ...
   *       EnablePMaxBrandGuidelinesRequest.newBuilder()
   *           .setCustomerId("customerId-1581184615")
   *           .addAllOperations(new ArrayList<EnableOperation>())
   *           .build();
   *   EnablePMaxBrandGuidelinesResponse response =
   *       campaignServiceClient.enablePMaxBrandGuidelines(request);
   * }
   * }</pre>
   *
   * @param request The request object containing all of the parameters for the API call.
  ...
  public final EnablePMaxBrandGuidelinesResponse enablePMaxBrandGuidelines(
      EnablePMaxBrandGuidelinesRequest request) {
    return enablePMaxBrandGuidelinesCallable().call(request);
  }
   ...
   *           .addAllOperations(new ArrayList<EnableOperation>())
   *           .build();
   *   ApiFuture<EnablePMaxBrandGuidelinesResponse> future =
   *       campaignServiceClient.enablePMaxBrandGuidelinesCallable().futureCall(request);
   *   // Do something.
   *   EnablePMaxBrandGuidelinesResponse response = future.get();
   * }
   * }</pre>
   */
  public final UnaryCallable<EnablePMaxBrandGuidelinesRequest, EnablePMaxBrandGuidelinesResponse>
      enablePMaxBrandGuidelinesCallable() {
    return stub.enablePMaxBrandGuidelinesCallable();
  }
