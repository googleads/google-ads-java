...
@VersionDescriptor(versionName = "v25",
...
public interface GoogleAdsVersion {
        ...
        @ServiceClientDescriptor(settingsClass = AssetGenerationServiceSettings.class)
        AssetGenerationServiceClient createAssetGenerationServiceClient();
        ...
        @ServiceClientDescriptor(settingsClass = AutomaticallyCreatedAssetRemovalServiceSettings.class)
        AutomaticallyCreatedAssetRemovalServiceClient createAutomaticallyCreatedAssetRemovalServiceClient();
         
        @ServiceClientDescriptor(settingsClass = BatchJobServiceSettings.class)
        BatchJobServiceClient createBatchJobServiceClient();
         
        @ServiceClientDescriptor(settingsClass = BenchmarksServiceSettings.class)
        BenchmarksServiceClient createBenchmarksServiceClient();
        ...
        @ServiceClientDescriptor(settingsClass = CampaignGoalConfigServiceSettings.class)
        CampaignGoalConfigServiceClient createCampaignGoalConfigServiceClient();
        ...
        @ServiceClientDescriptor(settingsClass = GoalServiceSettings.class)
        GoalServiceClient createGoalServiceClient();
        ...
        @ServiceClientDescriptor(settingsClass = IncentiveServiceSettings.class)
        IncentiveServiceClient createIncentiveServiceClient();
