...
import com.google.ads.googleads.v25.services.stub.AudienceServiceStub;
...
public class AudienceServiceClient implements BackgroundResource {
  private final @Nullable AudienceServiceSettings settings;
  ...
  public final @Nullable AudienceServiceSettings getSettings() {
    return settings;
  }
