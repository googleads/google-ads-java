...
public class CarrierConstantName implements ResourceName {
  private static final PathTemplate CRITERION_ID =
      PathTemplate.createWithoutUrlEncoding("carrierConstants/{criterion_id}");
  ...
  public static @Nullable CarrierConstantName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CarrierConstantName> values) {
