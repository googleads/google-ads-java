...
public class AssetSetTypeViewName implements ResourceName {
  ...
  public static @Nullable AssetSetTypeViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AssetSetTypeViewName> values) {
