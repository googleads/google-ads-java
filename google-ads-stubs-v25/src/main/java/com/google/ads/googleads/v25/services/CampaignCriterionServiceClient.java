...
import com.google.ads.googleads.v25.services.stub.CampaignCriterionServiceStub;
import com.google.ads.googleads.v25.services.stub.CampaignCriterionServiceStubSettings;
 ...
 *    </tr>
 *    <tr>
 *      <td><p> MutateCampaignCriteria</td>
 *      <td><p> Creates, updates, or removes criteria. Operation statuses are returned.
 * <p>  List of thrown errors:   [AdxError]()   [AuthenticationError]()   [AuthorizationError]()   [CampaignCriterionError]()   [CollectionSizeError]()   [ContextError]()   [CriterionError]()   [DatabaseError]()   [DistinctError]()   [FieldError]()   [FieldMaskError]()   [FunctionError]()   [HeaderError]()   [IdError]()   [InternalError]()   [MutateError]()   [NewResourceCreationError]()   [NotEmptyError]()   [NullError]()   [OperationAccessDeniedError]()   [OperatorError]()   [QuotaError]()   [RangeError]()   [RegionCodeError]()   [RequestError]()   [ResourceCountLimitExceededError]()   [SizeLimitError]()   [StringFormatError]()   [StringLengthError]()</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> mutateCampaignCriteria(MutateCampaignCriteriaRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> mutateCampaignCriteria(String customerId, List&lt;CampaignCriterionOperation&gt; operations)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> mutateCampaignCriteriaCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *  </table>
...
public class CampaignCriterionServiceClient implements BackgroundResource {
  private final @Nullable CampaignCriterionServiceSettings settings;
  ...
  public final @Nullable CampaignCriterionServiceSettings getSettings() {
    return settings;
  }
