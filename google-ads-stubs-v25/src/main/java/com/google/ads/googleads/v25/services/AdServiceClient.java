...
import com.google.ads.googleads.v25.services.stub.AdServiceStub;
...
public class AdServiceClient implements BackgroundResource {
  private final @Nullable AdServiceSettings settings;
  ...
  public final @Nullable AdServiceSettings getSettings() {
    return settings;
  }
