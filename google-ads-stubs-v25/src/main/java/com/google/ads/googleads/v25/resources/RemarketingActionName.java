...
public class RemarketingActionName implements ResourceName {
  ...
  public static @Nullable RemarketingActionName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable RemarketingActionName> values) {
