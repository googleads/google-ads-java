...
public class HotelGroupViewName implements ResourceName {
  ...
  public static HotelGroupViewName of(String customerId, String adGroupId, String criterionId) {
    return newBuilder()
  ...
  public static @Nullable HotelGroupViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable HotelGroupViewName> values) {
