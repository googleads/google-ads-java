...
public interface CreateOfflineUserDataJobRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v25.services.CreateOfflineUserDataJobRequest)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v25.resources.OfflineUserDataJob job = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * @return The job.
   */
  com.google.ads.googleads.v25.resources.OfflineUserDataJob getJob();
  /**
   * <pre>
   * Required. The offline user data job to be created.
   * </pre>
   ...
   * <code>.google.ads.googleads.v25.resources.OfflineUserDataJob job = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v25.resources.OfflineUserDataJobOrBuilder getJobOrBuilder();
