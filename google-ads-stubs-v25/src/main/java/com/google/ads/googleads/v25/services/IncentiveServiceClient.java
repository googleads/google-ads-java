...
import com.google.ads.googleads.v25.services.stub.IncentiveServiceStub;
 ...
 *           <li><p> applyIncentive(long selectedIncentiveId, String customerId, String countryCode)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
...
public class IncentiveServiceClient implements BackgroundResource {
   ...
   * // https://cloud.google.com/java/docs/setup#configure_endpoints_for_the_client_library
   * try (IncentiveServiceClient incentiveServiceClient = IncentiveServiceClient.create()) {
   *   long selectedIncentiveId = 1678975891;
   *   String customerId = "customerId-1581184615";
   *   String countryCode = "countryCode-1477067101";
   *   ApplyIncentiveResponse response =
   *       incentiveServiceClient.applyIncentive(selectedIncentiveId, customerId, countryCode);
   * }
   * }</pre>
   *
   * @param selectedIncentiveId Required. The incentive ID of this incentive. This is used to
   *     identify which incentive is selected by the user in the CYO flow.
   * @param customerId Required. The customer ID of the account that the incentive is being applied
   *     to.
   * @param countryCode Required. User's country code. Required. This field must be equal to the
   *     Google Ads account's billing country. Incentive eligibility, terms of service, and reward
   *     values are often country-specific. This country code is used to ensure the selected
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final ApplyIncentiveResponse applyIncentive(
      long selectedIncentiveId, String customerId, String countryCode) {
    ApplyIncentiveRequest request =
