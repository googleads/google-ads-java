...
public class ContentCriterionViewName implements ResourceName {
  ...
  @Deprecated
  protected ContentCriterionViewName() {
    customerId = null;
    adGroupId = null;
    criterionId = null;
  }

  private ContentCriterionViewName(Builder builder) {
  ...
  public static ContentCriterionViewName of(
  ...
  public static @Nullable ContentCriterionViewName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        CUSTOMER_ID_AD_GROUP_ID_CRITERION_ID.validatedMatch(
            formattedString, "ContentCriterionViewName.parse: formattedString not in valid format");
    return of(
        matchMap.get("customer_id"), matchMap.get("ad_group_id"), matchMap.get("criterion_id"));
  }

  public static List<ContentCriterionViewName> parseList(List<String> formattedStrings) {
    List<ContentCriterionViewName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable ContentCriterionViewName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (ContentCriterionViewName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ContentCriterionViewName that = ((ContentCriterionViewName) o);
  ...
  public static class Builder {
    ...
    private Builder(ContentCriterionViewName contentCriterionViewName) {
      this.customerId = contentCriterionViewName.customerId;
      this.adGroupId = contentCriterionViewName.adGroupId;
      this.criterionId = contentCriterionViewName.criterionId;
    }

    public ContentCriterionViewName build() {
      return new ContentCriterionViewName(this);
    }
  }
}
