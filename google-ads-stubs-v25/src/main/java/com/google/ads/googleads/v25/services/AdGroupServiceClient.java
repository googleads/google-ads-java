...
import com.google.ads.googleads.v25.services.stub.AdGroupServiceStub;
...
public class AdGroupServiceClient implements BackgroundResource {
  private final @Nullable AdGroupServiceSettings settings;
  ...
  public final @Nullable AdGroupServiceSettings getSettings() {
    return settings;
  }
