...
import com.google.ads.googleads.v25.common.AudienceInsightsAttribute;
import com.google.ads.googleads.v25.common.LocationInfo;
import com.google.ads.googleads.v25.enums.AudienceInsightsDimensionEnum;
import com.google.ads.googleads.v25.services.stub.AudienceInsightsServiceStub;
import com.google.ads.googleads.v25.services.stub.AudienceInsightsServiceStubSettings;
 ...
 *    </tr>
 *    <tr>
 *      <td><p> GenerateAudienceDefinition</td>
 *      <td><p> Returns a collection of audience attributes using generative AI based on the provided audience description.
 * <p>  List of thrown errors:   [AudienceInsightsError]()   [AuthenticationError]()   [AuthorizationError]()   [FieldError]()   [HeaderError]()   [InternalError]()   [QuotaError]()   [RequestError]()</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> generateAudienceDefinition(GenerateAudienceDefinitionRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> generateAudienceDefinition(String customerId, InsightsAudienceDescription audienceDescription)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> generateAudienceDefinitionCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
...
public class AudienceInsightsServiceClient implements BackgroundResource {
  ...
  // AUTO-GENERATED DOCUMENTATION AND METHOD.
  /**
   * Returns a collection of audience attributes using generative AI based on the provided audience
   * description.
   *
   * <p>List of thrown errors: [AudienceInsightsError]() [AuthenticationError]()
   * [AuthorizationError]() [FieldError]() [HeaderError]() [InternalError]() [QuotaError]()
   ...
   *     AudienceInsightsServiceClient.create()) {
   *   String customerId = "customerId-1581184615";
   *   InsightsAudienceDescription audienceDescription =
   *       InsightsAudienceDescription.newBuilder().build();
   *   GenerateAudienceDefinitionResponse response =
   *       audienceInsightsServiceClient.generateAudienceDefinition(customerId, audienceDescription);
   * }
   * }</pre>
   *
   * @param customerId Required. The ID of the customer.
   * @param audienceDescription Required. Provide a text description of an audience to get
   *     AI-generated structured suggestions. This can take around 5 or more seconds to complete
   *     Supported marketing objectives are: AWARENESS, CONSIDERATION and RESEARCH. Supported
   *     dimensions are: AGE_RANGE, GENDER, PARENTAL_STATUS, AFFINITY_USER_INTEREST,
   *     IN_MARKET_USER_INTEREST, LIFE_EVENT_USER_INTEREST, CATEGORY and KNOWLEDGE_GRAPH.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final GenerateAudienceDefinitionResponse generateAudienceDefinition(
      String customerId, InsightsAudienceDescription audienceDescription) {
    GenerateAudienceDefinitionRequest request =
        GenerateAudienceDefinitionRequest.newBuilder()
            .setCustomerId(customerId)
            .setAudienceDescription(audienceDescription)
            .build();
    return generateAudienceDefinition(request);
  }
   ...
   *       GenerateAudienceDefinitionRequest.newBuilder()
   *           .setCustomerId("customerId-1581184615")
   *           .setAudienceDescription(InsightsAudienceDescription.newBuilder().build())
   *           .setCustomerInsightsGroup("customerInsightsGroup1092118566")
   *           .setInsightsApplicationInfo(AdditionalApplicationInfo.newBuilder().build())
   *           .build();
   *   GenerateAudienceDefinitionResponse response =
   *       audienceInsightsServiceClient.generateAudienceDefinition(request);
   * }
   * }</pre>
   *
   * @param request The request object containing all of the parameters for the API call.
  ...
  public final GenerateAudienceDefinitionResponse generateAudienceDefinition(
      GenerateAudienceDefinitionRequest request) {
    return generateAudienceDefinitionCallable().call(request);
  }
   ...
   *           .setInsightsApplicationInfo(AdditionalApplicationInfo.newBuilder().build())
   *           .build();
   *   ApiFuture<GenerateAudienceDefinitionResponse> future =
   *       audienceInsightsServiceClient.generateAudienceDefinitionCallable().futureCall(request);
   *   // Do something.
   *   GenerateAudienceDefinitionResponse response = future.get();
   * }
   * }</pre>
   */
  public final UnaryCallable<GenerateAudienceDefinitionRequest, GenerateAudienceDefinitionResponse>
      generateAudienceDefinitionCallable() {
    return stub.generateAudienceDefinitionCallable();
  }
