...
public class VideoEnhancementName implements ResourceName {
  ...
  public static @Nullable VideoEnhancementName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable VideoEnhancementName> values) {
