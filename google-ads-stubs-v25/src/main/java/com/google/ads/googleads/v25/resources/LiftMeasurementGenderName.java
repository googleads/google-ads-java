...
public class LiftMeasurementGenderName implements ResourceName {
  ...
  @Deprecated
  protected LiftMeasurementGenderName() {
    customerId = null;
  ...
  private LiftMeasurementGenderName(Builder builder) {
  ...
  public static LiftMeasurementGenderName of(
      String customerId,
  ...
  public static @Nullable LiftMeasurementGenderName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_ID_LIFT_MEASUREMENT_CONFIGURATION_ID_CAMPAIGN_ID_CRITERION_ID.validatedMatch(
            formattedString,
            "LiftMeasurementGenderName.parse: formattedString not in valid format");
    return of(
  ...
  public static List<LiftMeasurementGenderName> parseList(List<String> formattedStrings) {
    List<LiftMeasurementGenderName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable LiftMeasurementGenderName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (LiftMeasurementGenderName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      LiftMeasurementGenderName that = ((LiftMeasurementGenderName) o);
  ...
  public static class Builder {
    ...
    private Builder(LiftMeasurementGenderName liftMeasurementGenderName) {
      this.customerId = liftMeasurementGenderName.customerId;
      this.liftMeasurementConfigurationId =
          liftMeasurementGenderName.liftMeasurementConfigurationId;
      this.campaignId = liftMeasurementGenderName.campaignId;
      this.criterionId = liftMeasurementGenderName.criterionId;
    }

    public LiftMeasurementGenderName build() {
      return new LiftMeasurementGenderName(this);
    }
  }
}
