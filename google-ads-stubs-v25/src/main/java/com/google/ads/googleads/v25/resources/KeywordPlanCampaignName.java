...
public class KeywordPlanCampaignName implements ResourceName {
  ...
  public static @Nullable KeywordPlanCampaignName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable KeywordPlanCampaignName> values) {
