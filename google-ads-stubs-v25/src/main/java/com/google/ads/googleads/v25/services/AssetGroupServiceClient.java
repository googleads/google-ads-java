...
import com.google.ads.googleads.v25.services.stub.AssetGroupServiceStub;
...
public class AssetGroupServiceClient implements BackgroundResource {
  private final @Nullable AssetGroupServiceSettings settings;
  ...
  public final @Nullable AssetGroupServiceSettings getSettings() {
    return settings;
  }
