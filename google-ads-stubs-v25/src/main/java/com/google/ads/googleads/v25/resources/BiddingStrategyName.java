...
public class BiddingStrategyName implements ResourceName {
  ...
  public static @Nullable BiddingStrategyName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable BiddingStrategyName> values) {
