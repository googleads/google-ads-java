...
import com.google.ads.googleads.v25.services.EnablePMaxBrandGuidelinesRequest;
import com.google.ads.googleads.v25.services.EnablePMaxBrandGuidelinesResponse;
import com.google.ads.googleads.v25.services.MutateCampaignsRequest;
...
public class GrpcCampaignServiceStub extends CampaignServiceStub {
  ...
  private static final MethodDescriptor<
      ...
      enablePMaxBrandGuidelinesMethodDescriptor =
          MethodDescriptor
              .<EnablePMaxBrandGuidelinesRequest, EnablePMaxBrandGuidelinesResponse>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.ads.googleads.v25.services.CampaignService/EnablePMaxBrandGuidelines")
              .setRequestMarshaller(
  ...
  private final UnaryCallable<EnablePMaxBrandGuidelinesRequest, EnablePMaxBrandGuidelinesResponse>
  ...
  protected GrpcCampaignServiceStub(
    ...
    GrpcCallSettings<MutateCampaignsRequest, MutateCampaignsResponse>
        mutateCampaignsTransportSettings =
            GrpcCallSettings.<MutateCampaignsRequest, MutateCampaignsResponse>newBuilder()
                ...
                .build();
    GrpcCallSettings<EnablePMaxBrandGuidelinesRequest, EnablePMaxBrandGuidelinesResponse>
        enablePMaxBrandGuidelinesTransportSettings =
            GrpcCallSettings
                .<EnablePMaxBrandGuidelinesRequest, EnablePMaxBrandGuidelinesResponse>newBuilder()
                .setMethodDescriptor(enablePMaxBrandGuidelinesMethodDescriptor)
                .setParamsExtractor(
                    request -> {
                      RequestParamsBuilder builder = RequestParamsBuilder.create();
                      builder.add("customer_id", String.valueOf(request.getCustomerId()));
    ...
    this.enablePMaxBrandGuidelinesCallable =
        callableFactory.createUnaryCallable(
            enablePMaxBrandGuidelinesTransportSettings,
            settings.enablePMaxBrandGuidelinesSettings(),
            clientContext);
  ...
  public UnaryCallable<EnablePMaxBrandGuidelinesRequest, EnablePMaxBrandGuidelinesResponse>
      enablePMaxBrandGuidelinesCallable() {
    return enablePMaxBrandGuidelinesCallable;
  }
