...
public class SharedCriterionName implements ResourceName {
  ...
  public static @Nullable SharedCriterionName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable SharedCriterionName> values) {
