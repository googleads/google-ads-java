...
public class CampaignCriterionName implements ResourceName {
  ...
  public static @Nullable CampaignCriterionName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CampaignCriterionName> values) {
