...
public class BiddingDataExclusionName implements ResourceName {
  ...
  public static @Nullable BiddingDataExclusionName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable BiddingDataExclusionName> values) {
