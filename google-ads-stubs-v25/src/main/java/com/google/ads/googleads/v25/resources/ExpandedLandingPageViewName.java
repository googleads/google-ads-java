...
public class ExpandedLandingPageViewName implements ResourceName {
  ...
  public static @Nullable ExpandedLandingPageViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ExpandedLandingPageViewName> values) {
