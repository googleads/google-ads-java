...
public class ParentalStatusViewName implements ResourceName {
  ...
  public static @Nullable ParentalStatusViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ParentalStatusViewName> values) {
