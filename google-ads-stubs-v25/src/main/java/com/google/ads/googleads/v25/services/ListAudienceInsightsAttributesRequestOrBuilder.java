...
public interface ListAudienceInsightsAttributesRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v25.services.ListAudienceInsightsAttributesRequest)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v25.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension dimensions = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   * @return A list containing the dimensions.
   */
  java.util.List<com.google.ads.googleads.v25.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension> getDimensionsList();
  /**
   * <pre>
   * Required. The types of attributes to be returned. Supported
   * dimensions are CATEGORY, KNOWLEDGE_GRAPH, DEVICE,
   ...
   */
  com.google.ads.googleads.v25.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension getDimensions(int index);
  /**
   * <pre>
   * Required. The types of attributes to be returned. Supported
   * dimensions are CATEGORY, KNOWLEDGE_GRAPH, DEVICE,
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v25.common.AdditionalApplicationInfo insights_application_info = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v25.common.LocationInfo location_country_filters = 5;</code>
   */
   ...
   * <code>repeated .google.ads.googleads.v25.common.LocationInfo location_country_filters = 5;</code>
   */
  com.google.ads.googleads.v25.common.LocationInfo getLocationCountryFilters(int index);
  /**
   * <pre>
   * If SUB_COUNTRY_LOCATION attributes are one of the requested dimensions and
   * this field is present, then the SUB_COUNTRY_LOCATION attributes returned
   ...
   * <code>repeated .google.ads.googleads.v25.common.LocationInfo location_country_filters = 5;</code>
   */
  com.google.ads.googleads.v25.common.LocationInfoOrBuilder getLocationCountryFiltersOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v25.common.LocationInfo youtube_reach_location = 6;</code>
   ...
   */
  com.google.ads.googleads.v25.common.LocationInfo getYoutubeReachLocation();
  /**
   * <pre>
   * If present, potential YouTube reach estimates within the specified market
   * will be returned for attributes for which they are available.  Reach is
   ...
   * <code>.google.ads.googleads.v25.common.LocationInfo youtube_reach_location = 6;</code>
   */
  com.google.ads.googleads.v25.common.LocationInfoOrBuilder getYoutubeReachLocationOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v25.services.KnowledgeGraphEntitySearchOptions knowledge_graph_entity_search_options = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   */
  com.google.ads.googleads.v25.services.KnowledgeGraphEntitySearchOptions getKnowledgeGraphEntitySearchOptions();
  /**
   * <pre>
   * Optional. Additional search options for Knowledge Graph Entities.
   * </pre>
   ...
   * <code>.google.ads.googleads.v25.services.KnowledgeGraphEntitySearchOptions knowledge_graph_entity_search_options = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.ads.googleads.v25.services.KnowledgeGraphEntitySearchOptionsOrBuilder getKnowledgeGraphEntitySearchOptionsOrBuilder();
}
