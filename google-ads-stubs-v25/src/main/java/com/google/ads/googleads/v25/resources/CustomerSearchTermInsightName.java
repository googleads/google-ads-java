...
public class CustomerSearchTermInsightName implements ResourceName {
  ...
  public static @Nullable CustomerSearchTermInsightName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CustomerSearchTermInsightName> values) {
