...
public class CampaignSimulationName implements ResourceName {
  ...
  public static @Nullable CampaignSimulationName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CampaignSimulationName> values) {
