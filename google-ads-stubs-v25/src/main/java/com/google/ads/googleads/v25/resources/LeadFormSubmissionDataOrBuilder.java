...
public interface LeadFormSubmissionDataOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v25.resources.LeadFormSubmissionData)
   ...
   */
  java.util.List<com.google.ads.googleads.v25.resources.LeadFormSubmissionField> 
   ...
   * <code>repeated .google.ads.googleads.v25.resources.LeadFormSubmissionField lead_form_submission_fields = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v25.resources.LeadFormSubmissionField getLeadFormSubmissionFields(int index);
  /**
   * <pre>
   * Output only. Submission data associated with a lead form.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v25.resources.LeadFormSubmissionField lead_form_submission_fields = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v25.resources.LeadFormSubmissionFieldOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v25.resources.LeadFormSubmissionField lead_form_submission_fields = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v25.resources.LeadFormSubmissionFieldOrBuilder getLeadFormSubmissionFieldsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.ads.googleads.v25.resources.CustomLeadFormSubmissionField> 
   ...
   * <code>repeated .google.ads.googleads.v25.resources.CustomLeadFormSubmissionField custom_lead_form_submission_fields = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v25.resources.CustomLeadFormSubmissionField getCustomLeadFormSubmissionFields(int index);
  /**
   * <pre>
   * Output only. Submission data associated with a custom lead form.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v25.resources.CustomLeadFormSubmissionField custom_lead_form_submission_fields = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v25.resources.CustomLeadFormSubmissionFieldOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v25.resources.CustomLeadFormSubmissionField custom_lead_form_submission_fields = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v25.resources.CustomLeadFormSubmissionFieldOrBuilder getCustomLeadFormSubmissionFieldsOrBuilder(
      int index);
