...
public class GroupPlacementViewName implements ResourceName {
  ...
  public static @Nullable GroupPlacementViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable GroupPlacementViewName> values) {
