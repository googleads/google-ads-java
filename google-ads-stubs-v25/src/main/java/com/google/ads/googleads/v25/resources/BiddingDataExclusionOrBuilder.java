...
public interface BiddingDataExclusionOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v25.resources.BiddingDataExclusion)
   ...
   * @return The scope.
   */
  com.google.ads.googleads.v25.enums.SeasonalityEventScopeEnum.SeasonalityEventScope getScope();
   ...
   * @return The status.
   */
  com.google.ads.googleads.v25.enums.SeasonalityEventStatusEnum.SeasonalityEventStatus getStatus();
   ...
   */
  java.util.List<com.google.ads.googleads.v25.enums.DeviceEnum.Device> getDevicesList();
  /**
   * <pre>
   * If not specified, all devices will be included in this exclusion.
   * Otherwise, only the specified targeted devices will be included in this
   ...
   */
  com.google.ads.googleads.v25.enums.DeviceEnum.Device getDevices(int index);
  /**
   * <pre>
   * If not specified, all devices will be included in this exclusion.
   * Otherwise, only the specified targeted devices will be included in this
   ...
   */
  java.util.List<com.google.ads.googleads.v25.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType> getAdvertisingChannelTypesList();
  /**
   * <pre>
   * The data_exclusion will apply to all the campaigns under the listed
   * channels retroactively as well as going forward when the scope of this
   ...
   */
  com.google.ads.googleads.v25.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType getAdvertisingChannelTypes(int index);
  /**
   * <pre>
   * The data_exclusion will apply to all the campaigns under the listed
   * channels retroactively as well as going forward when the scope of this
