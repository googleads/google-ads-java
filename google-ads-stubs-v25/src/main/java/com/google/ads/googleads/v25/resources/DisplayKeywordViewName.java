...
public class DisplayKeywordViewName implements ResourceName {
  ...
  public static @Nullable DisplayKeywordViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable DisplayKeywordViewName> values) {
