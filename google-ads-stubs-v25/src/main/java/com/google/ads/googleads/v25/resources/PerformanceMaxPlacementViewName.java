...
public class PerformanceMaxPlacementViewName implements ResourceName {
  ...
  public static @Nullable PerformanceMaxPlacementViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable PerformanceMaxPlacementViewName> values) {
