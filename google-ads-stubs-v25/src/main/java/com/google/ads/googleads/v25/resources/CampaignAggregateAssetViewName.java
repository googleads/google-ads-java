...
public class CampaignAggregateAssetViewName implements ResourceName {
  ...
  public static @Nullable CampaignAggregateAssetViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CampaignAggregateAssetViewName> values) {
