...
public class HotelPerformanceViewName implements ResourceName {
  ...
  public static @Nullable HotelPerformanceViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable HotelPerformanceViewName> values) {
