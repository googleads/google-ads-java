...
public class GeoTargetConstantName implements ResourceName {
  ...
  public static @Nullable GeoTargetConstantName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable GeoTargetConstantName> values) {
