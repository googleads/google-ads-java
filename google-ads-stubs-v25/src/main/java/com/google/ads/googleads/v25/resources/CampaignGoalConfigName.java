...
public class CampaignGoalConfigName implements ResourceName {
  ...
  public static @Nullable CampaignGoalConfigName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CampaignGoalConfigName> values) {
