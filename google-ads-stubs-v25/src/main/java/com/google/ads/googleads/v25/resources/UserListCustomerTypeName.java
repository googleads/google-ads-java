...
public class UserListCustomerTypeName implements ResourceName {
  ...
  public static @Nullable UserListCustomerTypeName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable UserListCustomerTypeName> values) {
