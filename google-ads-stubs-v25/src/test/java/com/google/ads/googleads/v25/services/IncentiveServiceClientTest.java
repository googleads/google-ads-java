...
public class IncentiveServiceClientTest {
  ...
  public void fetchIncentiveTest() throws Exception {
    ...
    Assert.assertEquals(request.getIncentiveType(), actualRequest.getIncentiveType());
    Assert.assertTrue(
  ...
  @Test
  public void applyIncentiveTest2() throws Exception {
    ApplyIncentiveResponse expectedResponse =
        ApplyIncentiveResponse.newBuilder()
            .setCouponCode("couponCode609122099")
            .setCreationTime("creationTime1586015820")
    ...
    ApplyIncentiveResponse actualResponse =
        client.applyIncentive(selectedIncentiveId, customerId, countryCode);
    Assert.assertEquals(expectedResponse, actualResponse);
    ...
    Assert.assertEquals(selectedIncentiveId, actualRequest.getSelectedIncentiveId());
  ...
  @Test
  public void applyIncentiveExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockIncentiveService.addException(exception);
