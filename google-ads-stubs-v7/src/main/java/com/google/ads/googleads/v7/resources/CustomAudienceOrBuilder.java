...
public interface CustomAudienceOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v7.resources.CustomAudience)
   ...
   * @return The status.
   */
  com.google.ads.googleads.v7.enums.CustomAudienceStatusEnum.CustomAudienceStatus getStatus();
   ...
   * @return The type.
   */
  com.google.ads.googleads.v7.enums.CustomAudienceTypeEnum.CustomAudienceType getType();
   ...
   */
  java.util.List<com.google.ads.googleads.v7.resources.CustomAudienceMember> 
      getMembersList();
  /**
   * <pre>
   * List of custom audience members that this custom audience is composed of.
   ...
   * <code>repeated .google.ads.googleads.v7.resources.CustomAudienceMember members = 7;</code>
   */
  com.google.ads.googleads.v7.resources.CustomAudienceMember getMembers(int index);
  /**
   * <pre>
   * List of custom audience members that this custom audience is composed of.
   * Members can be added during CustomAudience creation. If members are
   ...
   * <code>repeated .google.ads.googleads.v7.resources.CustomAudienceMember members = 7;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v7.resources.CustomAudienceMemberOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v7.resources.CustomAudienceMember members = 7;</code>
   */
  com.google.ads.googleads.v7.resources.CustomAudienceMemberOrBuilder getMembersOrBuilder(
      int index);
}
