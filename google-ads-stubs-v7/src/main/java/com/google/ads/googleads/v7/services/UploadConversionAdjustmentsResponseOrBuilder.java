...
public interface UploadConversionAdjustmentsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v7.services.UploadConversionAdjustmentsResponse)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v7.services.ConversionAdjustmentResult results = 2;</code>
   */
  java.util.List<com.google.ads.googleads.v7.services.ConversionAdjustmentResult> 
      getResultsList();
  /**
   * <pre>
   * Returned for successfully processed conversion adjustments. Proto will be
   ...
   * <code>repeated .google.ads.googleads.v7.services.ConversionAdjustmentResult results = 2;</code>
   */
  com.google.ads.googleads.v7.services.ConversionAdjustmentResult getResults(int index);
  /**
   * <pre>
   * Returned for successfully processed conversion adjustments. Proto will be
   * empty for rows that received an error. Results are not returned when
   ...
   * <code>repeated .google.ads.googleads.v7.services.ConversionAdjustmentResult results = 2;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v7.services.ConversionAdjustmentResultOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v7.services.ConversionAdjustmentResult results = 2;</code>
   */
  com.google.ads.googleads.v7.services.ConversionAdjustmentResultOrBuilder getResultsOrBuilder(
      int index);
}
