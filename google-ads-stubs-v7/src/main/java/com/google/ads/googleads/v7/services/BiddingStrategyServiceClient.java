...
import com.google.ads.googleads.v7.services.stub.BiddingStrategyServiceStub;
import com.google.ads.googleads.v7.services.stub.BiddingStrategyServiceStubSettings;
...
public class BiddingStrategyServiceClient implements BackgroundResource {
   ...
   *               BiddingStrategyName.of("[CUSTOMER_ID]", "[BIDDING_STRATEGY_ID]").toString())
   *           .build();
   *   ApiFuture<BiddingStrategy> future =
   *       biddingStrategyServiceClient.getBiddingStrategyCallable().futureCall(request);
   *   // Do something.
