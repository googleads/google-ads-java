...
import com.google.ads.googleads.v7.services.stub.FeedServiceStub;
import com.google.ads.googleads.v7.services.stub.FeedServiceStubSettings;
...
public class FeedServiceClient implements BackgroundResource {
   ...
   * <pre>{@code
   * try (FeedServiceClient feedServiceClient = FeedServiceClient.create()) {
   *   String resourceName = FeedName.of("[CUSTOMER_ID]", "[FEED_ID]").toString();
   *   Feed response = feedServiceClient.getFeed(resourceName);
   * }
   * }</pre>
   *
