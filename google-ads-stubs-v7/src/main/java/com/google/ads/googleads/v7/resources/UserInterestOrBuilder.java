...
public interface UserInterestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v7.resources.UserInterest)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v7.enums.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType taxonomy_type = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v7.enums.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType getTaxonomyType();
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v7.common.CriterionCategoryAvailability availabilities = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.ads.googleads.v7.common.CriterionCategoryAvailability> 
   ...
   * <code>repeated .google.ads.googleads.v7.common.CriterionCategoryAvailability availabilities = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v7.common.CriterionCategoryAvailability getAvailabilities(int index);
  /**
   * <pre>
   * Output only. Availability information of the user interest.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v7.common.CriterionCategoryAvailability availabilities = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v7.common.CriterionCategoryAvailabilityOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v7.common.CriterionCategoryAvailability availabilities = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v7.common.CriterionCategoryAvailabilityOrBuilder getAvailabilitiesOrBuilder(
      int index);
}
