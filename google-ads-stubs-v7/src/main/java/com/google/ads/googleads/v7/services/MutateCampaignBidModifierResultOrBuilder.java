...
public interface MutateCampaignBidModifierResultOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v7.services.MutateCampaignBidModifierResult)
   ...
   */
  com.google.ads.googleads.v7.resources.CampaignBidModifier getCampaignBidModifier();
  /**
   * <pre>
   * The mutated campaign bid modifier with only mutable fields after mutate.
   * The field will only be returned when response_content_type is set to
   ...
   * <code>.google.ads.googleads.v7.resources.CampaignBidModifier campaign_bid_modifier = 2;</code>
   */
  com.google.ads.googleads.v7.resources.CampaignBidModifierOrBuilder getCampaignBidModifierOrBuilder();
}
