...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v7/services/asset_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class AssetServiceGrpc {

  private AssetServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v7.services.AssetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetAssetRequest,
      com.google.ads.googleads.v7.resources.Asset> getGetAssetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAsset",
      requestType = com.google.ads.googleads.v7.services.GetAssetRequest.class,
      responseType = com.google.ads.googleads.v7.resources.Asset.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetAssetRequest,
      com.google.ads.googleads.v7.resources.Asset> getGetAssetMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetAssetRequest, com.google.ads.googleads.v7.resources.Asset> getGetAssetMethod;
      ...
      synchronized (AssetServiceGrpc.class) {
        if ((getGetAssetMethod = AssetServiceGrpc.getGetAssetMethod) == null) {
          AssetServiceGrpc.getGetAssetMethod = getGetAssetMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v7.services.GetAssetRequest, com.google.ads.googleads.v7.resources.Asset>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAsset"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.GetAssetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.resources.Asset.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.MutateAssetsRequest,
      com.google.ads.googleads.v7.services.MutateAssetsResponse> getMutateAssetsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAssets",
      requestType = com.google.ads.googleads.v7.services.MutateAssetsRequest.class,
      responseType = com.google.ads.googleads.v7.services.MutateAssetsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.MutateAssetsRequest,
      com.google.ads.googleads.v7.services.MutateAssetsResponse> getMutateAssetsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.MutateAssetsRequest, com.google.ads.googleads.v7.services.MutateAssetsResponse> getMutateAssetsMethod;
      ...
      synchronized (AssetServiceGrpc.class) {
        if ((getMutateAssetsMethod = AssetServiceGrpc.getMutateAssetsMethod) == null) {
          AssetServiceGrpc.getMutateAssetsMethod = getMutateAssetsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v7.services.MutateAssetsRequest, com.google.ads.googleads.v7.services.MutateAssetsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAssets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.MutateAssetsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.MutateAssetsResponse.getDefaultInstance()))
  ...
  public static abstract class AssetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAsset(com.google.ads.googleads.v7.services.GetAssetRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.resources.Asset> responseObserver) {
     ...
     * </pre>
     */
    public void mutateAssets(com.google.ads.googleads.v7.services.MutateAssetsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.services.MutateAssetsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v7.services.GetAssetRequest,
                com.google.ads.googleads.v7.resources.Asset>(
                  this, METHODID_GET_ASSET)))
          .addMethod(
            getMutateAssetsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v7.services.MutateAssetsRequest,
                com.google.ads.googleads.v7.services.MutateAssetsResponse>(
  ...
  public static final class AssetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AssetServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v7.resources.Asset getAsset(com.google.ads.googleads.v7.services.GetAssetRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v7.services.MutateAssetsResponse mutateAssets(com.google.ads.googleads.v7.services.MutateAssetsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AssetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AssetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v7.resources.Asset> getAsset(
        com.google.ads.googleads.v7.services.GetAssetRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v7.services.MutateAssetsResponse> mutateAssets(
        com.google.ads.googleads.v7.services.MutateAssetsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ASSET:
          serviceImpl.getAsset((com.google.ads.googleads.v7.services.GetAssetRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.resources.Asset>) responseObserver);
          break;
        case METHODID_MUTATE_ASSETS:
          serviceImpl.mutateAssets((com.google.ads.googleads.v7.services.MutateAssetsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.services.MutateAssetsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AssetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v7.services.AssetServiceProto.getDescriptor();
    }
