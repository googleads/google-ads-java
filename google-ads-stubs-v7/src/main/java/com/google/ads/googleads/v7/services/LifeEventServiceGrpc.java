...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v7/services/life_event_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class LifeEventServiceGrpc {

  private LifeEventServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v7.services.LifeEventService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetLifeEventRequest,
      com.google.ads.googleads.v7.resources.LifeEvent> getGetLifeEventMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetLifeEvent",
      requestType = com.google.ads.googleads.v7.services.GetLifeEventRequest.class,
      responseType = com.google.ads.googleads.v7.resources.LifeEvent.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetLifeEventRequest,
      com.google.ads.googleads.v7.resources.LifeEvent> getGetLifeEventMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetLifeEventRequest, com.google.ads.googleads.v7.resources.LifeEvent> getGetLifeEventMethod;
      ...
      synchronized (LifeEventServiceGrpc.class) {
        if ((getGetLifeEventMethod = LifeEventServiceGrpc.getGetLifeEventMethod) == null) {
          LifeEventServiceGrpc.getGetLifeEventMethod = getGetLifeEventMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v7.services.GetLifeEventRequest, com.google.ads.googleads.v7.resources.LifeEvent>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetLifeEvent"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.GetLifeEventRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.resources.LifeEvent.getDefaultInstance()))
  ...
  public static abstract class LifeEventServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getLifeEvent(com.google.ads.googleads.v7.services.GetLifeEventRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.resources.LifeEvent> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v7.services.GetLifeEventRequest,
                com.google.ads.googleads.v7.resources.LifeEvent>(
  ...
  public static final class LifeEventServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<LifeEventServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v7.resources.LifeEvent getLifeEvent(com.google.ads.googleads.v7.services.GetLifeEventRequest request) {
  ...
  public static final class LifeEventServiceFutureStub extends io.grpc.stub.AbstractFutureStub<LifeEventServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v7.resources.LifeEvent> getLifeEvent(
        com.google.ads.googleads.v7.services.GetLifeEventRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_LIFE_EVENT:
          serviceImpl.getLifeEvent((com.google.ads.googleads.v7.services.GetLifeEventRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.resources.LifeEvent>) responseObserver);
          break;
        default:
  ...
  private static abstract class LifeEventServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v7.services.LifeEventServiceProto.getDescriptor();
    }
