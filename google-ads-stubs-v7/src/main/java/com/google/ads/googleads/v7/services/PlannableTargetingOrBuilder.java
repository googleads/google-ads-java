...
public interface PlannableTargetingOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v7.services.PlannableTargeting)
   ...
   */
  java.util.List<com.google.ads.googleads.v7.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange> getAgeRangesList();
  /**
   * <pre>
   * Allowed plannable age ranges for the product for which metrics will be
   * reported. Actual targeting is computed by mapping this age range onto
   ...
   */
  com.google.ads.googleads.v7.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange getAgeRanges(int index);
  /**
   * <pre>
   * Allowed plannable age ranges for the product for which metrics will be
   * reported. Actual targeting is computed by mapping this age range onto
   ...
   */
  java.util.List<com.google.ads.googleads.v7.enums.ReachPlanNetworkEnum.ReachPlanNetwork> getNetworksList();
  /**
   * <pre>
   * Targetable networks for the ad product.
   * </pre>
   ...
   */
  com.google.ads.googleads.v7.enums.ReachPlanNetworkEnum.ReachPlanNetwork getNetworks(int index);
  /**
   * <pre>
   * Targetable networks for the ad product.
   * </pre>
