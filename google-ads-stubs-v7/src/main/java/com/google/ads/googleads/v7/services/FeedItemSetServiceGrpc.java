...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v7/services/feed_item_set_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class FeedItemSetServiceGrpc {

  private FeedItemSetServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v7.services.FeedItemSetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetFeedItemSetRequest,
      com.google.ads.googleads.v7.resources.FeedItemSet> getGetFeedItemSetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetFeedItemSet",
      requestType = com.google.ads.googleads.v7.services.GetFeedItemSetRequest.class,
      responseType = com.google.ads.googleads.v7.resources.FeedItemSet.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetFeedItemSetRequest,
      com.google.ads.googleads.v7.resources.FeedItemSet> getGetFeedItemSetMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetFeedItemSetRequest, com.google.ads.googleads.v7.resources.FeedItemSet> getGetFeedItemSetMethod;
      ...
      synchronized (FeedItemSetServiceGrpc.class) {
        if ((getGetFeedItemSetMethod = FeedItemSetServiceGrpc.getGetFeedItemSetMethod) == null) {
          FeedItemSetServiceGrpc.getGetFeedItemSetMethod = getGetFeedItemSetMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v7.services.GetFeedItemSetRequest, com.google.ads.googleads.v7.resources.FeedItemSet>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetFeedItemSet"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.GetFeedItemSetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.resources.FeedItemSet.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.MutateFeedItemSetsRequest,
      com.google.ads.googleads.v7.services.MutateFeedItemSetsResponse> getMutateFeedItemSetsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateFeedItemSets",
      requestType = com.google.ads.googleads.v7.services.MutateFeedItemSetsRequest.class,
      responseType = com.google.ads.googleads.v7.services.MutateFeedItemSetsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.MutateFeedItemSetsRequest,
      com.google.ads.googleads.v7.services.MutateFeedItemSetsResponse> getMutateFeedItemSetsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.MutateFeedItemSetsRequest, com.google.ads.googleads.v7.services.MutateFeedItemSetsResponse> getMutateFeedItemSetsMethod;
      ...
      synchronized (FeedItemSetServiceGrpc.class) {
        if ((getMutateFeedItemSetsMethod = FeedItemSetServiceGrpc.getMutateFeedItemSetsMethod) == null) {
          FeedItemSetServiceGrpc.getMutateFeedItemSetsMethod = getMutateFeedItemSetsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v7.services.MutateFeedItemSetsRequest, com.google.ads.googleads.v7.services.MutateFeedItemSetsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateFeedItemSets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.MutateFeedItemSetsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.MutateFeedItemSetsResponse.getDefaultInstance()))
  ...
  public static abstract class FeedItemSetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getFeedItemSet(com.google.ads.googleads.v7.services.GetFeedItemSetRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.resources.FeedItemSet> responseObserver) {
     ...
     * </pre>
     */
    public void mutateFeedItemSets(com.google.ads.googleads.v7.services.MutateFeedItemSetsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.services.MutateFeedItemSetsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v7.services.GetFeedItemSetRequest,
                com.google.ads.googleads.v7.resources.FeedItemSet>(
                  this, METHODID_GET_FEED_ITEM_SET)))
          .addMethod(
            getMutateFeedItemSetsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v7.services.MutateFeedItemSetsRequest,
                com.google.ads.googleads.v7.services.MutateFeedItemSetsResponse>(
  ...
  public static final class FeedItemSetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<FeedItemSetServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v7.resources.FeedItemSet getFeedItemSet(com.google.ads.googleads.v7.services.GetFeedItemSetRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v7.services.MutateFeedItemSetsResponse mutateFeedItemSets(com.google.ads.googleads.v7.services.MutateFeedItemSetsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class FeedItemSetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<FeedItemSetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v7.resources.FeedItemSet> getFeedItemSet(
        com.google.ads.googleads.v7.services.GetFeedItemSetRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v7.services.MutateFeedItemSetsResponse> mutateFeedItemSets(
        com.google.ads.googleads.v7.services.MutateFeedItemSetsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_FEED_ITEM_SET:
          serviceImpl.getFeedItemSet((com.google.ads.googleads.v7.services.GetFeedItemSetRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.resources.FeedItemSet>) responseObserver);
          break;
        case METHODID_MUTATE_FEED_ITEM_SETS:
          serviceImpl.mutateFeedItemSets((com.google.ads.googleads.v7.services.MutateFeedItemSetsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.services.MutateFeedItemSetsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class FeedItemSetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v7.services.FeedItemSetServiceProto.getDescriptor();
    }
