...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v7/services/customer_asset_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class CustomerAssetServiceGrpc {

  private CustomerAssetServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v7.services.CustomerAssetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetCustomerAssetRequest,
      com.google.ads.googleads.v7.resources.CustomerAsset> getGetCustomerAssetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCustomerAsset",
      requestType = com.google.ads.googleads.v7.services.GetCustomerAssetRequest.class,
      responseType = com.google.ads.googleads.v7.resources.CustomerAsset.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetCustomerAssetRequest,
      com.google.ads.googleads.v7.resources.CustomerAsset> getGetCustomerAssetMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetCustomerAssetRequest, com.google.ads.googleads.v7.resources.CustomerAsset> getGetCustomerAssetMethod;
      ...
      synchronized (CustomerAssetServiceGrpc.class) {
        if ((getGetCustomerAssetMethod = CustomerAssetServiceGrpc.getGetCustomerAssetMethod) == null) {
          CustomerAssetServiceGrpc.getGetCustomerAssetMethod = getGetCustomerAssetMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v7.services.GetCustomerAssetRequest, com.google.ads.googleads.v7.resources.CustomerAsset>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCustomerAsset"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.GetCustomerAssetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.resources.CustomerAsset.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.MutateCustomerAssetsRequest,
      com.google.ads.googleads.v7.services.MutateCustomerAssetsResponse> getMutateCustomerAssetsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCustomerAssets",
      requestType = com.google.ads.googleads.v7.services.MutateCustomerAssetsRequest.class,
      responseType = com.google.ads.googleads.v7.services.MutateCustomerAssetsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.MutateCustomerAssetsRequest,
      com.google.ads.googleads.v7.services.MutateCustomerAssetsResponse> getMutateCustomerAssetsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.MutateCustomerAssetsRequest, com.google.ads.googleads.v7.services.MutateCustomerAssetsResponse> getMutateCustomerAssetsMethod;
      ...
      synchronized (CustomerAssetServiceGrpc.class) {
        if ((getMutateCustomerAssetsMethod = CustomerAssetServiceGrpc.getMutateCustomerAssetsMethod) == null) {
          CustomerAssetServiceGrpc.getMutateCustomerAssetsMethod = getMutateCustomerAssetsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v7.services.MutateCustomerAssetsRequest, com.google.ads.googleads.v7.services.MutateCustomerAssetsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCustomerAssets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.MutateCustomerAssetsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.MutateCustomerAssetsResponse.getDefaultInstance()))
  ...
  public static abstract class CustomerAssetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCustomerAsset(com.google.ads.googleads.v7.services.GetCustomerAssetRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.resources.CustomerAsset> responseObserver) {
     ...
     * </pre>
     */
    public void mutateCustomerAssets(com.google.ads.googleads.v7.services.MutateCustomerAssetsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.services.MutateCustomerAssetsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v7.services.GetCustomerAssetRequest,
                com.google.ads.googleads.v7.resources.CustomerAsset>(
                  this, METHODID_GET_CUSTOMER_ASSET)))
          .addMethod(
            getMutateCustomerAssetsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v7.services.MutateCustomerAssetsRequest,
                com.google.ads.googleads.v7.services.MutateCustomerAssetsResponse>(
  ...
  public static final class CustomerAssetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CustomerAssetServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v7.resources.CustomerAsset getCustomerAsset(com.google.ads.googleads.v7.services.GetCustomerAssetRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v7.services.MutateCustomerAssetsResponse mutateCustomerAssets(com.google.ads.googleads.v7.services.MutateCustomerAssetsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CustomerAssetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CustomerAssetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v7.resources.CustomerAsset> getCustomerAsset(
        com.google.ads.googleads.v7.services.GetCustomerAssetRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v7.services.MutateCustomerAssetsResponse> mutateCustomerAssets(
        com.google.ads.googleads.v7.services.MutateCustomerAssetsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CUSTOMER_ASSET:
          serviceImpl.getCustomerAsset((com.google.ads.googleads.v7.services.GetCustomerAssetRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.resources.CustomerAsset>) responseObserver);
          break;
        case METHODID_MUTATE_CUSTOMER_ASSETS:
          serviceImpl.mutateCustomerAssets((com.google.ads.googleads.v7.services.MutateCustomerAssetsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.services.MutateCustomerAssetsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CustomerAssetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v7.services.CustomerAssetServiceProto.getDescriptor();
    }
