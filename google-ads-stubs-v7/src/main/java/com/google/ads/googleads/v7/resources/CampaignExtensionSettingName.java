...
public class CampaignExtensionSettingName implements ResourceName {
  private static final PathTemplate CUSTOMER_ID_CAMPAIGN_ID_EXTENSION_TYPE =
  ...
  public static CampaignExtensionSettingName of(
      String customerId, String campaignId, String extensionType) {
    return newBuilder()
  ...
  public static CampaignExtensionSettingName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_ID_CAMPAIGN_ID_EXTENSION_TYPE.validatedMatch(
            formattedString,
            "CampaignExtensionSettingName.parse: formattedString not in valid format");
    return of(
        matchMap.get("customer_id"), matchMap.get("campaign_id"), matchMap.get("extension_type"));
  }
  ...
  public String toString() {
    return CUSTOMER_ID_CAMPAIGN_ID_EXTENSION_TYPE.instantiate(
        "customer_id", customerId, "campaign_id", campaignId, "extension_type", extensionType);
  }
