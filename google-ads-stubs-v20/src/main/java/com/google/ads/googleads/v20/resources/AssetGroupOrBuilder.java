...
public interface AssetGroupOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v20.resources.AssetGroup)
   ...
   * @return The status.
   */
  com.google.ads.googleads.v20.enums.AssetGroupStatusEnum.AssetGroupStatus getStatus();
   ...
   */
  com.google.ads.googleads.v20.enums.AssetGroupPrimaryStatusEnum.AssetGroupPrimaryStatus getPrimaryStatus();
   ...
   */
  java.util.List<com.google.ads.googleads.v20.enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason> getPrimaryStatusReasonsList();
  /**
   * <pre>
   * Output only. Provides reasons into why an asset group is not serving or not
   * serving optimally. It will be empty when the asset group is serving without
   ...
   */
  com.google.ads.googleads.v20.enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason getPrimaryStatusReasons(int index);
  /**
   * <pre>
   * Output only. Provides reasons into why an asset group is not serving or not
   * serving optimally. It will be empty when the asset group is serving without
   ...
   */
  com.google.ads.googleads.v20.resources.AssetCoverage getAssetCoverage();
  /**
   * <pre>
   * Output only. The asset coverage of this asset group.
   * </pre>
   ...
   * <code>.google.ads.googleads.v20.resources.AssetCoverage asset_coverage = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v20.resources.AssetCoverageOrBuilder getAssetCoverageOrBuilder();
}
