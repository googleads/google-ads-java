...
public interface ListInsightsEligibleDatesResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v20.services.ListInsightsEligibleDatesResponse)
   ...
   */
  com.google.ads.googleads.v20.common.DateRange getLastThirtyDays();
  /**
   * <pre>
   * The actual dates covered by the "last 30 days" date range that will be used
   * implicitly for
   ...
   * <code>.google.ads.googleads.v20.common.DateRange last_thirty_days = 2;</code>
   */
  com.google.ads.googleads.v20.common.DateRangeOrBuilder getLastThirtyDaysOrBuilder();
}
