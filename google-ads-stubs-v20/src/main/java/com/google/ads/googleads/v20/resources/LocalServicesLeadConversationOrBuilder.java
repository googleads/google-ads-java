...
public interface LocalServicesLeadConversationOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v20.resources.LocalServicesLeadConversation)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v20.enums.LocalServicesLeadConversationTypeEnum.ConversationType conversation_channel = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v20.enums.LocalServicesLeadConversationTypeEnum.ConversationType getConversationChannel();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v20.enums.LocalServicesParticipantTypeEnum.ParticipantType participant_type = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v20.enums.LocalServicesParticipantTypeEnum.ParticipantType getParticipantType();
   ...
   * </pre>
   *
   * <code>optional .google.ads.googleads.v20.resources.PhoneCallDetails phone_call_details = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v20.resources.PhoneCallDetails getPhoneCallDetails();
  /**
   * <pre>
   * Output only. Details of phone call conversation in case of PHONE_CALL.
   * </pre>
   ...
   * <code>optional .google.ads.googleads.v20.resources.PhoneCallDetails phone_call_details = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v20.resources.PhoneCallDetailsOrBuilder getPhoneCallDetailsOrBuilder();
   ...
   * </pre>
   *
   * <code>optional .google.ads.googleads.v20.resources.MessageDetails message_details = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v20.resources.MessageDetails getMessageDetails();
  /**
   * <pre>
   * Output only. Details of message conversation in case of EMAIL, MESSAGE or
   * SMS.
   ...
   * <code>optional .google.ads.googleads.v20.resources.MessageDetails message_details = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v20.resources.MessageDetailsOrBuilder getMessageDetailsOrBuilder();
}
