...
public interface CriterionCategoryChannelAvailabilityOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v20.common.CriterionCategoryChannelAvailability)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v20.enums.CriterionCategoryChannelAvailabilityModeEnum.CriterionCategoryChannelAvailabilityMode availability_mode = 1;</code>
   ...
   */
  com.google.ads.googleads.v20.enums.CriterionCategoryChannelAvailabilityModeEnum.CriterionCategoryChannelAvailabilityMode getAvailabilityMode();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v20.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType advertising_channel_type = 2;</code>
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v20.enums.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType advertising_channel_sub_type = 3;</code>
   * @return A list containing the advertisingChannelSubType.
   */
  java.util.List<com.google.ads.googleads.v20.enums.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType> getAdvertisingChannelSubTypeList();
  /**
   * <pre>
   * Channel subtypes under the channel type the category is available to.
   * </pre>
   ...
   */
  com.google.ads.googleads.v20.enums.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType getAdvertisingChannelSubType(int index);
  /**
   * <pre>
   * Channel subtypes under the channel type the category is available to.
   * </pre>
