...
public interface ChainSetOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v20.common.ChainSet)
   ...
   */
  com.google.ads.googleads.v20.enums.ChainRelationshipTypeEnum.ChainRelationshipType getRelationshipType();
   ...
   * <code>repeated .google.ads.googleads.v20.common.ChainFilter chains = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v20.common.ChainFilter getChains(int index);
  /**
   * <pre>
   * Required. A list of chain level filters, all filters are OR'ed together.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v20.common.ChainFilter chains = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v20.common.ChainFilterOrBuilder getChainsOrBuilder(
      int index);
}
