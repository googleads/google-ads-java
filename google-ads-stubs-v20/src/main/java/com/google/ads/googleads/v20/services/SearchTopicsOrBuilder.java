...
public interface SearchTopicsOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v20.services.SearchTopics)
   ...
   */
  java.util.List<com.google.ads.googleads.v20.common.AudienceInsightsEntity> 
      getEntitiesList();
  /**
   * <pre>
   * Required. A list of knowledge graph entities to retrieve trend information
   ...
   * <code>repeated .google.ads.googleads.v20.common.AudienceInsightsEntity entities = 1 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v20.common.AudienceInsightsEntity getEntities(int index);
  /**
   * <pre>
   * Required. A list of knowledge graph entities to retrieve trend information
   * for. Supported entities are tagged with
   ...
   * <code>repeated .google.ads.googleads.v20.common.AudienceInsightsEntity entities = 1 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v20.common.AudienceInsightsEntityOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v20.common.AudienceInsightsEntity entities = 1 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v20.common.AudienceInsightsEntityOrBuilder getEntitiesOrBuilder(
      int index);
}
