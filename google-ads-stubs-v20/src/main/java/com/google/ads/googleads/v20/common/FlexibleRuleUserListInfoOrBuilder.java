...
public interface FlexibleRuleUserListInfoOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v20.common.FlexibleRuleUserListInfo)
   ...
   */
  com.google.ads.googleads.v20.enums.UserListFlexibleRuleOperatorEnum.UserListFlexibleRuleOperator getInclusiveRuleOperator();
   ...
   */
  java.util.List<com.google.ads.googleads.v20.common.FlexibleRuleOperandInfo> 
   ...
   * <code>repeated .google.ads.googleads.v20.common.FlexibleRuleOperandInfo inclusive_operands = 2;</code>
   */
  com.google.ads.googleads.v20.common.FlexibleRuleOperandInfo getInclusiveOperands(int index);
  /**
   * <pre>
   * Rules representing users that should be included in the user list. These
   * are located on the left side of the AND_NOT operator, and joined together
   ...
   * <code>repeated .google.ads.googleads.v20.common.FlexibleRuleOperandInfo inclusive_operands = 2;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v20.common.FlexibleRuleOperandInfoOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v20.common.FlexibleRuleOperandInfo inclusive_operands = 2;</code>
   */
  com.google.ads.googleads.v20.common.FlexibleRuleOperandInfoOrBuilder getInclusiveOperandsOrBuilder(
      int index);
   ...
   * <code>repeated .google.ads.googleads.v20.common.FlexibleRuleOperandInfo exclusive_operands = 3;</code>
   */
  com.google.ads.googleads.v20.common.FlexibleRuleOperandInfo getExclusiveOperands(int index);
  /**
   * <pre>
   * Rules representing users that should be excluded from the user list. These
   * are located on the right side of the AND_NOT operator, and joined together
   ...
   * <code>repeated .google.ads.googleads.v20.common.FlexibleRuleOperandInfo exclusive_operands = 3;</code>
   */
  com.google.ads.googleads.v20.common.FlexibleRuleOperandInfoOrBuilder getExclusiveOperandsOrBuilder(
      int index);
}
