...
public interface KeywordPlanAggregateMetricsOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v20.common.KeywordPlanAggregateMetrics)
   ...
   */
  java.util.List<com.google.ads.googleads.v20.enums.KeywordPlanAggregateMetricTypeEnum.KeywordPlanAggregateMetricType> getAggregateMetricTypesList();
  /**
   * <pre>
   * The list of aggregate metrics to fetch data.
   * </pre>
   ...
   */
  com.google.ads.googleads.v20.enums.KeywordPlanAggregateMetricTypeEnum.KeywordPlanAggregateMetricType getAggregateMetricTypes(int index);
  /**
   * <pre>
   * The list of aggregate metrics to fetch data.
   * </pre>
