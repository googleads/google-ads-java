...
public final class AdGroupAssetServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.ads.googleads.v20.services.AdGroupAssetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v20.services.MutateAdGroupAssetsRequest,
      com.google.ads.googleads.v20.services.MutateAdGroupAssetsResponse> getMutateAdGroupAssetsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAdGroupAssets",
      requestType = com.google.ads.googleads.v20.services.MutateAdGroupAssetsRequest.class,
      responseType = com.google.ads.googleads.v20.services.MutateAdGroupAssetsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v20.services.MutateAdGroupAssetsRequest,
      com.google.ads.googleads.v20.services.MutateAdGroupAssetsResponse> getMutateAdGroupAssetsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v20.services.MutateAdGroupAssetsRequest, com.google.ads.googleads.v20.services.MutateAdGroupAssetsResponse> getMutateAdGroupAssetsMethod;
      ...
      synchronized (AdGroupAssetServiceGrpc.class) {
        if ((getMutateAdGroupAssetsMethod = AdGroupAssetServiceGrpc.getMutateAdGroupAssetsMethod) == null) {
          AdGroupAssetServiceGrpc.getMutateAdGroupAssetsMethod = getMutateAdGroupAssetsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v20.services.MutateAdGroupAssetsRequest, com.google.ads.googleads.v20.services.MutateAdGroupAssetsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAdGroupAssets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v20.services.MutateAdGroupAssetsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v20.services.MutateAdGroupAssetsResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void mutateAdGroupAssets(com.google.ads.googleads.v20.services.MutateAdGroupAssetsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v20.services.MutateAdGroupAssetsResponse> responseObserver) {
  ...
  public static final class AdGroupAssetServiceStub
     ...
     * </pre>
     */
    public void mutateAdGroupAssets(com.google.ads.googleads.v20.services.MutateAdGroupAssetsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v20.services.MutateAdGroupAssetsResponse> responseObserver) {
  ...
  public static final class AdGroupAssetServiceBlockingV2Stub
     ...
     * </pre>
     */
    public com.google.ads.googleads.v20.services.MutateAdGroupAssetsResponse mutateAdGroupAssets(com.google.ads.googleads.v20.services.MutateAdGroupAssetsRequest request) throws io.grpc.StatusException {
  ...
  public static final class AdGroupAssetServiceBlockingStub
     ...
     * </pre>
     */
    public com.google.ads.googleads.v20.services.MutateAdGroupAssetsResponse mutateAdGroupAssets(com.google.ads.googleads.v20.services.MutateAdGroupAssetsRequest request) {
  ...
  public static final class AdGroupAssetServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v20.services.MutateAdGroupAssetsResponse> mutateAdGroupAssets(
        com.google.ads.googleads.v20.services.MutateAdGroupAssetsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MUTATE_AD_GROUP_ASSETS:
          serviceImpl.mutateAdGroupAssets((com.google.ads.googleads.v20.services.MutateAdGroupAssetsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v20.services.MutateAdGroupAssetsResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.google.ads.googleads.v20.services.MutateAdGroupAssetsRequest,
              com.google.ads.googleads.v20.services.MutateAdGroupAssetsResponse>(
  ...
  private static abstract class AdGroupAssetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v20.services.AdGroupAssetServiceProto.getDescriptor();
    }
