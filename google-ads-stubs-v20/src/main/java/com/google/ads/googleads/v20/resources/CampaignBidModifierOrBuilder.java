...
public interface CampaignBidModifierOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v20.resources.CampaignBidModifier)
   ...
   */
  com.google.ads.googleads.v20.common.InteractionTypeInfo getInteractionType();
  /**
   * <pre>
   * Immutable. Criterion for interaction type. Only supported for search
   * campaigns.
   ...
   * <code>.google.ads.googleads.v20.common.InteractionTypeInfo interaction_type = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.ads.googleads.v20.common.InteractionTypeInfoOrBuilder getInteractionTypeOrBuilder();

  com.google.ads.googleads.v20.resources.CampaignBidModifier.CriterionCase getCriterionCase();
}
