...
public final class RecommendationSubscriptionServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.ads.googleads.v20.services.RecommendationSubscriptionService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionRequest,
      com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionResponse> getMutateRecommendationSubscriptionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateRecommendationSubscription",
      requestType = com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionRequest.class,
      responseType = com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionRequest,
      com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionResponse> getMutateRecommendationSubscriptionMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionRequest, com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionResponse> getMutateRecommendationSubscriptionMethod;
      ...
      synchronized (RecommendationSubscriptionServiceGrpc.class) {
        if ((getMutateRecommendationSubscriptionMethod = RecommendationSubscriptionServiceGrpc.getMutateRecommendationSubscriptionMethod) == null) {
          RecommendationSubscriptionServiceGrpc.getMutateRecommendationSubscriptionMethod = getMutateRecommendationSubscriptionMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionRequest, com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateRecommendationSubscription"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void mutateRecommendationSubscription(com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionResponse> responseObserver) {
  ...
  public static final class RecommendationSubscriptionServiceStub
     ...
     * </pre>
     */
    public void mutateRecommendationSubscription(com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionResponse> responseObserver) {
  ...
  public static final class RecommendationSubscriptionServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionResponse> mutateRecommendationSubscription(
        com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MUTATE_RECOMMENDATION_SUBSCRIPTION:
          serviceImpl.mutateRecommendationSubscription((com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionRequest,
              com.google.ads.googleads.v20.services.MutateRecommendationSubscriptionResponse>(
  ...
  private static abstract class RecommendationSubscriptionServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v20.services.RecommendationSubscriptionServiceProto.getDescriptor();
    }
