...
public class CampaignFeedName implements ResourceName {
  private static final PathTemplate CUSTOMER_ID_CAMPAIGN_ID_FEED_ID =
  ...
  public static CampaignFeedName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_ID_CAMPAIGN_ID_FEED_ID.validatedMatch(
  ...
  public String toString() {
    return CUSTOMER_ID_CAMPAIGN_ID_FEED_ID.instantiate(
        "customer_id", customerId, "campaign_id", campaignId, "feed_id", feedId);
  }
