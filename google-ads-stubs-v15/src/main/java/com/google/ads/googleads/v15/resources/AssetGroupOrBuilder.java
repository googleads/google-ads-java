...
public interface AssetGroupOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v15.resources.AssetGroup)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v15.enums.AssetGroupStatusEnum.AssetGroupStatus status = 6;</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v15.enums.AssetGroupStatusEnum.AssetGroupStatus getStatus();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v15.enums.AssetGroupPrimaryStatusEnum.AssetGroupPrimaryStatus primary_status = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v15.enums.AssetGroupPrimaryStatusEnum.AssetGroupPrimaryStatus getPrimaryStatus();
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v15.enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason primary_status_reasons = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   * @return A list containing the primaryStatusReasons.
   */
  java.util.List<com.google.ads.googleads.v15.enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason> getPrimaryStatusReasonsList();
  /**
   * <pre>
   * Output only. Provides reasons into why an asset group is not serving or not
   * serving optimally. It will be empty when the asset group is serving without
   ...
   */
  com.google.ads.googleads.v15.enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason getPrimaryStatusReasons(int index);
  /**
   * <pre>
   * Output only. Provides reasons into why an asset group is not serving or not
   * serving optimally. It will be empty when the asset group is serving without
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v15.enums.AdStrengthEnum.AdStrength ad_strength = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v15.enums.AdStrengthEnum.AdStrength getAdStrength();
}
