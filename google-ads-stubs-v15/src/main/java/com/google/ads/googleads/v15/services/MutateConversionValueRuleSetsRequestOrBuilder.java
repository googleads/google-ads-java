...
public interface MutateConversionValueRuleSetsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v15.services.MutateConversionValueRuleSetsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v15.services.ConversionValueRuleSetOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual conversion value
   ...
   * <code>repeated .google.ads.googleads.v15.services.ConversionValueRuleSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v15.services.ConversionValueRuleSetOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual conversion value
   * rule sets.
   ...
   * <code>repeated .google.ads.googleads.v15.services.ConversionValueRuleSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v15.services.ConversionValueRuleSetOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v15.services.ConversionValueRuleSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v15.services.ConversionValueRuleSetOperationOrBuilder getOperationsOrBuilder(
      int index);
