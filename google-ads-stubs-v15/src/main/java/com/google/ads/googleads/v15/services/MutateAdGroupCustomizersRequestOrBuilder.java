...
public interface MutateAdGroupCustomizersRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v15.services.MutateAdGroupCustomizersRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v15.services.AdGroupCustomizerOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual ad group
   ...
   * <code>repeated .google.ads.googleads.v15.services.AdGroupCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v15.services.AdGroupCustomizerOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual ad group
   * customizers.
   ...
   * <code>repeated .google.ads.googleads.v15.services.AdGroupCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v15.services.AdGroupCustomizerOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v15.services.AdGroupCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v15.services.AdGroupCustomizerOperationOrBuilder getOperationsOrBuilder(
      int index);
