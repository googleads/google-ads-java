...
public interface MutateCampaignSharedSetsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v15.services.MutateCampaignSharedSetsRequest)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v15.services.CampaignSharedSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.ads.googleads.v15.services.CampaignSharedSetOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign shared
   ...
   * <code>repeated .google.ads.googleads.v15.services.CampaignSharedSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v15.services.CampaignSharedSetOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign shared
   * sets.
   ...
   * <code>repeated .google.ads.googleads.v15.services.CampaignSharedSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v15.services.CampaignSharedSetOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v15.services.CampaignSharedSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v15.services.CampaignSharedSetOperationOrBuilder getOperationsOrBuilder(
      int index);
