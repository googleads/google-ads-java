...
public interface MutateCampaignAssetSetsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v15.services.MutateCampaignAssetSetsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v15.services.CampaignAssetSetOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign asset
   ...
   * <code>repeated .google.ads.googleads.v15.services.CampaignAssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v15.services.CampaignAssetSetOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign asset
   * sets.
   ...
   * <code>repeated .google.ads.googleads.v15.services.CampaignAssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v15.services.CampaignAssetSetOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v15.services.CampaignAssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v15.services.CampaignAssetSetOperationOrBuilder getOperationsOrBuilder(
      int index);
