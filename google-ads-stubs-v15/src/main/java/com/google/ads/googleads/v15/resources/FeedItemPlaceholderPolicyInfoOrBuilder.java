...
public interface FeedItemPlaceholderPolicyInfoOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v15.resources.FeedItemPlaceholderPolicyInfo)
   ...
   */
  com.google.ads.googleads.v15.enums.PlaceholderTypeEnum.PlaceholderType getPlaceholderTypeEnum();
   ...
   */
  com.google.ads.googleads.v15.enums.FeedItemValidationStatusEnum.FeedItemValidationStatus getValidationStatus();
   ...
   */
  java.util.List<com.google.ads.googleads.v15.resources.FeedItemValidationError> 
   ...
   * <code>repeated .google.ads.googleads.v15.resources.FeedItemValidationError validation_errors = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v15.resources.FeedItemValidationError getValidationErrors(int index);
  /**
   * <pre>
   * Output only. List of placeholder type validation errors.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v15.resources.FeedItemValidationError validation_errors = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v15.resources.FeedItemValidationErrorOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v15.resources.FeedItemValidationError validation_errors = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v15.resources.FeedItemValidationErrorOrBuilder getValidationErrorsOrBuilder(
      int index);
   ...
   */
  com.google.ads.googleads.v15.enums.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatus getQualityApprovalStatus();
   ...
   */
  java.util.List<com.google.ads.googleads.v15.enums.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason> getQualityDisapprovalReasonsList();
  /**
   * <pre>
   * Output only. List of placeholder type quality evaluation disapproval
   * reasons.
   ...
   */
  com.google.ads.googleads.v15.enums.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason getQualityDisapprovalReasons(int index);
  /**
   * <pre>
   * Output only. List of placeholder type quality evaluation disapproval
   * reasons.
