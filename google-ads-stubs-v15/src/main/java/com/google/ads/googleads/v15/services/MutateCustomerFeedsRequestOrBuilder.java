...
public interface MutateCustomerFeedsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v15.services.MutateCustomerFeedsRequest)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v15.services.CustomerFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.ads.googleads.v15.services.CustomerFeedOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual customer feeds.
   ...
   * <code>repeated .google.ads.googleads.v15.services.CustomerFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v15.services.CustomerFeedOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual customer feeds.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v15.services.CustomerFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v15.services.CustomerFeedOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v15.services.CustomerFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v15.services.CustomerFeedOperationOrBuilder getOperationsOrBuilder(
      int index);
