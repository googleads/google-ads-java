 ...
 *
 * <p>For example, to set the total timeout of updateProductLinkInvitation to 30 seconds:
 *
 * <pre>{@code
  ...
  public static class Builder
    ...
    protected Builder(ClientContext clientContext) {
      ...
      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(updateProductLinkInvitationSettings);
      initDefaults(this);
    }
