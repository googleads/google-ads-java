...
public interface GenerateAudienceCompositionInsightsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v15.services.GenerateAudienceCompositionInsightsRequest)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v15.services.InsightsAudience baseline_audience = 6;</code>
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v15.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension dimensions = 4 [(.google.api.field_behavior) = REQUIRED];</code>
   * @return A list containing the dimensions.
   */
  java.util.List<com.google.ads.googleads.v15.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension> getDimensionsList();
  /**
   * <pre>
   * Required. The audience dimensions for which composition insights should be
   * returned.
   ...
   */
  com.google.ads.googleads.v15.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension getDimensions(int index);
  /**
   * <pre>
   * Required. The audience dimensions for which composition insights should be
   * returned.
