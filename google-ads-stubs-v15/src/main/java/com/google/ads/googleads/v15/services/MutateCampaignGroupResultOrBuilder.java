...
public interface MutateCampaignGroupResultOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v15.services.MutateCampaignGroupResult)
   ...
   */
  com.google.ads.googleads.v15.resources.CampaignGroup getCampaignGroup();
  /**
   * <pre>
   * The mutated campaign group with only mutable fields after mutate. The field
   * will only be returned when response_content_type is set to
   ...
   * <code>.google.ads.googleads.v15.resources.CampaignGroup campaign_group = 2;</code>
   */
  com.google.ads.googleads.v15.resources.CampaignGroupOrBuilder getCampaignGroupOrBuilder();
}
