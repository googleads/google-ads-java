...
public interface CartDataOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v12.services.CartData)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v12.services.CartData.Item items = 5;</code>
   */
  java.util.List<com.google.ads.googleads.v12.services.CartData.Item> 
      getItemsList();
  /**
   * <pre>
   * Data of the items purchased.
   ...
   * <code>repeated .google.ads.googleads.v12.services.CartData.Item items = 5;</code>
   */
  com.google.ads.googleads.v12.services.CartData.Item getItems(int index);
  /**
   * <pre>
   * Data of the items purchased.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v12.services.CartData.Item items = 5;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v12.services.CartData.ItemOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v12.services.CartData.Item items = 5;</code>
   */
  com.google.ads.googleads.v12.services.CartData.ItemOrBuilder getItemsOrBuilder(
      int index);
}
