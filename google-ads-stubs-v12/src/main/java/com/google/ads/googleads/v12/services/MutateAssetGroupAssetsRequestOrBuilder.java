...
public interface MutateAssetGroupAssetsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v12.services.MutateAssetGroupAssetsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v12.services.AssetGroupAssetOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual asset group
   ...
   * <code>repeated .google.ads.googleads.v12.services.AssetGroupAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v12.services.AssetGroupAssetOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v12.services.AssetGroupAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v12.services.AssetGroupAssetOperationOrBuilder getOperationsOrBuilder(
      int index);
