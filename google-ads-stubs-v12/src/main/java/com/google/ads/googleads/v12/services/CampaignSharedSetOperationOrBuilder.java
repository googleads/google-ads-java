...
public interface CampaignSharedSetOperationOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v12.services.CampaignSharedSetOperation)
   ...
   * @return The create.
   */
  com.google.ads.googleads.v12.resources.CampaignSharedSet getCreate();
  /**
   * <pre>
   * Create operation: No resource name is expected for the new campaign
   * shared set.
   ...
   * <code>.google.ads.googleads.v12.resources.CampaignSharedSet create = 1;</code>
   */
  com.google.ads.googleads.v12.resources.CampaignSharedSetOrBuilder getCreateOrBuilder();
