...
public interface MutateAssetGroupListingGroupFiltersRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v12.services.MutateAssetGroupListingGroupFiltersRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v12.services.AssetGroupListingGroupFilterOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual asset group listing group
   ...
   * <code>repeated .google.ads.googleads.v12.services.AssetGroupListingGroupFilterOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v12.services.AssetGroupListingGroupFilterOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v12.services.AssetGroupListingGroupFilterOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v12.services.AssetGroupListingGroupFilterOperationOrBuilder getOperationsOrBuilder(
      int index);
