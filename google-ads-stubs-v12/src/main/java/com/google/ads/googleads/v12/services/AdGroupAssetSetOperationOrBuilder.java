...
public interface AdGroupAssetSetOperationOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v12.services.AdGroupAssetSetOperation)
   ...
   * @return The create.
   */
  com.google.ads.googleads.v12.resources.AdGroupAssetSet getCreate();
  /**
   * <pre>
   * Create operation: No resource name is expected for the new ad group asset
   * set.
   ...
   * <code>.google.ads.googleads.v12.resources.AdGroupAssetSet create = 1;</code>
   */
  com.google.ads.googleads.v12.resources.AdGroupAssetSetOrBuilder getCreateOrBuilder();
