...
public interface GenerateReachForecastRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v12.services.GenerateReachForecastRequest)
   ...
   */
  com.google.ads.googleads.v12.services.CampaignDuration getCampaignDuration();
  /**
   * <pre>
   * Required. Campaign duration.
   * </pre>
   ...
   * <code>.google.ads.googleads.v12.services.CampaignDuration campaign_duration = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v12.services.CampaignDurationOrBuilder getCampaignDurationOrBuilder();
   ...
   */
  com.google.ads.googleads.v12.services.FrequencyCap getCookieFrequencyCapSetting();
  /**
   * <pre>
   * Chosen cookie frequency cap to be applied to each planned product.
   * This is equivalent to the frequency cap exposed in Google Ads when creating
   ...
   * <code>.google.ads.googleads.v12.services.FrequencyCap cookie_frequency_cap_setting = 8;</code>
   */
  com.google.ads.googleads.v12.services.FrequencyCapOrBuilder getCookieFrequencyCapSettingOrBuilder();
   ...
   */
  com.google.ads.googleads.v12.services.EffectiveFrequencyLimit getEffectiveFrequencyLimit();
  /**
   * <pre>
   * The highest minimum effective frequency (the number of times a person was
   * exposed to the ad) value [1-10] to include in
   ...
   * <code>optional .google.ads.googleads.v12.services.EffectiveFrequencyLimit effective_frequency_limit = 12;</code>
   */
  com.google.ads.googleads.v12.services.EffectiveFrequencyLimitOrBuilder getEffectiveFrequencyLimitOrBuilder();
   ...
   */
  com.google.ads.googleads.v12.services.Targeting getTargeting();
  /**
   * <pre>
   * The targeting to be applied to all products selected in the product mix.
   * This is planned targeting: execution details might vary based on the
   ...
   * <code>.google.ads.googleads.v12.services.Targeting targeting = 6;</code>
   */
  com.google.ads.googleads.v12.services.TargetingOrBuilder getTargetingOrBuilder();
   ...
   */
  java.util.List<com.google.ads.googleads.v12.services.PlannedProduct> 
   ...
   * <code>repeated .google.ads.googleads.v12.services.PlannedProduct planned_products = 7 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v12.services.PlannedProduct getPlannedProducts(int index);
  /**
   * <pre>
   * Required. The products to be forecast.
   * The max number of allowed planned products is 15.
   ...
   * <code>repeated .google.ads.googleads.v12.services.PlannedProduct planned_products = 7 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v12.services.PlannedProductOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v12.services.PlannedProduct planned_products = 7 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v12.services.PlannedProductOrBuilder getPlannedProductsOrBuilder(
      int index);
   ...
   */
  com.google.ads.googleads.v12.services.ForecastMetricOptions getForecastMetricOptions();
  /**
   * <pre>
   * Controls the forecast metrics returned in the response.
   * </pre>
   ...
   * <code>.google.ads.googleads.v12.services.ForecastMetricOptions forecast_metric_options = 13;</code>
   */
  com.google.ads.googleads.v12.services.ForecastMetricOptionsOrBuilder getForecastMetricOptionsOrBuilder();
