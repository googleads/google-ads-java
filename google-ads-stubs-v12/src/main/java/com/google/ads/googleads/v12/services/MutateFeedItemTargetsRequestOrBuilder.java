...
public interface MutateFeedItemTargetsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v12.services.MutateFeedItemTargetsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v12.services.FeedItemTargetOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual feed item targets.
   ...
   * <code>repeated .google.ads.googleads.v12.services.FeedItemTargetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v12.services.FeedItemTargetOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v12.services.FeedItemTargetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v12.services.FeedItemTargetOperationOrBuilder getOperationsOrBuilder(
      int index);
