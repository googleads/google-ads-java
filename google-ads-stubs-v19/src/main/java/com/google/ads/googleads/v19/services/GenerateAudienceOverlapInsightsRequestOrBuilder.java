...
public interface GenerateAudienceOverlapInsightsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v19.services.GenerateAudienceOverlapInsightsRequest)
   ...
   */
  com.google.ads.googleads.v19.common.AudienceInsightsAttribute getPrimaryAttribute();
  /**
   * <pre>
   * Required. The audience attribute that should be intersected with all other
   * eligible audiences.  This must be an Affinity or In-Market UserInterest, an
   ...
   * <code>.google.ads.googleads.v19.common.AudienceInsightsAttribute primary_attribute = 6 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v19.common.AudienceInsightsAttributeOrBuilder getPrimaryAttributeOrBuilder();
