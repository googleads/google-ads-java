...
import com.google.ads.googleads.v19.services.GenerateCreatorInsightsRequest;
import com.google.ads.googleads.v19.services.GenerateCreatorInsightsResponse;
import com.google.ads.googleads.v19.services.GenerateTrendingInsightsRequest;
import com.google.ads.googleads.v19.services.GenerateTrendingInsightsResponse;
...
/**
 * Settings class to configure an instance of {@link ContentCreatorInsightsServiceStub}.
 *
 ...
 * ContentCreatorInsightsServiceStubSettings.Builder contentCreatorInsightsServiceSettingsBuilder =
 *     ContentCreatorInsightsServiceStubSettings.newBuilder();
 ...
 *             .build());
 * ContentCreatorInsightsServiceStubSettings contentCreatorInsightsServiceSettings =
...
public class ContentCreatorInsightsServiceStubSettings
  ...
  private final UnaryCallSettings<GenerateCreatorInsightsRequest, GenerateCreatorInsightsResponse>
      generateCreatorInsightsSettings;
  private final UnaryCallSettings<GenerateTrendingInsightsRequest, GenerateTrendingInsightsResponse>
  ...
  public UnaryCallSettings<GenerateCreatorInsightsRequest, GenerateCreatorInsightsResponse>
      generateCreatorInsightsSettings() {
    return generateCreatorInsightsSettings;
  }
  ...
  public UnaryCallSettings<GenerateTrendingInsightsRequest, GenerateTrendingInsightsResponse>
      generateTrendingInsightsSettings() {
    return generateTrendingInsightsSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic",
            GaxProperties.getLibraryVersion(ContentCreatorInsightsServiceStubSettings.class))
        .setTransportToken(
  ...
  protected ContentCreatorInsightsServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    generateCreatorInsightsSettings = settingsBuilder.generateCreatorInsightsSettings().build();
    generateTrendingInsightsSettings = settingsBuilder.generateTrendingInsightsSettings().build();
  }
  ...
  public static class Builder
    ...
    protected Builder(ClientContext clientContext) {
      ...
      generateCreatorInsightsSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      generateTrendingInsightsSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              generateCreatorInsightsSettings, generateTrendingInsightsSettings);
      initDefaults(this);
    }
    ...
    protected Builder(ContentCreatorInsightsServiceStubSettings settings) {
      ...
      generateCreatorInsightsSettings = settings.generateCreatorInsightsSettings.toBuilder();
      generateTrendingInsightsSettings = settings.generateTrendingInsightsSettings.toBuilder();
