...
public class GrpcContentCreatorInsightsServiceStub extends ContentCreatorInsightsServiceStub {
  private static final MethodDescriptor<
      ...
      generateCreatorInsightsMethodDescriptor =
          MethodDescriptor
              ...
              .setFullMethodName(
                  "google.ads.googleads.v19.services.ContentCreatorInsightsService/GenerateCreatorInsights")
  ...
  private static final MethodDescriptor<
      ...
      generateTrendingInsightsMethodDescriptor =
          MethodDescriptor
              .<GenerateTrendingInsightsRequest, GenerateTrendingInsightsResponse>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.ads.googleads.v19.services.ContentCreatorInsightsService/GenerateTrendingInsights")
              .setRequestMarshaller(
  ...
  private final UnaryCallable<GenerateTrendingInsightsRequest, GenerateTrendingInsightsResponse>
  ...
  protected GrpcContentCreatorInsightsServiceStub(
    ...
    GrpcCallSettings<GenerateCreatorInsightsRequest, GenerateCreatorInsightsResponse>
        generateCreatorInsightsTransportSettings =
            GrpcCallSettings
                ...
                .build();
    GrpcCallSettings<GenerateTrendingInsightsRequest, GenerateTrendingInsightsResponse>
        generateTrendingInsightsTransportSettings =
            GrpcCallSettings
                .<GenerateTrendingInsightsRequest, GenerateTrendingInsightsResponse>newBuilder()
                .setMethodDescriptor(generateTrendingInsightsMethodDescriptor)
                .setParamsExtractor(
                    request -> {
                      RequestParamsBuilder builder = RequestParamsBuilder.create();
                      builder.add("customer_id", String.valueOf(request.getCustomerId()));
    ...
    this.generateCreatorInsightsCallable =
        callableFactory.createUnaryCallable(
            ...
            clientContext);
    this.generateTrendingInsightsCallable =
        callableFactory.createUnaryCallable(
            generateTrendingInsightsTransportSettings,
            settings.generateTrendingInsightsSettings(),
            clientContext);
  ...
  @Override
  public UnaryCallable<GenerateTrendingInsightsRequest, GenerateTrendingInsightsResponse>
      generateTrendingInsightsCallable() {
    return generateTrendingInsightsCallable;
  }
