...
public interface InsightsAudienceAttributeGroupOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v19.services.InsightsAudienceAttributeGroup)
   ...
   */
  java.util.List<com.google.ads.googleads.v19.common.AudienceInsightsAttribute> 
      getAttributesList();
  /**
   * <pre>
   * Required. A collection of audience attributes to be combined with logical
   ...
   * <code>repeated .google.ads.googleads.v19.common.AudienceInsightsAttribute attributes = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v19.common.AudienceInsightsAttribute getAttributes(int index);
  /**
   * <pre>
   * Required. A collection of audience attributes to be combined with logical
   * OR. Attributes need not all be the same dimension.  Only Knowledge Graph
   ...
   * <code>repeated .google.ads.googleads.v19.common.AudienceInsightsAttribute attributes = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v19.common.AudienceInsightsAttributeOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v19.common.AudienceInsightsAttribute attributes = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v19.common.AudienceInsightsAttributeOrBuilder getAttributesOrBuilder(
      int index);
}
