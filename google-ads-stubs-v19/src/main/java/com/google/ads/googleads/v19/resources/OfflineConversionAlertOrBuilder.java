...
public interface OfflineConversionAlertOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v19.resources.OfflineConversionAlert)
   ...
   * @return The error.
   */
  com.google.ads.googleads.v19.resources.OfflineConversionError getError();
  /**
   * <pre>
   * Output only. Error for offline conversion client alert.
   * </pre>
   ...
   * <code>.google.ads.googleads.v19.resources.OfflineConversionError error = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v19.resources.OfflineConversionErrorOrBuilder getErrorOrBuilder();
