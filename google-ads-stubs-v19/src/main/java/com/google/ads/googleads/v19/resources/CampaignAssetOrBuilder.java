...
public interface CampaignAssetOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v19.resources.CampaignAsset)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v19.enums.AssetFieldTypeEnum.AssetFieldType field_type = 4 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v19.enums.AssetSourceEnum.AssetSource source = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v19.enums.AssetLinkStatusEnum.AssetLinkStatus getStatus();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v19.enums.AssetLinkPrimaryStatusEnum.AssetLinkPrimaryStatus primary_status = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v19.enums.AssetLinkPrimaryStatusEnum.AssetLinkPrimaryStatus getPrimaryStatus();
   ...
   */
  java.util.List<com.google.ads.googleads.v19.common.AssetLinkPrimaryStatusDetails> 
   ...
   * <code>repeated .google.ads.googleads.v19.common.AssetLinkPrimaryStatusDetails primary_status_details = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v19.common.AssetLinkPrimaryStatusDetails getPrimaryStatusDetails(int index);
  /**
   * <pre>
   * Output only. Provides the details of the primary status and its associated
   * reasons.
   ...
   * <code>repeated .google.ads.googleads.v19.common.AssetLinkPrimaryStatusDetails primary_status_details = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v19.common.AssetLinkPrimaryStatusDetailsOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v19.common.AssetLinkPrimaryStatusDetails primary_status_details = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v19.common.AssetLinkPrimaryStatusDetailsOrBuilder getPrimaryStatusDetailsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v19.enums.AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason primary_status_reasons = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   * @return A list containing the primaryStatusReasons.
   */
  java.util.List<com.google.ads.googleads.v19.enums.AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason> getPrimaryStatusReasonsList();
  /**
   * <pre>
   * Output only. Provides a list of reasons for why an asset is not serving or
   * not serving at full capacity.
   ...
   */
  com.google.ads.googleads.v19.enums.AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason getPrimaryStatusReasons(int index);
  /**
   * <pre>
   * Output only. Provides a list of reasons for why an asset is not serving or
   * not serving at full capacity.
