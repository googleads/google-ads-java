...
public interface UploadClickConversionsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v19.services.UploadClickConversionsRequest)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v19.services.ClickConversion conversions = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.ads.googleads.v19.services.ClickConversion> 
      getConversionsList();
  /**
   * <pre>
   * Required. The conversions that are being uploaded.
   ...
   * <code>repeated .google.ads.googleads.v19.services.ClickConversion conversions = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v19.services.ClickConversion getConversions(int index);
  /**
   * <pre>
   * Required. The conversions that are being uploaded.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v19.services.ClickConversion conversions = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v19.services.ClickConversionOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v19.services.ClickConversion conversions = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v19.services.ClickConversionOrBuilder getConversionsOrBuilder(
      int index);
