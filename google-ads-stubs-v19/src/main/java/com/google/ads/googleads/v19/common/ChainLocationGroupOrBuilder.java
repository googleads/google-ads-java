...
public interface ChainLocationGroupOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v19.common.ChainLocationGroup)
   ...
   * <code>repeated .google.ads.googleads.v19.common.ChainFilter dynamic_chain_location_group_filters = 1;</code>
   */
  com.google.ads.googleads.v19.common.ChainFilter getDynamicChainLocationGroupFilters(int index);
  /**
   * <pre>
   * Used to filter chain locations by chain ids.
   * Only Locations that belong to the specified chain(s) will be in the asset
   ...
   * <code>repeated .google.ads.googleads.v19.common.ChainFilter dynamic_chain_location_group_filters = 1;</code>
   */
  com.google.ads.googleads.v19.common.ChainFilterOrBuilder getDynamicChainLocationGroupFiltersOrBuilder(
      int index);
}
