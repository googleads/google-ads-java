...
public interface ChangeEventOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v19.resources.ChangeEvent)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v19.enums.ChangeEventResourceTypeEnum.ChangeEventResourceType change_resource_type = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v19.enums.ChangeEventResourceTypeEnum.ChangeEventResourceType getChangeResourceType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v19.enums.ChangeClientTypeEnum.ChangeClientType client_type = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v19.enums.ChangeClientTypeEnum.ChangeClientType getClientType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v19.resources.ChangeEvent.ChangedResource old_resource = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v19.resources.ChangeEvent.ChangedResource getOldResource();
  /**
   * <pre>
   * Output only. The old resource before the change. Only changed fields will
   * be populated.
   ...
   * <code>.google.ads.googleads.v19.resources.ChangeEvent.ChangedResource old_resource = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v19.resources.ChangeEvent.ChangedResourceOrBuilder getOldResourceOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v19.resources.ChangeEvent.ChangedResource new_resource = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v19.resources.ChangeEvent.ChangedResource getNewResource();
  /**
   * <pre>
   * Output only. The new resource after the change. Only changed fields will be
   * populated.
   ...
   * <code>.google.ads.googleads.v19.resources.ChangeEvent.ChangedResource new_resource = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v19.resources.ChangeEvent.ChangedResourceOrBuilder getNewResourceOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v19.enums.ResourceChangeOperationEnum.ResourceChangeOperation resource_change_operation = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v19.enums.ResourceChangeOperationEnum.ResourceChangeOperation getResourceChangeOperation();
