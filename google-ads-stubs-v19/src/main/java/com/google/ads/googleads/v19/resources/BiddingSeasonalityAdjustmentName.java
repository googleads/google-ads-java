...
public class BiddingSeasonalityAdjustmentName implements ResourceName {
  ...
  public static BiddingSeasonalityAdjustmentName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<BiddingSeasonalityAdjustmentName> values) {
