...
public class AccessibleBiddingStrategyName implements ResourceName {
  ...
  @Deprecated
  protected AccessibleBiddingStrategyName() {
    customerId = null;
    biddingStrategyId = null;
  }

  private AccessibleBiddingStrategyName(Builder builder) {
  ...
  public static AccessibleBiddingStrategyName of(String customerId, String biddingStrategyId) {
  ...
  public static AccessibleBiddingStrategyName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_ID_BIDDING_STRATEGY_ID.validatedMatch(
            formattedString,
            "AccessibleBiddingStrategyName.parse: formattedString not in valid format");
    return of(matchMap.get("customer_id"), matchMap.get("bidding_strategy_id"));
  }

  public static List<AccessibleBiddingStrategyName> parseList(List<String> formattedStrings) {
    List<AccessibleBiddingStrategyName> list = new ArrayList<>(formattedStrings.size());
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      AccessibleBiddingStrategyName that = ((AccessibleBiddingStrategyName) o);
  ...
  public static class Builder {
    ...
    public AccessibleBiddingStrategyName build() {
      return new AccessibleBiddingStrategyName(this);
    }
  }
}
