...
public interface FeedItemTargetOperationOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v13.services.FeedItemTargetOperation)
   ...
   * @return The create.
   */
  com.google.ads.googleads.v13.resources.FeedItemTarget getCreate();
  /**
   * <pre>
   * Create operation: No resource name is expected for the new feed item
   * target.
   ...
   * <code>.google.ads.googleads.v13.resources.FeedItemTarget create = 1;</code>
   */
  com.google.ads.googleads.v13.resources.FeedItemTargetOrBuilder getCreateOrBuilder();
