...
public interface FeedMappingOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v13.resources.FeedMapping)
   ...
   * <code>repeated .google.ads.googleads.v13.resources.AttributeFieldMapping attribute_field_mappings = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.ads.googleads.v13.resources.AttributeFieldMapping getAttributeFieldMappings(int index);
  /**
   * <pre>
   * Immutable. Feed attributes to field mappings. These mappings are a
   * one-to-many relationship meaning that 1 feed attribute can be used to
   ...
   * <code>repeated .google.ads.googleads.v13.resources.AttributeFieldMapping attribute_field_mappings = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.ads.googleads.v13.resources.AttributeFieldMappingOrBuilder getAttributeFieldMappingsOrBuilder(
      int index);
   ...
   */
  com.google.ads.googleads.v13.enums.FeedMappingCriterionTypeEnum.FeedMappingCriterionType getCriterionType();

  public com.google.ads.googleads.v13.resources.FeedMapping.TargetCase getTargetCase();
}
