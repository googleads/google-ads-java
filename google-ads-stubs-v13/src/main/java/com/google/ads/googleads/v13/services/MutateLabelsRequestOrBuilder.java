...
public interface MutateLabelsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v13.services.MutateLabelsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v13.services.LabelOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on labels.
   ...
   * <code>repeated .google.ads.googleads.v13.services.LabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v13.services.LabelOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on labels.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v13.services.LabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v13.services.LabelOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v13.services.LabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v13.services.LabelOperationOrBuilder getOperationsOrBuilder(
      int index);
