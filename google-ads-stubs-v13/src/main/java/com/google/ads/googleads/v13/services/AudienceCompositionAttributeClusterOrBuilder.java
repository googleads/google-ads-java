...
public interface AudienceCompositionAttributeClusterOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v13.services.AudienceCompositionAttributeCluster)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v13.services.AudienceCompositionMetrics cluster_metrics = 3;</code>
   ...
   */
  com.google.ads.googleads.v13.services.AudienceCompositionMetrics getClusterMetrics();
  /**
   * <pre>
   * If the dimension associated with this cluster is YOUTUBE_CHANNEL, then
   * cluster_metrics are metrics associated with the cluster as a whole.
   ...
   * <code>.google.ads.googleads.v13.services.AudienceCompositionMetrics cluster_metrics = 3;</code>
   */
  com.google.ads.googleads.v13.services.AudienceCompositionMetricsOrBuilder getClusterMetricsOrBuilder();
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v13.services.AudienceCompositionAttribute attributes = 4;</code>
   */
   ...
   * <code>repeated .google.ads.googleads.v13.services.AudienceCompositionAttribute attributes = 4;</code>
   */
  com.google.ads.googleads.v13.services.AudienceCompositionAttribute getAttributes(int index);
  /**
   * <pre>
   * The individual attributes that make up this cluster, with metadata and
   * metrics.
   ...
   * <code>repeated .google.ads.googleads.v13.services.AudienceCompositionAttribute attributes = 4;</code>
   */
  com.google.ads.googleads.v13.services.AudienceCompositionAttributeOrBuilder getAttributesOrBuilder(
      int index);
}
