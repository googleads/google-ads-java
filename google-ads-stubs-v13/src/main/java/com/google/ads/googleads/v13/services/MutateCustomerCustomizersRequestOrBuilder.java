...
public interface MutateCustomerCustomizersRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v13.services.MutateCustomerCustomizersRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v13.services.CustomerCustomizerOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual customer
   ...
   * <code>repeated .google.ads.googleads.v13.services.CustomerCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v13.services.CustomerCustomizerOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual customer
   * customizers.
   ...
   * <code>repeated .google.ads.googleads.v13.services.CustomerCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v13.services.CustomerCustomizerOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v13.services.CustomerCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v13.services.CustomerCustomizerOperationOrBuilder getOperationsOrBuilder(
      int index);
