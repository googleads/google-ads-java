...
public interface MutateAssetSetAssetsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v13.services.MutateAssetSetAssetsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v13.services.AssetSetAssetOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual asset set assets.
   ...
   * <code>repeated .google.ads.googleads.v13.services.AssetSetAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v13.services.AssetSetAssetOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual asset set assets.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v13.services.AssetSetAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v13.services.AssetSetAssetOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v13.services.AssetSetAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v13.services.AssetSetAssetOperationOrBuilder getOperationsOrBuilder(
      int index);
