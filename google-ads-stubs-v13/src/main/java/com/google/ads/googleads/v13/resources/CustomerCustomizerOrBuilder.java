...
public interface CustomerCustomizerOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v13.resources.CustomerCustomizer)
   ...
   * @return The status.
   */
  com.google.ads.googleads.v13.enums.CustomizerValueStatusEnum.CustomizerValueStatus getStatus();
   ...
   * @return The value.
   */
  com.google.ads.googleads.v13.common.CustomizerValue getValue();
  /**
   * <pre>
   * Required. The value to associate with the customizer attribute at this
   * level. The value must be of the type specified for the CustomizerAttribute.
   ...
   * <code>.google.ads.googleads.v13.common.CustomizerValue value = 4 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v13.common.CustomizerValueOrBuilder getValueOrBuilder();
}
