...
public interface MutateAssetSetsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v13.services.MutateAssetSetsRequest)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v13.services.AssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.ads.googleads.v13.services.AssetSetOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual asset sets.
   ...
   * <code>repeated .google.ads.googleads.v13.services.AssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v13.services.AssetSetOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual asset sets.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v13.services.AssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v13.services.AssetSetOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v13.services.AssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v13.services.AssetSetOperationOrBuilder getOperationsOrBuilder(
      int index);
