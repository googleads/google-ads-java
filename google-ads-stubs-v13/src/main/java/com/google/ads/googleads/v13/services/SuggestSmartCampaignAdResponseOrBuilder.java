...
public interface SuggestSmartCampaignAdResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v13.services.SuggestSmartCampaignAdResponse)
   ...
   * @return The adInfo.
   */
  com.google.ads.googleads.v13.common.SmartCampaignAdInfo getAdInfo();
  /**
   * <pre>
   * Optional. Ad info includes 3 creative headlines and 2 creative
   * descriptions.
   ...
   * <code>.google.ads.googleads.v13.common.SmartCampaignAdInfo ad_info = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.ads.googleads.v13.common.SmartCampaignAdInfoOrBuilder getAdInfoOrBuilder();
}
