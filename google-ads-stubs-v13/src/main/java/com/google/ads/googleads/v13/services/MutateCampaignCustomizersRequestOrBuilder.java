...
public interface MutateCampaignCustomizersRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v13.services.MutateCampaignCustomizersRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v13.services.CampaignCustomizerOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign
   ...
   * <code>repeated .google.ads.googleads.v13.services.CampaignCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v13.services.CampaignCustomizerOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign
   * customizers.
   ...
   * <code>repeated .google.ads.googleads.v13.services.CampaignCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v13.services.CampaignCustomizerOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v13.services.CampaignCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v13.services.CampaignCustomizerOperationOrBuilder getOperationsOrBuilder(
      int index);
