...
public interface AccountBudgetProposalOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v13.resources.AccountBudgetProposal)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v13.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType proposal_type = 4 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v13.enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus status = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v13.enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus getStatus();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v13.enums.TimeTypeEnum.TimeType proposed_start_time_type = 7 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v13.enums.TimeTypeEnum.TimeType getProposedStartTimeType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v13.enums.TimeTypeEnum.TimeType proposed_end_time_type = 9 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v13.enums.TimeTypeEnum.TimeType getProposedEndTimeType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v13.enums.TimeTypeEnum.TimeType approved_end_time_type = 22 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v13.enums.TimeTypeEnum.TimeType getApprovedEndTimeType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v13.enums.SpendingLimitTypeEnum.SpendingLimitType proposed_spending_limit_type = 11 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v13.enums.SpendingLimitTypeEnum.SpendingLimitType getProposedSpendingLimitType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v13.enums.SpendingLimitTypeEnum.SpendingLimitType approved_spending_limit_type = 24 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v13.enums.SpendingLimitTypeEnum.SpendingLimitType getApprovedSpendingLimitType();

  public com.google.ads.googleads.v13.resources.AccountBudgetProposal.ProposedStartTimeCase getProposedStartTimeCase();

  public com.google.ads.googleads.v13.resources.AccountBudgetProposal.ProposedEndTimeCase getProposedEndTimeCase();

  public com.google.ads.googleads.v13.resources.AccountBudgetProposal.ApprovedEndTimeCase getApprovedEndTimeCase();

  public com.google.ads.googleads.v13.resources.AccountBudgetProposal.ProposedSpendingLimitCase getProposedSpendingLimitCase();

  public com.google.ads.googleads.v13.resources.AccountBudgetProposal.ApprovedSpendingLimitCase getApprovedSpendingLimitCase();
}
