...
public interface MutateCustomizerAttributesRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v13.services.MutateCustomizerAttributesRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v13.services.CustomizerAttributeOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual customizer
   ...
   * <code>repeated .google.ads.googleads.v13.services.CustomizerAttributeOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v13.services.CustomizerAttributeOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual customizer
   * attributes.
   ...
   * <code>repeated .google.ads.googleads.v13.services.CustomizerAttributeOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v13.services.CustomizerAttributeOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v13.services.CustomizerAttributeOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v13.services.CustomizerAttributeOperationOrBuilder getOperationsOrBuilder(
      int index);
