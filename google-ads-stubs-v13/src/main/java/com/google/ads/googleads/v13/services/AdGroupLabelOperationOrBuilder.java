...
public interface AdGroupLabelOperationOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v13.services.AdGroupLabelOperation)
   ...
   * @return The create.
   */
  com.google.ads.googleads.v13.resources.AdGroupLabel getCreate();
  /**
   * <pre>
   * Create operation: No resource name is expected for the new ad group
   * label.
   ...
   * <code>.google.ads.googleads.v13.resources.AdGroupLabel create = 1;</code>
   */
  com.google.ads.googleads.v13.resources.AdGroupLabelOrBuilder getCreateOrBuilder();
