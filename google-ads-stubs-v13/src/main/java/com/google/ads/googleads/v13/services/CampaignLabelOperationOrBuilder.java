...
public interface CampaignLabelOperationOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v13.services.CampaignLabelOperation)
   ...
   * @return The create.
   */
  com.google.ads.googleads.v13.resources.CampaignLabel getCreate();
  /**
   * <pre>
   * Create operation: No resource name is expected for the new campaign-label
   * relationship.
   ...
   * <code>.google.ads.googleads.v13.resources.CampaignLabel create = 1;</code>
   */
  com.google.ads.googleads.v13.resources.CampaignLabelOrBuilder getCreateOrBuilder();
