...
public interface AssetOperationOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v13.services.AssetOperation)
   ...
   * @return The create.
   */
  com.google.ads.googleads.v13.resources.Asset getCreate();
  /**
   * <pre>
   * Create operation: No resource name is expected for the new asset.
   * </pre>
   ...
   * <code>.google.ads.googleads.v13.resources.Asset create = 1;</code>
   */
  com.google.ads.googleads.v13.resources.AssetOrBuilder getCreateOrBuilder();
   ...
   * @return The update.
   */
  com.google.ads.googleads.v13.resources.Asset getUpdate();
  /**
   * <pre>
   * Update operation: The asset is expected to have a valid resource name in
   * this format:
