...
public interface MutateAccountBudgetProposalRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v13.services.MutateAccountBudgetProposalRequest)
   ...
   */
  com.google.ads.googleads.v13.services.AccountBudgetProposalOperation getOperation();
  /**
   * <pre>
   * Required. The operation to perform on an individual account-level budget
   * proposal.
   ...
   * <code>.google.ads.googleads.v13.services.AccountBudgetProposalOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v13.services.AccountBudgetProposalOperationOrBuilder getOperationOrBuilder();
