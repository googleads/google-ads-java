...
public interface MutateAdParametersRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v13.services.MutateAdParametersRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v13.services.AdParameterOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual ad parameters.
   ...
   * <code>repeated .google.ads.googleads.v13.services.AdParameterOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v13.services.AdParameterOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual ad parameters.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v13.services.AdParameterOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v13.services.AdParameterOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v13.services.AdParameterOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v13.services.AdParameterOperationOrBuilder getOperationsOrBuilder(
      int index);
