 ...
 *
 * In this code example, the functionality to create a campaign budget, search campaign and
 * ad group have been migrated to the Google Ads API. The rest of the functionality -
