...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 0,
      /* suffix= */ "",
      GenerateAdGroupThemesRequest.class.getName());
  }
  // Use GenerateAdGroupThemesRequest.newBuilder() to construct.
  private GenerateAdGroupThemesRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < adGroups_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, adGroups_.getRaw(i));
    }
