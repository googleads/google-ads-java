...
public interface UploadCallConversionsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v21.services.UploadCallConversionsResponse)
   ...
   */
  java.util.List<com.google.ads.googleads.v21.services.CallConversionResult> 
      getResultsList();
  /**
   * <pre>
   * Returned for successfully processed conversions. Proto will be empty for
   ...
   * <code>repeated .google.ads.googleads.v21.services.CallConversionResult results = 2;</code>
   */
  com.google.ads.googleads.v21.services.CallConversionResult getResults(int index);
  /**
   * <pre>
   * Returned for successfully processed conversions. Proto will be empty for
   * rows that received an error. Results are not returned when validate_only is
   ...
   * <code>repeated .google.ads.googleads.v21.services.CallConversionResult results = 2;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v21.services.CallConversionResultOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v21.services.CallConversionResult results = 2;</code>
   */
  com.google.ads.googleads.v21.services.CallConversionResultOrBuilder getResultsOrBuilder(
      int index);
}
