...
public interface InsightsAudienceAttributeGroupOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v21.services.InsightsAudienceAttributeGroup)
   ...
   * <code>repeated .google.ads.googleads.v21.common.AudienceInsightsAttribute attributes = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v21.common.AudienceInsightsAttribute getAttributes(int index);
  /**
   * <pre>
   * Required. A collection of audience attributes to be combined with logical
   * OR. Attributes need not all be the same dimension.  Only Knowledge Graph
   ...
   * <code>repeated .google.ads.googleads.v21.common.AudienceInsightsAttribute attributes = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v21.common.AudienceInsightsAttributeOrBuilder getAttributesOrBuilder(
      int index);
}
