...
public interface AccountBudgetOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v21.resources.AccountBudget)
   ...
   * @return The status.
   */
  com.google.ads.googleads.v21.enums.AccountBudgetStatusEnum.AccountBudgetStatus getStatus();
   ...
   */
  com.google.ads.googleads.v21.resources.AccountBudget.PendingAccountBudgetProposal getPendingProposal();
  /**
   * <pre>
   * Output only. The pending proposal to modify this budget, if applicable.
   * </pre>
   ...
   * <code>.google.ads.googleads.v21.resources.AccountBudget.PendingAccountBudgetProposal pending_proposal = 22 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v21.resources.AccountBudget.PendingAccountBudgetProposalOrBuilder getPendingProposalOrBuilder();
   ...
   */
  com.google.ads.googleads.v21.enums.SpendingLimitTypeEnum.SpendingLimitType getAdjustedSpendingLimitType();

  com.google.ads.googleads.v21.resources.AccountBudget.ProposedEndTimeCase getProposedEndTimeCase();

  com.google.ads.googleads.v21.resources.AccountBudget.ApprovedEndTimeCase getApprovedEndTimeCase();

  com.google.ads.googleads.v21.resources.AccountBudget.ProposedSpendingLimitCase getProposedSpendingLimitCase();

  com.google.ads.googleads.v21.resources.AccountBudget.ApprovedSpendingLimitCase getApprovedSpendingLimitCase();

  com.google.ads.googleads.v21.resources.AccountBudget.AdjustedSpendingLimitCase getAdjustedSpendingLimitCase();
}
