...
public interface MutateAccountLinkRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v21.services.MutateAccountLinkRequest)
   ...
   */
  com.google.ads.googleads.v21.services.AccountLinkOperation getOperation();
  /**
   * <pre>
   * Required. The operation to perform on the link.
   * </pre>
   ...
   * <code>.google.ads.googleads.v21.services.AccountLinkOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v21.services.AccountLinkOperationOrBuilder getOperationOrBuilder();
