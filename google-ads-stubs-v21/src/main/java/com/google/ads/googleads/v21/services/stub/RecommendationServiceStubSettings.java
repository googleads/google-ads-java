...
import com.google.ads.googleads.v21.services.ApplyRecommendationRequest;
import com.google.ads.googleads.v21.services.ApplyRecommendationResponse;
import com.google.ads.googleads.v21.services.DismissRecommendationRequest;
import com.google.ads.googleads.v21.services.DismissRecommendationResponse;
import com.google.ads.googleads.v21.services.GenerateRecommendationsRequest;
import com.google.ads.googleads.v21.services.GenerateRecommendationsResponse;
...
public class RecommendationServiceStubSettings
  ...
  private final UnaryCallSettings<GenerateRecommendationsRequest, GenerateRecommendationsResponse>
      generateRecommendationsSettings;
  ...
  /** Returns the object with the settings used for calls to generateRecommendations. */
  public UnaryCallSettings<GenerateRecommendationsRequest, GenerateRecommendationsResponse>
      generateRecommendationsSettings() {
    return generateRecommendationsSettings;
  }
  ...
  protected RecommendationServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    generateRecommendationsSettings = settingsBuilder.generateRecommendationsSettings().build();
  }
  ...
  public static class Builder
    ...
    protected Builder(ClientContext clientContext) {
      ...
      generateRecommendationsSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
    ...
    protected Builder(RecommendationServiceStubSettings settings) {
      ...
      generateRecommendationsSettings = settings.generateRecommendationsSettings.toBuilder();
    ...
    /** Returns the builder for the settings used for calls to generateRecommendations. */
