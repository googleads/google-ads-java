...
public interface InvoiceOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v21.resources.Invoice)
   ...
   * @return The type.
   */
  com.google.ads.googleads.v21.enums.InvoiceTypeEnum.InvoiceType getType();
   ...
   */
  com.google.ads.googleads.v21.common.DateRange getServiceDateRange();
  /**
   * <pre>
   * Output only. The service period date range of this invoice. The end date is
   * inclusive.
   ...
   * <code>.google.ads.googleads.v21.common.DateRange service_date_range = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v21.common.DateRangeOrBuilder getServiceDateRangeOrBuilder();
   ...
   */
  java.util.List<com.google.ads.googleads.v21.resources.Invoice.AccountBudgetSummary> 
   ...
   * <code>repeated .google.ads.googleads.v21.resources.Invoice.AccountBudgetSummary account_budget_summaries = 18 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v21.resources.Invoice.AccountBudgetSummary getAccountBudgetSummaries(int index);
  /**
   * <pre>
   * Output only. The list of summarized account budget information associated
   * with this invoice.
   ...
   * <code>repeated .google.ads.googleads.v21.resources.Invoice.AccountBudgetSummary account_budget_summaries = 18 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v21.resources.Invoice.AccountBudgetSummaryOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v21.resources.Invoice.AccountBudgetSummary account_budget_summaries = 18 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v21.resources.Invoice.AccountBudgetSummaryOrBuilder getAccountBudgetSummariesOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.ads.googleads.v21.resources.Invoice.AccountSummary> 
   ...
   * <code>repeated .google.ads.googleads.v21.resources.Invoice.AccountSummary account_summaries = 39 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v21.resources.Invoice.AccountSummary getAccountSummaries(int index);
  /**
   * <pre>
   * Output only. The list of summarized account information associated with
   * this invoice.
   ...
   * <code>repeated .google.ads.googleads.v21.resources.Invoice.AccountSummary account_summaries = 39 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v21.resources.Invoice.AccountSummaryOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v21.resources.Invoice.AccountSummary account_summaries = 39 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v21.resources.Invoice.AccountSummaryOrBuilder getAccountSummariesOrBuilder(
      int index);
}
