...
public interface ListAudienceInsightsAttributesRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v21.services.ListAudienceInsightsAttributesRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v21.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension> getDimensionsList();
  /**
   * <pre>
   * Required. The types of attributes to be returned. Supported
   * dimensions are CATEGORY, KNOWLEDGE_GRAPH, DEVICE,
   ...
   */
  com.google.ads.googleads.v21.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension getDimensions(int index);
  /**
   * <pre>
   * Required. The types of attributes to be returned. Supported
   * dimensions are CATEGORY, KNOWLEDGE_GRAPH, DEVICE,
   ...
   * <code>repeated .google.ads.googleads.v21.common.LocationInfo location_country_filters = 5;</code>
   */
  com.google.ads.googleads.v21.common.LocationInfo getLocationCountryFilters(int index);
  /**
   * <pre>
   * If SUB_COUNTRY_LOCATION attributes are one of the requested dimensions and
   * this field is present, then the SUB_COUNTRY_LOCATION attributes returned
   ...
   * <code>repeated .google.ads.googleads.v21.common.LocationInfo location_country_filters = 5;</code>
   */
  com.google.ads.googleads.v21.common.LocationInfoOrBuilder getLocationCountryFiltersOrBuilder(
      int index);
   ...
   */
  com.google.ads.googleads.v21.common.LocationInfo getYoutubeReachLocation();
  /**
   * <pre>
   * If present, potential YouTube reach estimates within the specified market
   * will be returned for attributes for which they are available.  Reach is
   ...
   * <code>.google.ads.googleads.v21.common.LocationInfo youtube_reach_location = 6;</code>
   */
  com.google.ads.googleads.v21.common.LocationInfoOrBuilder getYoutubeReachLocationOrBuilder();
}
