...
public interface GenerateReachForecastRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v21.services.GenerateReachForecastRequest)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v21.services.CampaignDuration campaign_duration = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   */
  com.google.ads.googleads.v21.services.CampaignDuration getCampaignDuration();
  /**
   * <pre>
   * Required. Campaign duration.
   * </pre>
   ...
   * <code>.google.ads.googleads.v21.services.CampaignDuration campaign_duration = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v21.services.CampaignDurationOrBuilder getCampaignDurationOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v21.services.FrequencyCap cookie_frequency_cap_setting = 8;</code>
   ...
   */
  com.google.ads.googleads.v21.services.FrequencyCap getCookieFrequencyCapSetting();
  /**
   * <pre>
   * Chosen cookie frequency cap to be applied to each planned product.
   * This is equivalent to the frequency cap exposed in Google Ads when creating
   ...
   * <code>.google.ads.googleads.v21.services.FrequencyCap cookie_frequency_cap_setting = 8;</code>
   */
  com.google.ads.googleads.v21.services.FrequencyCapOrBuilder getCookieFrequencyCapSettingOrBuilder();
   ...
   * </pre>
   *
   * <code>optional .google.ads.googleads.v21.services.EffectiveFrequencyLimit effective_frequency_limit = 12;</code>
   ...
   */
  com.google.ads.googleads.v21.services.EffectiveFrequencyLimit getEffectiveFrequencyLimit();
  /**
   * <pre>
   * The highest minimum effective frequency (the number of times a person was
   * exposed to the ad) value [1-10] to include in
   ...
   * <code>optional .google.ads.googleads.v21.services.EffectiveFrequencyLimit effective_frequency_limit = 12;</code>
   */
  com.google.ads.googleads.v21.services.EffectiveFrequencyLimitOrBuilder getEffectiveFrequencyLimitOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v21.services.Targeting targeting = 6;</code>
   ...
   */
  com.google.ads.googleads.v21.services.Targeting getTargeting();
  /**
   * <pre>
   * The targeting to be applied to all products selected in the product mix.
   *
   ...
   * <code>.google.ads.googleads.v21.services.Targeting targeting = 6;</code>
   */
  com.google.ads.googleads.v21.services.TargetingOrBuilder getTargetingOrBuilder();
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v21.services.PlannedProduct planned_products = 7 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.ads.googleads.v21.services.PlannedProduct> 
   ...
   * <code>repeated .google.ads.googleads.v21.services.PlannedProduct planned_products = 7 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v21.services.PlannedProduct getPlannedProducts(int index);
  /**
   * <pre>
   * Required. The products to be forecast.
   * The max number of allowed planned products is 15.
   ...
   * <code>repeated .google.ads.googleads.v21.services.PlannedProduct planned_products = 7 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v21.services.PlannedProductOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v21.services.PlannedProduct planned_products = 7 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v21.services.PlannedProductOrBuilder getPlannedProductsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v21.services.ForecastMetricOptions forecast_metric_options = 13;</code>
   ...
   */
  com.google.ads.googleads.v21.services.ForecastMetricOptions getForecastMetricOptions();
  /**
   * <pre>
   * Controls the forecast metrics returned in the response.
   * </pre>
   ...
   * <code>.google.ads.googleads.v21.services.ForecastMetricOptions forecast_metric_options = 13;</code>
   */
  com.google.ads.googleads.v21.services.ForecastMetricOptionsOrBuilder getForecastMetricOptionsOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v21.common.AdditionalApplicationInfo reach_application_info = 15 [(.google.api.field_behavior) = OPTIONAL];</code>
