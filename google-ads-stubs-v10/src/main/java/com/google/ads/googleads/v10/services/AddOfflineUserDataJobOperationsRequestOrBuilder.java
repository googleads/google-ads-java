...
public interface AddOfflineUserDataJobOperationsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v10.services.AddOfflineUserDataJobOperationsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v10.services.OfflineUserDataJobOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to be done.
   ...
   * <code>repeated .google.ads.googleads.v10.services.OfflineUserDataJobOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v10.services.OfflineUserDataJobOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to be done.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v10.services.OfflineUserDataJobOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v10.services.OfflineUserDataJobOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v10.services.OfflineUserDataJobOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v10.services.OfflineUserDataJobOperationOrBuilder getOperationsOrBuilder(
      int index);
