...
public interface PlannableTargetingOrBuilder extends
   ...
   */
  java.util.List<com.google.ads.googleads.v10.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange> getAgeRangesList();
  /**
   * <pre>
   * Allowed plannable age ranges for the product for which metrics will be
   * reported. Actual targeting is computed by mapping this age range onto
   ...
   */
  com.google.ads.googleads.v10.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange getAgeRanges(int index);
  /**
   * <pre>
   * Allowed plannable age ranges for the product for which metrics will be
   * reported. Actual targeting is computed by mapping this age range onto
   ...
   */
  java.util.List<com.google.ads.googleads.v10.common.GenderInfo> 
      getGendersList();
  /**
   * <pre>
   * Targetable genders for the ad product.
   ...
   * <code>repeated .google.ads.googleads.v10.common.GenderInfo genders = 2;</code>
   */
  com.google.ads.googleads.v10.common.GenderInfo getGenders(int index);
  /**
   * <pre>
   * Targetable genders for the ad product.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v10.common.GenderInfo genders = 2;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v10.common.GenderInfoOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v10.common.GenderInfo genders = 2;</code>
   */
  com.google.ads.googleads.v10.common.GenderInfoOrBuilder getGendersOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.ads.googleads.v10.common.DeviceInfo> 
      getDevicesList();
  /**
   * <pre>
   * Targetable devices for the ad product.
   ...
   * <code>repeated .google.ads.googleads.v10.common.DeviceInfo devices = 3;</code>
   */
  com.google.ads.googleads.v10.common.DeviceInfo getDevices(int index);
  /**
   * <pre>
   * Targetable devices for the ad product.
   * TABLET device targeting is automatically applied to reported metrics
   ...
   * <code>repeated .google.ads.googleads.v10.common.DeviceInfo devices = 3;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v10.common.DeviceInfoOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v10.common.DeviceInfo devices = 3;</code>
   */
  com.google.ads.googleads.v10.common.DeviceInfoOrBuilder getDevicesOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.ads.googleads.v10.enums.ReachPlanNetworkEnum.ReachPlanNetwork> getNetworksList();
  /**
   * <pre>
   * Targetable networks for the ad product.
   * </pre>
   ...
   */
  com.google.ads.googleads.v10.enums.ReachPlanNetworkEnum.ReachPlanNetwork getNetworks(int index);
  /**
   * <pre>
   * Targetable networks for the ad product.
   * </pre>
