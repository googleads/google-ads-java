...
public interface MutateConversionActionsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v10.services.MutateConversionActionsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v10.services.ConversionActionOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual conversion actions.
   ...
   * <code>repeated .google.ads.googleads.v10.services.ConversionActionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v10.services.ConversionActionOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual conversion actions.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v10.services.ConversionActionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v10.services.ConversionActionOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v10.services.ConversionActionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v10.services.ConversionActionOperationOrBuilder getOperationsOrBuilder(
      int index);
