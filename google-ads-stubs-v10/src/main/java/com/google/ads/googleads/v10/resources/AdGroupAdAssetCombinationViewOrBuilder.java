...
public interface AdGroupAdAssetCombinationViewOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v10.resources.AdGroupAdAssetCombinationView)
   ...
   */
  java.util.List<com.google.ads.googleads.v10.common.AssetUsage> 
      getServedAssetsList();
  /**
   * <pre>
   * Output only. Served assets.
   ...
   * <code>repeated .google.ads.googleads.v10.common.AssetUsage served_assets = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v10.common.AssetUsage getServedAssets(int index);
  /**
   * <pre>
   * Output only. Served assets.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v10.common.AssetUsage served_assets = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v10.common.AssetUsageOrBuilder> 
