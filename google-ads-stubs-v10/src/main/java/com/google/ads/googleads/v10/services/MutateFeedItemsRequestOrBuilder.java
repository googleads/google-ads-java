...
public interface MutateFeedItemsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v10.services.MutateFeedItemsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v10.services.FeedItemOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual feed items.
   ...
   * <code>repeated .google.ads.googleads.v10.services.FeedItemOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v10.services.FeedItemOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual feed items.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v10.services.FeedItemOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v10.services.FeedItemOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v10.services.FeedItemOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v10.services.FeedItemOperationOrBuilder getOperationsOrBuilder(
      int index);
