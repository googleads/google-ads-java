...
public interface ConversionValueRuleSetOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v10.resources.ConversionValueRuleSet)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v10.enums.ValueRuleSetDimensionEnum.ValueRuleSetDimension dimensions = 4;</code>
   * @return A list containing the dimensions.
   */
  java.util.List<com.google.ads.googleads.v10.enums.ValueRuleSetDimensionEnum.ValueRuleSetDimension> getDimensionsList();
  /**
   * <pre>
   * Defines dimensions for Value Rule conditions. The condition types of value
   * rules within this value rule set must be of these dimensions. The first
   ...
   */
  com.google.ads.googleads.v10.enums.ValueRuleSetDimensionEnum.ValueRuleSetDimension getDimensions(int index);
  /**
   * <pre>
   * Defines dimensions for Value Rule conditions. The condition types of value
   * rules within this value rule set must be of these dimensions. The first
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v10.enums.ValueRuleSetAttachmentTypeEnum.ValueRuleSetAttachmentType attachment_type = 6 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v10.enums.ValueRuleSetAttachmentTypeEnum.ValueRuleSetAttachmentType getAttachmentType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v10.enums.ConversionValueRuleSetStatusEnum.ConversionValueRuleSetStatus status = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v10.enums.ConversionValueRuleSetStatusEnum.ConversionValueRuleSetStatus getStatus();
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v10.enums.ConversionActionCategoryEnum.ConversionActionCategory conversion_action_categories = 9 [(.google.api.field_behavior) = IMMUTABLE];</code>
   * @return A list containing the conversionActionCategories.
   */
  java.util.List<com.google.ads.googleads.v10.enums.ConversionActionCategoryEnum.ConversionActionCategory> getConversionActionCategoriesList();
  /**
   * <pre>
   * Immutable. The conversion action categories of the conversion value rule set.
   * </pre>
   ...
   */
  com.google.ads.googleads.v10.enums.ConversionActionCategoryEnum.ConversionActionCategory getConversionActionCategories(int index);
  /**
   * <pre>
   * Immutable. The conversion action categories of the conversion value rule set.
   * </pre>
