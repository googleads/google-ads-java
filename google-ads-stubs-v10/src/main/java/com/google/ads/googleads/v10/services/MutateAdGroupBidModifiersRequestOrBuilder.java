...
public interface MutateAdGroupBidModifiersRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v10.services.MutateAdGroupBidModifiersRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v10.services.AdGroupBidModifierOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual ad group bid modifiers.
   ...
   * <code>repeated .google.ads.googleads.v10.services.AdGroupBidModifierOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v10.services.AdGroupBidModifierOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual ad group bid modifiers.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v10.services.AdGroupBidModifierOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v10.services.AdGroupBidModifierOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v10.services.AdGroupBidModifierOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v10.services.AdGroupBidModifierOperationOrBuilder getOperationsOrBuilder(
      int index);
