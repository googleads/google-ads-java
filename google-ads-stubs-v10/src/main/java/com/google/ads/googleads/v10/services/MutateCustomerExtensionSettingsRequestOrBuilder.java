...
public interface MutateCustomerExtensionSettingsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v10.services.MutateCustomerExtensionSettingsRequest)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v10.services.CustomerExtensionSettingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.ads.googleads.v10.services.CustomerExtensionSettingOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual customer extension
   ...
   * <code>repeated .google.ads.googleads.v10.services.CustomerExtensionSettingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v10.services.CustomerExtensionSettingOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual customer extension
   * settings.
   ...
   * <code>repeated .google.ads.googleads.v10.services.CustomerExtensionSettingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v10.services.CustomerExtensionSettingOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v10.services.CustomerExtensionSettingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v10.services.CustomerExtensionSettingOperationOrBuilder getOperationsOrBuilder(
      int index);
