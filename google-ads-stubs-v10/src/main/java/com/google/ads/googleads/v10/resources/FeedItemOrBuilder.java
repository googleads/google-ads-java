...
public interface FeedItemOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v10.resources.FeedItem)
   ...
   */
  java.util.List<com.google.ads.googleads.v10.resources.FeedItemAttributeValue> 
   ...
   * <code>repeated .google.ads.googleads.v10.resources.FeedItemAttributeValue attribute_values = 6;</code>
   */
  com.google.ads.googleads.v10.resources.FeedItemAttributeValue getAttributeValues(int index);
  /**
   * <pre>
   * The feed item's attribute values.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v10.resources.FeedItemAttributeValue attribute_values = 6;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v10.resources.FeedItemAttributeValueOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v10.resources.FeedItemAttributeValue attribute_values = 6;</code>
   */
  com.google.ads.googleads.v10.resources.FeedItemAttributeValueOrBuilder getAttributeValuesOrBuilder(
      int index);
   ...
   */
  com.google.ads.googleads.v10.enums.GeoTargetingRestrictionEnum.GeoTargetingRestriction getGeoTargetingRestriction();
   ...
   */
  java.util.List<com.google.ads.googleads.v10.resources.FeedItemPlaceholderPolicyInfo> 
      getPolicyInfosList();
  /**
   * <pre>
   * Output only. List of info about a feed item's validation and approval state for active
   ...
   * <code>repeated .google.ads.googleads.v10.resources.FeedItemPlaceholderPolicyInfo policy_infos = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v10.resources.FeedItemPlaceholderPolicyInfo getPolicyInfos(int index);
  /**
   * <pre>
   * Output only. List of info about a feed item's validation and approval state for active
   * feed mappings. There will be an entry in the list for each type of feed
   ...
   * <code>repeated .google.ads.googleads.v10.resources.FeedItemPlaceholderPolicyInfo policy_infos = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v10.resources.FeedItemPlaceholderPolicyInfoOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v10.resources.FeedItemPlaceholderPolicyInfo policy_infos = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v10.resources.FeedItemPlaceholderPolicyInfoOrBuilder getPolicyInfosOrBuilder(
      int index);
}
