...
public interface MutateAdGroupCriterionCustomizersRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v10.services.MutateAdGroupCriterionCustomizersRequest)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v10.services.AdGroupCriterionCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.ads.googleads.v10.services.AdGroupCriterionCustomizerOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual ad group criterion
   ...
   * <code>repeated .google.ads.googleads.v10.services.AdGroupCriterionCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v10.services.AdGroupCriterionCustomizerOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual ad group criterion
   * customizers.
   ...
   * <code>repeated .google.ads.googleads.v10.services.AdGroupCriterionCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v10.services.AdGroupCriterionCustomizerOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v10.services.AdGroupCriterionCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v10.services.AdGroupCriterionCustomizerOperationOrBuilder getOperationsOrBuilder(
      int index);
