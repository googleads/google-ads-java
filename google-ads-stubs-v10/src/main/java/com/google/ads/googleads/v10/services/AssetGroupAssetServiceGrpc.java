...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v10/services/asset_group_asset_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class AssetGroupAssetServiceGrpc {

  private AssetGroupAssetServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v10.services.AssetGroupAssetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v10.services.MutateAssetGroupAssetsRequest,
      com.google.ads.googleads.v10.services.MutateAssetGroupAssetsResponse> getMutateAssetGroupAssetsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAssetGroupAssets",
      requestType = com.google.ads.googleads.v10.services.MutateAssetGroupAssetsRequest.class,
      responseType = com.google.ads.googleads.v10.services.MutateAssetGroupAssetsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v10.services.MutateAssetGroupAssetsRequest,
      com.google.ads.googleads.v10.services.MutateAssetGroupAssetsResponse> getMutateAssetGroupAssetsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v10.services.MutateAssetGroupAssetsRequest, com.google.ads.googleads.v10.services.MutateAssetGroupAssetsResponse> getMutateAssetGroupAssetsMethod;
      ...
      synchronized (AssetGroupAssetServiceGrpc.class) {
        if ((getMutateAssetGroupAssetsMethod = AssetGroupAssetServiceGrpc.getMutateAssetGroupAssetsMethod) == null) {
          AssetGroupAssetServiceGrpc.getMutateAssetGroupAssetsMethod = getMutateAssetGroupAssetsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v10.services.MutateAssetGroupAssetsRequest, com.google.ads.googleads.v10.services.MutateAssetGroupAssetsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAssetGroupAssets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v10.services.MutateAssetGroupAssetsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v10.services.MutateAssetGroupAssetsResponse.getDefaultInstance()))
  ...
  public static abstract class AssetGroupAssetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void mutateAssetGroupAssets(com.google.ads.googleads.v10.services.MutateAssetGroupAssetsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v10.services.MutateAssetGroupAssetsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v10.services.MutateAssetGroupAssetsRequest,
                com.google.ads.googleads.v10.services.MutateAssetGroupAssetsResponse>(
  ...
  public static final class AssetGroupAssetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AssetGroupAssetServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v10.services.MutateAssetGroupAssetsResponse mutateAssetGroupAssets(com.google.ads.googleads.v10.services.MutateAssetGroupAssetsRequest request) {
  ...
  public static final class AssetGroupAssetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AssetGroupAssetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v10.services.MutateAssetGroupAssetsResponse> mutateAssetGroupAssets(
        com.google.ads.googleads.v10.services.MutateAssetGroupAssetsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MUTATE_ASSET_GROUP_ASSETS:
          serviceImpl.mutateAssetGroupAssets((com.google.ads.googleads.v10.services.MutateAssetGroupAssetsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v10.services.MutateAssetGroupAssetsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AssetGroupAssetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v10.services.AssetGroupAssetServiceProto.getDescriptor();
    }
