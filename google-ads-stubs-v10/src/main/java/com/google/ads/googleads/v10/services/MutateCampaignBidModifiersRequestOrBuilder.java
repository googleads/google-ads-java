...
public interface MutateCampaignBidModifiersRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v10.services.MutateCampaignBidModifiersRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v10.services.CampaignBidModifierOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign bid modifiers.
   ...
   * <code>repeated .google.ads.googleads.v10.services.CampaignBidModifierOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v10.services.CampaignBidModifierOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign bid modifiers.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v10.services.CampaignBidModifierOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v10.services.CampaignBidModifierOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v10.services.CampaignBidModifierOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v10.services.CampaignBidModifierOperationOrBuilder getOperationsOrBuilder(
      int index);
