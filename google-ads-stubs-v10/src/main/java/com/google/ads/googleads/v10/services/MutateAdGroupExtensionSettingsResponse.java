        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 18: {
              com.google.ads.googleads.v10.services.MutateAdGroupExtensionSettingResult m =
                  input.readMessage(
                      com.google.ads.googleads.v10.services.MutateAdGroupExtensionSettingResult.parser(),
                      extensionRegistry);
              if (resultsBuilder_ == null) {
                ensureResultsIsMutable();
                results_.add(m);
