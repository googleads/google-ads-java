...
public interface SuggestSmartCampaignAdRequestOrBuilder extends
   ...
   */
  com.google.ads.googleads.v10.services.SmartCampaignSuggestionInfo getSuggestionInfo();
  /**
   * <pre>
   * Required. Inputs used to suggest a Smart campaign ad.
   * Required fields: final_url, language_code, keyword_themes.
   ...
   * <code>.google.ads.googleads.v10.services.SmartCampaignSuggestionInfo suggestion_info = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v10.services.SmartCampaignSuggestionInfoOrBuilder getSuggestionInfoOrBuilder();
}
