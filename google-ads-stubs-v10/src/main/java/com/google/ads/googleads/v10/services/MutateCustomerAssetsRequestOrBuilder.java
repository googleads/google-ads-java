...
public interface MutateCustomerAssetsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v10.services.MutateCustomerAssetsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v10.services.CustomerAssetOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual customer assets.
   ...
   * <code>repeated .google.ads.googleads.v10.services.CustomerAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v10.services.CustomerAssetOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual customer assets.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v10.services.CustomerAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v10.services.CustomerAssetOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v10.services.CustomerAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v10.services.CustomerAssetOperationOrBuilder getOperationsOrBuilder(
      int index);
