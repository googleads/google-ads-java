...
public class CampaignExperimentServiceClientTest {
  ...
  public void graduateCampaignExperimentTest() throws Exception {
    ...
    Assert.assertEquals(campaignExperiment.toString(), actualRequest.getCampaignExperiment());
  ...
  @Test
  public void graduateCampaignExperimentTest2() throws Exception {
    GraduateCampaignExperimentResponse expectedResponse =
        GraduateCampaignExperimentResponse.newBuilder()
            .setGraduatedCampaign("graduatedCampaign-652334935")
            .build();
  ...
  @Test
  public void graduateCampaignExperimentExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockCampaignExperimentService.addException(exception);
  ...
  @Test
  public void promoteCampaignExperimentTest2() throws Exception {
    Empty expectedResponse = Empty.newBuilder().build();
    Operation resultOperation =
        Operation.newBuilder()
            .setName("promoteCampaignExperimentTest")
  ...
  @Test
  public void promoteCampaignExperimentExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockCampaignExperimentService.addException(exception);
  ...
  @Test
  public void endCampaignExperimentTest2() throws Exception {
    Empty expectedResponse = Empty.newBuilder().build();
    mockCampaignExperimentService.addResponse(expectedResponse);
  ...
  @Test
  public void endCampaignExperimentExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockCampaignExperimentService.addException(exception);
