...
public class GoogleAdsAllVersionsCodeGeneratorTest extends AbstractGeneratorTest {
  ...
  public void baseCaseGeneratedCodeMatches() throws IOException {
    assertGeneratedCodeMatches(
        "/com/google/ads/googleads/codegen/GoogleAdsAllVersions.java.expected");
  }
  ...
  protected JavaFile invokeCodeGenClass() {
    return new GoogleAdsAllVersionsCodeGenerator(versions, latestVersion, temporaryFolder.getRoot())
        .generate();
  }
}
