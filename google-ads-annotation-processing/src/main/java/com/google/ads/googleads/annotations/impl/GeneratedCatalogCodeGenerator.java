  ...
  public static void generate(
    ...
    FieldSpec supportedVersions =
        FieldSpec.builder(
                ParameterizedTypeName.get(
                    ClassName.get(ImmutableSortedSet.class),
                    VERSION_CLASS_NAME),
                "supportedVersions")
    ...
    MethodSpec constructor =
        MethodSpec.constructorBuilder()
            ...
            .addStatement(
                "supportedVersions = $T.copyOf(new $T<>(versions))",
    ...
    MethodSpec getSupportedVersions =
        MethodSpec.methodBuilder("getSupportedVersions")
            ...
            .returns(
                ParameterizedTypeName.get(
                    ClassName.get(SortedSet.class), VERSION_CLASS_NAME))
  ...
  private static TypeSpec createClient(int version, Elements elementUtils) {
    ...
    TypeSpec.Builder clientBuilder =
        TypeSpec.classBuilder("V" + version + "Client")
            .addModifiers(Modifier.PRIVATE, Modifier.STATIC)
            .addSuperinterface(
                GeneratorUtils.createServiceClientClassName(version, "GoogleAdsVersion"))
            .addField(provider)
  ...
  private static MethodSpec createServiceClient(int version, String serviceClient) {
    ...
    MethodSpec.Builder serviceBuilder =
        MethodSpec.methodBuilder("create" + serviceClient)
            ...
            .returns(GeneratorUtils.createServiceClientClassName(version, serviceClient));
    ...
    serviceBuilder.addCode(
        ""
            ...
            + "}\n",
        GeneratorUtils.createServiceClientClassName(version, noClientName + "Settings"),
        GeneratorUtils.createServiceClientClassName(version, noClientName + "Settings"),
        FixedCredentialsProvider.class,
        GeneratorUtils.createServiceClientClassName(version, serviceClient),
        IOException.class);
