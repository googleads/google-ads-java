...
import com.google.ads.googleads.v9.common.KeywordPlanAggregateMetricResults;
...
public class KeywordPlanServiceClientTest {
  ...
  @Test
  public void getKeywordPlanTest() throws Exception {
  ...
  @Test
  public void getKeywordPlanTest2() throws Exception {
    KeywordPlan expectedResponse =
        KeywordPlan.newBuilder()
            .setResourceName(KeywordPlanName.of("[CUSTOMER_ID]", "[KEYWORD_PLAN_ID]").toString())
            .setId(3355)
  ...
  @Test
  public void getKeywordPlanExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockKeywordPlanService.addException(exception);
