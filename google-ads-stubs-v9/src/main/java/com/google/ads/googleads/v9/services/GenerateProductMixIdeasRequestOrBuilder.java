...
public interface GenerateProductMixIdeasRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v9.services.GenerateProductMixIdeasRequest)
   ...
   */
  com.google.ads.googleads.v9.services.Preferences getPreferences();
  /**
   * <pre>
   * The preferences of the suggested product mix.
   * An unset preference is interpreted as all possible values are allowed,
   ...
   * <code>.google.ads.googleads.v9.services.Preferences preferences = 5;</code>
   */
  com.google.ads.googleads.v9.services.PreferencesOrBuilder getPreferencesOrBuilder();
}
