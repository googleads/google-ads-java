...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v9/services/campaign_bid_modifier_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class CampaignBidModifierServiceGrpc {

  private CampaignBidModifierServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v9.services.CampaignBidModifierService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetCampaignBidModifierRequest,
      com.google.ads.googleads.v9.resources.CampaignBidModifier> getGetCampaignBidModifierMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCampaignBidModifier",
      requestType = com.google.ads.googleads.v9.services.GetCampaignBidModifierRequest.class,
      responseType = com.google.ads.googleads.v9.resources.CampaignBidModifier.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetCampaignBidModifierRequest,
      com.google.ads.googleads.v9.resources.CampaignBidModifier> getGetCampaignBidModifierMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetCampaignBidModifierRequest, com.google.ads.googleads.v9.resources.CampaignBidModifier> getGetCampaignBidModifierMethod;
      ...
      synchronized (CampaignBidModifierServiceGrpc.class) {
        if ((getGetCampaignBidModifierMethod = CampaignBidModifierServiceGrpc.getGetCampaignBidModifierMethod) == null) {
          CampaignBidModifierServiceGrpc.getGetCampaignBidModifierMethod = getGetCampaignBidModifierMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.GetCampaignBidModifierRequest, com.google.ads.googleads.v9.resources.CampaignBidModifier>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCampaignBidModifier"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.GetCampaignBidModifierRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.resources.CampaignBidModifier.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest,
      com.google.ads.googleads.v9.services.MutateCampaignBidModifiersResponse> getMutateCampaignBidModifiersMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCampaignBidModifiers",
      requestType = com.google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest.class,
      responseType = com.google.ads.googleads.v9.services.MutateCampaignBidModifiersResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest,
      com.google.ads.googleads.v9.services.MutateCampaignBidModifiersResponse> getMutateCampaignBidModifiersMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest, com.google.ads.googleads.v9.services.MutateCampaignBidModifiersResponse> getMutateCampaignBidModifiersMethod;
      ...
      synchronized (CampaignBidModifierServiceGrpc.class) {
        if ((getMutateCampaignBidModifiersMethod = CampaignBidModifierServiceGrpc.getMutateCampaignBidModifiersMethod) == null) {
          CampaignBidModifierServiceGrpc.getMutateCampaignBidModifiersMethod = getMutateCampaignBidModifiersMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest, com.google.ads.googleads.v9.services.MutateCampaignBidModifiersResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCampaignBidModifiers"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.MutateCampaignBidModifiersResponse.getDefaultInstance()))
  ...
  public static abstract class CampaignBidModifierServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCampaignBidModifier(com.google.ads.googleads.v9.services.GetCampaignBidModifierRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.CampaignBidModifier> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetCampaignBidModifierMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    public void mutateCampaignBidModifiers(com.google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.MutateCampaignBidModifiersResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.GetCampaignBidModifierRequest,
                com.google.ads.googleads.v9.resources.CampaignBidModifier>(
                  this, METHODID_GET_CAMPAIGN_BID_MODIFIER)))
          .addMethod(
            getMutateCampaignBidModifiersMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest,
                com.google.ads.googleads.v9.services.MutateCampaignBidModifiersResponse>(
  ...
  public static final class CampaignBidModifierServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CampaignBidModifierServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.resources.CampaignBidModifier getCampaignBidModifier(com.google.ads.googleads.v9.services.GetCampaignBidModifierRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.services.MutateCampaignBidModifiersResponse mutateCampaignBidModifiers(com.google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CampaignBidModifierServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CampaignBidModifierServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.resources.CampaignBidModifier> getCampaignBidModifier(
        com.google.ads.googleads.v9.services.GetCampaignBidModifierRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.services.MutateCampaignBidModifiersResponse> mutateCampaignBidModifiers(
        com.google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CAMPAIGN_BID_MODIFIER:
          serviceImpl.getCampaignBidModifier((com.google.ads.googleads.v9.services.GetCampaignBidModifierRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.CampaignBidModifier>) responseObserver);
          break;
        case METHODID_MUTATE_CAMPAIGN_BID_MODIFIERS:
          serviceImpl.mutateCampaignBidModifiers((com.google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.MutateCampaignBidModifiersResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CampaignBidModifierServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v9.services.CampaignBidModifierServiceProto.getDescriptor();
    }
