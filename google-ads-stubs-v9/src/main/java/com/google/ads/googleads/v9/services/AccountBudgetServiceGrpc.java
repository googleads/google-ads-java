...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v9/services/account_budget_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class AccountBudgetServiceGrpc {

  private AccountBudgetServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v9.services.AccountBudgetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetAccountBudgetRequest,
      com.google.ads.googleads.v9.resources.AccountBudget> getGetAccountBudgetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAccountBudget",
      requestType = com.google.ads.googleads.v9.services.GetAccountBudgetRequest.class,
      responseType = com.google.ads.googleads.v9.resources.AccountBudget.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetAccountBudgetRequest,
      com.google.ads.googleads.v9.resources.AccountBudget> getGetAccountBudgetMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetAccountBudgetRequest, com.google.ads.googleads.v9.resources.AccountBudget> getGetAccountBudgetMethod;
      ...
      synchronized (AccountBudgetServiceGrpc.class) {
        if ((getGetAccountBudgetMethod = AccountBudgetServiceGrpc.getGetAccountBudgetMethod) == null) {
          AccountBudgetServiceGrpc.getGetAccountBudgetMethod = getGetAccountBudgetMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.GetAccountBudgetRequest, com.google.ads.googleads.v9.resources.AccountBudget>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAccountBudget"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.GetAccountBudgetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.resources.AccountBudget.getDefaultInstance()))
  ...
  public static abstract class AccountBudgetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAccountBudget(com.google.ads.googleads.v9.services.GetAccountBudgetRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.AccountBudget> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.GetAccountBudgetRequest,
                com.google.ads.googleads.v9.resources.AccountBudget>(
  ...
  public static final class AccountBudgetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AccountBudgetServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.resources.AccountBudget getAccountBudget(com.google.ads.googleads.v9.services.GetAccountBudgetRequest request) {
  ...
  public static final class AccountBudgetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AccountBudgetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.resources.AccountBudget> getAccountBudget(
        com.google.ads.googleads.v9.services.GetAccountBudgetRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ACCOUNT_BUDGET:
          serviceImpl.getAccountBudget((com.google.ads.googleads.v9.services.GetAccountBudgetRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.AccountBudget>) responseObserver);
          break;
        default:
  ...
  private static abstract class AccountBudgetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v9.services.AccountBudgetServiceProto.getDescriptor();
    }
