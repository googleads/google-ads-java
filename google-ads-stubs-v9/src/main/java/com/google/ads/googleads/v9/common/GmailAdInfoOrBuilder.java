...
public interface GmailAdInfoOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v9.common.GmailAdInfo)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v9.common.GmailTeaser teaser = 1;</code>
   ...
   * @return The teaser.
   */
  com.google.ads.googleads.v9.common.GmailTeaser getTeaser();
  /**
   * <pre>
   * The Gmail teaser.
   * </pre>
   ...
   * <code>.google.ads.googleads.v9.common.GmailTeaser teaser = 1;</code>
   */
  com.google.ads.googleads.v9.common.GmailTeaserOrBuilder getTeaserOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v9.common.DisplayCallToAction marketing_image_display_call_to_action = 6;</code>
   ...
   */
  com.google.ads.googleads.v9.common.DisplayCallToAction getMarketingImageDisplayCallToAction();
  /**
   * <pre>
   * Display-call-to-action of the marketing image.
   * </pre>
   ...
   * <code>.google.ads.googleads.v9.common.DisplayCallToAction marketing_image_display_call_to_action = 6;</code>
   */
  com.google.ads.googleads.v9.common.DisplayCallToActionOrBuilder getMarketingImageDisplayCallToActionOrBuilder();
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v9.common.ProductImage product_images = 7;</code>
   */
  java.util.List<com.google.ads.googleads.v9.common.ProductImage> 
   ...
   * <code>repeated .google.ads.googleads.v9.common.ProductImage product_images = 7;</code>
   */
  com.google.ads.googleads.v9.common.ProductImage getProductImages(int index);
  /**
   * <pre>
   * Product images. Up to 15 images are supported.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v9.common.ProductImage product_images = 7;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v9.common.ProductImageOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v9.common.ProductImage product_images = 7;</code>
   */
  com.google.ads.googleads.v9.common.ProductImageOrBuilder getProductImagesOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v9.common.ProductVideo product_videos = 8;</code>
   */
  java.util.List<com.google.ads.googleads.v9.common.ProductVideo> 
   ...
   * <code>repeated .google.ads.googleads.v9.common.ProductVideo product_videos = 8;</code>
   */
  com.google.ads.googleads.v9.common.ProductVideo getProductVideos(int index);
  /**
   * <pre>
   * Product videos. Up to 7 videos are supported. At least one product video
   * or a marketing image must be specified.
   ...
   * <code>repeated .google.ads.googleads.v9.common.ProductVideo product_videos = 8;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v9.common.ProductVideoOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v9.common.ProductVideo product_videos = 8;</code>
   */
  com.google.ads.googleads.v9.common.ProductVideoOrBuilder getProductVideosOrBuilder(
      int index);
}
