...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v9/services/smart_campaign_setting_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class SmartCampaignSettingServiceGrpc {

  private SmartCampaignSettingServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v9.services.SmartCampaignSettingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetSmartCampaignSettingRequest,
      com.google.ads.googleads.v9.resources.SmartCampaignSetting> getGetSmartCampaignSettingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetSmartCampaignSetting",
      requestType = com.google.ads.googleads.v9.services.GetSmartCampaignSettingRequest.class,
      responseType = com.google.ads.googleads.v9.resources.SmartCampaignSetting.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetSmartCampaignSettingRequest,
      com.google.ads.googleads.v9.resources.SmartCampaignSetting> getGetSmartCampaignSettingMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetSmartCampaignSettingRequest, com.google.ads.googleads.v9.resources.SmartCampaignSetting> getGetSmartCampaignSettingMethod;
      ...
      synchronized (SmartCampaignSettingServiceGrpc.class) {
        if ((getGetSmartCampaignSettingMethod = SmartCampaignSettingServiceGrpc.getGetSmartCampaignSettingMethod) == null) {
          SmartCampaignSettingServiceGrpc.getGetSmartCampaignSettingMethod = getGetSmartCampaignSettingMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.GetSmartCampaignSettingRequest, com.google.ads.googleads.v9.resources.SmartCampaignSetting>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetSmartCampaignSetting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.GetSmartCampaignSettingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.resources.SmartCampaignSetting.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsRequest,
      com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsResponse> getMutateSmartCampaignSettingsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateSmartCampaignSettings",
      requestType = com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsRequest.class,
      responseType = com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsRequest,
      com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsResponse> getMutateSmartCampaignSettingsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsRequest, com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsResponse> getMutateSmartCampaignSettingsMethod;
      ...
      synchronized (SmartCampaignSettingServiceGrpc.class) {
        if ((getMutateSmartCampaignSettingsMethod = SmartCampaignSettingServiceGrpc.getMutateSmartCampaignSettingsMethod) == null) {
          SmartCampaignSettingServiceGrpc.getMutateSmartCampaignSettingsMethod = getMutateSmartCampaignSettingsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsRequest, com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateSmartCampaignSettings"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsResponse.getDefaultInstance()))
  ...
  public static abstract class SmartCampaignSettingServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getSmartCampaignSetting(com.google.ads.googleads.v9.services.GetSmartCampaignSettingRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.SmartCampaignSetting> responseObserver) {
     ...
     * </pre>
     */
    public void mutateSmartCampaignSettings(com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.GetSmartCampaignSettingRequest,
                com.google.ads.googleads.v9.resources.SmartCampaignSetting>(
                  this, METHODID_GET_SMART_CAMPAIGN_SETTING)))
          .addMethod(
            getMutateSmartCampaignSettingsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsRequest,
                com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsResponse>(
  ...
  public static final class SmartCampaignSettingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<SmartCampaignSettingServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.resources.SmartCampaignSetting getSmartCampaignSetting(com.google.ads.googleads.v9.services.GetSmartCampaignSettingRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsResponse mutateSmartCampaignSettings(com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class SmartCampaignSettingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<SmartCampaignSettingServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.resources.SmartCampaignSetting> getSmartCampaignSetting(
        com.google.ads.googleads.v9.services.GetSmartCampaignSettingRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsResponse> mutateSmartCampaignSettings(
        com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_SMART_CAMPAIGN_SETTING:
          serviceImpl.getSmartCampaignSetting((com.google.ads.googleads.v9.services.GetSmartCampaignSettingRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.SmartCampaignSetting>) responseObserver);
          break;
        case METHODID_MUTATE_SMART_CAMPAIGN_SETTINGS:
          serviceImpl.mutateSmartCampaignSettings((com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.MutateSmartCampaignSettingsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SmartCampaignSettingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v9.services.SmartCampaignSettingServiceProto.getDescriptor();
    }
