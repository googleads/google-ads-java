...
public interface PolicyViolationDetailsOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v9.errors.PolicyViolationDetails)
   ...
   * @return The key.
   */
  com.google.ads.googleads.v9.common.PolicyViolationKey getKey();
  /**
   * <pre>
   * Unique identifier for this violation.
   * If policy is exemptible, this key may be used to request exemption.
   ...
   * <code>.google.ads.googleads.v9.common.PolicyViolationKey key = 4;</code>
   */
  com.google.ads.googleads.v9.common.PolicyViolationKeyOrBuilder getKeyOrBuilder();
