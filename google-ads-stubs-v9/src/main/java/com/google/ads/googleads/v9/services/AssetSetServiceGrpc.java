...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v9/services/asset_set_service.proto")
public final class AssetSetServiceGrpc {

  private AssetSetServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v9.services.AssetSetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateAssetSetsRequest,
      com.google.ads.googleads.v9.services.MutateAssetSetsResponse> getMutateAssetSetsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAssetSets",
      requestType = com.google.ads.googleads.v9.services.MutateAssetSetsRequest.class,
      responseType = com.google.ads.googleads.v9.services.MutateAssetSetsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateAssetSetsRequest,
      com.google.ads.googleads.v9.services.MutateAssetSetsResponse> getMutateAssetSetsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateAssetSetsRequest, com.google.ads.googleads.v9.services.MutateAssetSetsResponse> getMutateAssetSetsMethod;
      ...
      synchronized (AssetSetServiceGrpc.class) {
        if ((getMutateAssetSetsMethod = AssetSetServiceGrpc.getMutateAssetSetsMethod) == null) {
          AssetSetServiceGrpc.getMutateAssetSetsMethod = getMutateAssetSetsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.MutateAssetSetsRequest, com.google.ads.googleads.v9.services.MutateAssetSetsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAssetSets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.MutateAssetSetsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.MutateAssetSetsResponse.getDefaultInstance()))
  ...
  public static abstract class AssetSetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void mutateAssetSets(com.google.ads.googleads.v9.services.MutateAssetSetsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.MutateAssetSetsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.MutateAssetSetsRequest,
                com.google.ads.googleads.v9.services.MutateAssetSetsResponse>(
  ...
  public static final class AssetSetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AssetSetServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.services.MutateAssetSetsResponse mutateAssetSets(com.google.ads.googleads.v9.services.MutateAssetSetsRequest request) {
  ...
  public static final class AssetSetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AssetSetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.services.MutateAssetSetsResponse> mutateAssetSets(
        com.google.ads.googleads.v9.services.MutateAssetSetsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MUTATE_ASSET_SETS:
          serviceImpl.mutateAssetSets((com.google.ads.googleads.v9.services.MutateAssetSetsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.MutateAssetSetsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AssetSetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v9.services.AssetSetServiceProto.getDescriptor();
    }
