...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v9/services/feed_item_set_link_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class FeedItemSetLinkServiceGrpc {

  private FeedItemSetLinkServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v9.services.FeedItemSetLinkService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetFeedItemSetLinkRequest,
      com.google.ads.googleads.v9.resources.FeedItemSetLink> getGetFeedItemSetLinkMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetFeedItemSetLink",
      requestType = com.google.ads.googleads.v9.services.GetFeedItemSetLinkRequest.class,
      responseType = com.google.ads.googleads.v9.resources.FeedItemSetLink.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetFeedItemSetLinkRequest,
      com.google.ads.googleads.v9.resources.FeedItemSetLink> getGetFeedItemSetLinkMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetFeedItemSetLinkRequest, com.google.ads.googleads.v9.resources.FeedItemSetLink> getGetFeedItemSetLinkMethod;
      ...
      synchronized (FeedItemSetLinkServiceGrpc.class) {
        if ((getGetFeedItemSetLinkMethod = FeedItemSetLinkServiceGrpc.getGetFeedItemSetLinkMethod) == null) {
          FeedItemSetLinkServiceGrpc.getGetFeedItemSetLinkMethod = getGetFeedItemSetLinkMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.GetFeedItemSetLinkRequest, com.google.ads.googleads.v9.resources.FeedItemSetLink>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetFeedItemSetLink"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.GetFeedItemSetLinkRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.resources.FeedItemSetLink.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateFeedItemSetLinksRequest,
      com.google.ads.googleads.v9.services.MutateFeedItemSetLinksResponse> getMutateFeedItemSetLinksMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateFeedItemSetLinks",
      requestType = com.google.ads.googleads.v9.services.MutateFeedItemSetLinksRequest.class,
      responseType = com.google.ads.googleads.v9.services.MutateFeedItemSetLinksResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateFeedItemSetLinksRequest,
      com.google.ads.googleads.v9.services.MutateFeedItemSetLinksResponse> getMutateFeedItemSetLinksMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateFeedItemSetLinksRequest, com.google.ads.googleads.v9.services.MutateFeedItemSetLinksResponse> getMutateFeedItemSetLinksMethod;
      ...
      synchronized (FeedItemSetLinkServiceGrpc.class) {
        if ((getMutateFeedItemSetLinksMethod = FeedItemSetLinkServiceGrpc.getMutateFeedItemSetLinksMethod) == null) {
          FeedItemSetLinkServiceGrpc.getMutateFeedItemSetLinksMethod = getMutateFeedItemSetLinksMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.MutateFeedItemSetLinksRequest, com.google.ads.googleads.v9.services.MutateFeedItemSetLinksResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateFeedItemSetLinks"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.MutateFeedItemSetLinksRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.MutateFeedItemSetLinksResponse.getDefaultInstance()))
  ...
  public static abstract class FeedItemSetLinkServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getFeedItemSetLink(com.google.ads.googleads.v9.services.GetFeedItemSetLinkRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.FeedItemSetLink> responseObserver) {
     ...
     * </pre>
     */
    public void mutateFeedItemSetLinks(com.google.ads.googleads.v9.services.MutateFeedItemSetLinksRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.MutateFeedItemSetLinksResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.GetFeedItemSetLinkRequest,
                com.google.ads.googleads.v9.resources.FeedItemSetLink>(
                  this, METHODID_GET_FEED_ITEM_SET_LINK)))
          .addMethod(
            getMutateFeedItemSetLinksMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.MutateFeedItemSetLinksRequest,
                com.google.ads.googleads.v9.services.MutateFeedItemSetLinksResponse>(
  ...
  public static final class FeedItemSetLinkServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<FeedItemSetLinkServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.resources.FeedItemSetLink getFeedItemSetLink(com.google.ads.googleads.v9.services.GetFeedItemSetLinkRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.services.MutateFeedItemSetLinksResponse mutateFeedItemSetLinks(com.google.ads.googleads.v9.services.MutateFeedItemSetLinksRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class FeedItemSetLinkServiceFutureStub extends io.grpc.stub.AbstractFutureStub<FeedItemSetLinkServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.resources.FeedItemSetLink> getFeedItemSetLink(
        com.google.ads.googleads.v9.services.GetFeedItemSetLinkRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.services.MutateFeedItemSetLinksResponse> mutateFeedItemSetLinks(
        com.google.ads.googleads.v9.services.MutateFeedItemSetLinksRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_FEED_ITEM_SET_LINK:
          serviceImpl.getFeedItemSetLink((com.google.ads.googleads.v9.services.GetFeedItemSetLinkRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.FeedItemSetLink>) responseObserver);
          break;
        case METHODID_MUTATE_FEED_ITEM_SET_LINKS:
          serviceImpl.mutateFeedItemSetLinks((com.google.ads.googleads.v9.services.MutateFeedItemSetLinksRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.MutateFeedItemSetLinksResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class FeedItemSetLinkServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v9.services.FeedItemSetLinkServiceProto.getDescriptor();
    }
