...
public interface HistoricalMetricsOptionsOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v9.common.HistoricalMetricsOptions)
   ...
   */
  com.google.ads.googleads.v9.common.YearMonthRange getYearMonthRange();
  /**
   * <pre>
   * The year month range for historical metrics. If not specified the searches
   * will be returned for past 12 months.
   ...
   * <code>optional .google.ads.googleads.v9.common.YearMonthRange year_month_range = 1;</code>
   */
  com.google.ads.googleads.v9.common.YearMonthRangeOrBuilder getYearMonthRangeOrBuilder();
}
