...
public interface InvoiceOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v9.resources.Invoice)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v9.enums.InvoiceTypeEnum.InvoiceType type = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The type.
   */
  com.google.ads.googleads.v9.enums.InvoiceTypeEnum.InvoiceType getType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v9.common.DateRange service_date_range = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v9.common.DateRange getServiceDateRange();
  /**
   * <pre>
   * Output only. The service period date range of this invoice. The end date is inclusive.
   * </pre>
   ...
   * <code>.google.ads.googleads.v9.common.DateRange service_date_range = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v9.common.DateRangeOrBuilder getServiceDateRangeOrBuilder();
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v9.resources.Invoice.AccountBudgetSummary account_budget_summaries = 18 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.ads.googleads.v9.resources.Invoice.AccountBudgetSummary> 
   ...
   * <code>repeated .google.ads.googleads.v9.resources.Invoice.AccountBudgetSummary account_budget_summaries = 18 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v9.resources.Invoice.AccountBudgetSummary getAccountBudgetSummaries(int index);
  /**
   * <pre>
   * Output only. The list of summarized account budget information associated with this
   * invoice.
   ...
   * <code>repeated .google.ads.googleads.v9.resources.Invoice.AccountBudgetSummary account_budget_summaries = 18 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v9.resources.Invoice.AccountBudgetSummaryOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v9.resources.Invoice.AccountBudgetSummary account_budget_summaries = 18 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v9.resources.Invoice.AccountBudgetSummaryOrBuilder getAccountBudgetSummariesOrBuilder(
      int index);
}
