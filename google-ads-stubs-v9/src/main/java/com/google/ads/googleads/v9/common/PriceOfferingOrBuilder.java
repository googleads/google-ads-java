...
public interface PriceOfferingOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v9.common.PriceOffering)
   ...
   * @return The price.
   */
  com.google.ads.googleads.v9.common.Money getPrice();
  /**
   * <pre>
   * Required. The price value of the price offering.
   * </pre>
   ...
   * <code>.google.ads.googleads.v9.common.Money price = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v9.common.MoneyOrBuilder getPriceOrBuilder();
   ...
   * @return The unit.
   */
  com.google.ads.googleads.v9.enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit getUnit();
