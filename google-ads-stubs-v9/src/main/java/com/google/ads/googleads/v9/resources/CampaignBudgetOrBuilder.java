...
public interface CampaignBudgetOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v9.resources.CampaignBudget)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v9.enums.BudgetStatusEnum.BudgetStatus status = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v9.enums.BudgetStatusEnum.BudgetStatus getStatus();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v9.enums.BudgetDeliveryMethodEnum.BudgetDeliveryMethod delivery_method = 7;</code>
   ...
   */
  com.google.ads.googleads.v9.enums.BudgetDeliveryMethodEnum.BudgetDeliveryMethod getDeliveryMethod();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v9.enums.BudgetPeriodEnum.BudgetPeriod period = 13 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   * @return The period.
   */
  com.google.ads.googleads.v9.enums.BudgetPeriodEnum.BudgetPeriod getPeriod();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v9.enums.BudgetTypeEnum.BudgetType type = 18 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   * @return The type.
   */
  com.google.ads.googleads.v9.enums.BudgetTypeEnum.BudgetType getType();
}
