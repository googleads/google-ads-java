...
import com.google.ads.googleads.v9.services.stub.UserInterestServiceStub;
import com.google.ads.googleads.v9.services.stub.UserInterestServiceStubSettings;
...
public class UserInterestServiceClient implements BackgroundResource {
   ...
   * <pre>{@code
   * try (UserInterestServiceClient userInterestServiceClient = UserInterestServiceClient.create()) {
   *   String resourceName = UserInterestName.of("[CUSTOMER_ID]", "[USER_INTEREST_ID]").toString();
   *   UserInterest response = userInterestServiceClient.getUserInterest(resourceName);
   * }
   * }</pre>
   *
