...
import com.google.ads.googleads.v9.services.stub.MobileDeviceConstantServiceStub;
import com.google.ads.googleads.v9.services.stub.MobileDeviceConstantServiceStubSettings;
...
public class MobileDeviceConstantServiceClient implements BackgroundResource {
   ...
   * try (MobileDeviceConstantServiceClient mobileDeviceConstantServiceClient =
   *     MobileDeviceConstantServiceClient.create()) {
   *   String resourceName = MobileDeviceConstantName.of("[CRITERION_ID]").toString();
   *   MobileDeviceConstant response =
   *       mobileDeviceConstantServiceClient.getMobileDeviceConstant(resourceName);
   * }
   * }</pre>
