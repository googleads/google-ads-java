...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v9/services/asset_group_listing_group_filter_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class AssetGroupListingGroupFilterServiceGrpc {

  private AssetGroupListingGroupFilterServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v9.services.AssetGroupListingGroupFilterService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersRequest,
      com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersResponse> getMutateAssetGroupListingGroupFiltersMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAssetGroupListingGroupFilters",
      requestType = com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersRequest.class,
      responseType = com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersRequest,
      com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersResponse> getMutateAssetGroupListingGroupFiltersMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersRequest, com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersResponse> getMutateAssetGroupListingGroupFiltersMethod;
      ...
      synchronized (AssetGroupListingGroupFilterServiceGrpc.class) {
        if ((getMutateAssetGroupListingGroupFiltersMethod = AssetGroupListingGroupFilterServiceGrpc.getMutateAssetGroupListingGroupFiltersMethod) == null) {
          AssetGroupListingGroupFilterServiceGrpc.getMutateAssetGroupListingGroupFiltersMethod = getMutateAssetGroupListingGroupFiltersMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersRequest, com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAssetGroupListingGroupFilters"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersResponse.getDefaultInstance()))
  ...
  public static abstract class AssetGroupListingGroupFilterServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void mutateAssetGroupListingGroupFilters(com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersRequest,
                com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersResponse>(
  ...
  public static final class AssetGroupListingGroupFilterServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AssetGroupListingGroupFilterServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersResponse mutateAssetGroupListingGroupFilters(com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersRequest request) {
  ...
  public static final class AssetGroupListingGroupFilterServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AssetGroupListingGroupFilterServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersResponse> mutateAssetGroupListingGroupFilters(
        com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MUTATE_ASSET_GROUP_LISTING_GROUP_FILTERS:
          serviceImpl.mutateAssetGroupListingGroupFilters((com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AssetGroupListingGroupFilterServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v9.services.AssetGroupListingGroupFilterServiceProto.getDescriptor();
    }
