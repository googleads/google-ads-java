...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v9/services/campaign_asset_set_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class CampaignAssetSetServiceGrpc {

  private CampaignAssetSetServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v9.services.CampaignAssetSetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateCampaignAssetSetsRequest,
      com.google.ads.googleads.v9.services.MutateCampaignAssetSetsResponse> getMutateCampaignAssetSetsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCampaignAssetSets",
      requestType = com.google.ads.googleads.v9.services.MutateCampaignAssetSetsRequest.class,
      responseType = com.google.ads.googleads.v9.services.MutateCampaignAssetSetsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateCampaignAssetSetsRequest,
      com.google.ads.googleads.v9.services.MutateCampaignAssetSetsResponse> getMutateCampaignAssetSetsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateCampaignAssetSetsRequest, com.google.ads.googleads.v9.services.MutateCampaignAssetSetsResponse> getMutateCampaignAssetSetsMethod;
      ...
      synchronized (CampaignAssetSetServiceGrpc.class) {
        if ((getMutateCampaignAssetSetsMethod = CampaignAssetSetServiceGrpc.getMutateCampaignAssetSetsMethod) == null) {
          CampaignAssetSetServiceGrpc.getMutateCampaignAssetSetsMethod = getMutateCampaignAssetSetsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.MutateCampaignAssetSetsRequest, com.google.ads.googleads.v9.services.MutateCampaignAssetSetsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCampaignAssetSets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.MutateCampaignAssetSetsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.MutateCampaignAssetSetsResponse.getDefaultInstance()))
  ...
  public static abstract class CampaignAssetSetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void mutateCampaignAssetSets(com.google.ads.googleads.v9.services.MutateCampaignAssetSetsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.MutateCampaignAssetSetsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.MutateCampaignAssetSetsRequest,
                com.google.ads.googleads.v9.services.MutateCampaignAssetSetsResponse>(
  ...
  public static final class CampaignAssetSetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CampaignAssetSetServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.services.MutateCampaignAssetSetsResponse mutateCampaignAssetSets(com.google.ads.googleads.v9.services.MutateCampaignAssetSetsRequest request) {
  ...
  public static final class CampaignAssetSetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CampaignAssetSetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.services.MutateCampaignAssetSetsResponse> mutateCampaignAssetSets(
        com.google.ads.googleads.v9.services.MutateCampaignAssetSetsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MUTATE_CAMPAIGN_ASSET_SETS:
          serviceImpl.mutateCampaignAssetSets((com.google.ads.googleads.v9.services.MutateCampaignAssetSetsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.MutateCampaignAssetSetsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CampaignAssetSetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v9.services.CampaignAssetSetServiceProto.getDescriptor();
    }
