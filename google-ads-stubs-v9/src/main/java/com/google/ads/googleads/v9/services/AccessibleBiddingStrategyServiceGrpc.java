...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v9/services/accessible_bidding_strategy_service.proto")
public final class AccessibleBiddingStrategyServiceGrpc {

  private AccessibleBiddingStrategyServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v9.services.AccessibleBiddingStrategyService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetAccessibleBiddingStrategyRequest,
      com.google.ads.googleads.v9.resources.AccessibleBiddingStrategy> getGetAccessibleBiddingStrategyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAccessibleBiddingStrategy",
      requestType = com.google.ads.googleads.v9.services.GetAccessibleBiddingStrategyRequest.class,
      responseType = com.google.ads.googleads.v9.resources.AccessibleBiddingStrategy.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetAccessibleBiddingStrategyRequest,
      com.google.ads.googleads.v9.resources.AccessibleBiddingStrategy> getGetAccessibleBiddingStrategyMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetAccessibleBiddingStrategyRequest, com.google.ads.googleads.v9.resources.AccessibleBiddingStrategy> getGetAccessibleBiddingStrategyMethod;
      ...
      synchronized (AccessibleBiddingStrategyServiceGrpc.class) {
        if ((getGetAccessibleBiddingStrategyMethod = AccessibleBiddingStrategyServiceGrpc.getGetAccessibleBiddingStrategyMethod) == null) {
          AccessibleBiddingStrategyServiceGrpc.getGetAccessibleBiddingStrategyMethod = getGetAccessibleBiddingStrategyMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.GetAccessibleBiddingStrategyRequest, com.google.ads.googleads.v9.resources.AccessibleBiddingStrategy>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAccessibleBiddingStrategy"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.GetAccessibleBiddingStrategyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.resources.AccessibleBiddingStrategy.getDefaultInstance()))
  ...
  public static abstract class AccessibleBiddingStrategyServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAccessibleBiddingStrategy(com.google.ads.googleads.v9.services.GetAccessibleBiddingStrategyRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.AccessibleBiddingStrategy> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.GetAccessibleBiddingStrategyRequest,
                com.google.ads.googleads.v9.resources.AccessibleBiddingStrategy>(
  ...
  public static final class AccessibleBiddingStrategyServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AccessibleBiddingStrategyServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.resources.AccessibleBiddingStrategy getAccessibleBiddingStrategy(com.google.ads.googleads.v9.services.GetAccessibleBiddingStrategyRequest request) {
  ...
  public static final class AccessibleBiddingStrategyServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AccessibleBiddingStrategyServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.resources.AccessibleBiddingStrategy> getAccessibleBiddingStrategy(
        com.google.ads.googleads.v9.services.GetAccessibleBiddingStrategyRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ACCESSIBLE_BIDDING_STRATEGY:
          serviceImpl.getAccessibleBiddingStrategy((com.google.ads.googleads.v9.services.GetAccessibleBiddingStrategyRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.AccessibleBiddingStrategy>) responseObserver);
          break;
        default:
  ...
  private static abstract class AccessibleBiddingStrategyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v9.services.AccessibleBiddingStrategyServiceProto.getDescriptor();
    }
