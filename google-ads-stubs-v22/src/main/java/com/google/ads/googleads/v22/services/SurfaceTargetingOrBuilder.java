...
public interface SurfaceTargetingOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v22.services.SurfaceTargeting)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v22.enums.ReachPlanSurfaceEnum.ReachPlanSurface surfaces = 1;</code>
   * @return A list containing the surfaces.
   */
  java.util.List<com.google.ads.googleads.v22.enums.ReachPlanSurfaceEnum.ReachPlanSurface> getSurfacesList();
  /**
   * <pre>
   * List of surfaces available to target.
   * </pre>
   ...
   */
  com.google.ads.googleads.v22.enums.ReachPlanSurfaceEnum.ReachPlanSurface getSurfaces(int index);
  /**
   * <pre>
   * List of surfaces available to target.
   * </pre>
