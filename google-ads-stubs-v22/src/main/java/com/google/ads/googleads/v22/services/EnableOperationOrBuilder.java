...
public interface EnableOperationOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v22.services.EnableOperation)
   ...
   */
  com.google.ads.googleads.v22.services.BrandCampaignAssets getBrandAssets();
  /**
   * <pre>
   * Optional. The brand assets linked to the campaign. This field is required
   * when the value of auto_populate_brand_assets is false.
   ...
   * <code>.google.ads.googleads.v22.services.BrandCampaignAssets brand_assets = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.ads.googleads.v22.services.BrandCampaignAssetsOrBuilder getBrandAssetsOrBuilder();
