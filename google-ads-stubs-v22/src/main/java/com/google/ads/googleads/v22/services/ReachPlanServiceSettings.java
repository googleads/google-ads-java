...
public class ReachPlanServiceSettings extends ClientSettings<ReachPlanServiceSettings> {
  ...
  public UnaryCallSettings<ListPlannableUserInterestsRequest, ListPlannableUserInterestsResponse>
    ...
    return ((ReachPlanServiceStubSettings) getStubSettings()).listPlannableUserInterestsSettings();
  }
  ...
  public static class Builder extends ClientSettings.Builder<ReachPlanServiceSettings, Builder> {
    ...
    public UnaryCallSettings.Builder<
        ...
        listPlannableUserInterestsSettings() {
      return getStubSettingsBuilder().listPlannableUserInterestsSettings();
    }
