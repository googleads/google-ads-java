...
import com.google.ads.googleads.v22.services.stub.ReachPlanServiceStub;
import com.google.ads.googleads.v22.services.stub.ReachPlanServiceStubSettings;
 ...
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> listPlannableUserLists(ListPlannableUserListsRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> listPlannableUserLists(String customerId)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> listPlannableUserListsCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td><p> ListPlannableUserInterests</td>
 *      <td><p> Returns the list of plannable user interests. A plannable user interest is one that can be targeted in a reach forecast using [ReachPlanService.GenerateReachForecast][google.ads.googleads.v22.services.ReachPlanService.GenerateReachForecast].
 * <p>  List of thrown errors:   [AuthenticationError]()   [AuthorizationError]()   [FieldError]()   [HeaderError]()   [InternalError]()   [ListOperationError]()   [QuotaError]()   [RequestError]()   [StringLengthError]()</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> listPlannableUserInterests(ListPlannableUserInterestsRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> listPlannableUserInterests(String customerId)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> listPlannableUserInterestsCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *  </table>
...
public class ReachPlanServiceClient implements BackgroundResource {
   ...
   *           .setReachApplicationInfo(AdditionalApplicationInfo.newBuilder().build())
   *           .build();
   *   GenerateConversionRatesResponse response =
   ...
   *       ListPlannableLocationsRequest.newBuilder()
   *           .setReachApplicationInfo(AdditionalApplicationInfo.newBuilder().build())
   *           .build();
   ...
   * try (ReachPlanServiceClient reachPlanServiceClient = ReachPlanServiceClient.create()) {
   *   String customerId = "customerId-1581184615";
   *   ListPlannableUserListsResponse response =
   *       reachPlanServiceClient.listPlannableUserLists(customerId);
   * }
   * }</pre>
   *
   * @param customerId Required. The ID of the customer.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final ListPlannableUserListsResponse listPlannableUserLists(String customerId) {
    ListPlannableUserListsRequest request =
        ListPlannableUserListsRequest.newBuilder().setCustomerId(customerId).build();
    return listPlannableUserLists(request);
  }
   ...
   * try (ReachPlanServiceClient reachPlanServiceClient = ReachPlanServiceClient.create()) {
   *   ListPlannableUserListsRequest request =
   *       ListPlannableUserListsRequest.newBuilder()
   *           .setCustomerId("customerId-1581184615")
   *           .setCustomerReachGroup("customerReachGroup123255626")
   *           .setReachApplicationInfo(AdditionalApplicationInfo.newBuilder().build())
   *           .build();
   *   ListPlannableUserListsResponse response =
   *       reachPlanServiceClient.listPlannableUserLists(request);
   * }
   * }</pre>
   *
   * @param request The request object containing all of the parameters for the API call.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final ListPlannableUserListsResponse listPlannableUserLists(
      ListPlannableUserListsRequest request) {
    return listPlannableUserListsCallable().call(request);
  }
   ...
   *           .setReachApplicationInfo(AdditionalApplicationInfo.newBuilder().build())
   *           .build();
   *   ApiFuture<ListPlannableUserListsResponse> future =
   *       reachPlanServiceClient.listPlannableUserListsCallable().futureCall(request);
   *   // Do something.
   *   ListPlannableUserListsResponse response = future.get();
   * }
   * }</pre>
   */
  public final UnaryCallable<ListPlannableUserListsRequest, ListPlannableUserListsResponse>
      listPlannableUserListsCallable() {
    return stub.listPlannableUserListsCallable();
  }

  // AUTO-GENERATED DOCUMENTATION AND METHOD.
  /**
   * Returns the list of plannable user interests. A plannable user interest is one that can be
   * targeted in a reach forecast using
   * [ReachPlanService.GenerateReachForecast][google.ads.googleads.v22.services.ReachPlanService.GenerateReachForecast].
   *
   * <p>List of thrown errors: [AuthenticationError]() [AuthorizationError]() [FieldError]()
   * [HeaderError]() [InternalError]() [ListOperationError]() [QuotaError]() [RequestError]()
   * [StringLengthError]()
   *
   * <p>Sample code:
   *
   ...
   * try (ReachPlanServiceClient reachPlanServiceClient = ReachPlanServiceClient.create()) {
   *   String customerId = "customerId-1581184615";
   *   ListPlannableUserInterestsResponse response =
   *       reachPlanServiceClient.listPlannableUserInterests(customerId);
   * }
   * }</pre>
   *
   * @param customerId Required. The ID of the customer.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final ListPlannableUserInterestsResponse listPlannableUserInterests(String customerId) {
    ListPlannableUserInterestsRequest request =
        ListPlannableUserInterestsRequest.newBuilder().setCustomerId(customerId).build();
    return listPlannableUserInterests(request);
  }
   ...
   * try (ReachPlanServiceClient reachPlanServiceClient = ReachPlanServiceClient.create()) {
   *   ListPlannableUserInterestsRequest request =
   *       ListPlannableUserInterestsRequest.newBuilder()
   *           .setCustomerId("customerId-1581184615")
   *           .addAllUserInterestTaxonomyTypes(
   *               new ArrayList<UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType>())
   *           .setNameQuery("nameQuery1220971773")
   *           .setPathQuery("pathQuery-390491229")
   *           .setReachApplicationInfo(AdditionalApplicationInfo.newBuilder().build())
   *           .build();
   *   ListPlannableUserInterestsResponse response =
   *       reachPlanServiceClient.listPlannableUserInterests(request);
   * }
   * }</pre>
   *
   * @param request The request object containing all of the parameters for the API call.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final ListPlannableUserInterestsResponse listPlannableUserInterests(
      ListPlannableUserInterestsRequest request) {
    return listPlannableUserInterestsCallable().call(request);
  }
   ...
   *           .setReachApplicationInfo(AdditionalApplicationInfo.newBuilder().build())
   *           .build();
   *   ApiFuture<ListPlannableUserInterestsResponse> future =
   *       reachPlanServiceClient.listPlannableUserInterestsCallable().futureCall(request);
   *   // Do something.
   *   ListPlannableUserInterestsResponse response = future.get();
   * }
   * }</pre>
   */
  public final UnaryCallable<ListPlannableUserInterestsRequest, ListPlannableUserInterestsResponse>
      listPlannableUserInterestsCallable() {
    return stub.listPlannableUserInterestsCallable();
  }
