...
public interface CampaignLifecycleGoalOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v22.resources.CampaignLifecycleGoal)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v22.resources.CustomerAcquisitionGoalSettings customer_acquisition_goal_settings = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v22.resources.CustomerAcquisitionGoalSettings getCustomerAcquisitionGoalSettings();
  /**
   * <pre>
   * Output only. The customer acquisition goal settings for the campaign. The
   * customer acquisition goal is described in this article:
   ...
   * <code>.google.ads.googleads.v22.resources.CustomerAcquisitionGoalSettings customer_acquisition_goal_settings = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v22.resources.CustomerAcquisitionGoalSettingsOrBuilder getCustomerAcquisitionGoalSettingsOrBuilder();
}
