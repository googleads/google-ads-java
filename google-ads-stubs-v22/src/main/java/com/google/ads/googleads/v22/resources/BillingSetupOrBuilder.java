...
public interface BillingSetupOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v22.resources.BillingSetup)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v22.enums.BillingSetupStatusEnum.BillingSetupStatus status = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v22.enums.BillingSetupStatusEnum.BillingSetupStatus getStatus();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v22.resources.BillingSetup.PaymentsAccountInfo payments_account_info = 12 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v22.resources.BillingSetup.PaymentsAccountInfo getPaymentsAccountInfo();
  /**
   * <pre>
   * Immutable. The payments account information associated with this billing
   * setup. When setting up billing, this is used to signup with a new payments
   ...
   * <code>.google.ads.googleads.v22.resources.BillingSetup.PaymentsAccountInfo payments_account_info = 12 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.ads.googleads.v22.resources.BillingSetup.PaymentsAccountInfoOrBuilder getPaymentsAccountInfoOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v22.enums.TimeTypeEnum.TimeType start_time_type = 10 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v22.enums.TimeTypeEnum.TimeType getStartTimeType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v22.enums.TimeTypeEnum.TimeType end_time_type = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
  ...
  com.google.ads.googleads.v22.resources.BillingSetup.StartTimeCase getStartTimeCase();

  com.google.ads.googleads.v22.resources.BillingSetup.EndTimeCase getEndTimeCase();
}
