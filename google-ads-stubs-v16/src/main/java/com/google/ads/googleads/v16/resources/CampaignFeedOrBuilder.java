...
public interface CampaignFeedOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v16.resources.CampaignFeed)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v16.enums.PlaceholderTypeEnum.PlaceholderType placeholder_types = 4;</code>
   * @return A list containing the placeholderTypes.
   */
  java.util.List<com.google.ads.googleads.v16.enums.PlaceholderTypeEnum.PlaceholderType> getPlaceholderTypesList();
  /**
   * <pre>
   * Indicates which placeholder types the feed may populate under the connected
   * campaign. Required.
   ...
   */
  com.google.ads.googleads.v16.enums.PlaceholderTypeEnum.PlaceholderType getPlaceholderTypes(int index);
  /**
   * <pre>
   * Indicates which placeholder types the feed may populate under the connected
   * campaign. Required.
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v16.common.MatchingFunction matching_function = 5;</code>
   ...
   */
  com.google.ads.googleads.v16.common.MatchingFunction getMatchingFunction();
  /**
   * <pre>
   * Matching function associated with the CampaignFeed.
   * The matching function is used to filter the set of feed items selected.
   ...
   * <code>.google.ads.googleads.v16.common.MatchingFunction matching_function = 5;</code>
   */
  com.google.ads.googleads.v16.common.MatchingFunctionOrBuilder getMatchingFunctionOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v16.enums.FeedLinkStatusEnum.FeedLinkStatus status = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v16.enums.FeedLinkStatusEnum.FeedLinkStatus getStatus();
}
