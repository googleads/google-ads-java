...
public interface FeedItemSetOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v16.resources.FeedItemSet)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v16.enums.FeedItemSetStatusEnum.FeedItemSetStatus status = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v16.enums.FeedItemSetStatusEnum.FeedItemSetStatus getStatus();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v16.common.DynamicLocationSetFilter dynamic_location_set_filter = 5;</code>
   ...
   */
  com.google.ads.googleads.v16.common.DynamicLocationSetFilter getDynamicLocationSetFilter();
  /**
   * <pre>
   * Filter for dynamic location set.
   * It is only used for sets of locations.
   ...
   * <code>.google.ads.googleads.v16.common.DynamicLocationSetFilter dynamic_location_set_filter = 5;</code>
   */
  com.google.ads.googleads.v16.common.DynamicLocationSetFilterOrBuilder getDynamicLocationSetFilterOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v16.common.DynamicAffiliateLocationSetFilter dynamic_affiliate_location_set_filter = 6;</code>
   ...
   */
  com.google.ads.googleads.v16.common.DynamicAffiliateLocationSetFilter getDynamicAffiliateLocationSetFilter();
  /**
   * <pre>
   * Filter for dynamic affiliate location set.
   * This field doesn't apply generally to feed item sets. It is only used for
   ...
   * <code>.google.ads.googleads.v16.common.DynamicAffiliateLocationSetFilter dynamic_affiliate_location_set_filter = 6;</code>
   */
  com.google.ads.googleads.v16.common.DynamicAffiliateLocationSetFilterOrBuilder getDynamicAffiliateLocationSetFilterOrBuilder();

  com.google.ads.googleads.v16.resources.FeedItemSet.DynamicSetFilterCase getDynamicSetFilterCase();
}
