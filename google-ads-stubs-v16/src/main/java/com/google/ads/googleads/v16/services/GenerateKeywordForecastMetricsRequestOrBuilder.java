...
public interface GenerateKeywordForecastMetricsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v16.services.GenerateKeywordForecastMetricsRequest)
   ...
   */
  com.google.ads.googleads.v16.common.DateRange getForecastPeriod();
  /**
   * <pre>
   * The date range for the forecast. The start date must be in the future and
   * end date must be within 1 year from today. The reference timezone used is
   ...
   * <code>.google.ads.googleads.v16.common.DateRange forecast_period = 3;</code>
   */
  com.google.ads.googleads.v16.common.DateRangeOrBuilder getForecastPeriodOrBuilder();
   ...
   * @return The campaign.
   */
  com.google.ads.googleads.v16.services.CampaignToForecast getCampaign();
  /**
   * <pre>
   * Required. The campaign used in the forecast.
   * </pre>
   ...
   * <code>.google.ads.googleads.v16.services.CampaignToForecast campaign = 4 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v16.services.CampaignToForecastOrBuilder getCampaignOrBuilder();
}
