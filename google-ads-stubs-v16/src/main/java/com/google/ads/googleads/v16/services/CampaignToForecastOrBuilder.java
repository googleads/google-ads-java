...
public interface CampaignToForecastOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v16.services.CampaignToForecast)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v16.services.CriterionBidModifier geo_modifiers = 2;</code>
   */
  java.util.List<com.google.ads.googleads.v16.services.CriterionBidModifier> 
      getGeoModifiersList();
  /**
   * <pre>
   * Locations to be targeted. Locations must be unique.
   ...
   * <code>repeated .google.ads.googleads.v16.services.CriterionBidModifier geo_modifiers = 2;</code>
   */
  com.google.ads.googleads.v16.services.CriterionBidModifier getGeoModifiers(int index);
  /**
   * <pre>
   * Locations to be targeted. Locations must be unique.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v16.services.CriterionBidModifier geo_modifiers = 2;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v16.services.CriterionBidModifierOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v16.services.CriterionBidModifier geo_modifiers = 2;</code>
   */
  com.google.ads.googleads.v16.services.CriterionBidModifierOrBuilder getGeoModifiersOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v16.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork keyword_plan_network = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v16.common.KeywordInfo negative_keywords = 4;</code>
   */
   ...
   * <code>repeated .google.ads.googleads.v16.common.KeywordInfo negative_keywords = 4;</code>
   */
  com.google.ads.googleads.v16.common.KeywordInfo getNegativeKeywords(int index);
  /**
   * <pre>
   * The list of negative keywords to be used in the campaign when doing the
   * forecast.
   ...
   * <code>repeated .google.ads.googleads.v16.common.KeywordInfo negative_keywords = 4;</code>
   */
  com.google.ads.googleads.v16.common.KeywordInfoOrBuilder getNegativeKeywordsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v16.services.CampaignToForecast.CampaignBiddingStrategy bidding_strategy = 5 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   */
  com.google.ads.googleads.v16.services.CampaignToForecast.CampaignBiddingStrategy getBiddingStrategy();
  /**
   * <pre>
   * Required. The bidding strategy for the campaign.
   * </pre>
   ...
   * <code>.google.ads.googleads.v16.services.CampaignToForecast.CampaignBiddingStrategy bidding_strategy = 5 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v16.services.CampaignToForecast.CampaignBiddingStrategyOrBuilder getBiddingStrategyOrBuilder();
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v16.services.ForecastAdGroup ad_groups = 7;</code>
   */
  java.util.List<com.google.ads.googleads.v16.services.ForecastAdGroup> 
      getAdGroupsList();
  /**
   * <pre>
   * The ad groups in the new campaign to forecast.
   ...
   * <code>repeated .google.ads.googleads.v16.services.ForecastAdGroup ad_groups = 7;</code>
   */
  com.google.ads.googleads.v16.services.ForecastAdGroup getAdGroups(int index);
  /**
   * <pre>
   * The ad groups in the new campaign to forecast.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v16.services.ForecastAdGroup ad_groups = 7;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v16.services.ForecastAdGroupOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v16.services.ForecastAdGroup ad_groups = 7;</code>
   */
  com.google.ads.googleads.v16.services.ForecastAdGroupOrBuilder getAdGroupsOrBuilder(
      int index);
}
