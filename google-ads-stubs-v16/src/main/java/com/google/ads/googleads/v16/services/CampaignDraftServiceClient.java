...
import com.google.ads.googleads.v16.services.stub.CampaignDraftServiceStub;
import com.google.ads.googleads.v16.services.stub.CampaignDraftServiceStubSettings;
 ...
 * <p>  This method returns a Long Running Operation (LRO) indicating if the Promote is done. Use [Operations.GetOperation] to poll the LRO until it is done. Only a done status is returned in the response. See the status in the Campaign Draft resource to determine if the promotion was successful. If the LRO failed, use [CampaignDraftService.ListCampaignDraftAsyncErrors][google.ads.googleads.v16.services.CampaignDraftService.ListCampaignDraftAsyncErrors] to view the list of error reasons.
