...
public interface GenerateAudienceCompositionInsightsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v16.services.GenerateAudienceCompositionInsightsRequest)
   ...
   * @return The audience.
   */
  com.google.ads.googleads.v16.services.InsightsAudience getAudience();
  /**
   * <pre>
   * Required. The audience of interest for which insights are being requested.
   * </pre>
   ...
   * <code>.google.ads.googleads.v16.services.InsightsAudience audience = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v16.services.InsightsAudienceOrBuilder getAudienceOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v16.services.InsightsAudience baseline_audience = 6;</code>
   ...
   */
  com.google.ads.googleads.v16.services.InsightsAudience getBaselineAudience();
  /**
   * <pre>
   * The baseline audience to which the audience of interest is being
   * compared.
   ...
   * <code>.google.ads.googleads.v16.services.InsightsAudience baseline_audience = 6;</code>
   */
  com.google.ads.googleads.v16.services.InsightsAudienceOrBuilder getBaselineAudienceOrBuilder();
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v16.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension dimensions = 4 [(.google.api.field_behavior) = REQUIRED];</code>
   * @return A list containing the dimensions.
   */
  java.util.List<com.google.ads.googleads.v16.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension> getDimensionsList();
  /**
   * <pre>
   * Required. The audience dimensions for which composition insights should be
   * returned.
   ...
   */
  com.google.ads.googleads.v16.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension getDimensions(int index);
  /**
   * <pre>
   * Required. The audience dimensions for which composition insights should be
   * returned.
