...
import com.google.ads.googleads.v18.services.stub.GoogleAdsServiceStub;
import com.google.ads.googleads.v18.services.stub.GoogleAdsServiceStubSettings;
...
public class GoogleAdsServiceClient implements BackgroundResource {
   ...
   *           .setSearchSettings(SearchSettings.newBuilder().build())
   *           .build();
