...
public interface GraduateExperimentRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v18.services.GraduateExperimentRequest)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v18.services.CampaignBudgetMapping campaign_budget_mappings = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.ads.googleads.v18.services.CampaignBudgetMapping> 
   ...
   * <code>repeated .google.ads.googleads.v18.services.CampaignBudgetMapping campaign_budget_mappings = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v18.services.CampaignBudgetMapping getCampaignBudgetMappings(int index);
  /**
   * <pre>
   * Required. List of campaign budget mappings for graduation. Each campaign
   * that appears here will graduate, and will be assigned a new budget that is
   ...
   * <code>repeated .google.ads.googleads.v18.services.CampaignBudgetMapping campaign_budget_mappings = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v18.services.CampaignBudgetMappingOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v18.services.CampaignBudgetMapping campaign_budget_mappings = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v18.services.CampaignBudgetMappingOrBuilder getCampaignBudgetMappingsOrBuilder(
      int index);
