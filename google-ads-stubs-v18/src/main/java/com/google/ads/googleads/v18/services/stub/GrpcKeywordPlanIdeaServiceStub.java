...
import static com.google.ads.googleads.v18.services.KeywordPlanIdeaServiceClient.GenerateKeywordIdeasPagedResponse;
  ...
  private static final MethodDescriptor<
      ...
      generateKeywordHistoricalMetricsMethodDescriptor =
          MethodDescriptor
              ...
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.ads.googleads.v18.services.KeywordPlanIdeaService/GenerateKeywordHistoricalMetrics")
              .setRequestMarshaller(
  ...
  private static final MethodDescriptor<GenerateAdGroupThemesRequest, GenerateAdGroupThemesResponse>
      generateAdGroupThemesMethodDescriptor =
          MethodDescriptor.<GenerateAdGroupThemesRequest, GenerateAdGroupThemesResponse>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.ads.googleads.v18.services.KeywordPlanIdeaService/GenerateAdGroupThemes")
              .setRequestMarshaller(
  ...
  private static final MethodDescriptor<
      ...
      generateKeywordForecastMetricsMethodDescriptor =
          MethodDescriptor
              ...
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.ads.googleads.v18.services.KeywordPlanIdeaService/GenerateKeywordForecastMetrics")
              .setRequestMarshaller(
