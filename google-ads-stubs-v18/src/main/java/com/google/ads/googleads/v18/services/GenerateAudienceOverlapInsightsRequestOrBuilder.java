...
public interface GenerateAudienceOverlapInsightsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v18.services.GenerateAudienceOverlapInsightsRequest)
   ...
   */
  com.google.ads.googleads.v18.services.AudienceInsightsAttribute getPrimaryAttribute();
  /**
   * <pre>
   * Required. The audience attribute that should be intersected with all other
   * eligible audiences.  This must be an Affinity or In-Market UserInterest, an
   ...
   * <code>.google.ads.googleads.v18.services.AudienceInsightsAttribute primary_attribute = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v18.services.AudienceInsightsAttributeOrBuilder getPrimaryAttributeOrBuilder();
