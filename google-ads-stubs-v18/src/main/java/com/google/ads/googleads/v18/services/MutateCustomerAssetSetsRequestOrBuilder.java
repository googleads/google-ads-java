...
public interface MutateCustomerAssetSetsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v18.services.MutateCustomerAssetSetsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v18.services.CustomerAssetSetOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual customer asset
   ...
   * <code>repeated .google.ads.googleads.v18.services.CustomerAssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v18.services.CustomerAssetSetOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual customer asset
   * sets.
   ...
   * <code>repeated .google.ads.googleads.v18.services.CustomerAssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v18.services.CustomerAssetSetOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v18.services.CustomerAssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v18.services.CustomerAssetSetOperationOrBuilder getOperationsOrBuilder(
      int index);
