...
public interface MutateExtensionFeedItemsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v18.services.MutateExtensionFeedItemsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v18.services.ExtensionFeedItemOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual extension feed
   ...
   * <code>repeated .google.ads.googleads.v18.services.ExtensionFeedItemOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v18.services.ExtensionFeedItemOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual extension feed
   * items.
   ...
   * <code>repeated .google.ads.googleads.v18.services.ExtensionFeedItemOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v18.services.ExtensionFeedItemOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v18.services.ExtensionFeedItemOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v18.services.ExtensionFeedItemOperationOrBuilder getOperationsOrBuilder(
      int index);
