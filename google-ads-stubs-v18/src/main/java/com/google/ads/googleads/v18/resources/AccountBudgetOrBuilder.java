...
public interface AccountBudgetOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v18.resources.AccountBudget)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v18.enums.AccountBudgetStatusEnum.AccountBudgetStatus status = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v18.enums.AccountBudgetStatusEnum.AccountBudgetStatus getStatus();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v18.resources.AccountBudget.PendingAccountBudgetProposal pending_proposal = 22 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v18.resources.AccountBudget.PendingAccountBudgetProposal getPendingProposal();
  /**
   * <pre>
   * Output only. The pending proposal to modify this budget, if applicable.
   * </pre>
   ...
   * <code>.google.ads.googleads.v18.resources.AccountBudget.PendingAccountBudgetProposal pending_proposal = 22 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v18.resources.AccountBudget.PendingAccountBudgetProposalOrBuilder getPendingProposalOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v18.enums.TimeTypeEnum.TimeType proposed_end_time_type = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v18.enums.TimeTypeEnum.TimeType getProposedEndTimeType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v18.enums.TimeTypeEnum.TimeType approved_end_time_type = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v18.enums.TimeTypeEnum.TimeType getApprovedEndTimeType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v18.enums.SpendingLimitTypeEnum.SpendingLimitType proposed_spending_limit_type = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v18.enums.SpendingLimitTypeEnum.SpendingLimitType getProposedSpendingLimitType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v18.enums.SpendingLimitTypeEnum.SpendingLimitType approved_spending_limit_type = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v18.enums.SpendingLimitTypeEnum.SpendingLimitType getApprovedSpendingLimitType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v18.enums.SpendingLimitTypeEnum.SpendingLimitType adjusted_spending_limit_type = 17 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v18.enums.SpendingLimitTypeEnum.SpendingLimitType getAdjustedSpendingLimitType();

  com.google.ads.googleads.v18.resources.AccountBudget.ProposedEndTimeCase getProposedEndTimeCase();

  com.google.ads.googleads.v18.resources.AccountBudget.ApprovedEndTimeCase getApprovedEndTimeCase();

  com.google.ads.googleads.v18.resources.AccountBudget.ProposedSpendingLimitCase getProposedSpendingLimitCase();

  com.google.ads.googleads.v18.resources.AccountBudget.ApprovedSpendingLimitCase getApprovedSpendingLimitCase();

  com.google.ads.googleads.v18.resources.AccountBudget.AdjustedSpendingLimitCase getAdjustedSpendingLimitCase();
}
