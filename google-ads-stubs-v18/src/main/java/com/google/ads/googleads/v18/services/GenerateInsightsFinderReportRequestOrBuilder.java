...
public interface GenerateInsightsFinderReportRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v18.services.GenerateInsightsFinderReportRequest)
   ...
   */
  com.google.ads.googleads.v18.services.BasicInsightsAudience getBaselineAudience();
  /**
   * <pre>
   * Required. A baseline audience for this report, typically all people in a
   * region.
   ...
   * <code>.google.ads.googleads.v18.services.BasicInsightsAudience baseline_audience = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v18.services.BasicInsightsAudienceOrBuilder getBaselineAudienceOrBuilder();
   ...
   */
  com.google.ads.googleads.v18.services.BasicInsightsAudience getSpecificAudience();
  /**
   * <pre>
   * Required. The specific audience of interest for this report.  The insights
   * in the report will be based on attributes more prevalent in this audience
   ...
   * <code>.google.ads.googleads.v18.services.BasicInsightsAudience specific_audience = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v18.services.BasicInsightsAudienceOrBuilder getSpecificAudienceOrBuilder();
