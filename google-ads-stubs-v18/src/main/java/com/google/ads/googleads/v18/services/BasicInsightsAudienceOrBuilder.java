...
public interface BasicInsightsAudienceOrBuilder extends
   ...
   * <code>repeated .google.ads.googleads.v18.common.LocationInfo country_location = 1 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v18.common.LocationInfo getCountryLocation(int index);
  /**
   * <pre>
   * Required. The countries for this audience.
   * </pre>
   ...
   */
  java.util.List<com.google.ads.googleads.v18.common.UserInterestInfo> 
   ...
   * <code>repeated .google.ads.googleads.v18.common.UserInterestInfo user_interests = 5;</code>
   */
  com.google.ads.googleads.v18.common.UserInterestInfo getUserInterests(int index);
  /**
   * <pre>
   * User interests defining this audience.  Affinity and In-Market audiences
   * are supported.
   ...
   * <code>repeated .google.ads.googleads.v18.common.UserInterestInfo user_interests = 5;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v18.common.UserInterestInfoOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v18.common.UserInterestInfo user_interests = 5;</code>
   */
  com.google.ads.googleads.v18.common.UserInterestInfoOrBuilder getUserInterestsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.ads.googleads.v18.services.AudienceInsightsTopic> 
      getTopicsList();
  /**
   * <pre>
   * Topics, represented by Knowledge Graph entities and/or Product &amp; Service
   ...
   * <code>repeated .google.ads.googleads.v18.services.AudienceInsightsTopic topics = 6;</code>
   */
  com.google.ads.googleads.v18.services.AudienceInsightsTopic getTopics(int index);
  /**
   * <pre>
   * Topics, represented by Knowledge Graph entities and/or Product &amp; Service
   * categories, that this audience is interested in.
   ...
   * <code>repeated .google.ads.googleads.v18.services.AudienceInsightsTopic topics = 6;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v18.services.AudienceInsightsTopicOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v18.services.AudienceInsightsTopic topics = 6;</code>
   */
  com.google.ads.googleads.v18.services.AudienceInsightsTopicOrBuilder getTopicsOrBuilder(
      int index);
}
