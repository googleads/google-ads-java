...
public interface CustomizerAttributeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v18.resources.CustomizerAttribute)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v18.enums.CustomizerAttributeTypeEnum.CustomizerAttributeType type = 4 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   * @return The type.
   */
  com.google.ads.googleads.v18.enums.CustomizerAttributeTypeEnum.CustomizerAttributeType getType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v18.enums.CustomizerAttributeStatusEnum.CustomizerAttributeStatus status = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v18.enums.CustomizerAttributeStatusEnum.CustomizerAttributeStatus getStatus();
}
