...
public class CampaignAggregateAssetViewName implements ResourceName {
  private static final PathTemplate CUSTOMER_ID_CAMPAIGN_ID_ASSET_ID_ASSET_LINK_SOURCE_FIELD_TYPE =
  ...
  private CampaignAggregateAssetViewName(Builder builder) {
    ...
    assetLinkSource = Preconditions.checkNotNull(builder.getAssetLinkSource());
  ...
  public static CampaignAggregateAssetViewName of(
      String customerId,
      String campaignId,
      String assetId,
      String assetLinkSource,
      String fieldType) {
    return newBuilder()
        .setCustomerId(customerId)
        .setCampaignId(campaignId)
        .setAssetId(assetId)
        .setAssetLinkSource(assetLinkSource)
  ...
  public static CampaignAggregateAssetViewName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_ID_CAMPAIGN_ID_ASSET_ID_ASSET_LINK_SOURCE_FIELD_TYPE.validatedMatch(
            formattedString,
            "CampaignAggregateAssetViewName.parse: formattedString not in valid format");
    return of(
        matchMap.get("customer_id"),
        matchMap.get("campaign_id"),
        matchMap.get("asset_id"),
        matchMap.get("asset_link_source"),
        matchMap.get("field_type"));
  }

  public static List<CampaignAggregateAssetViewName> parseList(List<String> formattedStrings) {
    List<CampaignAggregateAssetViewName> list = new ArrayList<>(formattedStrings.size());
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (assetLinkSource != null) {
            fieldMapBuilder.put("asset_link_source", assetLinkSource);
          }
          if (fieldType != null) {
  ...
  public String toString() {
    return CUSTOMER_ID_CAMPAIGN_ID_ASSET_ID_ASSET_LINK_SOURCE_FIELD_TYPE.instantiate(
        "customer_id",
        customerId,
        "campaign_id",
        campaignId,
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.customerId, that.customerId)
          ...
          && Objects.equals(this.assetLinkSource, that.assetLinkSource)
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(assetLinkSource);
    h *= 1000003;
