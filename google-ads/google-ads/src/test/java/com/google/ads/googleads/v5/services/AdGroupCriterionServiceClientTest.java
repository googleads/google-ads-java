...
public class AdGroupCriterionServiceClientTest {
  ...
  public void getAdGroupCriterionTest() {
    com.google.ads.googleads.v5.services.AdGroupCriterionName resourceName2 =
        com.google.ads.googleads.v5.services.AdGroupCriterionName.of(
            "[CUSTOMER]", "[AD_GROUP_CRITERION]");
    long criterionId = 326773895L;
    AdGroupName adGroup = AdGroupName.of("[CUSTOMER]", "[AD_GROUP]");
    boolean negative = false;
    double bidModifier = 1.36236335E8;
    long cpcBidMicros = 909381114L;
    long cpmBidMicros = 2094758992L;
    long cpvBidMicros = 933014521L;
    long percentCpcBidMicros = 2098488628L;
    long effectiveCpcBidMicros = 1373966446L;
    long effectiveCpmBidMicros = 83139256L;
    long effectiveCpvBidMicros = 1078605215L;
    long effectivePercentCpcBidMicros = 584306996L;
    ...
    AdGroupCriterion expectedResponse =
        AdGroupCriterion.newBuilder()
            ...
            .setAdGroup(adGroup.toString())
            .setNegative(negative)
            .setBidModifier(bidModifier)
            .setCpcBidMicros(cpcBidMicros)
            .setCpmBidMicros(cpmBidMicros)
            .setCpvBidMicros(cpvBidMicros)
            .setPercentCpcBidMicros(percentCpcBidMicros)
            .setEffectiveCpcBidMicros(effectiveCpcBidMicros)
            .setEffectiveCpmBidMicros(effectiveCpmBidMicros)
            .setEffectiveCpvBidMicros(effectiveCpvBidMicros)
            .setEffectivePercentCpcBidMicros(effectivePercentCpcBidMicros)
    ...
    Assert.assertEquals(resourceName, AdGroupCriterionName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
