...
import com.google.ads.googleads.v5.resources.CustomerLabel;
...
public class CustomerLabelServiceClientTest {
  ...
  public void getCustomerLabelTest() {
    com.google.ads.googleads.v5.services.CustomerLabelName resourceName2 =
        com.google.ads.googleads.v5.services.CustomerLabelName.of(
            "[CUSTOMER]", "[CUSTOMER_LABEL]");
    CustomerLabel expectedResponse =
        CustomerLabel.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, CustomerLabelName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCustomerLabelsTest() {
    MutateCustomerLabelsResponse expectedResponse =
        MutateCustomerLabelsResponse.newBuilder().build();
    mockCustomerLabelService.addResponse(expectedResponse);
