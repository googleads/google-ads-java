...
public class ProductGroupViewServiceClientTest {
  ...
  public void getProductGroupViewTest() {
    com.google.ads.googleads.v5.services.ProductGroupViewName resourceName2 =
        com.google.ads.googleads.v5.services.ProductGroupViewName.of(
            "[CUSTOMER]", "[PRODUCT_GROUP_VIEW]");
    ProductGroupView expectedResponse =
        ProductGroupView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, ProductGroupViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
