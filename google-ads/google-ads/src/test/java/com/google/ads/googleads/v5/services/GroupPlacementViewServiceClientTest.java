...
public class GroupPlacementViewServiceClientTest {
  ...
  public void getGroupPlacementViewTest() {
    com.google.ads.googleads.v5.services.GroupPlacementViewName resourceName2 =
        com.google.ads.googleads.v5.services.GroupPlacementViewName.of(
            "[CUSTOMER]", "[GROUP_PLACEMENT_VIEW]");
    GroupPlacementView expectedResponse =
        GroupPlacementView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, GroupPlacementViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
