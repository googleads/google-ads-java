...
public class CampaignDraftServiceClientTest {
  ...
  public void getCampaignDraftTest() {
    com.google.ads.googleads.v5.services.CampaignDraftName resourceName2 =
        com.google.ads.googleads.v5.services.CampaignDraftName.of(
            "[CUSTOMER]", "[CAMPAIGN_DRAFT]");
    CampaignDraft expectedResponse =
        CampaignDraft.newBuilder().setResourceName(resourceName2.toString()).build();
