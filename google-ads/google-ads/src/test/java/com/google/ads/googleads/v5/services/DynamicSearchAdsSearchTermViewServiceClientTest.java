...
import com.google.ads.googleads.v5.resources.DynamicSearchAdsSearchTermView;
...
public class DynamicSearchAdsSearchTermViewServiceClientTest {
  ...
  public void getDynamicSearchAdsSearchTermViewTest() {
    com.google.ads.googleads.v5.services.DynamicSearchAdsSearchTermViewName resourceName2 =
        com.google.ads.googleads.v5.services.DynamicSearchAdsSearchTermViewName.of(
            "[CUSTOMER]", "[DYNAMIC_SEARCH_ADS_SEARCH_TERM_VIEW]");
    String searchTerm = "searchTerm-539238237";
    String headline = "headline-1115058732";
    String landingPage = "landingPage-1755408457";
    String pageUrl = "pageUrl859797439";
    boolean hasNegativeKeyword = true;
    boolean hasMatchingKeyword = true;
    boolean hasNegativeUrl = true;
    DynamicSearchAdsSearchTermView expectedResponse =
        DynamicSearchAdsSearchTermView.newBuilder()
            ...
            .setPageUrl(pageUrl)
            .setHasNegativeKeyword(hasNegativeKeyword)
            .setHasMatchingKeyword(hasMatchingKeyword)
            .setHasNegativeUrl(hasNegativeUrl)
            .build();
    ...
    Assert.assertEquals(
        resourceName, DynamicSearchAdsSearchTermViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
