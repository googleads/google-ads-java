...
public class GenderViewServiceClientTest {
  ...
  public void getGenderViewTest() {
    com.google.ads.googleads.v5.services.GenderViewName resourceName2 =
        com.google.ads.googleads.v5.services.GenderViewName.of("[CUSTOMER]", "[GENDER_VIEW]");
    GenderView expectedResponse =
        GenderView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, GenderViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
