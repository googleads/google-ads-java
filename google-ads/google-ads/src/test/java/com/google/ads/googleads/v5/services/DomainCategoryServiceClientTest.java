...
public class DomainCategoryServiceClientTest {
  ...
  public void getDomainCategoryTest() {
    com.google.ads.googleads.v5.services.DomainCategoryName resourceName2 =
        com.google.ads.googleads.v5.services.DomainCategoryName.of(
            "[CUSTOMER]", "[DOMAIN_CATEGORY]");
    CampaignName campaign = CampaignName.of("[CUSTOMER]", "[CAMPAIGN]");
    String category = "category50511102";
    String languageCode = "languageCode-412800396";
    String domain = "domain-1326197564";
    double coverageFraction = -1.8111113E8;
    long categoryRank = 338802381L;
    boolean hasChildren = true;
    long recommendedCpcBidMicros = 1202568286L;
    DomainCategory expectedResponse =
        DomainCategory.newBuilder()
            ...
            .setDomain(domain)
            .setCoverageFraction(coverageFraction)
            .setCategoryRank(categoryRank)
            .setHasChildren(hasChildren)
            .setRecommendedCpcBidMicros(recommendedCpcBidMicros)
            .build();
    ...
    Assert.assertEquals(resourceName, DomainCategoryName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
