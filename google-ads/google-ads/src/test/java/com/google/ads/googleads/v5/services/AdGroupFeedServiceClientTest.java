...
public class AdGroupFeedServiceClientTest {
  ...
  public void getAdGroupFeedTest() {
    com.google.ads.googleads.v5.services.AdGroupFeedName resourceName2 =
        com.google.ads.googleads.v5.services.AdGroupFeedName.of("[CUSTOMER]", "[AD_GROUP_FEED]");
    AdGroupFeed expectedResponse =
        AdGroupFeed.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, AdGroupFeedName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateAdGroupFeedsTest() {
    MutateAdGroupFeedsResponse expectedResponse = MutateAdGroupFeedsResponse.newBuilder().build();
    mockAdGroupFeedService.addResponse(expectedResponse);
