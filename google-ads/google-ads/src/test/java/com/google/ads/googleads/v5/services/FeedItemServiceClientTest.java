...
public class FeedItemServiceClientTest {
  ...
  public void getFeedItemTest() {
    com.google.ads.googleads.v5.services.FeedItemName resourceName2 =
        com.google.ads.googleads.v5.services.FeedItemName.of("[CUSTOMER]", "[FEED_ITEM]");
    FeedItem expectedResponse =
        FeedItem.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, FeedItemName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
