...
public class KeywordPlanCampaignKeywordServiceClientTest {
  ...
  public void getKeywordPlanCampaignKeywordTest() {
    com.google.ads.googleads.v5.services.KeywordPlanCampaignKeywordName resourceName2 =
        com.google.ads.googleads.v5.services.KeywordPlanCampaignKeywordName.of(
            "[CUSTOMER]", "[KEYWORD_PLAN_CAMPAIGN_KEYWORD]");
    KeywordPlanCampaignKeyword expectedResponse =
        KeywordPlanCampaignKeyword.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, KeywordPlanCampaignKeywordName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateKeywordPlanCampaignKeywordsTest() {
    MutateKeywordPlanCampaignKeywordsResponse expectedResponse =
        MutateKeywordPlanCampaignKeywordsResponse.newBuilder().build();
    mockKeywordPlanCampaignKeywordService.addResponse(expectedResponse);
