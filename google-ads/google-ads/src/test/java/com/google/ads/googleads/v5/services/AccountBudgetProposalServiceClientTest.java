...
public class AccountBudgetProposalServiceClientTest {
  ...
  public void getAccountBudgetProposalTest() {
    com.google.ads.googleads.v5.services.AccountBudgetProposalName resourceName2 =
        com.google.ads.googleads.v5.services.AccountBudgetProposalName.of(
            "[CUSTOMER]", "[ACCOUNT_BUDGET_PROPOSAL]");
    AccountBudgetProposal expectedResponse =
        AccountBudgetProposal.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, AccountBudgetProposalName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
