...
public class FeedItemTargetServiceClientTest {
  ...
  public void getFeedItemTargetTest() {
    com.google.ads.googleads.v5.services.FeedItemTargetName resourceName2 =
        com.google.ads.googleads.v5.services.FeedItemTargetName.of(
            "[CUSTOMER]", "[FEED_ITEM_TARGET]");
    FeedItemTarget expectedResponse =
        FeedItemTarget.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, FeedItemTargetName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateFeedItemTargetsTest() {
    MutateFeedItemTargetsResponse expectedResponse =
        MutateFeedItemTargetsResponse.newBuilder().build();
    mockFeedItemTargetService.addResponse(expectedResponse);
