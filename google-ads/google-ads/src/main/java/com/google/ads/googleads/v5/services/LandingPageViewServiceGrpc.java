...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/landing_page_view_service.proto")
public final class LandingPageViewServiceGrpc {

  private LandingPageViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.LandingPageViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetLandingPageViewRequest,
      com.google.ads.googleads.v5.resources.LandingPageView> getGetLandingPageViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetLandingPageView",
      requestType = com.google.ads.googleads.v5.services.GetLandingPageViewRequest.class,
      responseType = com.google.ads.googleads.v5.resources.LandingPageView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetLandingPageViewRequest,
      com.google.ads.googleads.v5.resources.LandingPageView> getGetLandingPageViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetLandingPageViewRequest, com.google.ads.googleads.v5.resources.LandingPageView> getGetLandingPageViewMethod;
      ...
      synchronized (LandingPageViewServiceGrpc.class) {
        if ((getGetLandingPageViewMethod = LandingPageViewServiceGrpc.getGetLandingPageViewMethod) == null) {
          LandingPageViewServiceGrpc.getGetLandingPageViewMethod = getGetLandingPageViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetLandingPageViewRequest, com.google.ads.googleads.v5.resources.LandingPageView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetLandingPageView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetLandingPageViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.LandingPageView.getDefaultInstance()))
  ...
  public static abstract class LandingPageViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getLandingPageView(com.google.ads.googleads.v5.services.GetLandingPageViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.LandingPageView> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetLandingPageViewRequest,
                com.google.ads.googleads.v5.resources.LandingPageView>(
  ...
  public static final class LandingPageViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<LandingPageViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.LandingPageView getLandingPageView(com.google.ads.googleads.v5.services.GetLandingPageViewRequest request) {
  ...
  public static final class LandingPageViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<LandingPageViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.LandingPageView> getLandingPageView(
        com.google.ads.googleads.v5.services.GetLandingPageViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_LANDING_PAGE_VIEW:
          serviceImpl.getLandingPageView((com.google.ads.googleads.v5.services.GetLandingPageViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.LandingPageView>) responseObserver);
          break;
        default:
  ...
  private static abstract class LandingPageViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.LandingPageViewServiceProto.getDescriptor();
    }
