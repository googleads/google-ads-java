...
public interface MobileDeviceConstantOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v5.resources.MobileDeviceConstant)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v5.enums.MobileDeviceTypeEnum.MobileDeviceType type = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The type.
   */
  com.google.ads.googleads.v5.enums.MobileDeviceTypeEnum.MobileDeviceType getType();
}
