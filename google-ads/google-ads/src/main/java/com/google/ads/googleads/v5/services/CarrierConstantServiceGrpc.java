...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/carrier_constant_service.proto")
public final class CarrierConstantServiceGrpc {

  private CarrierConstantServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.CarrierConstantService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCarrierConstantRequest,
      com.google.ads.googleads.v5.resources.CarrierConstant> getGetCarrierConstantMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCarrierConstant",
      requestType = com.google.ads.googleads.v5.services.GetCarrierConstantRequest.class,
      responseType = com.google.ads.googleads.v5.resources.CarrierConstant.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCarrierConstantRequest,
      com.google.ads.googleads.v5.resources.CarrierConstant> getGetCarrierConstantMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCarrierConstantRequest, com.google.ads.googleads.v5.resources.CarrierConstant> getGetCarrierConstantMethod;
      ...
      synchronized (CarrierConstantServiceGrpc.class) {
        if ((getGetCarrierConstantMethod = CarrierConstantServiceGrpc.getGetCarrierConstantMethod) == null) {
          CarrierConstantServiceGrpc.getGetCarrierConstantMethod = getGetCarrierConstantMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetCarrierConstantRequest, com.google.ads.googleads.v5.resources.CarrierConstant>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCarrierConstant"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetCarrierConstantRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.CarrierConstant.getDefaultInstance()))
  ...
  public static abstract class CarrierConstantServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCarrierConstant(com.google.ads.googleads.v5.services.GetCarrierConstantRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.CarrierConstant> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetCarrierConstantRequest,
                com.google.ads.googleads.v5.resources.CarrierConstant>(
  ...
  public static final class CarrierConstantServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CarrierConstantServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.CarrierConstant getCarrierConstant(com.google.ads.googleads.v5.services.GetCarrierConstantRequest request) {
  ...
  public static final class CarrierConstantServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CarrierConstantServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.CarrierConstant> getCarrierConstant(
        com.google.ads.googleads.v5.services.GetCarrierConstantRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CARRIER_CONSTANT:
          serviceImpl.getCarrierConstant((com.google.ads.googleads.v5.services.GetCarrierConstantRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.CarrierConstant>) responseObserver);
          break;
        default:
  ...
  private static abstract class CarrierConstantServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.CarrierConstantServiceProto.getDescriptor();
    }
