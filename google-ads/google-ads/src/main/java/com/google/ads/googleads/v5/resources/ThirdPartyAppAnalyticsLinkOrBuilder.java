...
public interface ThirdPartyAppAnalyticsLinkOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v5.resources.ThirdPartyAppAnalyticsLink)
   ...
   */
  com.google.protobuf.StringValue getShareableLinkId();
  /**
   * <pre>
   * Output only. The shareable link ID that should be provided to the third party when
   * setting up app analytics. This is able to be regenerated using regenerate
   ...
   * <code>.google.protobuf.StringValue shareable_link_id = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.protobuf.StringValueOrBuilder getShareableLinkIdOrBuilder();
}
