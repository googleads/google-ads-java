...
public interface DateSpecificRuleUserListInfoOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v5.common.DateSpecificRuleUserListInfo)
   ...
   * @return The rule.
   */
  com.google.ads.googleads.v5.common.UserListRuleInfo getRule();
  /**
   * <pre>
   * Boolean rule that defines visitor of a page.
   * Required for creating a date specific rule user list.
   ...
   * <code>.google.ads.googleads.v5.common.UserListRuleInfo rule = 1;</code>
   */
  com.google.ads.googleads.v5.common.UserListRuleInfoOrBuilder getRuleOrBuilder();
