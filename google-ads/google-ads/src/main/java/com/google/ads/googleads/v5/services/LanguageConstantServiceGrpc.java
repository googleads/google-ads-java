...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/language_constant_service.proto")
public final class LanguageConstantServiceGrpc {

  private LanguageConstantServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.LanguageConstantService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetLanguageConstantRequest,
      com.google.ads.googleads.v5.resources.LanguageConstant> getGetLanguageConstantMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetLanguageConstant",
      requestType = com.google.ads.googleads.v5.services.GetLanguageConstantRequest.class,
      responseType = com.google.ads.googleads.v5.resources.LanguageConstant.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetLanguageConstantRequest,
      com.google.ads.googleads.v5.resources.LanguageConstant> getGetLanguageConstantMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetLanguageConstantRequest, com.google.ads.googleads.v5.resources.LanguageConstant> getGetLanguageConstantMethod;
      ...
      synchronized (LanguageConstantServiceGrpc.class) {
        if ((getGetLanguageConstantMethod = LanguageConstantServiceGrpc.getGetLanguageConstantMethod) == null) {
          LanguageConstantServiceGrpc.getGetLanguageConstantMethod = getGetLanguageConstantMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetLanguageConstantRequest, com.google.ads.googleads.v5.resources.LanguageConstant>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetLanguageConstant"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetLanguageConstantRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.LanguageConstant.getDefaultInstance()))
  ...
  public static abstract class LanguageConstantServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getLanguageConstant(com.google.ads.googleads.v5.services.GetLanguageConstantRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.LanguageConstant> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetLanguageConstantRequest,
                com.google.ads.googleads.v5.resources.LanguageConstant>(
  ...
  public static final class LanguageConstantServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<LanguageConstantServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.LanguageConstant getLanguageConstant(com.google.ads.googleads.v5.services.GetLanguageConstantRequest request) {
  ...
  public static final class LanguageConstantServiceFutureStub extends io.grpc.stub.AbstractFutureStub<LanguageConstantServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.LanguageConstant> getLanguageConstant(
        com.google.ads.googleads.v5.services.GetLanguageConstantRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_LANGUAGE_CONSTANT:
          serviceImpl.getLanguageConstant((com.google.ads.googleads.v5.services.GetLanguageConstantRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.LanguageConstant>) responseObserver);
          break;
        default:
  ...
  private static abstract class LanguageConstantServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.LanguageConstantServiceProto.getDescriptor();
    }
