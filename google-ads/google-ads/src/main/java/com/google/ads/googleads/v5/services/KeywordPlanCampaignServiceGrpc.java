...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/keyword_plan_campaign_service.proto")
public final class KeywordPlanCampaignServiceGrpc {

  private KeywordPlanCampaignServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.KeywordPlanCampaignService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetKeywordPlanCampaignRequest,
      com.google.ads.googleads.v5.resources.KeywordPlanCampaign> getGetKeywordPlanCampaignMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetKeywordPlanCampaign",
      requestType = com.google.ads.googleads.v5.services.GetKeywordPlanCampaignRequest.class,
      responseType = com.google.ads.googleads.v5.resources.KeywordPlanCampaign.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetKeywordPlanCampaignRequest,
      com.google.ads.googleads.v5.resources.KeywordPlanCampaign> getGetKeywordPlanCampaignMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetKeywordPlanCampaignRequest, com.google.ads.googleads.v5.resources.KeywordPlanCampaign> getGetKeywordPlanCampaignMethod;
      ...
      synchronized (KeywordPlanCampaignServiceGrpc.class) {
        if ((getGetKeywordPlanCampaignMethod = KeywordPlanCampaignServiceGrpc.getGetKeywordPlanCampaignMethod) == null) {
          KeywordPlanCampaignServiceGrpc.getGetKeywordPlanCampaignMethod = getGetKeywordPlanCampaignMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetKeywordPlanCampaignRequest, com.google.ads.googleads.v5.resources.KeywordPlanCampaign>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetKeywordPlanCampaign"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetKeywordPlanCampaignRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.KeywordPlanCampaign.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsRequest,
      com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsResponse> getMutateKeywordPlanCampaignsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateKeywordPlanCampaigns",
      requestType = com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsRequest.class,
      responseType = com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsRequest,
      com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsResponse> getMutateKeywordPlanCampaignsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsRequest, com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsResponse> getMutateKeywordPlanCampaignsMethod;
      ...
      synchronized (KeywordPlanCampaignServiceGrpc.class) {
        if ((getMutateKeywordPlanCampaignsMethod = KeywordPlanCampaignServiceGrpc.getMutateKeywordPlanCampaignsMethod) == null) {
          KeywordPlanCampaignServiceGrpc.getMutateKeywordPlanCampaignsMethod = getMutateKeywordPlanCampaignsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsRequest, com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateKeywordPlanCampaigns"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsResponse.getDefaultInstance()))
  ...
  public static abstract class KeywordPlanCampaignServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getKeywordPlanCampaign(com.google.ads.googleads.v5.services.GetKeywordPlanCampaignRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.KeywordPlanCampaign> responseObserver) {
     ...
     * </pre>
     */
    public void mutateKeywordPlanCampaigns(com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetKeywordPlanCampaignRequest,
                com.google.ads.googleads.v5.resources.KeywordPlanCampaign>(
                  this, METHODID_GET_KEYWORD_PLAN_CAMPAIGN)))
          .addMethod(
            getMutateKeywordPlanCampaignsMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsRequest,
                com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsResponse>(
  ...
  public static final class KeywordPlanCampaignServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<KeywordPlanCampaignServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.KeywordPlanCampaign getKeywordPlanCampaign(com.google.ads.googleads.v5.services.GetKeywordPlanCampaignRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsResponse mutateKeywordPlanCampaigns(com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsRequest request) {
      return blockingUnaryCall(
  ...
  public static final class KeywordPlanCampaignServiceFutureStub extends io.grpc.stub.AbstractFutureStub<KeywordPlanCampaignServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.KeywordPlanCampaign> getKeywordPlanCampaign(
        com.google.ads.googleads.v5.services.GetKeywordPlanCampaignRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsResponse> mutateKeywordPlanCampaigns(
        com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_KEYWORD_PLAN_CAMPAIGN:
          serviceImpl.getKeywordPlanCampaign((com.google.ads.googleads.v5.services.GetKeywordPlanCampaignRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.KeywordPlanCampaign>) responseObserver);
          break;
        case METHODID_MUTATE_KEYWORD_PLAN_CAMPAIGNS:
          serviceImpl.mutateKeywordPlanCampaigns((com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class KeywordPlanCampaignServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.KeywordPlanCampaignServiceProto.getDescriptor();
    }
