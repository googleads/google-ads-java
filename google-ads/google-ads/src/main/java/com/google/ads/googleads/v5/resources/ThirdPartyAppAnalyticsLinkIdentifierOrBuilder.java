...
public interface ThirdPartyAppAnalyticsLinkIdentifierOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v5.resources.ThirdPartyAppAnalyticsLinkIdentifier)
   ...
   */
  com.google.protobuf.Int64Value getAppAnalyticsProviderId();
  /**
   * <pre>
   * Immutable. The ID of the app analytics provider.
   * This field should not be empty when creating a new third
   ...
   * <code>.google.protobuf.Int64Value app_analytics_provider_id = 1 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.protobuf.Int64ValueOrBuilder getAppAnalyticsProviderIdOrBuilder();
   ...
   */
  com.google.ads.googleads.v5.enums.MobileAppVendorEnum.MobileAppVendor getAppVendor();
}
