...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/user_location_view_service.proto")
public final class UserLocationViewServiceGrpc {

  private UserLocationViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.UserLocationViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetUserLocationViewRequest,
      com.google.ads.googleads.v5.resources.UserLocationView> getGetUserLocationViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetUserLocationView",
      requestType = com.google.ads.googleads.v5.services.GetUserLocationViewRequest.class,
      responseType = com.google.ads.googleads.v5.resources.UserLocationView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetUserLocationViewRequest,
      com.google.ads.googleads.v5.resources.UserLocationView> getGetUserLocationViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetUserLocationViewRequest, com.google.ads.googleads.v5.resources.UserLocationView> getGetUserLocationViewMethod;
      ...
      synchronized (UserLocationViewServiceGrpc.class) {
        if ((getGetUserLocationViewMethod = UserLocationViewServiceGrpc.getGetUserLocationViewMethod) == null) {
          UserLocationViewServiceGrpc.getGetUserLocationViewMethod = getGetUserLocationViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetUserLocationViewRequest, com.google.ads.googleads.v5.resources.UserLocationView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetUserLocationView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetUserLocationViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.UserLocationView.getDefaultInstance()))
  ...
  public static abstract class UserLocationViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getUserLocationView(com.google.ads.googleads.v5.services.GetUserLocationViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.UserLocationView> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetUserLocationViewRequest,
                com.google.ads.googleads.v5.resources.UserLocationView>(
  ...
  public static final class UserLocationViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<UserLocationViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.UserLocationView getUserLocationView(com.google.ads.googleads.v5.services.GetUserLocationViewRequest request) {
  ...
  public static final class UserLocationViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<UserLocationViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.UserLocationView> getUserLocationView(
        com.google.ads.googleads.v5.services.GetUserLocationViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_USER_LOCATION_VIEW:
          serviceImpl.getUserLocationView((com.google.ads.googleads.v5.services.GetUserLocationViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.UserLocationView>) responseObserver);
          break;
        default:
  ...
  private static abstract class UserLocationViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.UserLocationViewServiceProto.getDescriptor();
    }
