...
public interface LocalAdInfoOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v5.common.LocalAdInfo)
   ...
   * <code>repeated .google.ads.googleads.v5.common.AdTextAsset call_to_actions = 3;</code>
   */
  com.google.ads.googleads.v5.common.AdTextAsset getCallToActions(int index);
  /**
   * <pre>
   * List of text assets for call-to-actions. When the ad serves the
   * call-to-actions will be selected from this list. Call-to-actions are
   ...
   * <code>repeated .google.ads.googleads.v5.common.AdTextAsset call_to_actions = 3;</code>
   */
  com.google.ads.googleads.v5.common.AdTextAssetOrBuilder getCallToActionsOrBuilder(
      int index);
   ...
   * <code>repeated .google.ads.googleads.v5.common.AdVideoAsset videos = 6;</code>
   */
  com.google.ads.googleads.v5.common.AdVideoAsset getVideos(int index);
  /**
   * <pre>
   * List of YouTube video assets that may be displayed with the ad. Videos
   * are optional and at most 20 can be specified.
   ...
   * <code>repeated .google.ads.googleads.v5.common.AdVideoAsset videos = 6;</code>
   */
  com.google.ads.googleads.v5.common.AdVideoAssetOrBuilder getVideosOrBuilder(
      int index);
