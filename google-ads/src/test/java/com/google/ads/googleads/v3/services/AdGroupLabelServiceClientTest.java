...
public class AdGroupLabelServiceClientTest {
  ...
  public void getAdGroupLabelTest() {
    String resourceName2 = "resourceName2625949903";
    AdGroupLabel expectedResponse =
        AdGroupLabel.newBuilder().setResourceName(resourceName2).build();
    mockAdGroupLabelService.addResponse(expectedResponse);

    String formattedResourceName =
        AdGroupLabelServiceClient.formatAdGroupLabelName("[CUSTOMER]", "[AD_GROUP_LABEL]");

    AdGroupLabel actualResponse = client.getAdGroupLabel(formattedResourceName);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateAdGroupLabelsTest() {
    MutateAdGroupLabelsResponse expectedResponse = MutateAdGroupLabelsResponse.newBuilder().build();
    mockAdGroupLabelService.addResponse(expectedResponse);
    ...
    MutateAdGroupLabelsResponse actualResponse =
        client.mutateAdGroupLabels(customerId, operations, partialFailure, validateOnly);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateAdGroupLabelsTest2() {
    MutateAdGroupLabelsResponse expectedResponse = MutateAdGroupLabelsResponse.newBuilder().build();
    mockAdGroupLabelService.addResponse(expectedResponse);
