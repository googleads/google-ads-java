...
public class CustomerManagerLinkServiceClientTest {
  ...
  public void getCustomerManagerLinkTest() {
    com.google.ads.googleads.v6.services.CustomerManagerLinkName resourceName2 =
        com.google.ads.googleads.v6.services.CustomerManagerLinkName.of(
            "[CUSTOMER_ID]", "[MANAGER_CUSTOMER_ID]", "[MANAGER_LINK_ID]");
    String managerCustomer = "managerCustomer1293939760";
    ...
    CustomerManagerLink expectedResponse =
        CustomerManagerLink.newBuilder()
            ...
            .setManagerCustomer(managerCustomer)
