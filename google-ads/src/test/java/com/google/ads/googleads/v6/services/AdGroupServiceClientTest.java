...
public class AdGroupServiceClientTest {
  ...
  public void getAdGroupTest() {
    com.google.ads.googleads.v6.services.AdGroupName resourceName2 =
        com.google.ads.googleads.v6.services.AdGroupName.of("[CUSTOMER_ID]", "[AD_GROUP_ID]");
    long id = 3355L;
    com.google.ads.googleads.v6.services.AdGroupName name =
        com.google.ads.googleads.v6.services.AdGroupName.of("[CUSTOMER_ID]", "[AD_GROUP_ID]");
    com.google.ads.googleads.v6.services.AdGroupName baseAdGroup =
        com.google.ads.googleads.v6.services.AdGroupName.of("[CUSTOMER_ID]", "[AD_GROUP_ID]");
    ...
    long targetCpaMicros = 733096280L;
    long cpvBidMicros = 933014521L;
    long targetCpmMicros = 1294208740L;
    double targetRoas = -2.08462819E8;
    long percentCpcBidMicros = 2098488628L;
    String finalUrlSuffix = "finalUrlSuffix-1825164662";
    long effectiveTargetCpaMicros = 248222192L;
    double effectiveTargetRoas = -1.71721561E8;
    AdGroup expectedResponse =
        AdGroup.newBuilder()
            ...
            .setTargetCpaMicros(targetCpaMicros)
            .setCpvBidMicros(cpvBidMicros)
            .setTargetCpmMicros(targetCpmMicros)
            .setTargetRoas(targetRoas)
            .setPercentCpcBidMicros(percentCpcBidMicros)
            .setFinalUrlSuffix(finalUrlSuffix)
            .setEffectiveTargetCpaMicros(effectiveTargetCpaMicros)
            .setEffectiveTargetRoas(effectiveTargetRoas)
            .build();
    ...
    Assert.assertEquals(resourceName, AdGroupName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
