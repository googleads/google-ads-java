...
public class CustomerServiceClientTest {
  ...
  public void getCustomerTest() {
    com.google.ads.googleads.v6.services.CustomerName resourceName2 =
        com.google.ads.googleads.v6.services.CustomerName.of("[CUSTOMER_ID]");
    long id = 3355L;
    ...
    double optimizationScoreWeight = 9.9727215E7;
    Customer expectedResponse =
        Customer.newBuilder()
            ...
            .setOptimizationScoreWeight(optimizationScoreWeight)
            .build();
