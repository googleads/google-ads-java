...
public class ExpandedLandingPageViewServiceClientTest {
  ...
  public void getExpandedLandingPageViewTest() {
    com.google.ads.googleads.v6.services.ExpandedLandingPageViewName resourceName2 =
        com.google.ads.googleads.v6.services.ExpandedLandingPageViewName.of(
            "[CUSTOMER_ID]", "[EXPANDED_FINAL_URL_FINGERPRINT]");
    String expandedFinalUrl = "expandedFinalUrl1081925408";
    ExpandedLandingPageView expectedResponse =
        ExpandedLandingPageView.newBuilder()
            .setResourceName(resourceName2.toString())
            .setExpandedFinalUrl(expandedFinalUrl)
            .build();
