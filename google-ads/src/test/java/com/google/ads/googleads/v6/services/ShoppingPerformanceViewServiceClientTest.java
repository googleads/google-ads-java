...
public class ShoppingPerformanceViewServiceClientTest {
  ...
  public void getShoppingPerformanceViewTest() {
    com.google.ads.googleads.v6.services.ShoppingPerformanceViewName resourceName2 =
        com.google.ads.googleads.v6.services.ShoppingPerformanceViewName.of("[CUSTOMER_ID]");
    ShoppingPerformanceView expectedResponse =
        ShoppingPerformanceView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, ShoppingPerformanceViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
