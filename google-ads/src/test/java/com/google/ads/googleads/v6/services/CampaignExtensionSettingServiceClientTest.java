...
public class CampaignExtensionSettingServiceClientTest {
  ...
  public void getCampaignExtensionSettingTest() {
    com.google.ads.googleads.v6.services.CampaignExtensionSettingName resourceName2 =
        com.google.ads.googleads.v6.services.CampaignExtensionSettingName.of(
    ...
    Assert.assertEquals(
        resourceName, CampaignExtensionSettingName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
