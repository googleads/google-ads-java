...
public class AdGroupExtensionSettingServiceClientTest {
  ...
  public void getAdGroupExtensionSettingTest() {
    ...
    List<GeneratedMessageV3> actualRequests = mockAdGroupExtensionSettingService.getRequests();
  ...
  public void mutateAdGroupExtensionSettingsTest() {
    ...
    MutateAdGroupExtensionSettingsResponse actualResponse =
        client.mutateAdGroupExtensionSettings(customerId, operations, partialFailure, validateOnly);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateAdGroupExtensionSettingsExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(Status.INVALID_ARGUMENT);
    mockAdGroupExtensionSettingService.addException(exception);
