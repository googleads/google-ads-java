...
public class UserLocationViewServiceClientTest {
  ...
  public void getUserLocationViewTest() {
    com.google.ads.googleads.v5.services.UserLocationViewName resourceName2 =
        com.google.ads.googleads.v5.services.UserLocationViewName.of(
            "[CUSTOMER]", "[USER_LOCATION_VIEW]");
    UserLocationView expectedResponse =
        UserLocationView.newBuilder().setResourceName(resourceName2.toString()).build();
