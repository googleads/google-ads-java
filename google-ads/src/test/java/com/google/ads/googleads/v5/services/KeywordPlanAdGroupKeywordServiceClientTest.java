...
public class KeywordPlanAdGroupKeywordServiceClientTest {
  ...
  public void getKeywordPlanAdGroupKeywordTest() {
    com.google.ads.googleads.v5.services.KeywordPlanAdGroupKeywordName resourceName2 =
        com.google.ads.googleads.v5.services.KeywordPlanAdGroupKeywordName.of(
            "[CUSTOMER]", "[KEYWORD_PLAN_AD_GROUP_KEYWORD]");
    KeywordPlanAdGroupKeyword expectedResponse =
        KeywordPlanAdGroupKeyword.newBuilder().setResourceName(resourceName2.toString()).build();
