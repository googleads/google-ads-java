...
public class AccountLinkServiceClientTest {
  ...
  public void getAccountLinkTest() {
    String resourceName2 = "resourceName2625949903";
    AccountLink expectedResponse = AccountLink.newBuilder().setResourceName(resourceName2).build();
    mockAccountLinkService.addResponse(expectedResponse);

    String formattedResourceName =
        AccountLinkServiceClient.formatAccountLinkName("[CUSTOMER]", "[ACCOUNT_LINK]");

    AccountLink actualResponse = client.getAccountLink(formattedResourceName);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateAccountLinkTest() {
    MutateAccountLinkResponse expectedResponse = MutateAccountLinkResponse.newBuilder().build();
    mockAccountLinkService.addResponse(expectedResponse);
    ...
    MutateAccountLinkResponse actualResponse =
        client.mutateAccountLink(customerId, operation, partialFailure, validateOnly);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateAccountLinkTest2() {
    MutateAccountLinkResponse expectedResponse = MutateAccountLinkResponse.newBuilder().build();
    mockAccountLinkService.addResponse(expectedResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateAccountLinkExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(Status.INVALID_ARGUMENT);
    mockAccountLinkService.addException(exception);
