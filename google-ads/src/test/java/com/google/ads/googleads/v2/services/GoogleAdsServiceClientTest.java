...
public class GoogleAdsServiceClientTest {
  ...
  public void searchTest() {
    ...
    boolean returnSummaryRow = true;

    SearchPagedResponse pagedListResponse =
        client.search(customerId, query, validateOnly, returnSummaryRow);
    ...
    Assert.assertEquals(returnSummaryRow, actualRequest.getReturnSummaryRow());
    Assert.assertTrue(
