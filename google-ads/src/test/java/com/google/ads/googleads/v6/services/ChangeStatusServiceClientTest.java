...
public class ChangeStatusServiceClientTest {
  ...
  public void getChangeStatusTest() {
    com.google.ads.googleads.v6.services.ChangeStatusName resourceName2 =
        com.google.ads.googleads.v6.services.ChangeStatusName.of(
            "[CUSTOMER_ID]", "[CHANGE_STATUS_ID]");
    String lastChangeDateTime = "lastChangeDateTime-1232504456";
    ...
    CampaignCriterionName campaignCriterion =
    ...
    AdGroupFeedName adGroupFeed = AdGroupFeedName.of("[CUSTOMER_ID]", "[AD_GROUP_ID]", "[FEED_ID]");
    CampaignFeedName campaignFeed =
        CampaignFeedName.of("[CUSTOMER_ID]", "[CAMPAIGN_ID]", "[FEED_ID]");
    AdGroupBidModifierName adGroupBidModifier =
    ...
    ChangeStatus expectedResponse =
        ChangeStatus.newBuilder()
            ...
            .setCampaignCriterion(campaignCriterion.toString())
            .setFeed(feed.toString())
            .setFeedItem(feedItem.toString())
            .setAdGroupFeed(adGroupFeed.toString())
            .setCampaignFeed(campaignFeed.toString())
            .setAdGroupBidModifier(adGroupBidModifier.toString())
            .build();
