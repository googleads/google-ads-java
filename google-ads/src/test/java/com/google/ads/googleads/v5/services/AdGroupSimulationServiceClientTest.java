...
public class AdGroupSimulationServiceClientTest {
  ...
  public void getAdGroupSimulationTest() {
    com.google.ads.googleads.v5.services.AdGroupSimulationName resourceName2 =
        com.google.ads.googleads.v5.services.AdGroupSimulationName.of(
            "[CUSTOMER]", "[AD_GROUP_SIMULATION]");
    long adGroupId = 85224585L;
    ...
    Assert.assertEquals(resourceName, AdGroupSimulationName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
