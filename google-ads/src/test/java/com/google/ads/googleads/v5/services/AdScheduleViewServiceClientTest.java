...
public class AdScheduleViewServiceClientTest {
  ...
  public void getAdScheduleViewTest() {
    com.google.ads.googleads.v5.services.AdScheduleViewName resourceName2 =
        com.google.ads.googleads.v5.services.AdScheduleViewName.of(
            "[CUSTOMER]", "[AD_SCHEDULE_VIEW]");
    AdScheduleView expectedResponse =
        AdScheduleView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, AdScheduleViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
