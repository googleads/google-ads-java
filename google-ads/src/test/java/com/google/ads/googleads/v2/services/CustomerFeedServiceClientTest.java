...
public class CustomerFeedServiceClientTest {
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCustomerFeedsTest() {
    MutateCustomerFeedsResponse expectedResponse = MutateCustomerFeedsResponse.newBuilder().build();
    mockCustomerFeedService.addResponse(expectedResponse);
    ...
    MutateCustomerFeedsResponse actualResponse =
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCustomerFeedsTest2() {
    MutateCustomerFeedsResponse expectedResponse = MutateCustomerFeedsResponse.newBuilder().build();
    mockCustomerFeedService.addResponse(expectedResponse);
