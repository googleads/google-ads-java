...
public class KeywordPlanAdGroupServiceClientTest {
  ...
  public void getKeywordPlanAdGroupTest() {
    com.google.ads.googleads.v5.services.KeywordPlanAdGroupName resourceName2 =
        com.google.ads.googleads.v5.services.KeywordPlanAdGroupName.of(
            "[CUSTOMER]", "[KEYWORD_PLAN_AD_GROUP]");
    KeywordPlanAdGroup expectedResponse =
        KeywordPlanAdGroup.newBuilder().setResourceName(resourceName2.toString()).build();
