...
public class LocationViewServiceClientTest {
  ...
  public void getLocationViewTest() {
    com.google.ads.googleads.v6.services.LocationViewName resourceName2 =
        com.google.ads.googleads.v6.services.LocationViewName.of(
            "[CUSTOMER_ID]", "[CAMPAIGN_ID]", "[CRITERION_ID]");
    LocationView expectedResponse =
        LocationView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, LocationViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
