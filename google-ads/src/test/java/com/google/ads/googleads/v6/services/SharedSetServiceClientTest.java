...
public class SharedSetServiceClientTest {
  ...
  public void getSharedSetTest() {
    com.google.ads.googleads.v6.services.SharedSetName resourceName2 =
        com.google.ads.googleads.v6.services.SharedSetName.of("[CUSTOMER_ID]", "[SHARED_SET_ID]");
    long id = 3355L;
    com.google.ads.googleads.v6.services.SharedSetName name =
        com.google.ads.googleads.v6.services.SharedSetName.of("[CUSTOMER_ID]", "[SHARED_SET_ID]");
    long memberCount = 59350230L;
    ...
    Assert.assertEquals(resourceName, SharedSetName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
