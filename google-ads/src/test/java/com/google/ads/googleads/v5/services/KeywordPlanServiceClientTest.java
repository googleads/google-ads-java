...
public class KeywordPlanServiceClientTest {
  ...
  public void getKeywordPlanTest() {
    com.google.ads.googleads.v5.services.KeywordPlanName resourceName2 =
        com.google.ads.googleads.v5.services.KeywordPlanName.of("[CUSTOMER]", "[KEYWORD_PLAN]");
    KeywordPlan expectedResponse =
        KeywordPlan.newBuilder().setResourceName(resourceName2.toString()).build();
    mockKeywordPlanService.addResponse(expectedResponse);

    KeywordPlanName resourceName = KeywordPlanName.of("[CUSTOMER]", "[KEYWORD_PLAN]");

    KeywordPlan actualResponse = client.getKeywordPlan(resourceName);
    ...
    Assert.assertEquals(resourceName, KeywordPlanName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  public void getKeywordPlanExceptionTest() throws Exception {
    ...
    try {
      ...
      client.getKeywordPlan(resourceName);
  ...
  @Test
  @SuppressWarnings("all")
  public void generateForecastCurveTest() {
  ...
  @Test
  @SuppressWarnings("all")
  public void generateForecastTimeSeriesTest() {
