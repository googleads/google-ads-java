...
public class GeographicViewServiceClientTest {
  ...
  public void getGeographicViewTest() {
    com.google.ads.googleads.v5.services.GeographicViewName resourceName2 =
        com.google.ads.googleads.v5.services.GeographicViewName.of(
            "[CUSTOMER]", "[GEOGRAPHIC_VIEW]");
    ...
    Assert.assertEquals(resourceName, GeographicViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
