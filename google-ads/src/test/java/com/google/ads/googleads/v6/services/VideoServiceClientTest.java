...
public class VideoServiceClientTest {
  ...
  public void getVideoTest() {
    com.google.ads.googleads.v6.services.VideoName resourceName2 =
        com.google.ads.googleads.v6.services.VideoName.of("[CUSTOMER_ID]", "[VIDEO_ID]");
    String id = "id3355";
    String channelId = "channelId-1930808873";
    long durationMillis = 1817418577L;
