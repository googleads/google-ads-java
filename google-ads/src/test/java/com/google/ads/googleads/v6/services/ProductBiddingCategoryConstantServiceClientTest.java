...
public class ProductBiddingCategoryConstantServiceClientTest {
  ...
  public void getProductBiddingCategoryConstantTest() {
    com.google.ads.googleads.v6.services.ProductBiddingCategoryConstantName resourceName2 =
        com.google.ads.googleads.v6.services.ProductBiddingCategoryConstantName.of(
            "[COUNTRY_CODE]", "[LEVEL]", "[ID]");
    long id = 3355L;
    String countryCode = "countryCode1481071862";
    com.google.ads.googleads.v6.services.ProductBiddingCategoryConstantName
        productBiddingCategoryConstantParent =
            com.google.ads.googleads.v6.services.ProductBiddingCategoryConstantName.of(
                "[COUNTRY_CODE]", "[LEVEL]", "[ID]");
    String languageCode = "languageCode-412800396";
    String localizedName = "localizedName134243535";
    ProductBiddingCategoryConstant expectedResponse =
        ProductBiddingCategoryConstant.newBuilder()
            ...
            .setProductBiddingCategoryConstantParent(
                productBiddingCategoryConstantParent.toString())
