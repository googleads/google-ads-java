...
import com.google.ads.googleads.v0.resources.RemarketingAction;
...
public class RemarketingActionServiceClientTest {
  ...
  public void getRemarketingActionTest() {
    String resourceName2 = "resourceName2625949903";
    RemarketingAction expectedResponse =
        RemarketingAction.newBuilder().setResourceName(resourceName2).build();
    mockRemarketingActionService.addResponse(expectedResponse);

    String formattedResourceName =
        RemarketingActionServiceClient.formatRemarketingActionName(
            "[CUSTOMER]", "[REMARKETING_ACTION]");

    RemarketingAction actualResponse = client.getRemarketingAction(formattedResourceName);
    Assert.assertEquals(expectedResponse, actualResponse);

    List<GeneratedMessageV3> actualRequests = mockRemarketingActionService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    GetRemarketingActionRequest actualRequest = (GetRemarketingActionRequest) actualRequests.get(0);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateRemarketingActionsTest() {
    MutateRemarketingActionsResponse expectedResponse =
        MutateRemarketingActionsResponse.newBuilder().build();
    mockRemarketingActionService.addResponse(expectedResponse);
    ...
    MutateRemarketingActionsResponse actualResponse =
        client.mutateRemarketingActions(customerId, operations, partialFailure, validateOnly);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateRemarketingActionsTest2() {
    MutateRemarketingActionsResponse expectedResponse =
        MutateRemarketingActionsResponse.newBuilder().build();
    mockRemarketingActionService.addResponse(expectedResponse);
