...
public class KeywordViewServiceClientTest {
  ...
  public void getKeywordViewTest() {
    com.google.ads.googleads.v5.services.KeywordViewName resourceName2 =
        com.google.ads.googleads.v5.services.KeywordViewName.of("[CUSTOMER]", "[KEYWORD_VIEW]");
    KeywordView expectedResponse =
        KeywordView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, KeywordViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
