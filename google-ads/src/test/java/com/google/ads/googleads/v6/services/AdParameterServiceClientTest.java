...
public class AdParameterServiceClientTest {
  ...
  public void getAdParameterTest() {
    com.google.ads.googleads.v6.services.AdParameterName resourceName2 =
        com.google.ads.googleads.v6.services.AdParameterName.of(
            "[CUSTOMER_ID]", "[AD_GROUP_ID]", "[CRITERION_ID]", "[PARAMETER_INDEX]");
    AdGroupCriterionName adGroupCriterion =
        AdGroupCriterionName.of("[CUSTOMER_ID]", "[AD_GROUP_ID]", "[CRITERION_ID]");
    long parameterIndex = 763436220L;
    String insertionText = "insertionText-1755831107";
    AdParameter expectedResponse =
        AdParameter.newBuilder()
            .setResourceName(resourceName2.toString())
            .setAdGroupCriterion(adGroupCriterion.toString())
    ...
    Assert.assertEquals(resourceName, AdParameterName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
