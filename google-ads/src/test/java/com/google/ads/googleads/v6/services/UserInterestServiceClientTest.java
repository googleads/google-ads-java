...
public class UserInterestServiceClientTest {
  ...
  public void getUserInterestTest() {
    com.google.ads.googleads.v6.services.UserInterestName resourceName2 =
        com.google.ads.googleads.v6.services.UserInterestName.of(
            "[CUSTOMER_ID]", "[USER_INTEREST_ID]");
    long userInterestId = 413168604L;
    com.google.ads.googleads.v6.services.UserInterestName name =
        com.google.ads.googleads.v6.services.UserInterestName.of(
            "[CUSTOMER_ID]", "[USER_INTEREST_ID]");
    com.google.ads.googleads.v6.services.UserInterestName userInterestParent =
        com.google.ads.googleads.v6.services.UserInterestName.of(
            "[CUSTOMER_ID]", "[USER_INTEREST_ID]");
    boolean launchedToAll = true;
    UserInterest expectedResponse =
        UserInterest.newBuilder()
            ...
            .setUserInterestParent(userInterestParent.toString())
            .setLaunchedToAll(launchedToAll)
            .build();
    ...
    Assert.assertEquals(resourceName, UserInterestName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
