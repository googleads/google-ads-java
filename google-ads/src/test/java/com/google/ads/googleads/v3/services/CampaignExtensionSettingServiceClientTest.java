...
public class CampaignExtensionSettingServiceClientTest {
  ...
  public void getCampaignExtensionSettingTest() {
    String resourceName2 = "resourceName2625949903";
    CampaignExtensionSetting expectedResponse =
        CampaignExtensionSetting.newBuilder().setResourceName(resourceName2).build();
    mockCampaignExtensionSettingService.addResponse(expectedResponse);

    String formattedResourceName =
        CampaignExtensionSettingServiceClient.formatCampaignExtensionSettingName(
            "[CUSTOMER]", "[CAMPAIGN_EXTENSION_SETTING]");

    CampaignExtensionSetting actualResponse =
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCampaignExtensionSettingsTest() {
    MutateCampaignExtensionSettingsResponse expectedResponse =
        MutateCampaignExtensionSettingsResponse.newBuilder().build();
    mockCampaignExtensionSettingService.addResponse(expectedResponse);
  ...
  public void mutateCampaignExtensionSettingsExceptionTest() throws Exception {
    ...
    try {
      ...
      client.mutateCampaignExtensionSettings(customerId, operations, partialFailure, validateOnly);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception
    }
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCampaignExtensionSettingsTest2() {
    MutateCampaignExtensionSettingsResponse expectedResponse =
        MutateCampaignExtensionSettingsResponse.newBuilder().build();
    mockCampaignExtensionSettingService.addResponse(expectedResponse);
