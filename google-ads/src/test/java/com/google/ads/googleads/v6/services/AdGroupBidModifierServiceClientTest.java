...
public class AdGroupBidModifierServiceClientTest {
  ...
  public void getAdGroupBidModifierTest() {
    com.google.ads.googleads.v6.services.AdGroupBidModifierName resourceName2 =
        com.google.ads.googleads.v6.services.AdGroupBidModifierName.of(
    ...
    AdGroupName baseAdGroup = AdGroupName.of("[CUSTOMER_ID]", "[AD_GROUP_ID]");
    AdGroupBidModifier expectedResponse =
        AdGroupBidModifier.newBuilder()
            ...
            .setBaseAdGroup(baseAdGroup.toString())
            .build();
    ...
    Assert.assertEquals(
        resourceName, AdGroupBidModifierName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
