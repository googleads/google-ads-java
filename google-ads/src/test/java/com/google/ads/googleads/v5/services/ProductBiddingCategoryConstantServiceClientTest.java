...
public class ProductBiddingCategoryConstantServiceClientTest {
  ...
  public void getProductBiddingCategoryConstantTest() {
    com.google.ads.googleads.v5.services.ProductBiddingCategoryConstantName resourceName2 =
        com.google.ads.googleads.v5.services.ProductBiddingCategoryConstantName.of(
    ...
    Assert.assertEquals(
        resourceName, ProductBiddingCategoryConstantName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
