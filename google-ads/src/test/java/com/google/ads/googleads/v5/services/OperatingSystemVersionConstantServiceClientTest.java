...
public class OperatingSystemVersionConstantServiceClientTest {
  ...
  public void getOperatingSystemVersionConstantTest() {
    com.google.ads.googleads.v5.services.OperatingSystemVersionConstantName resourceName2 =
        com.google.ads.googleads.v5.services.OperatingSystemVersionConstantName.of(
            "[OPERATING_SYSTEM_VERSION_CONSTANT]");
    long id = 3355L;
    com.google.ads.googleads.v5.services.OperatingSystemVersionConstantName name =
        com.google.ads.googleads.v5.services.OperatingSystemVersionConstantName.of(
            "[OPERATING_SYSTEM_VERSION_CONSTANT]");
    int osMajorVersion = 1346408137;
    int osMinorVersion = 1088382771;
    OperatingSystemVersionConstant expectedResponse =
        OperatingSystemVersionConstant.newBuilder()
            ...
            .setOsMajorVersion(osMajorVersion)
            .setOsMinorVersion(osMinorVersion)
            .build();
    ...
    Assert.assertEquals(
        resourceName, OperatingSystemVersionConstantName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
