...
public class ExtensionFeedItemServiceClientTest {
  ...
  public void getExtensionFeedItemTest() {
    com.google.ads.googleads.v6.services.ExtensionFeedItemName resourceName2 =
        com.google.ads.googleads.v6.services.ExtensionFeedItemName.of(
            "[CUSTOMER_ID]", "[FEED_ITEM_ID]");
    long id = 3355L;
    String startDateTime = "startDateTime-1830951647";
    String endDateTime = "endDateTime700982874";
    GeoTargetConstantName targetedGeoTargetConstant = GeoTargetConstantName.of("[CRITERION_ID]");
    CampaignName targetedCampaign = CampaignName.of("[CUSTOMER_ID]", "[CAMPAIGN_ID]");
    ExtensionFeedItem expectedResponse =
        ExtensionFeedItem.newBuilder()
            ...
            .setTargetedGeoTargetConstant(targetedGeoTargetConstant.toString())
            .setTargetedCampaign(targetedCampaign.toString())
            .build();
    ...
    Assert.assertEquals(resourceName, ExtensionFeedItemName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateExtensionFeedItemsTest() {
    MutateExtensionFeedItemsResponse expectedResponse =
        MutateExtensionFeedItemsResponse.newBuilder().build();
    mockExtensionFeedItemService.addResponse(expectedResponse);
