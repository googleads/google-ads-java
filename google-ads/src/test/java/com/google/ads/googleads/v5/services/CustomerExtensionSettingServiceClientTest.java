...
public class CustomerExtensionSettingServiceClientTest {
  ...
  public void getCustomerExtensionSettingTest() {
    com.google.ads.googleads.v5.services.CustomerExtensionSettingName resourceName2 =
        com.google.ads.googleads.v5.services.CustomerExtensionSettingName.of(
            "[CUSTOMER]", "[CUSTOMER_EXTENSION_SETTING]");
    CustomerExtensionSetting expectedResponse =
        CustomerExtensionSetting.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, CustomerExtensionSettingName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCustomerExtensionSettingsTest() {
    MutateCustomerExtensionSettingsResponse expectedResponse =
        MutateCustomerExtensionSettingsResponse.newBuilder().build();
    mockCustomerExtensionSettingService.addResponse(expectedResponse);
