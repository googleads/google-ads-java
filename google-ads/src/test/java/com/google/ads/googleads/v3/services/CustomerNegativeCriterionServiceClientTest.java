...
public class CustomerNegativeCriterionServiceClientTest {
  ...
  public void getCustomerNegativeCriterionTest() {
    String resourceName2 = "resourceName2625949903";
    CustomerNegativeCriterion expectedResponse =
        CustomerNegativeCriterion.newBuilder().setResourceName(resourceName2).build();
    mockCustomerNegativeCriterionService.addResponse(expectedResponse);

    String formattedResourceName =
        CustomerNegativeCriterionServiceClient.formatCustomerNegativeCriteriaName(
            "[CUSTOMER]", "[CUSTOMER_NEGATIVE_CRITERIA]");

    CustomerNegativeCriterion actualResponse =
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCustomerNegativeCriteriaTest() {
    MutateCustomerNegativeCriteriaResponse expectedResponse =
        MutateCustomerNegativeCriteriaResponse.newBuilder().build();
    mockCustomerNegativeCriterionService.addResponse(expectedResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCustomerNegativeCriteriaTest2() {
    MutateCustomerNegativeCriteriaResponse expectedResponse =
        MutateCustomerNegativeCriteriaResponse.newBuilder().build();
    mockCustomerNegativeCriterionService.addResponse(expectedResponse);
