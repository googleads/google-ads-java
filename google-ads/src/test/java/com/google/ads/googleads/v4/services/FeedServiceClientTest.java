...
public class FeedServiceClientTest {
  ...
  public void getFeedTest() {
    ...
    Feed expectedResponse = Feed.newBuilder().setResourceName(resourceName2).build();
  ...
  public void mutateFeedsTest() {
    ...
    MutateFeedsResponse actualResponse =
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateFeedsExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(Status.INVALID_ARGUMENT);
    mockFeedService.addException(exception);
