...
public class FeedMappingServiceClientTest {
  ...
  public void getFeedMappingTest() {
    com.google.ads.googleads.v5.services.FeedMappingName resourceName2 =
        com.google.ads.googleads.v5.services.FeedMappingName.of("[CUSTOMER]", "[FEED_MAPPING]");
    FeedMapping expectedResponse =
        FeedMapping.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, FeedMappingName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateFeedMappingsTest() {
