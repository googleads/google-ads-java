...
public class CampaignSharedSetServiceClientTest {
  ...
  public void getCampaignSharedSetTest() {
    com.google.ads.googleads.v6.services.CampaignSharedSetName resourceName2 =
        com.google.ads.googleads.v6.services.CampaignSharedSetName.of(
            "[CUSTOMER_ID]", "[CAMPAIGN_ID]", "[SHARED_SET_ID]");
    CampaignName campaign = CampaignName.of("[CUSTOMER_ID]", "[CAMPAIGN_ID]");
    SharedSetName sharedSet = SharedSetName.of("[CUSTOMER_ID]", "[SHARED_SET_ID]");
    CampaignSharedSet expectedResponse =
        CampaignSharedSet.newBuilder()
            ...
            .setSharedSet(sharedSet.toString())
            .build();
    ...
    Assert.assertEquals(resourceName, CampaignSharedSetName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
