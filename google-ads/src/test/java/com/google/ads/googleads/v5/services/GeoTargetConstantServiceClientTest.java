...
public class GeoTargetConstantServiceClientTest {
  ...
  public void getGeoTargetConstantTest() {
    com.google.ads.googleads.v5.services.GeoTargetConstantName resourceName2 =
        com.google.ads.googleads.v5.services.GeoTargetConstantName.of("[GEO_TARGET_CONSTANT]");
    long id = 3355L;
    com.google.ads.googleads.v5.services.GeoTargetConstantName name =
        com.google.ads.googleads.v5.services.GeoTargetConstantName.of("[GEO_TARGET_CONSTANT]");
    ...
    Assert.assertEquals(resourceName, GeoTargetConstantName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
