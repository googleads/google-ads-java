...
public class AdGroupCriterionSimulationServiceClientTest {
  ...
  public void getAdGroupCriterionSimulationTest() {
    String resourceName2 = "resourceName2625949903";
    AdGroupCriterionSimulation expectedResponse =
        AdGroupCriterionSimulation.newBuilder().setResourceName(resourceName2).build();
    mockAdGroupCriterionSimulationService.addResponse(expectedResponse);

    String formattedResourceName =
        AdGroupCriterionSimulationServiceClient.formatAdGroupCriterionSimulationName(
            "[CUSTOMER]", "[AD_GROUP_CRITERION_SIMULATION]");

    AdGroupCriterionSimulation actualResponse =
