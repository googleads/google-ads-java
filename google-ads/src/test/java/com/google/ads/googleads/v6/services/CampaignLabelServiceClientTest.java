...
public class CampaignLabelServiceClientTest {
  ...
  public void getCampaignLabelTest() {
    com.google.ads.googleads.v6.services.CampaignLabelName resourceName2 =
        com.google.ads.googleads.v6.services.CampaignLabelName.of(
            "[CUSTOMER_ID]", "[CAMPAIGN_ID]", "[LABEL_ID]");
    CampaignName campaign = CampaignName.of("[CUSTOMER_ID]", "[CAMPAIGN_ID]");
    LabelName label = LabelName.of("[CUSTOMER_ID]", "[LABEL_ID]");
    ...
    Assert.assertEquals(resourceName, CampaignLabelName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCampaignLabelsTest() {
    MutateCampaignLabelsResponse expectedResponse =
        MutateCampaignLabelsResponse.newBuilder().build();
    mockCampaignLabelService.addResponse(expectedResponse);
