...
public class LabelServiceClientTest {
  ...
  public void getLabelTest() {
    com.google.ads.googleads.v5.services.LabelName resourceName2 =
        com.google.ads.googleads.v5.services.LabelName.of("[CUSTOMER]", "[LABEL]");
    Label expectedResponse = Label.newBuilder().setResourceName(resourceName2.toString()).build();
