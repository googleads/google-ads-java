...
public class RecommendationServiceClientTest {
  ...
  public void getRecommendationTest() {
    com.google.ads.googleads.v5.services.RecommendationName resourceName2 =
        com.google.ads.googleads.v5.services.RecommendationName.of(
            "[CUSTOMER]", "[RECOMMENDATION]");
    Recommendation expectedResponse =
        Recommendation.newBuilder().setResourceName(resourceName2.toString()).build();
