...
public class RecommendationServiceClientTest {
  ...
  public void getRecommendationTest() {
    com.google.ads.googleads.v6.services.RecommendationName resourceName2 =
        com.google.ads.googleads.v6.services.RecommendationName.of(
            "[CUSTOMER_ID]", "[RECOMMENDATION_ID]");
    CampaignBudgetName campaignBudget =
        CampaignBudgetName.of("[CUSTOMER_ID]", "[CAMPAIGN_BUDGET_ID]");
    CampaignName campaign = CampaignName.of("[CUSTOMER_ID]", "[CAMPAIGN_ID]");
    AdGroupName adGroup = AdGroupName.of("[CUSTOMER_ID]", "[AD_GROUP_ID]");
    boolean dismissed = false;
    Recommendation expectedResponse =
        Recommendation.newBuilder()
            .setResourceName(resourceName2.toString())
            .setCampaignBudget(campaignBudget.toString())
            .setCampaign(campaign.toString())
    ...
    Assert.assertEquals(resourceName, RecommendationName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
