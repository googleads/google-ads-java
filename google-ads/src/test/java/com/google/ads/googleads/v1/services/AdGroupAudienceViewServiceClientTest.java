...
public class AdGroupAudienceViewServiceClientTest {
  ...
  public void getAdGroupAudienceViewTest() {
    String resourceName2 = "resourceName2625949903";
    AdGroupAudienceView expectedResponse =
        AdGroupAudienceView.newBuilder().setResourceName(resourceName2).build();
    mockAdGroupAudienceViewService.addResponse(expectedResponse);

    String formattedResourceName =
        AdGroupAudienceViewServiceClient.formatAdGroupAudienceViewName(
            "[CUSTOMER]", "[AD_GROUP_AUDIENCE_VIEW]");

    AdGroupAudienceView actualResponse = client.getAdGroupAudienceView(formattedResourceName);
    Assert.assertEquals(expectedResponse, actualResponse);

    List<GeneratedMessageV3> actualRequests = mockAdGroupAudienceViewService.getRequests();
