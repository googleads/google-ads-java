...
public class MobileAppCategoryConstantServiceClientTest {
  ...
  public void getMobileAppCategoryConstantTest() {
    com.google.ads.googleads.v6.services.MobileAppCategoryConstantName resourceName2 =
        com.google.ads.googleads.v6.services.MobileAppCategoryConstantName.of(
            "[MOBILE_APP_CATEGORY_ID]");
    int id = 3355;
    com.google.ads.googleads.v6.services.MobileAppCategoryConstantName name =
        com.google.ads.googleads.v6.services.MobileAppCategoryConstantName.of(
            "[MOBILE_APP_CATEGORY_ID]");
    ...
    Assert.assertEquals(
        resourceName, MobileAppCategoryConstantName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
