...
public class AccountBudgetProposalServiceClientTest {
  ...
  public void getAccountBudgetProposalTest() {
    com.google.ads.googleads.v6.services.AccountBudgetProposalName resourceName2 =
        com.google.ads.googleads.v6.services.AccountBudgetProposalName.of(
            "[CUSTOMER_ID]", "[ACCOUNT_BUDGET_PROPOSAL_ID]");
    long id = 3355L;
    BillingSetupName billingSetup = BillingSetupName.of("[CUSTOMER_ID]", "[BILLING_SETUP_ID]");
    AccountBudgetName accountBudget = AccountBudgetName.of("[CUSTOMER_ID]", "[ACCOUNT_BUDGET_ID]");
    String proposedName = "proposedName-1200293948";
    String approvedStartDateTime = "approvedStartDateTime-58305639";
    String proposedPurchaseOrderNumber = "proposedPurchaseOrderNumber461694911";
    String proposedNotes = "proposedNotes1446017192";
    String creationDateTime = "creationDateTime263411550";
    String approvalDateTime = "approvalDateTime-1411096126";
    ...
    AccountBudgetProposal expectedResponse =
        AccountBudgetProposal.newBuilder()
            ...
            .setAccountBudget(accountBudget.toString())
            .setProposedName(proposedName)
            .setApprovedStartDateTime(approvedStartDateTime)
            .setProposedPurchaseOrderNumber(proposedPurchaseOrderNumber)
            .setProposedNotes(proposedNotes)
            .setCreationDateTime(creationDateTime)
            .setApprovalDateTime(approvalDateTime)
