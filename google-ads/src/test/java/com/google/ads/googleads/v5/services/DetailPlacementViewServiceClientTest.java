...
public class DetailPlacementViewServiceClientTest {
  ...
  public void getDetailPlacementViewTest() {
    com.google.ads.googleads.v5.services.DetailPlacementViewName resourceName2 =
        com.google.ads.googleads.v5.services.DetailPlacementViewName.of(
            "[CUSTOMER]", "[DETAIL_PLACEMENT_VIEW]");
    DetailPlacementView expectedResponse =
        DetailPlacementView.newBuilder().setResourceName(resourceName2.toString()).build();
