...
public class OperatingSystemVersionConstantServiceClientTest {
  ...
  public void getOperatingSystemVersionConstantTest() {
    ...
    OperatingSystemVersionConstant expectedResponse =
        OperatingSystemVersionConstant.newBuilder().setResourceName(resourceName2).build();
    mockOperatingSystemVersionConstantService.addResponse(expectedResponse);

    String formattedResourceName =
        OperatingSystemVersionConstantServiceClient.formatOperatingSystemVersionConstantName(
