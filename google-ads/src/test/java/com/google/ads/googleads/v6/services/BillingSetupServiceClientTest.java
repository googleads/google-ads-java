...
import com.google.ads.googleads.v6.services.PaymentsAccountName;
...
public class BillingSetupServiceClientTest {
  ...
  public void getBillingSetupTest() {
    com.google.ads.googleads.v6.services.BillingSetupName resourceName2 =
        com.google.ads.googleads.v6.services.BillingSetupName.of(
            "[CUSTOMER_ID]", "[BILLING_SETUP_ID]");
    long id = 3355L;
    PaymentsAccountName paymentsAccount =
        PaymentsAccountName.of("[CUSTOMER_ID]", "[PAYMENTS_ACCOUNT_ID]");
    ...
    BillingSetup expectedResponse =
        BillingSetup.newBuilder()
            ...
            .setId(id)
            .setPaymentsAccount(paymentsAccount.toString())
