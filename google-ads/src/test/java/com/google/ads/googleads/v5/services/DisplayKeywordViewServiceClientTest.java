...
public class DisplayKeywordViewServiceClientTest {
  ...
  public void getDisplayKeywordViewTest() {
    com.google.ads.googleads.v5.services.DisplayKeywordViewName resourceName2 =
        com.google.ads.googleads.v5.services.DisplayKeywordViewName.of(
            "[CUSTOMER]", "[DISPLAY_KEYWORD_VIEW]");
    DisplayKeywordView expectedResponse =
        DisplayKeywordView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, DisplayKeywordViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
