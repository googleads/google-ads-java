...
public class CustomerClientLinkServiceClientTest {
  ...
  public void getCustomerClientLinkTest() {
    com.google.ads.googleads.v5.services.CustomerClientLinkName resourceName2 =
        com.google.ads.googleads.v5.services.CustomerClientLinkName.of(
            "[CUSTOMER]", "[CUSTOMER_CLIENT_LINK]");
    CustomerClientLink expectedResponse =
        CustomerClientLink.newBuilder().setResourceName(resourceName2.toString()).build();
