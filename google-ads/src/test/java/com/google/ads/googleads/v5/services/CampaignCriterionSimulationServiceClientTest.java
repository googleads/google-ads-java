...
public class CampaignCriterionSimulationServiceClientTest {
  ...
  public void getCampaignCriterionSimulationTest() {
    com.google.ads.googleads.v5.services.CampaignCriterionSimulationName resourceName2 =
        com.google.ads.googleads.v5.services.CampaignCriterionSimulationName.of(
            "[CUSTOMER]", "[CAMPAIGN_CRITERION_SIMULATION]");
    long campaignId = 2083788458L;
    ...
    Assert.assertEquals(
        resourceName, CampaignCriterionSimulationName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
