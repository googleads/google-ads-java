...
public class RemarketingActionServiceClientTest {
  ...
  public void getRemarketingActionTest() {
    com.google.ads.googleads.v5.services.RemarketingActionName resourceName2 =
        com.google.ads.googleads.v5.services.RemarketingActionName.of(
            "[CUSTOMER]", "[REMARKETING_ACTION]");
    long id = 3355L;
    com.google.ads.googleads.v5.services.RemarketingActionName name =
        com.google.ads.googleads.v5.services.RemarketingActionName.of(
            "[CUSTOMER]", "[REMARKETING_ACTION]");
    ...
    Assert.assertEquals(resourceName, RemarketingActionName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
