...
public class FeedItemSetLinkServiceClientTest {
  ...
  public void getFeedItemSetLinkTest() {
    com.google.ads.googleads.v6.services.FeedItemSetLinkName resourceName2 =
        com.google.ads.googleads.v6.services.FeedItemSetLinkName.of(
            "[CUSTOMER_ID]", "[FEED_ID]", "[FEED_ITEM_SET_ID]", "[FEED_ITEM_ID]");
    FeedItemName feedItem = FeedItemName.of("[CUSTOMER_ID]", "[FEED_ID]", "[FEED_ITEM_ID]");
    FeedItemSetName feedItemSet =
    ...
    FeedItemSetLink expectedResponse =
        FeedItemSetLink.newBuilder()
            ...
            .setFeedItem(feedItem.toString())
            .setFeedItemSet(feedItemSet.toString())
            .build();
    ...
    Assert.assertEquals(resourceName, FeedItemSetLinkName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateFeedItemSetLinksTest() {
    MutateFeedItemSetLinksResponse expectedResponse =
        MutateFeedItemSetLinksResponse.newBuilder().build();
    mockFeedItemSetLinkService.addResponse(expectedResponse);
