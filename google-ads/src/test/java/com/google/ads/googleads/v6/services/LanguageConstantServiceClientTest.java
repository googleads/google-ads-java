...
public class LanguageConstantServiceClientTest {
  ...
  public void getLanguageConstantTest() {
    com.google.ads.googleads.v6.services.LanguageConstantName resourceName2 =
        com.google.ads.googleads.v6.services.LanguageConstantName.of("[CRITERION_ID]");
    long id = 3355L;
    String code = "code3059181";
    com.google.ads.googleads.v6.services.LanguageConstantName name =
        com.google.ads.googleads.v6.services.LanguageConstantName.of("[CRITERION_ID]");
    ...
    Assert.assertEquals(resourceName, LanguageConstantName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
