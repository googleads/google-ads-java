...
public class AdGroupCriterionSimulationServiceClientTest {
  ...
  public void getAdGroupCriterionSimulationTest() {
    com.google.ads.googleads.v6.services.AdGroupCriterionSimulationName resourceName2 =
        com.google.ads.googleads.v6.services.AdGroupCriterionSimulationName.of(
            "[CUSTOMER_ID]",
            "[AD_GROUP_ID]",
            "[CRITERION_ID]",
            "[TYPE]",
    ...
    Assert.assertEquals(
        resourceName, AdGroupCriterionSimulationName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
