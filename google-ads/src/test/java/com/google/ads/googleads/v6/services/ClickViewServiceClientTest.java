...
public class ClickViewServiceClientTest {
  ...
  public void getClickViewTest() {
    com.google.ads.googleads.v6.services.ClickViewName resourceName2 =
        com.google.ads.googleads.v6.services.ClickViewName.of(
            "[CUSTOMER_ID]", "[DATE]", "[GCLID]");
    ...
    GeoTargetConstantName campaignLocationTarget = GeoTargetConstantName.of("[CRITERION_ID]");
    UserListName userList = UserListName.of("[CUSTOMER_ID]", "[USER_LIST_ID]");
