...
public class HotelPerformanceViewServiceClientTest {
  ...
  public void getHotelPerformanceViewTest() {
    com.google.ads.googleads.v6.services.HotelPerformanceViewName resourceName2 =
        com.google.ads.googleads.v6.services.HotelPerformanceViewName.of("[CUSTOMER_ID]");
    HotelPerformanceView expectedResponse =
        HotelPerformanceView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, HotelPerformanceViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
