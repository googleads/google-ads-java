...
public class CustomerUserAccessServiceClientTest {
  ...
  public void getCustomerUserAccessTest() {
    com.google.ads.googleads.v6.services.CustomerUserAccessName resourceName2 =
        com.google.ads.googleads.v6.services.CustomerUserAccessName.of(
            "[CUSTOMER_ID]", "[USER_ID]");
    long userId = 147132913L;
    String emailAddress = "emailAddress-769510831";
    String accessCreationDateTime = "accessCreationDateTime1731167769";
    String inviterUserEmailAddress = "inviterUserEmailAddress1138622035";
    CustomerUserAccess expectedResponse =
        CustomerUserAccess.newBuilder()
            .setResourceName(resourceName2.toString())
            .setUserId(userId)
            .setEmailAddress(emailAddress)
            .setAccessCreationDateTime(accessCreationDateTime)
            .setInviterUserEmailAddress(inviterUserEmailAddress)
            .build();
    ...
    Assert.assertEquals(
        resourceName, CustomerUserAccessName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCustomerUserAccessTest() {
    MutateCustomerUserAccessResponse expectedResponse =
        MutateCustomerUserAccessResponse.newBuilder().build();
    mockCustomerUserAccessService.addResponse(expectedResponse);
