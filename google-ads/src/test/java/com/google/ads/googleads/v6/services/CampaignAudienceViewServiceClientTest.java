...
public class CampaignAudienceViewServiceClientTest {
  ...
  public void getCampaignAudienceViewTest() {
    com.google.ads.googleads.v6.services.CampaignAudienceViewName resourceName2 =
        com.google.ads.googleads.v6.services.CampaignAudienceViewName.of(
            "[CUSTOMER_ID]", "[CAMPAIGN_ID]", "[CRITERION_ID]");
    CampaignAudienceView expectedResponse =
        CampaignAudienceView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, CampaignAudienceViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
