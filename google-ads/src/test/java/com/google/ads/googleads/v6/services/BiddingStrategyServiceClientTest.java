...
public class BiddingStrategyServiceClientTest {
  ...
  public void getBiddingStrategyTest() {
    com.google.ads.googleads.v6.services.BiddingStrategyName resourceName2 =
        com.google.ads.googleads.v6.services.BiddingStrategyName.of(
            "[CUSTOMER_ID]", "[BIDDING_STRATEGY_ID]");
    long id = 3355L;
    com.google.ads.googleads.v6.services.BiddingStrategyName name =
        com.google.ads.googleads.v6.services.BiddingStrategyName.of(
            "[CUSTOMER_ID]", "[BIDDING_STRATEGY_ID]");
    ...
    Assert.assertEquals(resourceName, BiddingStrategyName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
