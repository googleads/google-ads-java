...
public class ExpandedLandingPageViewServiceClientTest {
  ...
  public void getExpandedLandingPageViewTest() {
    com.google.ads.googleads.v5.services.ExpandedLandingPageViewName resourceName2 =
        com.google.ads.googleads.v5.services.ExpandedLandingPageViewName.of(
            "[CUSTOMER]", "[EXPANDED_LANDING_PAGE_VIEW]");
    ExpandedLandingPageView expectedResponse =
        ExpandedLandingPageView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, ExpandedLandingPageViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
