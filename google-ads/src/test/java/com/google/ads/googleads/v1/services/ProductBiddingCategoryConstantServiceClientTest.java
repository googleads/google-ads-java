...
public class ProductBiddingCategoryConstantServiceClientTest {
  ...
  public void getProductBiddingCategoryConstantTest() {
    ...
    ProductBiddingCategoryConstant expectedResponse =
        ProductBiddingCategoryConstant.newBuilder().setResourceName(resourceName2).build();
    mockProductBiddingCategoryConstantService.addResponse(expectedResponse);

    String formattedResourceName =
        ProductBiddingCategoryConstantServiceClient.formatProductBiddingCategoryConstantName(
    ...
    List<GeneratedMessageV3> actualRequests =
        mockProductBiddingCategoryConstantService.getRequests();
