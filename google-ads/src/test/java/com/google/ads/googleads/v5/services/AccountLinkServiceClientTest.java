...
public class AccountLinkServiceClientTest {
  ...
  public void getAccountLinkTest() {
    com.google.ads.googleads.v5.services.AccountLinkName resourceName2 =
        com.google.ads.googleads.v5.services.AccountLinkName.of("[CUSTOMER]", "[ACCOUNT_LINK]");
    AccountLink expectedResponse =
        AccountLink.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, AccountLinkName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
