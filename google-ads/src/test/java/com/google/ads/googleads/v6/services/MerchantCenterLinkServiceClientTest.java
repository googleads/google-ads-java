...
public class MerchantCenterLinkServiceClientTest {
  ...
  public void listMerchantCenterLinksTest() {
    ListMerchantCenterLinksResponse expectedResponse =
        ListMerchantCenterLinksResponse.newBuilder().build();
  ...
  @Test
  @SuppressWarnings("all")
  public void getMerchantCenterLinkTest() {
    com.google.ads.googleads.v6.services.MerchantCenterLinkName resourceName2 =
        com.google.ads.googleads.v6.services.MerchantCenterLinkName.of(
            "[CUSTOMER_ID]", "[MERCHANT_CENTER_ID]");
    long id = 3355L;
    String merchantCenterAccountName = "merchantCenterAccountName-835145712";
    MerchantCenterLink expectedResponse =
        MerchantCenterLink.newBuilder()
            .setResourceName(resourceName2.toString())
            .setId(id)
            .setMerchantCenterAccountName(merchantCenterAccountName)
            .build();
    mockMerchantCenterLinkService.addResponse(expectedResponse);
    ...
    Assert.assertEquals(
        resourceName, MerchantCenterLinkName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
        channelProvider.isHeaderSent(
            ApiClientHeaderProvider.getDefaultApiClientHeaderKey(),
            GaxGrpcProperties.getDefaultApiClientHeaderPattern()));
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateMerchantCenterLinkTest() {
    MutateMerchantCenterLinkResponse expectedResponse =
        MutateMerchantCenterLinkResponse.newBuilder().build();
    mockMerchantCenterLinkService.addResponse(expectedResponse);
