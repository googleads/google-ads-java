...
import com.google.ads.googleads.v1.resources.TopicView;
...
public class TopicViewServiceClientTest {
  ...
  public void getTopicViewTest() {
    ...
    TopicView expectedResponse = TopicView.newBuilder().setResourceName(resourceName2).build();
    ...
    TopicView actualResponse = client.getTopicView(formattedResourceName);
    Assert.assertEquals(expectedResponse, actualResponse);

    List<GeneratedMessageV3> actualRequests = mockTopicViewService.getRequests();
