...
public class CustomerManagerLinkServiceClientTest {
  ...
  public void getCustomerManagerLinkTest() {
    com.google.ads.googleads.v5.services.CustomerManagerLinkName resourceName2 =
        com.google.ads.googleads.v5.services.CustomerManagerLinkName.of(
            "[CUSTOMER]", "[CUSTOMER_MANAGER_LINK]");
    CustomerManagerLink expectedResponse =
        CustomerManagerLink.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, CustomerManagerLinkName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void moveManagerLinkTest() {
    String resourceName = "resourceName979421212";
    MoveManagerLinkResponse expectedResponse =
        MoveManagerLinkResponse.newBuilder().setResourceName(resourceName).build();
    mockCustomerManagerLinkService.addResponse(expectedResponse);
