...
public class IncomeRangeViewServiceClientTest {
  ...
  public void getIncomeRangeViewTest() {
    com.google.ads.googleads.v6.services.IncomeRangeViewName resourceName2 =
        com.google.ads.googleads.v6.services.IncomeRangeViewName.of(
            "[CUSTOMER_ID]", "[AD_GROUP_ID]", "[CRITERION_ID]");
    IncomeRangeView expectedResponse =
        IncomeRangeView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, IncomeRangeViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
