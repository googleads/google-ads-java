...
public class LandingPageViewServiceClientTest {
  ...
  public void getLandingPageViewTest() {
    String resourceName2 = "resourceName2625949903";
    LandingPageView expectedResponse =
        LandingPageView.newBuilder().setResourceName(resourceName2).build();
    mockLandingPageViewService.addResponse(expectedResponse);

    String formattedResourceName =
        LandingPageViewServiceClient.formatLandingPageViewName("[CUSTOMER]", "[LANDING_PAGE_VIEW]");
