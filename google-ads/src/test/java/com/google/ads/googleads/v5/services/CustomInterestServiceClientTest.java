...
public class CustomInterestServiceClientTest {
  ...
  public void getCustomInterestTest() {
    com.google.ads.googleads.v5.services.CustomInterestName resourceName2 =
        com.google.ads.googleads.v5.services.CustomInterestName.of(
            "[CUSTOMER]", "[CUSTOM_INTEREST]");
    CustomInterest expectedResponse =
        CustomInterest.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, CustomInterestName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCustomInterestsTest() {
    MutateCustomInterestsResponse expectedResponse =
        MutateCustomInterestsResponse.newBuilder().build();
    mockCustomInterestService.addResponse(expectedResponse);
