...
public class KeywordPlanAdGroupKeywordServiceClientTest {
  ...
  public void getKeywordPlanAdGroupKeywordTest() {
    com.google.ads.googleads.v6.services.KeywordPlanAdGroupKeywordName resourceName2 =
        com.google.ads.googleads.v6.services.KeywordPlanAdGroupKeywordName.of(
            "[CUSTOMER_ID]", "[KEYWORD_PLAN_AD_GROUP_KEYWORD_ID]");
    KeywordPlanAdGroupName keywordPlanAdGroup =
    ...
    KeywordPlanAdGroupKeyword expectedResponse =
        KeywordPlanAdGroupKeyword.newBuilder()
            ...
            .setKeywordPlanAdGroup(keywordPlanAdGroup.toString())
            .setId(id)
            .setText(text)
    ...
    Assert.assertEquals(
        resourceName, KeywordPlanAdGroupKeywordName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
