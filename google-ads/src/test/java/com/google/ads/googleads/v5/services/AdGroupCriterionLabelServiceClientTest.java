...
public class AdGroupCriterionLabelServiceClientTest {
  ...
  public void getAdGroupCriterionLabelTest() {
    com.google.ads.googleads.v5.services.AdGroupCriterionLabelName resourceName2 =
        com.google.ads.googleads.v5.services.AdGroupCriterionLabelName.of(
            "[CUSTOMER]", "[AD_GROUP_CRITERION_LABEL]");
    AdGroupCriterionLabel expectedResponse =
        AdGroupCriterionLabel.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, AdGroupCriterionLabelName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
