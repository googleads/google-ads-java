...
public class AdGroupAdAssetViewServiceClientTest {
  ...
  public void getAdGroupAdAssetViewTest() {
    ...
    AdGroupAdAssetView expectedResponse =
        AdGroupAdAssetView.newBuilder().setResourceName(resourceName2).build();
    mockAdGroupAdAssetViewService.addResponse(expectedResponse);

    String formattedResourceName =
        AdGroupAdAssetViewServiceClient.formatAdGroupAdAssetViewName(
            "[CUSTOMER]", "[AD_GROUP_AD_ASSET_VIEW]");

    AdGroupAdAssetView actualResponse = client.getAdGroupAdAssetView(formattedResourceName);
