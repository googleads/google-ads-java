...
public class HotelPerformanceViewServiceClientTest {
  ...
  public void getHotelPerformanceViewTest() {
    ...
    HotelPerformanceView expectedResponse =
        HotelPerformanceView.newBuilder().setResourceName(resourceName2).build();
    mockHotelPerformanceViewService.addResponse(expectedResponse);

    String formattedResourceName =
        HotelPerformanceViewServiceClient.formatCustomerHotelPerformanceViewName("[CUSTOMER]");

    HotelPerformanceView actualResponse = client.getHotelPerformanceView(formattedResourceName);
    Assert.assertEquals(expectedResponse, actualResponse);

    List<GeneratedMessageV3> actualRequests = mockHotelPerformanceViewService.getRequests();
