...
public class ThirdPartyAppAnalyticsLinkServiceClientTest {
  ...
  public void getThirdPartyAppAnalyticsLinkTest() {
    ...
    ThirdPartyAppAnalyticsLink expectedResponse =
        ThirdPartyAppAnalyticsLink.newBuilder().setResourceName(resourceName2).build();
    mockThirdPartyAppAnalyticsLinkService.addResponse(expectedResponse);

    String formattedResourceName =
        ThirdPartyAppAnalyticsLinkServiceClient.formatThirdPartyAppAnalyticsLinkName(
            "[CUSTOMER]", "[THIRD_PARTY_APP_ANALYTICS_LINK]");

    ThirdPartyAppAnalyticsLink actualResponse =
        client.getThirdPartyAppAnalyticsLink(formattedResourceName);
