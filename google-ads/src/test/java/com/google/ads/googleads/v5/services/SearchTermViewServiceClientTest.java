...
public class SearchTermViewServiceClientTest {
  ...
  public void getSearchTermViewTest() {
    com.google.ads.googleads.v5.services.SearchTermViewName resourceName2 =
        com.google.ads.googleads.v5.services.SearchTermViewName.of(
            "[CUSTOMER]", "[SEARCH_TERM_VIEW]");
    SearchTermView expectedResponse =
        SearchTermView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, SearchTermViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
