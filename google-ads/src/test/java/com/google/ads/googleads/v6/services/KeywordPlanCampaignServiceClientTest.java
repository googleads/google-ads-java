...
public class KeywordPlanCampaignServiceClientTest {
  ...
  public void getKeywordPlanCampaignTest() {
    com.google.ads.googleads.v6.services.KeywordPlanCampaignName resourceName2 =
        com.google.ads.googleads.v6.services.KeywordPlanCampaignName.of(
            "[CUSTOMER_ID]", "[KEYWORD_PLAN_CAMPAIGN_ID]");
    KeywordPlanName keywordPlan = KeywordPlanName.of("[CUSTOMER_ID]", "[KEYWORD_PLAN_ID]");
    long id = 3355L;
    com.google.ads.googleads.v6.services.KeywordPlanCampaignName name =
        com.google.ads.googleads.v6.services.KeywordPlanCampaignName.of(
            "[CUSTOMER_ID]", "[KEYWORD_PLAN_CAMPAIGN_ID]");
