...
public class CampaignDraftServiceClientTest {
  ...
  public void getCampaignDraftTest() {
    com.google.ads.googleads.v6.services.CampaignDraftName resourceName2 =
        com.google.ads.googleads.v6.services.CampaignDraftName.of(
            "[CUSTOMER_ID]", "[BASE_CAMPAIGN_ID]", "[DRAFT_ID]");
    long draftId = 841643911L;
    CampaignName baseCampaign = CampaignName.of("[CUSTOMER_ID]", "[CAMPAIGN_ID]");
    com.google.ads.googleads.v6.services.CampaignDraftName name =
        com.google.ads.googleads.v6.services.CampaignDraftName.of(
            "[CUSTOMER_ID]", "[BASE_CAMPAIGN_ID]", "[DRAFT_ID]");
    CampaignName draftCampaign = CampaignName.of("[CUSTOMER_ID]", "[CAMPAIGN_ID]");
    boolean hasExperimentRunning = true;
    ...
    CampaignDraft expectedResponse =
        CampaignDraft.newBuilder()
            ...
            .setDraftId(draftId)
            .setBaseCampaign(baseCampaign.toString())
            .setName(name.toString())
            .setDraftCampaign(draftCampaign.toString())
            .setHasExperimentRunning(hasExperimentRunning)
    ...
    CampaignDraft actualResponse = client.getCampaignDraft(resourceName);
    ...
    Assert.assertEquals(resourceName, CampaignDraftName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void getCampaignDraftExceptionTest() throws Exception {
    ...
    try {
      ...
      client.getCampaignDraft(resourceName);
  ...
  public void promoteCampaignDraftTest() throws Exception {
    ...
    String campaignDraft = "campaignDraft-1319448142";

    Empty actualResponse = client.promoteCampaignDraftAsync(campaignDraft).get();
    Assert.assertEquals(expectedResponse, actualResponse);

    List<AbstractMessage> actualRequests = mockCampaignDraftService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    PromoteCampaignDraftRequest actualRequest = (PromoteCampaignDraftRequest) actualRequests.get(0);
  ...
  @Test
  @SuppressWarnings("all")
  public void listCampaignDraftAsyncErrorsTest() {
