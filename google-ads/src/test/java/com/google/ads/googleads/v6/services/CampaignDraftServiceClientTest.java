...
public class CampaignDraftServiceClientTest {
  ...
  @Test
  public void getCampaignDraftTest() throws Exception {
  ...
  @Test
  public void getCampaignDraftTest2() throws Exception {
    CampaignDraft expectedResponse =
        CampaignDraft.newBuilder()
            .setResourceName(
                CampaignDraftName.of("[CUSTOMER_ID]", "[BASE_CAMPAIGN_ID]", "[DRAFT_ID]")
  ...
  @Test
  public void getCampaignDraftExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockCampaignDraftService.addException(exception);
