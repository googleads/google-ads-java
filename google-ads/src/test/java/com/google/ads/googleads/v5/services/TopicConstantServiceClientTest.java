...
public class TopicConstantServiceClientTest {
  ...
  public void getTopicConstantTest() {
    com.google.ads.googleads.v5.services.TopicConstantName resourceName2 =
        com.google.ads.googleads.v5.services.TopicConstantName.of("[TOPIC_CONSTANT]");
    long id = 3355L;
    com.google.ads.googleads.v5.services.TopicConstantName topicConstantParent =
        com.google.ads.googleads.v5.services.TopicConstantName.of("[TOPIC_CONSTANT]");
    TopicConstant expectedResponse =
        TopicConstant.newBuilder()
            .setResourceName(resourceName2.toString())
            .setId(id)
            .setTopicConstantParent(topicConstantParent.toString())
            .build();
    ...
    Assert.assertEquals(resourceName, TopicConstantName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
