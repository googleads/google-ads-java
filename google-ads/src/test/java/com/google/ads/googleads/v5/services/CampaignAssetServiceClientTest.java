...
public class CampaignAssetServiceClientTest {
  ...
  public void getCampaignAssetTest() {
    com.google.ads.googleads.v5.services.CampaignAssetName resourceName2 =
        com.google.ads.googleads.v5.services.CampaignAssetName.of(
            "[CUSTOMER]", "[CAMPAIGN_ASSET]");
    CampaignAsset expectedResponse =
        CampaignAsset.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, CampaignAssetName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCampaignAssetsTest() {
    MutateCampaignAssetsResponse expectedResponse =
        MutateCampaignAssetsResponse.newBuilder().build();
    mockCampaignAssetService.addResponse(expectedResponse);
    ...
    List<AbstractMessage> actualRequests = mockCampaignAssetService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    MutateCampaignAssetsRequest actualRequest = (MutateCampaignAssetsRequest) actualRequests.get(0);
