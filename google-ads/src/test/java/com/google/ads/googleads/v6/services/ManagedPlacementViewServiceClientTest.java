...
public class ManagedPlacementViewServiceClientTest {
  ...
  public void getManagedPlacementViewTest() {
    com.google.ads.googleads.v6.services.ManagedPlacementViewName resourceName2 =
        com.google.ads.googleads.v6.services.ManagedPlacementViewName.of(
            "[CUSTOMER_ID]", "[AD_GROUP_ID]", "[CRITERION_ID]");
    ManagedPlacementView expectedResponse =
        ManagedPlacementView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, ManagedPlacementViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
