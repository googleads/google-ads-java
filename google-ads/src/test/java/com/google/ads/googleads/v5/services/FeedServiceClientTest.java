...
public class FeedServiceClientTest {
  ...
  public void getFeedTest() {
    com.google.ads.googleads.v5.services.FeedName resourceName2 =
        com.google.ads.googleads.v5.services.FeedName.of("[CUSTOMER]", "[FEED]");
    Feed expectedResponse = Feed.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, FeedName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
