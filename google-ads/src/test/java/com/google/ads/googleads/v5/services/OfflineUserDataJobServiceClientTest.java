...
public class OfflineUserDataJobServiceClientTest {
  ...
  public void runOfflineUserDataJobTest() throws Exception {
    ...
    Empty actualResponse = client.runOfflineUserDataJobAsync(resourceName).get();
    ...
    Assert.assertEquals(
        resourceName, OfflineUserDataJobName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  public void getOfflineUserDataJobTest() {
    com.google.ads.googleads.v5.services.OfflineUserDataJobName resourceName2 =
        com.google.ads.googleads.v5.services.OfflineUserDataJobName.of(
            "[CUSTOMER]", "[OFFLINE_USER_DATA_JOB]");
    OfflineUserDataJob expectedResponse =
        OfflineUserDataJob.newBuilder().setResourceName(resourceName2.toString()).build();
    mockOfflineUserDataJobService.addResponse(expectedResponse);
