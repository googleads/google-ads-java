...
public class CampaignExtensionSettingServiceClientTest {
  ...
  public void getCampaignExtensionSettingTest() {
    com.google.ads.googleads.v5.services.CampaignExtensionSettingName resourceName2 =
        com.google.ads.googleads.v5.services.CampaignExtensionSettingName.of(
            "[CUSTOMER]", "[CAMPAIGN_EXTENSION_SETTING]");
    CampaignExtensionSetting expectedResponse =
        CampaignExtensionSetting.newBuilder().setResourceName(resourceName2.toString()).build();
