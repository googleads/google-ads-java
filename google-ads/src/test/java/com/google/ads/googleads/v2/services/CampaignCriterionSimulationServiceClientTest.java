...
public class CampaignCriterionSimulationServiceClientTest {
  ...
  public void getCampaignCriterionSimulationTest() {
    ...
    CampaignCriterionSimulation expectedResponse =
        CampaignCriterionSimulation.newBuilder().setResourceName(resourceName2).build();
    mockCampaignCriterionSimulationService.addResponse(expectedResponse);

    String formattedResourceName =
        CampaignCriterionSimulationServiceClient.formatCampaignCriterionSimulationName(
