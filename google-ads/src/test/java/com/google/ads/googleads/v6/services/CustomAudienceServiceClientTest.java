...
public class CustomAudienceServiceClientTest {
  ...
  public void getCustomAudienceTest() {
    com.google.ads.googleads.v6.services.CustomAudienceName resourceName2 =
        com.google.ads.googleads.v6.services.CustomAudienceName.of(
            "[CUSTOMER_ID]", "[CUSTOM_AUDIENCE_ID]");
    long id = 3355L;
    com.google.ads.googleads.v6.services.CustomAudienceName name =
        com.google.ads.googleads.v6.services.CustomAudienceName.of(
            "[CUSTOMER_ID]", "[CUSTOM_AUDIENCE_ID]");
    ...
    Assert.assertEquals(resourceName, CustomAudienceName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCustomAudiencesTest() {
    MutateCustomAudiencesResponse expectedResponse =
        MutateCustomAudiencesResponse.newBuilder().build();
    mockCustomAudienceService.addResponse(expectedResponse);
