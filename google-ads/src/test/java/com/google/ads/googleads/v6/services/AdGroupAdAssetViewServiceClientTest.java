...
public class AdGroupAdAssetViewServiceClientTest {
  ...
  public void getAdGroupAdAssetViewTest() {
    com.google.ads.googleads.v6.services.AdGroupAdAssetViewName resourceName2 =
        com.google.ads.googleads.v6.services.AdGroupAdAssetViewName.of(
            "[CUSTOMER_ID]", "[AD_GROUP_ID]", "[AD_ID]", "[ASSET_ID]", "[FIELD_TYPE]");
    AdGroupAdName adGroupAd = AdGroupAdName.of("[CUSTOMER_ID]", "[AD_GROUP_ID]", "[AD_ID]");
    AssetName asset = AssetName.of("[CUSTOMER_ID]", "[ASSET_ID]");
