...
public class TopicViewServiceClientTest {
  ...
  public void getTopicViewTest() {
    com.google.ads.googleads.v5.services.TopicViewName resourceName2 =
        com.google.ads.googleads.v5.services.TopicViewName.of("[CUSTOMER]", "[TOPIC_VIEW]");
    TopicView expectedResponse =
        TopicView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, TopicViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
