...
public class BatchJobServiceClientTest {
  ...
  public void getBatchJobTest() {
    com.google.ads.googleads.v6.services.BatchJobName resourceName2 =
        com.google.ads.googleads.v6.services.BatchJobName.of("[CUSTOMER_ID]", "[BATCH_JOB_ID]");
    long id = 3355L;
    String nextAddSequenceToken = "nextAddSequenceToken1654552613";
    String longRunningOperation = "longRunningOperation827165668";
    BatchJob expectedResponse =
        BatchJob.newBuilder()
            .setResourceName(resourceName2.toString())
            .setId(id)
            .setNextAddSequenceToken(nextAddSequenceToken)
