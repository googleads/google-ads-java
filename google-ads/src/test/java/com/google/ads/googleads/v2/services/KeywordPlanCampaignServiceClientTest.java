...
public class KeywordPlanCampaignServiceClientTest {
  ...
  public void getKeywordPlanCampaignTest() {
    String resourceName2 = "resourceName2625949903";
    KeywordPlanCampaign expectedResponse =
        KeywordPlanCampaign.newBuilder().setResourceName(resourceName2).build();
    mockKeywordPlanCampaignService.addResponse(expectedResponse);

    String formattedResourceName =
        KeywordPlanCampaignServiceClient.formatKeywordPlanCampaignName(
            "[CUSTOMER]", "[KEYWORD_PLAN_CAMPAIGN]");
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateKeywordPlanCampaignsTest() {
    MutateKeywordPlanCampaignsResponse expectedResponse =
        MutateKeywordPlanCampaignsResponse.newBuilder().build();
    mockKeywordPlanCampaignService.addResponse(expectedResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateKeywordPlanCampaignsTest2() {
    MutateKeywordPlanCampaignsResponse expectedResponse =
        MutateKeywordPlanCampaignsResponse.newBuilder().build();
    mockKeywordPlanCampaignService.addResponse(expectedResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateKeywordPlanCampaignsExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(Status.INVALID_ARGUMENT);
    mockKeywordPlanCampaignService.addException(exception);
