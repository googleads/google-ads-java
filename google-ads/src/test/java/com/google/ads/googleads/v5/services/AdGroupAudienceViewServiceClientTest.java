...
public class AdGroupAudienceViewServiceClientTest {
  ...
  public void getAdGroupAudienceViewTest() {
    com.google.ads.googleads.v5.services.AdGroupAudienceViewName resourceName2 =
        com.google.ads.googleads.v5.services.AdGroupAudienceViewName.of(
            "[CUSTOMER]", "[AD_GROUP_AUDIENCE_VIEW]");
    AdGroupAudienceView expectedResponse =
        AdGroupAudienceView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, AdGroupAudienceViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
