...
public class KeywordPlanAdGroupServiceClientTest {
  ...
  public void getKeywordPlanAdGroupTest() {
    com.google.ads.googleads.v6.services.KeywordPlanAdGroupName resourceName2 =
        com.google.ads.googleads.v6.services.KeywordPlanAdGroupName.of(
            "[CUSTOMER_ID]", "[KEYWORD_PLAN_AD_GROUP_ID]");
    KeywordPlanCampaignName keywordPlanCampaign =
        KeywordPlanCampaignName.of("[CUSTOMER_ID]", "[KEYWORD_PLAN_CAMPAIGN_ID]");
    long id = 3355L;
    com.google.ads.googleads.v6.services.KeywordPlanAdGroupName name =
        com.google.ads.googleads.v6.services.KeywordPlanAdGroupName.of(
            "[CUSTOMER_ID]", "[KEYWORD_PLAN_AD_GROUP_ID]");
    ...
    KeywordPlanAdGroup expectedResponse =
        KeywordPlanAdGroup.newBuilder()
            ...
            .setKeywordPlanCampaign(keywordPlanCampaign.toString())
            .setId(id)
    ...
    Assert.assertEquals(
        resourceName, KeywordPlanAdGroupName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
