...
public class SearchTermViewServiceClientTest {
  ...
  public void getSearchTermViewTest() {
    String resourceName2 = "resourceName2625949903";
    SearchTermView expectedResponse =
        SearchTermView.newBuilder().setResourceName(resourceName2).build();
    ...
    SearchTermView actualResponse = client.getSearchTermView(formattedResourceName);
    Assert.assertEquals(expectedResponse, actualResponse);

    List<GeneratedMessageV3> actualRequests = mockSearchTermViewService.getRequests();
