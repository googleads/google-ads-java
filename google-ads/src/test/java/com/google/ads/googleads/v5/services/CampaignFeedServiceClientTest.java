...
public class CampaignFeedServiceClientTest {
  ...
  public void getCampaignFeedTest() {
    com.google.ads.googleads.v5.services.CampaignFeedName resourceName2 =
        com.google.ads.googleads.v5.services.CampaignFeedName.of("[CUSTOMER]", "[CAMPAIGN_FEED]");
    CampaignFeed expectedResponse =
        CampaignFeed.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, CampaignFeedName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
