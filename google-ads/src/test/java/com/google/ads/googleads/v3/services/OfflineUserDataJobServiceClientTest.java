...
public class OfflineUserDataJobServiceClientTest {
  ...
  public void createOfflineUserDataJobTest() {
    String resourceName = "resourceName979421212";
    CreateOfflineUserDataJobResponse expectedResponse =
        CreateOfflineUserDataJobResponse.newBuilder().setResourceName(resourceName).build();
  ...
  @Test
  @SuppressWarnings("all")
  public void getOfflineUserDataJobTest() {
    String resourceName2 = "resourceName2625949903";
    OfflineUserDataJob expectedResponse =
        OfflineUserDataJob.newBuilder().setResourceName(resourceName2).build();
    mockOfflineUserDataJobService.addResponse(expectedResponse);
    ...
    OfflineUserDataJob actualResponse = client.getOfflineUserDataJob(formattedResourceName);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void runOfflineUserDataJobExceptionTest() throws Exception {
    ...
    try {
      ...
      client.runOfflineUserDataJobAsync(formattedResourceName).get();
      Assert.fail("No exception raised");
