...
public class CampaignCriterionServiceClientTest {
  ...
  public void getCampaignCriterionTest() {
    com.google.ads.googleads.v5.services.CampaignCriterionName resourceName2 =
        com.google.ads.googleads.v5.services.CampaignCriterionName.of(
            "[CUSTOMER]", "[CAMPAIGN_CRITERION]");
    CampaignName campaign = CampaignName.of("[CUSTOMER]", "[CAMPAIGN]");
    long criterionId = 326773895L;
    float bidModifier = 1.36236335E8F;
    ...
    Assert.assertEquals(resourceName, CampaignCriterionName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
