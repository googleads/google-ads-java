...
public class CustomerServiceClientTest {
  ...
  public void mutateCustomerTest() {
    ...
    MutateCustomerResponse actualResponse =
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCustomerTest2() {
    MutateCustomerResponse expectedResponse = MutateCustomerResponse.newBuilder().build();
    mockCustomerService.addResponse(expectedResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCustomerExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(Status.INVALID_ARGUMENT);
    mockCustomerService.addException(exception);
  ...
  public void createCustomerClientTest() {
    ...
    CreateCustomerClientResponse expectedResponse =
        CreateCustomerClientResponse.newBuilder().setResourceName(resourceName).build();
    mockCustomerService.addResponse(expectedResponse);
    ...
    Assert.assertEquals(emailAddress, actualRequest.getEmailAddress());
    Assert.assertEquals(accessRole, actualRequest.getAccessRole());
    Assert.assertTrue(
        channelProvider.isHeaderSent(
            ApiClientHeaderProvider.getDefaultApiClientHeaderKey(),
            GaxGrpcProperties.getDefaultApiClientHeaderPattern()));
  ...
  @Test
  @SuppressWarnings("all")
  public void createCustomerClientTest2() {
    String resourceName = "resourceName979421212";
    CreateCustomerClientResponse expectedResponse =
        CreateCustomerClientResponse.newBuilder().setResourceName(resourceName).build();
    mockCustomerService.addResponse(expectedResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void createCustomerClientExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(Status.INVALID_ARGUMENT);
    mockCustomerService.addException(exception);
