...
public class PaymentsAccountServiceClientTest {
  ...
  public void listPaymentsAccountsTest() {
    ListPaymentsAccountsResponse expectedResponse =
        ListPaymentsAccountsResponse.newBuilder().build();
    ...
    List<GeneratedMessageV3> actualRequests = mockPaymentsAccountService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    ListPaymentsAccountsRequest actualRequest = (ListPaymentsAccountsRequest) actualRequests.get(0);
