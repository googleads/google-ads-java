...
public class VideoServiceClientTest {
  ...
  public void getVideoTest() {
    com.google.ads.googleads.v5.services.VideoName resourceName2 =
        com.google.ads.googleads.v5.services.VideoName.of("[CUSTOMER]", "[VIDEO]");
    Video expectedResponse = Video.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, VideoName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
