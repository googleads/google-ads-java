...
import com.google.ads.googleads.v4.enums.KeywordPlanNetworkEnum;
...
public class KeywordPlanIdeaServiceClientTest {
  ...
  public void generateKeywordIdeasTest() {
    ...
    long totalSize = 705419236L;
    GenerateKeywordIdeaResult resultsElement = GenerateKeywordIdeaResult.newBuilder().build();
    List<GenerateKeywordIdeaResult> results = Arrays.asList(resultsElement);
    ...
    boolean includeAdultKeywords = true;
    ...
    Assert.assertEquals(includeAdultKeywords, actualRequest.getIncludeAdultKeywords());
