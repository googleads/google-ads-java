...
public class PaidOrganicSearchTermViewServiceClientTest {
  ...
  public void getPaidOrganicSearchTermViewTest() {
    com.google.ads.googleads.v5.services.PaidOrganicSearchTermViewName resourceName2 =
        com.google.ads.googleads.v5.services.PaidOrganicSearchTermViewName.of(
            "[CUSTOMER]", "[PAID_ORGANIC_SEARCH_TERM_VIEW]");
    PaidOrganicSearchTermView expectedResponse =
        PaidOrganicSearchTermView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, PaidOrganicSearchTermViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
