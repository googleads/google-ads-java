...
public class CustomerFeedServiceClientTest {
  ...
  public void getCustomerFeedTest() {
    com.google.ads.googleads.v5.services.CustomerFeedName resourceName2 =
        com.google.ads.googleads.v5.services.CustomerFeedName.of("[CUSTOMER]", "[CUSTOMER_FEED]");
    CustomerFeed expectedResponse =
        CustomerFeed.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, CustomerFeedName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
