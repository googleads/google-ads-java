...
public class DomainCategoryServiceClientTest {
  ...
  public void getDomainCategoryTest() {
    ...
    DomainCategory expectedResponse =
        DomainCategory.newBuilder().setResourceName(resourceName2).build();
    ...
    DomainCategory actualResponse = client.getDomainCategory(formattedResourceName);
    Assert.assertEquals(expectedResponse, actualResponse);

    List<GeneratedMessageV3> actualRequests = mockDomainCategoryService.getRequests();
