...
public class KeywordPlanAdGroupServiceClientTest {
  ...
  public void getKeywordPlanAdGroupTest() {
    String resourceName2 = "resourceName2625949903";
    KeywordPlanAdGroup expectedResponse =
        KeywordPlanAdGroup.newBuilder().setResourceName(resourceName2).build();
    mockKeywordPlanAdGroupService.addResponse(expectedResponse);

    String formattedResourceName =
        KeywordPlanAdGroupServiceClient.formatKeywordPlanAdGroupName(
            "[CUSTOMER]", "[KEYWORD_PLAN_AD_GROUP]");

    KeywordPlanAdGroup actualResponse = client.getKeywordPlanAdGroup(formattedResourceName);
    Assert.assertEquals(expectedResponse, actualResponse);

    List<GeneratedMessageV3> actualRequests = mockKeywordPlanAdGroupService.getRequests();
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateKeywordPlanAdGroupsTest() {
    MutateKeywordPlanAdGroupsResponse expectedResponse =
        MutateKeywordPlanAdGroupsResponse.newBuilder().build();
    mockKeywordPlanAdGroupService.addResponse(expectedResponse);
    ...
    MutateKeywordPlanAdGroupsResponse actualResponse =
        client.mutateKeywordPlanAdGroups(customerId, operations, partialFailure, validateOnly);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateKeywordPlanAdGroupsTest2() {
    MutateKeywordPlanAdGroupsResponse expectedResponse =
        MutateKeywordPlanAdGroupsResponse.newBuilder().build();
    mockKeywordPlanAdGroupService.addResponse(expectedResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateKeywordPlanAdGroupsExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(Status.INVALID_ARGUMENT);
    mockKeywordPlanAdGroupService.addException(exception);
