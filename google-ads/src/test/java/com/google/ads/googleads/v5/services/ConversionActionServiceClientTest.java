...
public class ConversionActionServiceClientTest {
  ...
  public void getConversionActionTest() {
    com.google.ads.googleads.v5.services.ConversionActionName resourceName2 =
        com.google.ads.googleads.v5.services.ConversionActionName.of(
            "[CUSTOMER]", "[CONVERSION_ACTION]");
    long id = 3355L;
    com.google.ads.googleads.v5.services.ConversionActionName name =
        com.google.ads.googleads.v5.services.ConversionActionName.of(
            "[CUSTOMER]", "[CONVERSION_ACTION]");
    String ownerCustomer = "ownerCustomer-857925654";
    boolean includeInConversionsMetric = false;
    long clickThroughLookbackWindowDays = 1040290530L;
    long viewThroughLookbackWindowDays = 990677281L;
    long phoneCallDurationSeconds = 917713540L;
    String appId = "appId-1411074055";
    ConversionAction expectedResponse =
        ConversionAction.newBuilder()
            .setResourceName(resourceName2.toString())
            .setId(id)
            .setName(name.toString())
            .setOwnerCustomer(ownerCustomer)
            .setIncludeInConversionsMetric(includeInConversionsMetric)
            .setClickThroughLookbackWindowDays(clickThroughLookbackWindowDays)
            .setViewThroughLookbackWindowDays(viewThroughLookbackWindowDays)
            .setPhoneCallDurationSeconds(phoneCallDurationSeconds)
            .setAppId(appId)
            .build();
    ...
    Assert.assertEquals(resourceName, ConversionActionName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateConversionActionsTest() {
    MutateConversionActionsResponse expectedResponse =
        MutateConversionActionsResponse.newBuilder().build();
    mockConversionActionService.addResponse(expectedResponse);
