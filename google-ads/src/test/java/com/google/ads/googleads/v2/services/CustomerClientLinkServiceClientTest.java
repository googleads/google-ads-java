...
import com.google.ads.googleads.v2.resources.CustomerClientLink;
...
public class CustomerClientLinkServiceClientTest {
  ...
  public void getCustomerClientLinkTest() {
    ...
    CustomerClientLink expectedResponse =
        CustomerClientLink.newBuilder().setResourceName(resourceName2).build();
    mockCustomerClientLinkService.addResponse(expectedResponse);

    String formattedResourceName =
        CustomerClientLinkServiceClient.formatCustomerClientLinkName(
            "[CUSTOMER]", "[CUSTOMER_CLIENT_LINK]");

    CustomerClientLink actualResponse = client.getCustomerClientLink(formattedResourceName);
