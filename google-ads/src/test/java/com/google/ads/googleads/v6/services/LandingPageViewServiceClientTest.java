...
public class LandingPageViewServiceClientTest {
  ...
  public void getLandingPageViewTest() {
    com.google.ads.googleads.v6.services.LandingPageViewName resourceName2 =
        com.google.ads.googleads.v6.services.LandingPageViewName.of(
            "[CUSTOMER_ID]", "[UNEXPANDED_FINAL_URL_FINGERPRINT]");
    String unexpandedFinalUrl = "unexpandedFinalUrl2091506041";
    LandingPageView expectedResponse =
        LandingPageView.newBuilder()
            .setResourceName(resourceName2.toString())
            .setUnexpandedFinalUrl(unexpandedFinalUrl)
            .build();
    ...
    Assert.assertEquals(resourceName, LandingPageViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
