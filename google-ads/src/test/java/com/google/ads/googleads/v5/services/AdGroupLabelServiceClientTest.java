...
public class AdGroupLabelServiceClientTest {
  ...
  public void getAdGroupLabelTest() {
    com.google.ads.googleads.v5.services.AdGroupLabelName resourceName2 =
        com.google.ads.googleads.v5.services.AdGroupLabelName.of("[CUSTOMER]", "[AD_GROUP_LABEL]");
    AdGroupLabel expectedResponse =
        AdGroupLabel.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, AdGroupLabelName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
