...
public class KeywordPlanAdGroupKeywordServiceClientTest {
  ...
  public void getKeywordPlanAdGroupKeywordTest() {
    String resourceName2 = "resourceName2625949903";
    KeywordPlanAdGroupKeyword expectedResponse =
        KeywordPlanAdGroupKeyword.newBuilder().setResourceName(resourceName2).build();
    mockKeywordPlanAdGroupKeywordService.addResponse(expectedResponse);

    String formattedResourceName =
        KeywordPlanAdGroupKeywordServiceClient.formatKeywordPlanAdGroupKeywordName(
            "[CUSTOMER]", "[KEYWORD_PLAN_AD_GROUP_KEYWORD]");

    KeywordPlanAdGroupKeyword actualResponse =
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateKeywordPlanAdGroupKeywordsTest() {
    MutateKeywordPlanAdGroupKeywordsResponse expectedResponse =
        MutateKeywordPlanAdGroupKeywordsResponse.newBuilder().build();
    mockKeywordPlanAdGroupKeywordService.addResponse(expectedResponse);
  ...
  public void mutateKeywordPlanAdGroupKeywordsExceptionTest() throws Exception {
    ...
    try {
      ...
      client.mutateKeywordPlanAdGroupKeywords(customerId, operations, partialFailure, validateOnly);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception
    }
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateKeywordPlanAdGroupKeywordsTest2() {
    MutateKeywordPlanAdGroupKeywordsResponse expectedResponse =
        MutateKeywordPlanAdGroupKeywordsResponse.newBuilder().build();
    mockKeywordPlanAdGroupKeywordService.addResponse(expectedResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateKeywordPlanAdGroupKeywordsExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(Status.INVALID_ARGUMENT);
    mockKeywordPlanAdGroupKeywordService.addException(exception);
