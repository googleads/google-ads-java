...
public class ChangeStatusServiceClientTest {
  ...
  public void getChangeStatusTest() {
    com.google.ads.googleads.v5.services.ChangeStatusName resourceName2 =
        com.google.ads.googleads.v5.services.ChangeStatusName.of("[CUSTOMER]", "[CHANGE_STATUS]");
    ...
    Assert.assertEquals(resourceName, ChangeStatusName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
