...
import com.google.ads.googleads.v14.common.ManualCpm;
...
import com.google.ads.googleads.v14.resources.Campaign.SelectiveOptimization;
import com.google.ads.googleads.v14.resources.Campaign.TrackingSetting;
...
public class FieldMasksTest {
  ...
  public void getFieldValue_non_message_throws_exception() {
    ...
    assertEquals(
        "Unable to access subfield of google.ads.googleads.v14.resources.Campaign.status which is"
            + " not a Message",
        exception.getMessage());
  }
