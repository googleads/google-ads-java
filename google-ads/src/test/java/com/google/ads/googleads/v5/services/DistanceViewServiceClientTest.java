...
public class DistanceViewServiceClientTest {
  ...
  public void getDistanceViewTest() {
    com.google.ads.googleads.v5.services.DistanceViewName resourceName2 =
        com.google.ads.googleads.v5.services.DistanceViewName.of("[CUSTOMER]", "[DISTANCE_VIEW]");
    ...
    Assert.assertEquals(resourceName, DistanceViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
