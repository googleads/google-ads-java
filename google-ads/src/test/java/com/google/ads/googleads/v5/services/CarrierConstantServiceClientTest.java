...
public class CarrierConstantServiceClientTest {
  ...
  public void getCarrierConstantTest() {
    com.google.ads.googleads.v5.services.CarrierConstantName resourceName2 =
        com.google.ads.googleads.v5.services.CarrierConstantName.of("[CARRIER_CONSTANT]");
    long id = 3355L;
    com.google.ads.googleads.v5.services.CarrierConstantName name =
        com.google.ads.googleads.v5.services.CarrierConstantName.of("[CARRIER_CONSTANT]");
    ...
    Assert.assertEquals(resourceName, CarrierConstantName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
