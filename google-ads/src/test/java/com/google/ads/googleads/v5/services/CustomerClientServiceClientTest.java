...
public class CustomerClientServiceClientTest {
  ...
  public void getCustomerClientTest() {
    com.google.ads.googleads.v5.services.CustomerClientName resourceName2 =
        com.google.ads.googleads.v5.services.CustomerClientName.of(
            "[CUSTOMER]", "[CUSTOMER_CLIENT]");
    CustomerClient expectedResponse =
        CustomerClient.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, CustomerClientName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
