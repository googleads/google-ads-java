...
public class MediaFileServiceClientTest {
  ...
  public void getMediaFileTest() {
    com.google.ads.googleads.v6.services.MediaFileName resourceName2 =
        com.google.ads.googleads.v6.services.MediaFileName.of("[CUSTOMER_ID]", "[MEDIA_FILE_ID]");
    long id = 3355L;
    String sourceUrl = "sourceUrl-1111107765";
    com.google.ads.googleads.v6.services.MediaFileName name =
        com.google.ads.googleads.v6.services.MediaFileName.of("[CUSTOMER_ID]", "[MEDIA_FILE_ID]");
    long fileSize = 1316310812L;
    ...
    Assert.assertEquals(resourceName, MediaFileName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
