...
public class GoogleAdsFieldServiceClientTest {
  ...
  public void getGoogleAdsFieldTest() {
    com.google.ads.googleads.v5.services.GoogleAdsFieldName resourceName2 =
        com.google.ads.googleads.v5.services.GoogleAdsFieldName.of("[GOOGLE_ADS_FIELD]");
    com.google.ads.googleads.v5.services.GoogleAdsFieldName name =
        com.google.ads.googleads.v5.services.GoogleAdsFieldName.of("[GOOGLE_ADS_FIELD]");
    boolean selectable = true;
    boolean filterable = true;
    boolean sortable = true;
    String typeUrl = "typeUrl-675981590";
    ...
    Assert.assertEquals(resourceName, GoogleAdsFieldName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
