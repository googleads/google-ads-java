...
public class KeywordPlanCampaignServiceClientTest {
  ...
  public void getKeywordPlanCampaignTest() {
    com.google.ads.googleads.v5.services.KeywordPlanCampaignName resourceName2 =
        com.google.ads.googleads.v5.services.KeywordPlanCampaignName.of(
            "[CUSTOMER]", "[KEYWORD_PLAN_CAMPAIGN]");
    KeywordPlanCampaign expectedResponse =
        KeywordPlanCampaign.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, KeywordPlanCampaignName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
