...
public class ConversionUploadServiceClientTest {
  ...
  @Test
  @SuppressWarnings("all")
  public void uploadClickConversionsTest2() {
    UploadClickConversionsResponse expectedResponse =
        UploadClickConversionsResponse.newBuilder().build();
    mockConversionUploadService.addResponse(expectedResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void uploadCallConversionsTest() {
    UploadCallConversionsResponse expectedResponse =
        UploadCallConversionsResponse.newBuilder().build();
    mockConversionUploadService.addResponse(expectedResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void uploadCallConversionsTest2() {
    UploadCallConversionsResponse expectedResponse =
        UploadCallConversionsResponse.newBuilder().build();
    mockConversionUploadService.addResponse(expectedResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void uploadCallConversionsExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(Status.INVALID_ARGUMENT);
    mockConversionUploadService.addException(exception);
