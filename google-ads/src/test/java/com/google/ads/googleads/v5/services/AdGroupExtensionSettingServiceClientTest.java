...
public class AdGroupExtensionSettingServiceClientTest {
  ...
  public void getAdGroupExtensionSettingTest() {
    com.google.ads.googleads.v5.services.AdGroupExtensionSettingName resourceName2 =
        com.google.ads.googleads.v5.services.AdGroupExtensionSettingName.of(
            "[CUSTOMER]", "[AD_GROUP_EXTENSION_SETTING]");
    AdGroupExtensionSetting expectedResponse =
        AdGroupExtensionSetting.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, AdGroupExtensionSettingName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateAdGroupExtensionSettingsTest() {
