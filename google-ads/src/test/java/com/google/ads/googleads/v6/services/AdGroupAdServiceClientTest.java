...
public class AdGroupAdServiceClientTest {
  ...
  public void getAdGroupAdTest() {
    com.google.ads.googleads.v6.services.AdGroupAdName resourceName2 =
        com.google.ads.googleads.v6.services.AdGroupAdName.of(
    ...
    Assert.assertEquals(resourceName, AdGroupAdName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
