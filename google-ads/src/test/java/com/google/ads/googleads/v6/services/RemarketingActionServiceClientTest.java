...
public class RemarketingActionServiceClientTest {
  ...
  public void getRemarketingActionTest() {
    com.google.ads.googleads.v6.services.RemarketingActionName resourceName2 =
        com.google.ads.googleads.v6.services.RemarketingActionName.of(
            "[CUSTOMER_ID]", "[REMARKETING_ACTION_ID]");
    long id = 3355L;
    com.google.ads.googleads.v6.services.RemarketingActionName name =
        com.google.ads.googleads.v6.services.RemarketingActionName.of(
            "[CUSTOMER_ID]", "[REMARKETING_ACTION_ID]");
