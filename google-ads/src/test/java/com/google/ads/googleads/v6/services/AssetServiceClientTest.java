...
public class AssetServiceClientTest {
  ...
  public void getAssetTest() {
    com.google.ads.googleads.v6.services.AssetName resourceName2 =
        com.google.ads.googleads.v6.services.AssetName.of("[CUSTOMER_ID]", "[ASSET_ID]");
    long id = 3355L;
    com.google.ads.googleads.v6.services.AssetName name =
        com.google.ads.googleads.v6.services.AssetName.of("[CUSTOMER_ID]", "[ASSET_ID]");
    ...
    Assert.assertEquals(resourceName, AssetName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateAssetsTest() {
    MutateAssetsResponse expectedResponse = MutateAssetsResponse.newBuilder().build();
    mockAssetService.addResponse(expectedResponse);
