...
public class CampaignBidModifierServiceClientTest {
  ...
  public void getCampaignBidModifierTest() {
    com.google.ads.googleads.v6.services.CampaignBidModifierName resourceName2 =
        com.google.ads.googleads.v6.services.CampaignBidModifierName.of(
    ...
    Assert.assertEquals(
        resourceName, CampaignBidModifierName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCampaignBidModifiersTest() {
    MutateCampaignBidModifiersResponse expectedResponse =
        MutateCampaignBidModifiersResponse.newBuilder().build();
    mockCampaignBidModifierService.addResponse(expectedResponse);
