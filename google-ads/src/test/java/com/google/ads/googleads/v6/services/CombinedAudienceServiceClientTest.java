...
public class CombinedAudienceServiceClientTest {
  ...
  public void getCombinedAudienceTest() {
    com.google.ads.googleads.v6.services.CombinedAudienceName resourceName2 =
        com.google.ads.googleads.v6.services.CombinedAudienceName.of(
            "[CUSTOMER_ID]", "[COMBINED_AUDIENCE_ID]");
    long id = 3355L;
    com.google.ads.googleads.v6.services.CombinedAudienceName name =
        com.google.ads.googleads.v6.services.CombinedAudienceName.of(
            "[CUSTOMER_ID]", "[COMBINED_AUDIENCE_ID]");
    ...
    Assert.assertEquals(resourceName, CombinedAudienceName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
