...
public class CampaignLabelServiceClientTest {
  ...
  public void getCampaignLabelTest() {
    com.google.ads.googleads.v5.services.CampaignLabelName resourceName2 =
        com.google.ads.googleads.v5.services.CampaignLabelName.of(
            "[CUSTOMER]", "[CAMPAIGN_LABEL]");
    CampaignLabel expectedResponse =
        CampaignLabel.newBuilder().setResourceName(resourceName2.toString()).build();
