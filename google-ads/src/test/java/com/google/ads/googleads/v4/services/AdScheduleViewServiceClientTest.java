...
public class AdScheduleViewServiceClientTest {
  ...
  public void getAdScheduleViewTest() {
    ...
    String formattedResourceName =
        AdScheduleViewServiceClient.formatAdScheduleViewName("[CUSTOMER]", "[AD_SCHEDULE_VIEW]");

    AdScheduleView actualResponse = client.getAdScheduleView(formattedResourceName);
