...
public class ReachPlanServiceClientTest {
  ...
  public void listPlannableLocationsTest() {
    ListPlannableLocationsResponse expectedResponse =
        ListPlannableLocationsResponse.newBuilder().build();
  ...
  @Test
  @SuppressWarnings("all")
  public void listPlannableProductsTest() {
    ListPlannableProductsResponse expectedResponse =
        ListPlannableProductsResponse.newBuilder().build();
    mockReachPlanService.addResponse(expectedResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void generateProductMixIdeasTest() {
    GenerateProductMixIdeasResponse expectedResponse =
        GenerateProductMixIdeasResponse.newBuilder().build();
    mockReachPlanService.addResponse(expectedResponse);
    ...
    GenerateProductMixIdeasResponse actualResponse = client.generateProductMixIdeas(request);
    Assert.assertEquals(expectedResponse, actualResponse);
    ...
    Assert.assertEquals(preferences, actualRequest.getPreferences());
    Assert.assertTrue(
        channelProvider.isHeaderSent(
            ApiClientHeaderProvider.getDefaultApiClientHeaderKey(),
            GaxGrpcProperties.getDefaultApiClientHeaderPattern()));
  ...
  public void generateProductMixIdeasExceptionTest() throws Exception {
    ...
    try {
      ...
      client.generateProductMixIdeas(request);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception
    }
  ...
  @Test
  @SuppressWarnings("all")
  public void generateReachForecastTest() {
    GenerateReachForecastResponse expectedResponse =
        GenerateReachForecastResponse.newBuilder().build();
    mockReachPlanService.addResponse(expectedResponse);
    ...
    FrequencyCap cookieFrequencyCapSetting = FrequencyCap.newBuilder().build();
    ...
    GenerateReachForecastRequest request =
        GenerateReachForecastRequest.newBuilder()
            ...
            .setCookieFrequencyCapSetting(cookieFrequencyCapSetting)
            .setMinEffectiveFrequency(minEffectiveFrequency)
            .setTargeting(targeting)
            .addAllPlannedProducts(plannedProducts)
            .build();

    GenerateReachForecastResponse actualResponse = client.generateReachForecast(request);
    Assert.assertEquals(expectedResponse, actualResponse);
    ...
    Assert.assertEquals(cookieFrequencyCap, actualRequest.getCookieFrequencyCap());
    Assert.assertEquals(cookieFrequencyCapSetting, actualRequest.getCookieFrequencyCapSetting());
    Assert.assertEquals(minEffectiveFrequency, actualRequest.getMinEffectiveFrequency());
    Assert.assertEquals(targeting, actualRequest.getTargeting());
  ...
  public void generateReachForecastExceptionTest() throws Exception {
    ...
    try {
      ...
      client.generateReachForecast(request);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception
    }
