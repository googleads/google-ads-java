...
public class ClickViewServiceClientTest {
  ...
  public void getClickViewTest() {
    com.google.ads.googleads.v5.services.ClickViewName resourceName2 =
        com.google.ads.googleads.v5.services.ClickViewName.of("[CUSTOMER]", "[CLICK_VIEW]");
    String gclid = "gclid98179115";
    long pageNumber = 1156954375L;
    AdGroupAdName adGroupAd = AdGroupAdName.of("[CUSTOMER]", "[AD_GROUP_AD]");
    GeoTargetConstantName campaignLocationTarget =
        GeoTargetConstantName.of("[GEO_TARGET_CONSTANT]");
    UserListName userList = UserListName.of("[CUSTOMER]", "[USER_LIST]");
    ClickView expectedResponse =
        ClickView.newBuilder()
            .setResourceName(resourceName2.toString())
            .setGclid(gclid)
            .setPageNumber(pageNumber)
            .setAdGroupAd(adGroupAd.toString())
            .setCampaignLocationTarget(campaignLocationTarget.toString())
    ...
    Assert.assertEquals(resourceName, ClickViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
