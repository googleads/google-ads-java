...
public class CustomerExtensionSettingServiceClientTest {
  ...
  public void getCustomerExtensionSettingTest() {
    ...
    CustomerExtensionSetting expectedResponse =
        CustomerExtensionSetting.newBuilder().setResourceName(resourceName2).build();
    mockCustomerExtensionSettingService.addResponse(expectedResponse);

    String formattedResourceName =
        CustomerExtensionSettingServiceClient.formatCustomerExtensionSettingName(
            "[CUSTOMER]", "[CUSTOMER_EXTENSION_SETTING]");

    CustomerExtensionSetting actualResponse =
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCustomerExtensionSettingsTest2() {
    MutateCustomerExtensionSettingsResponse expectedResponse =
        MutateCustomerExtensionSettingsResponse.newBuilder().build();
    mockCustomerExtensionSettingService.addResponse(expectedResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCustomerExtensionSettingsExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(Status.INVALID_ARGUMENT);
    mockCustomerExtensionSettingService.addException(exception);
