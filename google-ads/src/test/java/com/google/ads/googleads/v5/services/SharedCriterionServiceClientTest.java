...
public class SharedCriterionServiceClientTest {
  ...
  public void getSharedCriterionTest() {
    com.google.ads.googleads.v5.services.SharedCriterionName resourceName2 =
        com.google.ads.googleads.v5.services.SharedCriterionName.of(
            "[CUSTOMER]", "[SHARED_CRITERION]");
    SharedSetName sharedSet = SharedSetName.of("[CUSTOMER]", "[SHARED_SET]");
    ...
    Assert.assertEquals(resourceName, SharedCriterionName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
