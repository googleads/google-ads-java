...
public class AdServiceClientTest {
  ...
  public void getAdTest() {
    com.google.ads.googleads.v6.services.AdName resourceName2 =
        com.google.ads.googleads.v6.services.AdName.of("[CUSTOMER_ID]", "[AD_ID]");
    long id = 3355L;
    String trackingUrlTemplate = "trackingUrlTemplate-1611329070";
    String finalUrlSuffix = "finalUrlSuffix-1825164662";
    String displayUrl = "displayUrl1714674802";
    boolean addedByGoogleAds = false;
    com.google.ads.googleads.v6.services.AdName name =
        com.google.ads.googleads.v6.services.AdName.of("[CUSTOMER_ID]", "[AD_ID]");
    Ad expectedResponse =
        Ad.newBuilder()
            ...
            .setAddedByGoogleAds(addedByGoogleAds)
    ...
    Assert.assertEquals(resourceName, AdName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateAdsTest() {
    MutateAdsResponse expectedResponse = MutateAdsResponse.newBuilder().build();
    mockAdService.addResponse(expectedResponse);
