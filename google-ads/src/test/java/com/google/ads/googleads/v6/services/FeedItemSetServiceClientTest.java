...
public class FeedItemSetServiceClientTest {
  ...
  public void getFeedItemSetTest() {
    com.google.ads.googleads.v6.services.FeedItemSetName resourceName2 =
        com.google.ads.googleads.v6.services.FeedItemSetName.of(
            "[CUSTOMER_ID]", "[FEED_ID]", "[FEED_ITEM_SET_ID]");
    FeedName feed = FeedName.of("[CUSTOMER_ID]", "[FEED_ID]");
    long feedItemSetId = 1588723619L;
    String displayName = "displayName1615086568";
    FeedItemSet expectedResponse =
        FeedItemSet.newBuilder()
            .setResourceName(resourceName2.toString())
            .setFeed(feed.toString())
    ...
    Assert.assertEquals(resourceName, FeedItemSetName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateFeedItemSetsTest() {
    MutateFeedItemSetsResponse expectedResponse = MutateFeedItemSetsResponse.newBuilder().build();
    mockFeedItemSetService.addResponse(expectedResponse);
