...
public class AdGroupCriterionLabelServiceClientTest {
  ...
  public void getAdGroupCriterionLabelTest() {
    ...
    AdGroupCriterionLabel expectedResponse =
        AdGroupCriterionLabel.newBuilder().setResourceName(resourceName2).build();
    ...
    AdGroupCriterionLabel actualResponse = client.getAdGroupCriterionLabel(formattedResourceName);
    Assert.assertEquals(expectedResponse, actualResponse);

    List<GeneratedMessageV3> actualRequests = mockAdGroupCriterionLabelService.getRequests();
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateAdGroupCriterionLabelsTest2() {
    MutateAdGroupCriterionLabelsResponse expectedResponse =
        MutateAdGroupCriterionLabelsResponse.newBuilder().build();
    mockAdGroupCriterionLabelService.addResponse(expectedResponse);
