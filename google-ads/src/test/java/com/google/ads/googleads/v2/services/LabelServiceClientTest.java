...
public class LabelServiceClientTest {
  ...
  public void getLabelTest() {
    ...
    Label expectedResponse = Label.newBuilder().setResourceName(resourceName2).build();
    ...
    Label actualResponse = client.getLabel(formattedResourceName);
  ...
  public void mutateLabelsTest() {
    ...
    MutateLabelsResponse actualResponse =
