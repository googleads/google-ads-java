...
public class CampaignDraftServiceClientTest {
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCampaignDraftsTest2() {
    MutateCampaignDraftsResponse expectedResponse =
        MutateCampaignDraftsResponse.newBuilder().build();
    mockCampaignDraftService.addResponse(expectedResponse);
  ...
  public void promoteCampaignDraftTest() throws Exception {
    ...
    Empty actualResponse = client.promoteCampaignDraftAsync(formattedCampaignDraft).get();
    Assert.assertEquals(expectedResponse, actualResponse);
    ...
    Assert.assertEquals(formattedCampaignDraft, actualRequest.getCampaignDraft());
    Assert.assertTrue(
        channelProvider.isHeaderSent(
            ApiClientHeaderProvider.getDefaultApiClientHeaderKey(),
            GaxGrpcProperties.getDefaultApiClientHeaderPattern()));
