...
public class CustomerLabelServiceClientTest {
  ...
  public void getCustomerLabelTest() {
    ...
    CustomerLabel expectedResponse =
        CustomerLabel.newBuilder().setResourceName(resourceName2).build();
    mockCustomerLabelService.addResponse(expectedResponse);

    String formattedResourceName =
        CustomerLabelServiceClient.formatCustomerLabelName("[CUSTOMER]", "[CUSTOMER_LABEL]");
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCustomerLabelsTest2() {
    MutateCustomerLabelsResponse expectedResponse =
        MutateCustomerLabelsResponse.newBuilder().build();
    mockCustomerLabelService.addResponse(expectedResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCustomerLabelsExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(Status.INVALID_ARGUMENT);
    mockCustomerLabelService.addException(exception);
