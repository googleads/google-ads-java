...
import com.google.ads.googleads.v2.resources.FeedPlaceholderView;
...
public class FeedPlaceholderViewServiceClientTest {
  ...
  public void getFeedPlaceholderViewTest() {
    ...
    FeedPlaceholderView expectedResponse =
        FeedPlaceholderView.newBuilder().setResourceName(resourceName2).build();
    mockFeedPlaceholderViewService.addResponse(expectedResponse);

    String formattedResourceName =
        FeedPlaceholderViewServiceClient.formatFeedPlaceholderViewName(
