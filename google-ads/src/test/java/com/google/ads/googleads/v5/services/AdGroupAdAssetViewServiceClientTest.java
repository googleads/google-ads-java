...
public class AdGroupAdAssetViewServiceClientTest {
  ...
  public void getAdGroupAdAssetViewTest() {
    com.google.ads.googleads.v5.services.AdGroupAdAssetViewName resourceName2 =
        com.google.ads.googleads.v5.services.AdGroupAdAssetViewName.of(
            "[CUSTOMER]", "[AD_GROUP_AD_ASSET_VIEW]");
    AdGroupAdAssetView expectedResponse =
        AdGroupAdAssetView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, AdGroupAdAssetViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
