...
public class CampaignBudgetServiceClientTest {
  ...
  public void getCampaignBudgetTest() {
    com.google.ads.googleads.v6.services.CampaignBudgetName resourceName2 =
        com.google.ads.googleads.v6.services.CampaignBudgetName.of(
            "[CUSTOMER_ID]", "[CAMPAIGN_BUDGET_ID]");
    long id = 3355L;
    com.google.ads.googleads.v6.services.CampaignBudgetName name =
        com.google.ads.googleads.v6.services.CampaignBudgetName.of(
            "[CUSTOMER_ID]", "[CAMPAIGN_BUDGET_ID]");
    long amountMicros = 64599030L;
    long totalAmountMicros = 795564603L;
    boolean explicitlyShared = false;
    long referenceCount = 1214713627L;
    boolean hasRecommendedBudget = true;
    long recommendedBudgetAmountMicros = 332010528L;
    long recommendedBudgetEstimatedChangeWeeklyClicks = 1719888019L;
    long recommendedBudgetEstimatedChangeWeeklyCostMicros = 1264508103L;
    long recommendedBudgetEstimatedChangeWeeklyInteractions = 290892983L;
    long recommendedBudgetEstimatedChangeWeeklyViews = 1181313222L;
    CampaignBudget expectedResponse =
        CampaignBudget.newBuilder()
            ...
            .setExplicitlyShared(explicitlyShared)
            .setReferenceCount(referenceCount)
            .setHasRecommendedBudget(hasRecommendedBudget)
            .setRecommendedBudgetAmountMicros(recommendedBudgetAmountMicros)
    ...
    Assert.assertEquals(resourceName, CampaignBudgetName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
