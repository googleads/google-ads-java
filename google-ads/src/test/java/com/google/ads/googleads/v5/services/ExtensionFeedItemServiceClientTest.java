...
public class ExtensionFeedItemServiceClientTest {
  ...
  public void getExtensionFeedItemTest() {
    com.google.ads.googleads.v5.services.ExtensionFeedItemName resourceName2 =
        com.google.ads.googleads.v5.services.ExtensionFeedItemName.of(
            "[CUSTOMER]", "[EXTENSION_FEED_ITEM]");
    ExtensionFeedItem expectedResponse =
        ExtensionFeedItem.newBuilder().setResourceName(resourceName2.toString()).build();
