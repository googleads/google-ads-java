...
public class IncomeRangeViewServiceClientTest {
  ...
  public void getIncomeRangeViewTest() {
    ...
    IncomeRangeView expectedResponse =
        IncomeRangeView.newBuilder().setResourceName(resourceName2).build();
    mockIncomeRangeViewService.addResponse(expectedResponse);

    String formattedResourceName =
        IncomeRangeViewServiceClient.formatIncomeRangeViewName("[CUSTOMER]", "[INCOME_RANGE_VIEW]");

    IncomeRangeView actualResponse = client.getIncomeRangeView(formattedResourceName);
  ...
  public void getIncomeRangeViewExceptionTest() throws Exception {
    ...
    try {
      String formattedResourceName =
          IncomeRangeViewServiceClient.formatIncomeRangeViewName(
