...
public class UserListServiceClientTest {
  ...
  public void getUserListTest() {
    com.google.ads.googleads.v5.services.UserListName resourceName2 =
        com.google.ads.googleads.v5.services.UserListName.of("[CUSTOMER]", "[USER_LIST]");
    UserList expectedResponse =
        UserList.newBuilder().setResourceName(resourceName2.toString()).build();
