...
public class AdGroupAdLabelServiceClientTest {
  ...
  public void getAdGroupAdLabelTest() {
    com.google.ads.googleads.v5.services.AdGroupAdLabelName resourceName2 =
        com.google.ads.googleads.v5.services.AdGroupAdLabelName.of(
            "[CUSTOMER]", "[AD_GROUP_AD_LABEL]");
    AdGroupAdLabel expectedResponse =
        AdGroupAdLabel.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, AdGroupAdLabelName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateAdGroupAdLabelsTest() {
    MutateAdGroupAdLabelsResponse expectedResponse =
        MutateAdGroupAdLabelsResponse.newBuilder().build();
    mockAdGroupAdLabelService.addResponse(expectedResponse);
