...
public class CustomerClientLinkServiceClientTest {
  ...
  public void getCustomerClientLinkTest() {
    com.google.ads.googleads.v6.services.CustomerClientLinkName resourceName2 =
        com.google.ads.googleads.v6.services.CustomerClientLinkName.of(
            "[CUSTOMER_ID]", "[CLIENT_CUSTOMER_ID]", "[MANAGER_LINK_ID]");
    String clientCustomer = "clientCustomer-1152265774";
    long managerLinkId = 614908142L;
    boolean hidden = true;
    ...
    Assert.assertEquals(
        resourceName, CustomerClientLinkName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
