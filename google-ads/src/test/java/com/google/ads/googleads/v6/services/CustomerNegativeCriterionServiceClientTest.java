...
public class CustomerNegativeCriterionServiceClientTest {
  ...
  public void getCustomerNegativeCriterionTest() {
    com.google.ads.googleads.v6.services.CustomerNegativeCriterionName resourceName2 =
        com.google.ads.googleads.v6.services.CustomerNegativeCriterionName.of(
    ...
    Assert.assertEquals(
        resourceName, CustomerNegativeCriterionName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
