...
public class ManagedPlacementViewServiceClientTest {
  ...
  public void getManagedPlacementViewTest() {
    ...
    ManagedPlacementView expectedResponse =
        ManagedPlacementView.newBuilder().setResourceName(resourceName2).build();
    ...
    ManagedPlacementView actualResponse = client.getManagedPlacementView(formattedResourceName);
    Assert.assertEquals(expectedResponse, actualResponse);

    List<GeneratedMessageV3> actualRequests = mockManagedPlacementViewService.getRequests();
