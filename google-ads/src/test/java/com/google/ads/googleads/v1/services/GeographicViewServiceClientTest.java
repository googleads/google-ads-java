...
public class GeographicViewServiceClientTest {
  ...
  public void getGeographicViewTest() {
    ...
    GeographicView expectedResponse =
        GeographicView.newBuilder().setResourceName(resourceName2).build();
    ...
    GeographicView actualResponse = client.getGeographicView(formattedResourceName);
    Assert.assertEquals(expectedResponse, actualResponse);

    List<GeneratedMessageV3> actualRequests = mockGeographicViewService.getRequests();
