...
public class FeedPlaceholderViewServiceClientTest {
  ...
  public void getFeedPlaceholderViewTest() {
    com.google.ads.googleads.v6.services.FeedPlaceholderViewName resourceName2 =
        com.google.ads.googleads.v6.services.FeedPlaceholderViewName.of(
            "[CUSTOMER_ID]", "[PLACEHOLDER_TYPE]");
    FeedPlaceholderView expectedResponse =
        FeedPlaceholderView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, FeedPlaceholderViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
