...
public class DetailPlacementViewServiceClientTest {
  ...
  public void getDetailPlacementViewTest() {
    com.google.ads.googleads.v6.services.DetailPlacementViewName resourceName2 =
        com.google.ads.googleads.v6.services.DetailPlacementViewName.of(
            "[CUSTOMER_ID]", "[AD_GROUP_ID]", "[BASE64_PLACEMENT]");
    String placement = "placement1792938725";
    String displayName = "displayName1615086568";
    String groupPlacementTargetUrl = "groupPlacementTargetUrl-866148069";
    String targetUrl = "targetUrl486946241";
    DetailPlacementView expectedResponse =
        DetailPlacementView.newBuilder()
            .setResourceName(resourceName2.toString())
            .setPlacement(placement)
            .setDisplayName(displayName)
            .setGroupPlacementTargetUrl(groupPlacementTargetUrl)
    ...
    Assert.assertEquals(
        resourceName, DetailPlacementViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
