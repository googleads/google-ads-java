...
public class DynamicSearchAdsSearchTermViewServiceClientTest {
  ...
  public void getDynamicSearchAdsSearchTermViewTest() {
    ...
    DynamicSearchAdsSearchTermView expectedResponse =
        DynamicSearchAdsSearchTermView.newBuilder().setResourceName(resourceName2).build();
    mockDynamicSearchAdsSearchTermViewService.addResponse(expectedResponse);

    String formattedResourceName =
        DynamicSearchAdsSearchTermViewServiceClient.formatDynamicSearchAdsSearchTermViewName(
