...
public class BillingSetupServiceClientTest {
  ...
  public void getBillingSetupTest() {
    com.google.ads.googleads.v5.services.BillingSetupName resourceName2 =
        com.google.ads.googleads.v5.services.BillingSetupName.of("[CUSTOMER]", "[BILLING_SETUP]");
    BillingSetup expectedResponse =
        BillingSetup.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, BillingSetupName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
