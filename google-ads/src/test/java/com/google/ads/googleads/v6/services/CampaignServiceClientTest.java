...
public class CampaignServiceClientTest {
  ...
  public void getCampaignTest() {
    com.google.ads.googleads.v6.services.CampaignName resourceName2 =
        com.google.ads.googleads.v6.services.CampaignName.of("[CUSTOMER_ID]", "[CAMPAIGN_ID]");
    long id = 3355L;
    com.google.ads.googleads.v6.services.CampaignName name =
        com.google.ads.googleads.v6.services.CampaignName.of("[CUSTOMER_ID]", "[CAMPAIGN_ID]");
    String trackingUrlTemplate = "trackingUrlTemplate-1611329070";
    com.google.ads.googleads.v6.services.CampaignName baseCampaign =
        com.google.ads.googleads.v6.services.CampaignName.of("[CUSTOMER_ID]", "[CAMPAIGN_ID]");
    ...
    BiddingStrategyName biddingStrategy =
    ...
    Campaign expectedResponse =
        Campaign.newBuilder()
            ...
            .setBiddingStrategy(biddingStrategy.toString())
            .build();
