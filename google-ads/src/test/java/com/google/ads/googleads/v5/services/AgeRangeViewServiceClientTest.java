...
public class AgeRangeViewServiceClientTest {
  ...
  public void getAgeRangeViewTest() {
    com.google.ads.googleads.v5.services.AgeRangeViewName resourceName2 =
        com.google.ads.googleads.v5.services.AgeRangeViewName.of("[CUSTOMER]", "[AGE_RANGE_VIEW]");
    AgeRangeView expectedResponse =
        AgeRangeView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, AgeRangeViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
