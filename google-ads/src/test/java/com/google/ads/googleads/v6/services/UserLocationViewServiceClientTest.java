...
public class UserLocationViewServiceClientTest {
  ...
  public void getUserLocationViewTest() {
    com.google.ads.googleads.v6.services.UserLocationViewName resourceName2 =
        com.google.ads.googleads.v6.services.UserLocationViewName.of(
            "[CUSTOMER_ID]", "[COUNTRY_CRITERION_ID]", "[IS_TARGETING_LOCATION]");
    long countryCriterionId = 1427674750L;
    boolean targetingLocation = false;
    UserLocationView expectedResponse =
        UserLocationView.newBuilder()
            ...
            .setTargetingLocation(targetingLocation)
            .build();
    ...
    Assert.assertEquals(resourceName, UserLocationViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
