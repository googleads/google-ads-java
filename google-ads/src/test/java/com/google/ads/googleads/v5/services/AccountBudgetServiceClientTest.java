...
public class AccountBudgetServiceClientTest {
  ...
  public void getAccountBudgetTest() {
    com.google.ads.googleads.v5.services.AccountBudgetName resourceName2 =
        com.google.ads.googleads.v5.services.AccountBudgetName.of(
            "[CUSTOMER]", "[ACCOUNT_BUDGET]");
    long id = 3355L;
    BillingSetupName billingSetup = BillingSetupName.of("[CUSTOMER]", "[BILLING_SETUP]");
    com.google.ads.googleads.v5.services.AccountBudgetName name =
        com.google.ads.googleads.v5.services.AccountBudgetName.of(
            "[CUSTOMER]", "[ACCOUNT_BUDGET]");
    String proposedStartDateTime = "proposedStartDateTime1279924808";
    String approvedStartDateTime = "approvedStartDateTime-58305639";
    long totalAdjustmentsMicros = 1469082819L;
    long amountServedMicros = 1848146642L;
    String purchaseOrderNumber = "purchaseOrderNumber1774283736";
    String notes = "notes105008833";
    String proposedEndDateTime = "proposedEndDateTime1799190849";
    String approvedEndDateTime = "approvedEndDateTime-450243886";
    long proposedSpendingLimitMicros = 368712267L;
    long approvedSpendingLimitMicros = 2102140486L;
    long adjustedSpendingLimitMicros = 1818287939L;
    AccountBudget expectedResponse =
        AccountBudget.newBuilder()
            .setResourceName(resourceName2.toString())
            .setId(id)
            .setBillingSetup(billingSetup.toString())
            .setName(name.toString())
            .setProposedStartDateTime(proposedStartDateTime)
            .setApprovedStartDateTime(approvedStartDateTime)
            .setTotalAdjustmentsMicros(totalAdjustmentsMicros)
            .setAmountServedMicros(amountServedMicros)
            .setPurchaseOrderNumber(purchaseOrderNumber)
            .setNotes(notes)
            .setProposedEndDateTime(proposedEndDateTime)
            .setApprovedEndDateTime(approvedEndDateTime)
            .setProposedSpendingLimitMicros(proposedSpendingLimitMicros)
            .setApprovedSpendingLimitMicros(approvedSpendingLimitMicros)
            .setAdjustedSpendingLimitMicros(adjustedSpendingLimitMicros)
            .build();
    ...
    Assert.assertEquals(resourceName, AccountBudgetName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
