...
public class HotelGroupViewServiceClientTest {
  ...
  public void getHotelGroupViewTest() {
    com.google.ads.googleads.v5.services.HotelGroupViewName resourceName2 =
        com.google.ads.googleads.v5.services.HotelGroupViewName.of(
            "[CUSTOMER]", "[HOTEL_GROUP_VIEW]");
    HotelGroupView expectedResponse =
        HotelGroupView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(resourceName, HotelGroupViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
