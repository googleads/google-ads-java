...
public class UserInterestServiceClientTest {
  ...
  public void getUserInterestTest() {
    com.google.ads.googleads.v5.services.UserInterestName resourceName2 =
        com.google.ads.googleads.v5.services.UserInterestName.of("[CUSTOMER]", "[USER_INTEREST]");
    UserInterest expectedResponse =
        UserInterest.newBuilder().setResourceName(resourceName2.toString()).build();
