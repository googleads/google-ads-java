...
public class AdGroupAdLabelServiceClientTest {
  ...
  public void getAdGroupAdLabelTest() {
    ...
    AdGroupAdLabel expectedResponse =
        AdGroupAdLabel.newBuilder().setResourceName(resourceName2).build();
    mockAdGroupAdLabelService.addResponse(expectedResponse);

    String formattedResourceName =
        AdGroupAdLabelServiceClient.formatAdGroupAdLabelName("[CUSTOMER]", "[AD_GROUP_AD_LABEL]");
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateAdGroupAdLabelsTest2() {
    MutateAdGroupAdLabelsResponse expectedResponse =
        MutateAdGroupAdLabelsResponse.newBuilder().build();
    mockAdGroupAdLabelService.addResponse(expectedResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateAdGroupAdLabelsExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(Status.INVALID_ARGUMENT);
    mockAdGroupAdLabelService.addException(exception);
