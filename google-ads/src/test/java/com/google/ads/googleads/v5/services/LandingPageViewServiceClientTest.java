...
public class LandingPageViewServiceClientTest {
  ...
  public void getLandingPageViewTest() {
    com.google.ads.googleads.v5.services.LandingPageViewName resourceName2 =
        com.google.ads.googleads.v5.services.LandingPageViewName.of(
            "[CUSTOMER]", "[LANDING_PAGE_VIEW]");
    LandingPageView expectedResponse =
        LandingPageView.newBuilder().setResourceName(resourceName2.toString()).build();
