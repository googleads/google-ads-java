...
public class CampaignExperimentServiceClientTest {
  ...
  public void getCampaignExperimentTest() {
    com.google.ads.googleads.v5.services.CampaignExperimentName resourceName2 =
        com.google.ads.googleads.v5.services.CampaignExperimentName.of(
            "[CUSTOMER]", "[CAMPAIGN_EXPERIMENT]");
    CampaignExperiment expectedResponse =
        CampaignExperiment.newBuilder().setResourceName(resourceName2.toString()).build();
