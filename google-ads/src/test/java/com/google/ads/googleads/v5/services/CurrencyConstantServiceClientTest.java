...
public class CurrencyConstantServiceClientTest {
  ...
  public void getCurrencyConstantTest() {
    com.google.ads.googleads.v5.services.CurrencyConstantName resourceName2 =
        com.google.ads.googleads.v5.services.CurrencyConstantName.of("[CURRENCY_CONSTANT]");
    String code = "code3059181";
    com.google.ads.googleads.v5.services.CurrencyConstantName name =
        com.google.ads.googleads.v5.services.CurrencyConstantName.of("[CURRENCY_CONSTANT]");
    String symbol = "symbol-887523944";
    long billableUnitMicros = 1611838444L;
    CurrencyConstant expectedResponse =
        CurrencyConstant.newBuilder()
            ...
            .setSymbol(symbol)
            .setBillableUnitMicros(billableUnitMicros)
            .build();
    ...
    Assert.assertEquals(resourceName, CurrencyConstantName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
