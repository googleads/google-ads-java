...
public class AccountBudgetServiceClientTest {
  ...
  public void getAccountBudgetTest() {
    com.google.ads.googleads.v6.services.AccountBudgetName resourceName2 =
        com.google.ads.googleads.v6.services.AccountBudgetName.of(
            "[CUSTOMER_ID]", "[ACCOUNT_BUDGET_ID]");
    long id = 3355L;
    BillingSetupName billingSetup = BillingSetupName.of("[CUSTOMER_ID]", "[BILLING_SETUP_ID]");
    com.google.ads.googleads.v6.services.AccountBudgetName name =
        com.google.ads.googleads.v6.services.AccountBudgetName.of(
            "[CUSTOMER_ID]", "[ACCOUNT_BUDGET_ID]");
