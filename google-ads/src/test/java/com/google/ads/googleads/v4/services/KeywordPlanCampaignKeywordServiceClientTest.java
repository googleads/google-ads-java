...
public class KeywordPlanCampaignKeywordServiceClientTest {
  ...
  public void getKeywordPlanCampaignKeywordTest() {
    ...
    KeywordPlanCampaignKeyword expectedResponse =
        KeywordPlanCampaignKeyword.newBuilder().setResourceName(resourceName2).build();
    mockKeywordPlanCampaignKeywordService.addResponse(expectedResponse);

    String formattedResourceName =
        KeywordPlanCampaignKeywordServiceClient.formatKeywordPlanCampaignKeywordName(
            "[CUSTOMER]", "[KEYWORD_PLAN_CAMPAIGN_KEYWORD]");

    KeywordPlanCampaignKeyword actualResponse =
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateKeywordPlanCampaignKeywordsTest2() {
    MutateKeywordPlanCampaignKeywordsResponse expectedResponse =
        MutateKeywordPlanCampaignKeywordsResponse.newBuilder().build();
    mockKeywordPlanCampaignKeywordService.addResponse(expectedResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateKeywordPlanCampaignKeywordsExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(Status.INVALID_ARGUMENT);
    mockKeywordPlanCampaignKeywordService.addException(exception);
