...
public class CustomInterestServiceClientTest {
  ...
  public void getCustomInterestTest() {
    ...
    CustomInterest expectedResponse =
        CustomInterest.newBuilder().setResourceName(resourceName2).build();
    mockCustomInterestService.addResponse(expectedResponse);

    String formattedResourceName =
        CustomInterestServiceClient.formatCustomInterestName("[CUSTOMER]", "[CUSTOM_INTEREST]");
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateCustomInterestsTest2() {
    MutateCustomInterestsResponse expectedResponse =
        MutateCustomInterestsResponse.newBuilder().build();
    mockCustomInterestService.addResponse(expectedResponse);
