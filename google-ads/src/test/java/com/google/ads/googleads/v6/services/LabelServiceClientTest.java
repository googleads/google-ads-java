...
public class LabelServiceClientTest {
  ...
  public void getLabelTest() {
    com.google.ads.googleads.v6.services.LabelName resourceName2 =
        com.google.ads.googleads.v6.services.LabelName.of("[CUSTOMER_ID]", "[LABEL_ID]");
    long id = 3355L;
    com.google.ads.googleads.v6.services.LabelName name =
        com.google.ads.googleads.v6.services.LabelName.of("[CUSTOMER_ID]", "[LABEL_ID]");
    ...
    Assert.assertEquals(resourceName, LabelName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
  ...
  @Test
  @SuppressWarnings("all")
  public void mutateLabelsTest() {
    MutateLabelsResponse expectedResponse = MutateLabelsResponse.newBuilder().build();
    mockLabelService.addResponse(expectedResponse);
