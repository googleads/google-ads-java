...
public class ParentalStatusViewServiceClientTest {
  ...
  public void getParentalStatusViewTest() {
    com.google.ads.googleads.v5.services.ParentalStatusViewName resourceName2 =
        com.google.ads.googleads.v5.services.ParentalStatusViewName.of(
            "[CUSTOMER]", "[PARENTAL_STATUS_VIEW]");
    ParentalStatusView expectedResponse =
        ParentalStatusView.newBuilder().setResourceName(resourceName2.toString()).build();
    ...
    Assert.assertEquals(
        resourceName, ParentalStatusViewName.parse(actualRequest.getResourceName()));
    Assert.assertTrue(
