...
public class CampaignServiceClientTest {
  ...
  public void getCampaignTest() {
    com.google.ads.googleads.v5.services.CampaignName resourceName2 =
        com.google.ads.googleads.v5.services.CampaignName.of("[CUSTOMER]", "[CAMPAIGN]");
    long id = 3355L;
    com.google.ads.googleads.v5.services.CampaignName name =
        com.google.ads.googleads.v5.services.CampaignName.of("[CUSTOMER]", "[CAMPAIGN]");
    String trackingUrlTemplate = "trackingUrlTemplate-1611329070";
    com.google.ads.googleads.v5.services.CampaignName baseCampaign =
        com.google.ads.googleads.v5.services.CampaignName.of("[CUSTOMER]", "[CAMPAIGN]");
    CampaignBudgetName campaignBudget = CampaignBudgetName.of("[CUSTOMER]", "[CAMPAIGN_BUDGET]");
    ...
    BiddingStrategyName biddingStrategy =
        BiddingStrategyName.of("[CUSTOMER]", "[BIDDING_STRATEGY]");
