...
import com.google.ads.googleads.v0.services.stub.ParentalStatusViewServiceStub;
import com.google.ads.googleads.v0.services.stub.ParentalStatusViewServiceStubSettings;
...
public class ParentalStatusViewServiceClient implements BackgroundResource {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  private final ParentalStatusView getParentalStatusView(GetParentalStatusViewRequest request) {
