 ...
 * }</pre>
 *
 * <p>Note: close() needs to be called on the DetailedDemographicServiceClient object to clean up
...
public class DetailedDemographicServiceClient implements BackgroundResource {
   ...
   *                   .toString())
   *           .build();
   *   ApiFuture<DetailedDemographic> future =
   ...
   * }</pre>
   */
  public final UnaryCallable<GetDetailedDemographicRequest, DetailedDemographic>
