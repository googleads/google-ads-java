...
public interface ReachForecastOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v4.services.ReachForecast)
   ...
   * @return The forecast.
   */
  com.google.ads.googleads.v4.services.Forecast getForecast();
  /**
   * <pre>
   * Forecasted traffic metrics for this point.
   * </pre>
   ...
   * <code>.google.ads.googleads.v4.services.Forecast forecast = 2;</code>
   */
  com.google.ads.googleads.v4.services.ForecastOrBuilder getForecastOrBuilder();
   ...
   * <code>repeated .google.ads.googleads.v4.services.ProductAllocation forecasted_product_allocations = 3;</code>
   */
  com.google.ads.googleads.v4.services.ProductAllocation getForecastedProductAllocations(int index);
  /**
   * <pre>
   * The forecasted allocation. This differs from the input allocation if one
   * or more product cannot fulfill the budget because of limited inventory.
   ...
   * <code>repeated .google.ads.googleads.v4.services.ProductAllocation forecasted_product_allocations = 3;</code>
   */
  com.google.ads.googleads.v4.services.ProductAllocationOrBuilder getForecastedProductAllocationsOrBuilder(
      int index);
}
