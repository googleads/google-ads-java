...
public interface MutateSharedSetsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v6.services.MutateSharedSetsRequest)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v6.services.SharedSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.ads.googleads.v6.services.SharedSetOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual shared sets.
   ...
   * <code>repeated .google.ads.googleads.v6.services.SharedSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v6.services.SharedSetOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual shared sets.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v6.services.SharedSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v6.services.SharedSetOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v6.services.SharedSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v6.services.SharedSetOperationOrBuilder getOperationsOrBuilder(
      int index);
