...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v7/services/user_data_service.proto")
public final class UserDataServiceGrpc {

  private UserDataServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v7.services.UserDataService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.UploadUserDataRequest,
      com.google.ads.googleads.v7.services.UploadUserDataResponse> getUploadUserDataMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UploadUserData",
      requestType = com.google.ads.googleads.v7.services.UploadUserDataRequest.class,
      responseType = com.google.ads.googleads.v7.services.UploadUserDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.UploadUserDataRequest,
      com.google.ads.googleads.v7.services.UploadUserDataResponse> getUploadUserDataMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.UploadUserDataRequest, com.google.ads.googleads.v7.services.UploadUserDataResponse> getUploadUserDataMethod;
      ...
      synchronized (UserDataServiceGrpc.class) {
        if ((getUploadUserDataMethod = UserDataServiceGrpc.getUploadUserDataMethod) == null) {
          UserDataServiceGrpc.getUploadUserDataMethod = getUploadUserDataMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v7.services.UploadUserDataRequest, com.google.ads.googleads.v7.services.UploadUserDataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "UploadUserData"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.UploadUserDataRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.UploadUserDataResponse.getDefaultInstance()))
  ...
  public static abstract class UserDataServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void uploadUserData(com.google.ads.googleads.v7.services.UploadUserDataRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.services.UploadUserDataResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v7.services.UploadUserDataRequest,
                com.google.ads.googleads.v7.services.UploadUserDataResponse>(
  ...
  public static final class UserDataServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<UserDataServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v7.services.UploadUserDataResponse uploadUserData(com.google.ads.googleads.v7.services.UploadUserDataRequest request) {
  ...
  public static final class UserDataServiceFutureStub extends io.grpc.stub.AbstractFutureStub<UserDataServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v7.services.UploadUserDataResponse> uploadUserData(
        com.google.ads.googleads.v7.services.UploadUserDataRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_UPLOAD_USER_DATA:
          serviceImpl.uploadUserData((com.google.ads.googleads.v7.services.UploadUserDataRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.services.UploadUserDataResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class UserDataServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v7.services.UserDataServiceProto.getDescriptor();
    }
