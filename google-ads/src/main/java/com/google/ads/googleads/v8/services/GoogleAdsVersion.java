...
public interface GoogleAdsVersion {
        ...
        @ServiceClientDescriptor(settingsClass = BiddingStrategySimulationServiceSettings.class)
        BiddingStrategySimulationServiceClient createBiddingStrategySimulationServiceClient();
        ...
        @ServiceClientDescriptor(settingsClass = CampaignSimulationServiceSettings.class)
        CampaignSimulationServiceClient createCampaignSimulationServiceClient();
        ...
        @ServiceClientDescriptor(settingsClass = LifeEventServiceSettings.class)
        LifeEventServiceClient createLifeEventServiceClient();
        ...
        @ServiceClientDescriptor(settingsClass = WebpageViewServiceSettings.class)
        WebpageViewServiceClient createWebpageViewServiceClient();
