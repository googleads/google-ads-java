...
import com.google.ads.googleads.v0.services.stub.KeywordPlanKeywordServiceStub;
...
public class KeywordPlanKeywordServiceClient implements BackgroundResource {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  private final KeywordPlanKeyword getKeywordPlanKeyword(GetKeywordPlanKeywordRequest request) {
