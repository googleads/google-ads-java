...
import com.google.ads.googleads.v0.services.stub.TopicViewServiceStub;
import com.google.ads.googleads.v0.services.stub.TopicViewServiceStubSettings;
...
public class TopicViewServiceClient implements BackgroundResource {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  private final TopicView getTopicView(GetTopicViewRequest request) {
