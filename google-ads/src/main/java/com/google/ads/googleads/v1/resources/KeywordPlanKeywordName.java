...
public class KeywordPlanKeywordName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("customers/{customer}/keywordPlanKeywords/{keyword_plan_keyword}");
  ...
  public static KeywordPlanKeywordName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(formattedString, "KeywordPlanKeywordName.parse: formattedString not in valid format");
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          fieldMapBuilder.put("keywordPlanKeyword", keywordPlanKeyword);
  ...
  public String toString() {
    return PATH_TEMPLATE.instantiate("customer", customer, "keyword_plan_keyword", keywordPlanKeyword);
  }

  /** Builder for KeywordPlanKeywordName. */
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof KeywordPlanKeywordName) {
      KeywordPlanKeywordName that = (KeywordPlanKeywordName) o;
      return (this.customer.equals(that.customer))
          && (this.keywordPlanKeyword.equals(that.keywordPlanKeyword));
    }
    return false;
  }
