...
import com.google.ads.googleads.v1.services.stub.AdGroupExtensionSettingServiceStub;
import com.google.ads.googleads.v1.services.stub.AdGroupExtensionSettingServiceStubSettings;
...
public class AdGroupExtensionSettingServiceClient implements BackgroundResource {
   ...
   * </code></pre>
   *
   * @param resourceName The resource name of the ad group extension setting to fetch.
   ...
   * </code></pre>
   *
   * @param customerId The ID of the customer whose ad group extension settings are being modified.
   * @param operations The list of operations to perform on individual ad group extension settings.
