...
public interface FrequencyCapEntryOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v4.common.FrequencyCapEntry)
   ...
   * @return The key.
   */
  com.google.ads.googleads.v4.common.FrequencyCapKey getKey();
  /**
   * <pre>
   * The key of a particular frequency cap. There can be no more
   * than one frequency cap with the same key.
   ...
   * <code>.google.ads.googleads.v4.common.FrequencyCapKey key = 1;</code>
   */
  com.google.ads.googleads.v4.common.FrequencyCapKeyOrBuilder getKeyOrBuilder();
