...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/age_range_view_service.proto")
public final class AgeRangeViewServiceGrpc {

  private AgeRangeViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.AgeRangeViewService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  @java.lang.Deprecated // Use {@link #getGetAgeRangeViewMethod()} instead. 
  public static final io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAgeRangeViewRequest,
      com.google.ads.googleads.v4.resources.AgeRangeView> METHOD_GET_AGE_RANGE_VIEW = getGetAgeRangeViewMethodHelper();

  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAgeRangeViewRequest,
      com.google.ads.googleads.v4.resources.AgeRangeView> getGetAgeRangeViewMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAgeRangeViewRequest,
      com.google.ads.googleads.v4.resources.AgeRangeView> getGetAgeRangeViewMethod() {
    return getGetAgeRangeViewMethodHelper();
  }

  private static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAgeRangeViewRequest,
      com.google.ads.googleads.v4.resources.AgeRangeView> getGetAgeRangeViewMethodHelper() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAgeRangeViewRequest, com.google.ads.googleads.v4.resources.AgeRangeView> getGetAgeRangeViewMethod;
      ...
      synchronized (AgeRangeViewServiceGrpc.class) {
        if ((getGetAgeRangeViewMethod = AgeRangeViewServiceGrpc.getGetAgeRangeViewMethod) == null) {
          AgeRangeViewServiceGrpc.getGetAgeRangeViewMethod = getGetAgeRangeViewMethod = 
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetAgeRangeViewRequest, com.google.ads.googleads.v4.resources.AgeRangeView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "google.ads.googleads.v4.services.AgeRangeViewService", "GetAgeRangeView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetAgeRangeViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.AgeRangeView.getDefaultInstance()))
  ...
  public static abstract class AgeRangeViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAgeRangeView(com.google.ads.googleads.v4.services.GetAgeRangeViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.AgeRangeView> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetAgeRangeViewRequest,
                com.google.ads.googleads.v4.resources.AgeRangeView>(
  ...
  public static final class AgeRangeViewServiceBlockingStub extends io.grpc.stub.AbstractStub<AgeRangeViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.AgeRangeView getAgeRangeView(com.google.ads.googleads.v4.services.GetAgeRangeViewRequest request) {
  ...
  public static final class AgeRangeViewServiceFutureStub extends io.grpc.stub.AbstractStub<AgeRangeViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.AgeRangeView> getAgeRangeView(
        com.google.ads.googleads.v4.services.GetAgeRangeViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AGE_RANGE_VIEW:
          serviceImpl.getAgeRangeView((com.google.ads.googleads.v4.services.GetAgeRangeViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.AgeRangeView>) responseObserver);
          break;
        default:
  ...
  private static abstract class AgeRangeViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.AgeRangeViewServiceProto.getDescriptor();
    }
