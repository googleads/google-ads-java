...
public interface MutateMediaFilesRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v6.services.MutateMediaFilesRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v6.services.MediaFileOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual media file.
   ...
   * <code>repeated .google.ads.googleads.v6.services.MediaFileOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v6.services.MediaFileOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual media file.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v6.services.MediaFileOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v6.services.MediaFileOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v6.services.MediaFileOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v6.services.MediaFileOperationOrBuilder getOperationsOrBuilder(
      int index);
