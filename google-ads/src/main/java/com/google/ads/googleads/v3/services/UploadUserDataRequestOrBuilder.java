...
public interface UploadUserDataRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v3.services.UploadUserDataRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v3.services.UserDataOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to be done.
   ...
   * <code>repeated .google.ads.googleads.v3.services.UserDataOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v3.services.UserDataOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to be done.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v3.services.UserDataOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v3.services.UserDataOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v3.services.UserDataOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v3.services.UserDataOperationOrBuilder getOperationsOrBuilder(
      int index);
  ...
  public com.google.ads.googleads.v3.services.UploadUserDataRequest.MetadataCase getMetadataCase();
}
