...
public class AdGroupBidModifierName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("customers/{customer_id}/adGroupBidModifiers/{ad_group_id}~{criterion_id}");
  ...
  public static AdGroupBidModifierName of(String customerId, String adGroupId, String criterionId) {
    return newBuilder()
