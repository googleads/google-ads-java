...
import com.google.ads.googleads.v2.services.stub.AssetServiceStub;
import com.google.ads.googleads.v2.services.stub.AssetServiceStubSettings;
...
public class AssetServiceClient implements BackgroundResource {
   ...
   * </code></pre>
   *
   * @param resourceName The resource name of the asset to fetch.
   ...
   * </code></pre>
   *
   * @param customerId The ID of the customer whose assets are being modified.
   * @param operations The list of operations to perform on individual assets.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
