...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v9/services/campaign_simulation_service.proto")
public final class CampaignSimulationServiceGrpc {

  private CampaignSimulationServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v9.services.CampaignSimulationService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetCampaignSimulationRequest,
      com.google.ads.googleads.v9.resources.CampaignSimulation> getGetCampaignSimulationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCampaignSimulation",
      requestType = com.google.ads.googleads.v9.services.GetCampaignSimulationRequest.class,
      responseType = com.google.ads.googleads.v9.resources.CampaignSimulation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetCampaignSimulationRequest,
      com.google.ads.googleads.v9.resources.CampaignSimulation> getGetCampaignSimulationMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetCampaignSimulationRequest, com.google.ads.googleads.v9.resources.CampaignSimulation> getGetCampaignSimulationMethod;
      ...
      synchronized (CampaignSimulationServiceGrpc.class) {
        if ((getGetCampaignSimulationMethod = CampaignSimulationServiceGrpc.getGetCampaignSimulationMethod) == null) {
          CampaignSimulationServiceGrpc.getGetCampaignSimulationMethod = getGetCampaignSimulationMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.GetCampaignSimulationRequest, com.google.ads.googleads.v9.resources.CampaignSimulation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCampaignSimulation"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.GetCampaignSimulationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.resources.CampaignSimulation.getDefaultInstance()))
  ...
  public static abstract class CampaignSimulationServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCampaignSimulation(com.google.ads.googleads.v9.services.GetCampaignSimulationRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.CampaignSimulation> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.GetCampaignSimulationRequest,
                com.google.ads.googleads.v9.resources.CampaignSimulation>(
  ...
  public static final class CampaignSimulationServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CampaignSimulationServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.resources.CampaignSimulation getCampaignSimulation(com.google.ads.googleads.v9.services.GetCampaignSimulationRequest request) {
  ...
  public static final class CampaignSimulationServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CampaignSimulationServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.resources.CampaignSimulation> getCampaignSimulation(
        com.google.ads.googleads.v9.services.GetCampaignSimulationRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CAMPAIGN_SIMULATION:
          serviceImpl.getCampaignSimulation((com.google.ads.googleads.v9.services.GetCampaignSimulationRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.CampaignSimulation>) responseObserver);
          break;
        default:
  ...
  private static abstract class CampaignSimulationServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v9.services.CampaignSimulationServiceProto.getDescriptor();
    }
