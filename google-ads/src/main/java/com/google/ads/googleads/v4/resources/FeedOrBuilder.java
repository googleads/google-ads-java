...
public interface FeedOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v4.resources.Feed)
   ...
   */
  java.util.List<com.google.ads.googleads.v4.resources.FeedAttribute> 
      getAttributesList();
  /**
   * <pre>
   * The Feed's attributes. Required on CREATE, unless
   ...
   * <code>repeated .google.ads.googleads.v4.resources.FeedAttribute attributes = 4;</code>
   */
  com.google.ads.googleads.v4.resources.FeedAttribute getAttributes(int index);
  /**
   * <pre>
   * The Feed's attributes. Required on CREATE, unless
   * system_feed_generation_data is provided, in which case Google Ads will
   ...
   * <code>repeated .google.ads.googleads.v4.resources.FeedAttribute attributes = 4;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v4.resources.FeedAttributeOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v4.resources.FeedAttribute attributes = 4;</code>
   */
  com.google.ads.googleads.v4.resources.FeedAttributeOrBuilder getAttributesOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.ads.googleads.v4.resources.FeedAttributeOperation> 
   ...
   * <code>repeated .google.ads.googleads.v4.resources.FeedAttributeOperation attribute_operations = 9;</code>
   */
  com.google.ads.googleads.v4.resources.FeedAttributeOperation getAttributeOperations(int index);
  /**
   * <pre>
   * The list of operations changing the feed attributes. Attributes can only
   * be added, not removed.
   ...
   * <code>repeated .google.ads.googleads.v4.resources.FeedAttributeOperation attribute_operations = 9;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v4.resources.FeedAttributeOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v4.resources.FeedAttributeOperation attribute_operations = 9;</code>
   */
  com.google.ads.googleads.v4.resources.FeedAttributeOperationOrBuilder getAttributeOperationsOrBuilder(
      int index);
   ...
   * @return The origin.
   */
  com.google.ads.googleads.v4.enums.FeedOriginEnum.FeedOrigin getOrigin();
   ...
   * @return The status.
   */
  com.google.ads.googleads.v4.enums.FeedStatusEnum.FeedStatus getStatus();
   ...
   */
  com.google.ads.googleads.v4.resources.Feed.PlacesLocationFeedData getPlacesLocationFeedData();
  /**
   * <pre>
   * Data used to configure a location feed populated from Google My Business
   * Locations.
   ...
   * <code>.google.ads.googleads.v4.resources.Feed.PlacesLocationFeedData places_location_feed_data = 6;</code>
   */
  com.google.ads.googleads.v4.resources.Feed.PlacesLocationFeedDataOrBuilder getPlacesLocationFeedDataOrBuilder();
   ...
   */
  com.google.ads.googleads.v4.resources.Feed.AffiliateLocationFeedData getAffiliateLocationFeedData();
  /**
   * <pre>
   * Data used to configure an affiliate location feed populated with
   * the specified chains.
   ...
   * <code>.google.ads.googleads.v4.resources.Feed.AffiliateLocationFeedData affiliate_location_feed_data = 7;</code>
   */
  com.google.ads.googleads.v4.resources.Feed.AffiliateLocationFeedDataOrBuilder getAffiliateLocationFeedDataOrBuilder();

  public com.google.ads.googleads.v4.resources.Feed.SystemFeedGenerationDataCase getSystemFeedGenerationDataCase();
}
