...
public interface CampaignFeedOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v0.resources.CampaignFeed)
   ...
   */
  java.util.List<com.google.ads.googleads.v0.enums.PlaceholderTypeEnum.PlaceholderType> getPlaceholderTypesList();
  /**
   * <pre>
   * Indicates which placeholder types the feed may populate under the connected
   * campaign. Required.
   ...
   * <code>repeated .google.ads.googleads.v0.enums.PlaceholderTypeEnum.PlaceholderType placeholder_types = 4;</code>
   */
  com.google.ads.googleads.v0.enums.PlaceholderTypeEnum.PlaceholderType getPlaceholderTypes(int index);
  /**
   * <pre>
   * Indicates which placeholder types the feed may populate under the connected
   * campaign. Required.
   ...
   * <code>.google.ads.googleads.v0.common.MatchingFunction matching_function = 5;</code>
   */
  com.google.ads.googleads.v0.common.MatchingFunction getMatchingFunction();
  /**
   * <pre>
   * Matching function associated with the CampaignFeed.
   * The matching function is used to filter the set of feed items selected.
   ...
   * <code>.google.ads.googleads.v0.common.MatchingFunction matching_function = 5;</code>
   */
  com.google.ads.googleads.v0.common.MatchingFunctionOrBuilder getMatchingFunctionOrBuilder();
   ...
   * <code>.google.ads.googleads.v0.enums.FeedLinkStatusEnum.FeedLinkStatus status = 6;</code>
   */
  com.google.ads.googleads.v0.enums.FeedLinkStatusEnum.FeedLinkStatus getStatus();
}
