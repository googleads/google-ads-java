...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/video_service.proto")
public final class VideoServiceGrpc {

  private VideoServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.VideoService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetVideoRequest,
      com.google.ads.googleads.v5.resources.Video> getGetVideoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetVideo",
      requestType = com.google.ads.googleads.v5.services.GetVideoRequest.class,
      responseType = com.google.ads.googleads.v5.resources.Video.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetVideoRequest,
      com.google.ads.googleads.v5.resources.Video> getGetVideoMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetVideoRequest, com.google.ads.googleads.v5.resources.Video> getGetVideoMethod;
      ...
      synchronized (VideoServiceGrpc.class) {
        if ((getGetVideoMethod = VideoServiceGrpc.getGetVideoMethod) == null) {
          VideoServiceGrpc.getGetVideoMethod = getGetVideoMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetVideoRequest, com.google.ads.googleads.v5.resources.Video>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetVideo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetVideoRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.Video.getDefaultInstance()))
  ...
  public static abstract class VideoServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getVideo(com.google.ads.googleads.v5.services.GetVideoRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.Video> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetVideoRequest,
                com.google.ads.googleads.v5.resources.Video>(
  ...
  public static final class VideoServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<VideoServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.Video getVideo(com.google.ads.googleads.v5.services.GetVideoRequest request) {
  ...
  public static final class VideoServiceFutureStub extends io.grpc.stub.AbstractFutureStub<VideoServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.Video> getVideo(
        com.google.ads.googleads.v5.services.GetVideoRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_VIDEO:
          serviceImpl.getVideo((com.google.ads.googleads.v5.services.GetVideoRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.Video>) responseObserver);
          break;
        default:
  ...
  private static abstract class VideoServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.VideoServiceProto.getDescriptor();
    }
