...
public class DomainCategoryName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("customers/{customer}/domainCategories/{domain_category}");
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          fieldMapBuilder.put("domainCategory", domainCategory);
  ...
  public String toString() {
    return PATH_TEMPLATE.instantiate("customer", customer, "domain_category", domainCategory);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof DomainCategoryName) {
      ...
      return (this.customer.equals(that.customer))
          && (this.domainCategory.equals(that.domainCategory));
    }
    return false;
  }
