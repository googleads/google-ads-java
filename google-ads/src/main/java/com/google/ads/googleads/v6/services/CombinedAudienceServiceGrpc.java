...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/combined_audience_service.proto")
public final class CombinedAudienceServiceGrpc {

  private CombinedAudienceServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.CombinedAudienceService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCombinedAudienceRequest,
      com.google.ads.googleads.v6.resources.CombinedAudience> getGetCombinedAudienceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCombinedAudience",
      requestType = com.google.ads.googleads.v6.services.GetCombinedAudienceRequest.class,
      responseType = com.google.ads.googleads.v6.resources.CombinedAudience.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCombinedAudienceRequest,
      com.google.ads.googleads.v6.resources.CombinedAudience> getGetCombinedAudienceMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCombinedAudienceRequest, com.google.ads.googleads.v6.resources.CombinedAudience> getGetCombinedAudienceMethod;
      ...
      synchronized (CombinedAudienceServiceGrpc.class) {
        if ((getGetCombinedAudienceMethod = CombinedAudienceServiceGrpc.getGetCombinedAudienceMethod) == null) {
          CombinedAudienceServiceGrpc.getGetCombinedAudienceMethod = getGetCombinedAudienceMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetCombinedAudienceRequest, com.google.ads.googleads.v6.resources.CombinedAudience>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCombinedAudience"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetCombinedAudienceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.CombinedAudience.getDefaultInstance()))
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_COMBINED_AUDIENCE:
          serviceImpl.getCombinedAudience((com.google.ads.googleads.v6.services.GetCombinedAudienceRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.CombinedAudience>) responseObserver);
          break;
        default:
  ...
  private static abstract class CombinedAudienceServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.CombinedAudienceServiceProto.getDescriptor();
    }
