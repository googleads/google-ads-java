...
public class KeywordPlanCampaignName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("customers/{customer_id}/keywordPlanCampaigns/{keyword_plan_campaign_id}");
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          fieldMapBuilder.put("keywordPlanCampaignId", keywordPlanCampaignId);
  ...
  public String toString() {
    return PATH_TEMPLATE.instantiate("customer_id", customerId, "keyword_plan_campaign_id", keywordPlanCampaignId);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof KeywordPlanCampaignName) {
      ...
      return (this.customerId.equals(that.customerId))
          && (this.keywordPlanCampaignId.equals(that.keywordPlanCampaignId));
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= keywordPlanCampaignId.hashCode();
    return h;
  }
}
