...
import com.google.ads.googleads.v2.resources.ClickView;
import com.google.ads.googleads.v2.services.stub.ClickViewServiceStubSettings;
 ...
 * example, to set the total timeout of getClickView to 30 seconds:
 *
 * <pre>
 * <code>
 * ClickViewServiceSettings.Builder clickViewServiceSettingsBuilder =
 *     ClickViewServiceSettings.newBuilder();
 * clickViewServiceSettingsBuilder.getClickViewSettings().getRetrySettings().toBuilder()
