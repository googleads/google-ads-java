...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v9/services/keyword_theme_constant_service.proto")
public final class KeywordThemeConstantServiceGrpc {

  private KeywordThemeConstantServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v9.services.KeywordThemeConstantService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetKeywordThemeConstantRequest,
      com.google.ads.googleads.v9.resources.KeywordThemeConstant> getGetKeywordThemeConstantMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetKeywordThemeConstant",
      requestType = com.google.ads.googleads.v9.services.GetKeywordThemeConstantRequest.class,
      responseType = com.google.ads.googleads.v9.resources.KeywordThemeConstant.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetKeywordThemeConstantRequest,
      com.google.ads.googleads.v9.resources.KeywordThemeConstant> getGetKeywordThemeConstantMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetKeywordThemeConstantRequest, com.google.ads.googleads.v9.resources.KeywordThemeConstant> getGetKeywordThemeConstantMethod;
      ...
      synchronized (KeywordThemeConstantServiceGrpc.class) {
        if ((getGetKeywordThemeConstantMethod = KeywordThemeConstantServiceGrpc.getGetKeywordThemeConstantMethod) == null) {
          KeywordThemeConstantServiceGrpc.getGetKeywordThemeConstantMethod = getGetKeywordThemeConstantMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.GetKeywordThemeConstantRequest, com.google.ads.googleads.v9.resources.KeywordThemeConstant>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetKeywordThemeConstant"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.GetKeywordThemeConstantRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.resources.KeywordThemeConstant.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsRequest,
      com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsResponse> getSuggestKeywordThemeConstantsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SuggestKeywordThemeConstants",
      requestType = com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsRequest.class,
      responseType = com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsRequest,
      com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsResponse> getSuggestKeywordThemeConstantsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsRequest, com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsResponse> getSuggestKeywordThemeConstantsMethod;
      ...
      synchronized (KeywordThemeConstantServiceGrpc.class) {
        if ((getSuggestKeywordThemeConstantsMethod = KeywordThemeConstantServiceGrpc.getSuggestKeywordThemeConstantsMethod) == null) {
          KeywordThemeConstantServiceGrpc.getSuggestKeywordThemeConstantsMethod = getSuggestKeywordThemeConstantsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsRequest, com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SuggestKeywordThemeConstants"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsResponse.getDefaultInstance()))
  ...
  public static abstract class KeywordThemeConstantServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getKeywordThemeConstant(com.google.ads.googleads.v9.services.GetKeywordThemeConstantRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.KeywordThemeConstant> responseObserver) {
     ...
     * </pre>
     */
    public void suggestKeywordThemeConstants(com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.GetKeywordThemeConstantRequest,
                com.google.ads.googleads.v9.resources.KeywordThemeConstant>(
                  this, METHODID_GET_KEYWORD_THEME_CONSTANT)))
          .addMethod(
            getSuggestKeywordThemeConstantsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsRequest,
                com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsResponse>(
  ...
  public static final class KeywordThemeConstantServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<KeywordThemeConstantServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.resources.KeywordThemeConstant getKeywordThemeConstant(com.google.ads.googleads.v9.services.GetKeywordThemeConstantRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsResponse suggestKeywordThemeConstants(com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class KeywordThemeConstantServiceFutureStub extends io.grpc.stub.AbstractFutureStub<KeywordThemeConstantServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.resources.KeywordThemeConstant> getKeywordThemeConstant(
        com.google.ads.googleads.v9.services.GetKeywordThemeConstantRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsResponse> suggestKeywordThemeConstants(
        com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_KEYWORD_THEME_CONSTANT:
          serviceImpl.getKeywordThemeConstant((com.google.ads.googleads.v9.services.GetKeywordThemeConstantRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.KeywordThemeConstant>) responseObserver);
          break;
        case METHODID_SUGGEST_KEYWORD_THEME_CONSTANTS:
          serviceImpl.suggestKeywordThemeConstants((com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class KeywordThemeConstantServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v9.services.KeywordThemeConstantServiceProto.getDescriptor();
    }
