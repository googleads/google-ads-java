...
public class SmartCampaignSettingServiceClient implements BackgroundResource {
   ...
   * }</pre>
   *
   * @param resourceName Required. The resource name of the Smart campaign setting to fetch.
  ...
  public final SmartCampaignSetting getSmartCampaignSetting(SmartCampaignSettingName resourceName) {
    GetSmartCampaignSettingRequest request =
        GetSmartCampaignSettingRequest.newBuilder()
            .setResourceName(resourceName == null ? null : resourceName.toString())
            .build();
    return getSmartCampaignSetting(request);
  }
  ...
  public final SmartCampaignSetting getSmartCampaignSetting(String resourceName) {
    GetSmartCampaignSettingRequest request =
        GetSmartCampaignSettingRequest.newBuilder().setResourceName(resourceName).build();
    return getSmartCampaignSetting(request);
  }
   ...
   *           .build();
   *   SmartCampaignSetting response =
   *       smartCampaignSettingServiceClient.getSmartCampaignSetting(request);
   * }
   * }</pre>
   *
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final SmartCampaignSetting getSmartCampaignSetting(
      GetSmartCampaignSettingRequest request) {
    return getSmartCampaignSettingCallable().call(request);
  }
   ...
   *               SmartCampaignSettingName.of("[CUSTOMER_ID]", "[CAMPAIGN_ID]").toString())
   *           .build();
   *   ApiFuture<SmartCampaignSetting> future =
   *       smartCampaignSettingServiceClient.getSmartCampaignSettingCallable().futureCall(request);
   *   // Do something.
   *   SmartCampaignSetting response = future.get();
   * }
   * }</pre>
   */
  public final UnaryCallable<GetSmartCampaignSettingRequest, SmartCampaignSetting>
      getSmartCampaignSettingCallable() {
    return stub.getSmartCampaignSettingCallable();
  }
