...
import com.google.ads.googleads.v1.services.stub.AdParameterServiceStub;
import com.google.ads.googleads.v1.services.stub.AdParameterServiceStubSettings;
...
public class AdParameterServiceClient implements BackgroundResource {
   ...
   * </code></pre>
   *
   * @param resourceName The resource name of the ad parameter to fetch.
   ...
   * </code></pre>
   *
   * @param customerId The ID of the customer whose ad parameters are being modified.
   * @param operations The list of operations to perform on individual ad parameters.
