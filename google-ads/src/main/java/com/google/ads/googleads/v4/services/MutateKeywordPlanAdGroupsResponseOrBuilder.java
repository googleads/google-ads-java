...
public interface MutateKeywordPlanAdGroupsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v4.services.MutateKeywordPlanAdGroupsResponse)
   ...
   */
  java.util.List<com.google.ads.googleads.v4.services.MutateKeywordPlanAdGroupResult> 
      getResultsList();
  /**
   * <pre>
   * All results for the mutate. The order of the results is determined by the
   ...
   * <code>repeated .google.ads.googleads.v4.services.MutateKeywordPlanAdGroupResult results = 2;</code>
   */
  com.google.ads.googleads.v4.services.MutateKeywordPlanAdGroupResult getResults(int index);
  /**
   * <pre>
   * All results for the mutate. The order of the results is determined by the
   * order of the keywords in the original request.
   ...
   * <code>repeated .google.ads.googleads.v4.services.MutateKeywordPlanAdGroupResult results = 2;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v4.services.MutateKeywordPlanAdGroupResultOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v4.services.MutateKeywordPlanAdGroupResult results = 2;</code>
   */
  com.google.ads.googleads.v4.services.MutateKeywordPlanAdGroupResultOrBuilder getResultsOrBuilder(
      int index);
}
