...
import com.google.ads.googleads.v3.services.stub.ProductBiddingCategoryConstantServiceStubSettings;
 ...
 * example, to set the total timeout of getProductBiddingCategoryConstant to 30 seconds:
 *
 * <pre>
 * <code>
 * ProductBiddingCategoryConstantServiceSettings.Builder productBiddingCategoryConstantServiceSettingsBuilder =
 *     ProductBiddingCategoryConstantServiceSettings.newBuilder();
 * productBiddingCategoryConstantServiceSettingsBuilder.getProductBiddingCategoryConstantSettings().getRetrySettings().toBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * ProductBiddingCategoryConstantServiceSettings productBiddingCategoryConstantServiceSettings = productBiddingCategoryConstantServiceSettingsBuilder.build();
 * </code>
 * </pre>
 */
