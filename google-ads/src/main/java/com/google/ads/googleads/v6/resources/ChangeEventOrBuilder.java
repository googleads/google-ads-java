...
public interface ChangeEventOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v6.resources.ChangeEvent)
   ...
   */
  com.google.ads.googleads.v6.enums.ChangeEventResourceTypeEnum.ChangeEventResourceType getChangeResourceType();
   ...
   */
  com.google.ads.googleads.v6.enums.ChangeClientTypeEnum.ChangeClientType getClientType();
   ...
   */
  com.google.ads.googleads.v6.resources.ChangeEvent.ChangedResource getOldResource();
  /**
   * <pre>
   * Output only. The old resource before the change. Only changed fields will be populated.
   * </pre>
   ...
   * <code>.google.ads.googleads.v6.resources.ChangeEvent.ChangedResource old_resource = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v6.resources.ChangeEvent.ChangedResourceOrBuilder getOldResourceOrBuilder();
   ...
   */
  com.google.ads.googleads.v6.resources.ChangeEvent.ChangedResource getNewResource();
  /**
   * <pre>
   * Output only. The new resource after the change. Only changed fields will be populated.
   * </pre>
   ...
   * <code>.google.ads.googleads.v6.resources.ChangeEvent.ChangedResource new_resource = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v6.resources.ChangeEvent.ChangedResourceOrBuilder getNewResourceOrBuilder();
   ...
   */
  com.google.ads.googleads.v6.enums.ResourceChangeOperationEnum.ResourceChangeOperation getResourceChangeOperation();
