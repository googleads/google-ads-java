...
public interface MutateConversionGoalCampaignConfigsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v9.services.MutateConversionGoalCampaignConfigsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v9.services.ConversionGoalCampaignConfigOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual conversion goal campaign
   ...
   * <code>repeated .google.ads.googleads.v9.services.ConversionGoalCampaignConfigOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v9.services.ConversionGoalCampaignConfigOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual conversion goal campaign
   * config.
   ...
   * <code>repeated .google.ads.googleads.v9.services.ConversionGoalCampaignConfigOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v9.services.ConversionGoalCampaignConfigOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v9.services.ConversionGoalCampaignConfigOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v9.services.ConversionGoalCampaignConfigOperationOrBuilder getOperationsOrBuilder(
      int index);
