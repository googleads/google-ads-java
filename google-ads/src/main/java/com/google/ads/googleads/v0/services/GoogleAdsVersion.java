...
import com.google.ads.googleads.v0.errors.GoogleAdsException;

@VersionDescriptor(versionName = "v0", googleAdsExceptionFactory = GoogleAdsException.Factory.class)
