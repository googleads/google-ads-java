...
import com.google.ads.googleads.v2.resources.AdGroupAdLabel;
import com.google.ads.googleads.v2.services.stub.AdGroupAdLabelServiceStubSettings;
 ...
 * example, to set the total timeout of getAdGroupAdLabel to 30 seconds:
 *
 * <pre>
 * <code>
 * AdGroupAdLabelServiceSettings.Builder adGroupAdLabelServiceSettingsBuilder =
 *     AdGroupAdLabelServiceSettings.newBuilder();
 * adGroupAdLabelServiceSettingsBuilder.getAdGroupAdLabelSettings().getRetrySettings().toBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * AdGroupAdLabelServiceSettings adGroupAdLabelServiceSettings = adGroupAdLabelServiceSettingsBuilder.build();
 * </code>
 * </pre>
 */
