...
import com.google.ads.googleads.v0.services.stub.BillingSetupServiceStub;
import com.google.ads.googleads.v0.services.stub.BillingSetupServiceStubSettings;
...
public class BillingSetupServiceClient implements BackgroundResource {
   ...
   * </code></pre>
   *
   * @param resourceName The resource name of the billing setup to fetch.
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  private final BillingSetup getBillingSetup(GetBillingSetupRequest request) {
   ...
   * </code></pre>
   *
   * @param customerId Id of the customer to apply the billing setup mutate operation to.
