...
public interface AccountBudgetOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v6.resources.AccountBudget)
   ...
   * @return The status.
   */
  com.google.ads.googleads.v6.enums.AccountBudgetStatusEnum.AccountBudgetStatus getStatus();
   ...
   */
  com.google.ads.googleads.v6.resources.AccountBudget.PendingAccountBudgetProposal getPendingProposal();
  /**
   * <pre>
   * Output only. The pending proposal to modify this budget, if applicable.
   * </pre>
   ...
   * <code>.google.ads.googleads.v6.resources.AccountBudget.PendingAccountBudgetProposal pending_proposal = 22 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v6.resources.AccountBudget.PendingAccountBudgetProposalOrBuilder getPendingProposalOrBuilder();
   ...
   */
  com.google.ads.googleads.v6.enums.TimeTypeEnum.TimeType getApprovedEndTimeType();
   ...
   */
  com.google.ads.googleads.v6.enums.SpendingLimitTypeEnum.SpendingLimitType getProposedSpendingLimitType();
   ...
   */
  com.google.ads.googleads.v6.enums.SpendingLimitTypeEnum.SpendingLimitType getApprovedSpendingLimitType();
   ...
   */
  com.google.ads.googleads.v6.enums.SpendingLimitTypeEnum.SpendingLimitType getAdjustedSpendingLimitType();

  public com.google.ads.googleads.v6.resources.AccountBudget.ProposedEndTimeCase getProposedEndTimeCase();

  public com.google.ads.googleads.v6.resources.AccountBudget.ApprovedEndTimeCase getApprovedEndTimeCase();

  public com.google.ads.googleads.v6.resources.AccountBudget.ProposedSpendingLimitCase getProposedSpendingLimitCase();

  public com.google.ads.googleads.v6.resources.AccountBudget.ApprovedSpendingLimitCase getApprovedSpendingLimitCase();

  public com.google.ads.googleads.v6.resources.AccountBudget.AdjustedSpendingLimitCase getAdjustedSpendingLimitCase();
}
