...
public interface BatchJobOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v6.resources.BatchJob)
   ...
   * @return The metadata.
   */
  com.google.ads.googleads.v6.resources.BatchJob.BatchJobMetadata getMetadata();
  /**
   * <pre>
   * Output only. Contains additional information about this batch job.
   * </pre>
   ...
   * <code>.google.ads.googleads.v6.resources.BatchJob.BatchJobMetadata metadata = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v6.resources.BatchJob.BatchJobMetadataOrBuilder getMetadataOrBuilder();
   ...
   * @return The status.
   */
  com.google.ads.googleads.v6.enums.BatchJobStatusEnum.BatchJobStatus getStatus();
