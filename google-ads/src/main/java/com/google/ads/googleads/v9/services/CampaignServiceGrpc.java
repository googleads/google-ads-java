...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v9/services/campaign_service.proto")
public final class CampaignServiceGrpc {

  private CampaignServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v9.services.CampaignService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetCampaignRequest,
      com.google.ads.googleads.v9.resources.Campaign> getGetCampaignMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCampaign",
      requestType = com.google.ads.googleads.v9.services.GetCampaignRequest.class,
      responseType = com.google.ads.googleads.v9.resources.Campaign.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetCampaignRequest,
      com.google.ads.googleads.v9.resources.Campaign> getGetCampaignMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetCampaignRequest, com.google.ads.googleads.v9.resources.Campaign> getGetCampaignMethod;
      ...
      synchronized (CampaignServiceGrpc.class) {
        if ((getGetCampaignMethod = CampaignServiceGrpc.getGetCampaignMethod) == null) {
          CampaignServiceGrpc.getGetCampaignMethod = getGetCampaignMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.GetCampaignRequest, com.google.ads.googleads.v9.resources.Campaign>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCampaign"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.GetCampaignRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.resources.Campaign.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateCampaignsRequest,
      com.google.ads.googleads.v9.services.MutateCampaignsResponse> getMutateCampaignsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCampaigns",
      requestType = com.google.ads.googleads.v9.services.MutateCampaignsRequest.class,
      responseType = com.google.ads.googleads.v9.services.MutateCampaignsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateCampaignsRequest,
      com.google.ads.googleads.v9.services.MutateCampaignsResponse> getMutateCampaignsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateCampaignsRequest, com.google.ads.googleads.v9.services.MutateCampaignsResponse> getMutateCampaignsMethod;
      ...
      synchronized (CampaignServiceGrpc.class) {
        if ((getMutateCampaignsMethod = CampaignServiceGrpc.getMutateCampaignsMethod) == null) {
          CampaignServiceGrpc.getMutateCampaignsMethod = getMutateCampaignsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.MutateCampaignsRequest, com.google.ads.googleads.v9.services.MutateCampaignsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCampaigns"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.MutateCampaignsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.MutateCampaignsResponse.getDefaultInstance()))
  ...
  public static abstract class CampaignServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCampaign(com.google.ads.googleads.v9.services.GetCampaignRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.Campaign> responseObserver) {
     ...
     * </pre>
     */
    public void mutateCampaigns(com.google.ads.googleads.v9.services.MutateCampaignsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.MutateCampaignsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.GetCampaignRequest,
                com.google.ads.googleads.v9.resources.Campaign>(
                  this, METHODID_GET_CAMPAIGN)))
          .addMethod(
            getMutateCampaignsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.MutateCampaignsRequest,
                com.google.ads.googleads.v9.services.MutateCampaignsResponse>(
  ...
  public static final class CampaignServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CampaignServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.resources.Campaign getCampaign(com.google.ads.googleads.v9.services.GetCampaignRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.services.MutateCampaignsResponse mutateCampaigns(com.google.ads.googleads.v9.services.MutateCampaignsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CampaignServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CampaignServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.resources.Campaign> getCampaign(
        com.google.ads.googleads.v9.services.GetCampaignRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.services.MutateCampaignsResponse> mutateCampaigns(
        com.google.ads.googleads.v9.services.MutateCampaignsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CAMPAIGN:
          serviceImpl.getCampaign((com.google.ads.googleads.v9.services.GetCampaignRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.Campaign>) responseObserver);
          break;
        case METHODID_MUTATE_CAMPAIGNS:
          serviceImpl.mutateCampaigns((com.google.ads.googleads.v9.services.MutateCampaignsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.MutateCampaignsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CampaignServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v9.services.CampaignServiceProto.getDescriptor();
    }
