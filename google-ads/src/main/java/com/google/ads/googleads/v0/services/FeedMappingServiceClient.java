...
import com.google.ads.googleads.v0.services.stub.FeedMappingServiceStub;
import com.google.ads.googleads.v0.services.stub.FeedMappingServiceStubSettings;
...
public class FeedMappingServiceClient implements BackgroundResource {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  private final FeedMapping getFeedMapping(GetFeedMappingRequest request) {
