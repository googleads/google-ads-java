...
public class CampaignBidModifierName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("customers/{customer_id}/campaignBidModifiers/{campaign_id}~{criterion_id}");
  ...
  public static CampaignBidModifierName of(String customerId, String campaignId, String criterionId) {
    return newBuilder()
