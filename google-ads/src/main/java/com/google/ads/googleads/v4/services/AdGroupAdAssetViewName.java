...
public class AdGroupAdAssetViewName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("customers/{customer}/adGroupAdAssetViews/{ad_group_ad_asset_view}");
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          fieldMapBuilder.put("adGroupAdAssetView", adGroupAdAssetView);
  ...
  public String toString() {
    return PATH_TEMPLATE.instantiate("customer", customer, "ad_group_ad_asset_view", adGroupAdAssetView);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AdGroupAdAssetViewName) {
      ...
      return (this.customer.equals(that.customer))
          && (this.adGroupAdAssetView.equals(that.adGroupAdAssetView));
    }
    return false;
  }
