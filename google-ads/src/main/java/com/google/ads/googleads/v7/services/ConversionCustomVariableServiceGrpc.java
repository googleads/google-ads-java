...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v7/services/conversion_custom_variable_service.proto")
public final class ConversionCustomVariableServiceGrpc {

  private ConversionCustomVariableServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v7.services.ConversionCustomVariableService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetConversionCustomVariableRequest,
      com.google.ads.googleads.v7.resources.ConversionCustomVariable> getGetConversionCustomVariableMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetConversionCustomVariable",
      requestType = com.google.ads.googleads.v7.services.GetConversionCustomVariableRequest.class,
      responseType = com.google.ads.googleads.v7.resources.ConversionCustomVariable.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetConversionCustomVariableRequest,
      com.google.ads.googleads.v7.resources.ConversionCustomVariable> getGetConversionCustomVariableMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetConversionCustomVariableRequest, com.google.ads.googleads.v7.resources.ConversionCustomVariable> getGetConversionCustomVariableMethod;
      ...
      synchronized (ConversionCustomVariableServiceGrpc.class) {
        if ((getGetConversionCustomVariableMethod = ConversionCustomVariableServiceGrpc.getGetConversionCustomVariableMethod) == null) {
          ConversionCustomVariableServiceGrpc.getGetConversionCustomVariableMethod = getGetConversionCustomVariableMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v7.services.GetConversionCustomVariableRequest, com.google.ads.googleads.v7.resources.ConversionCustomVariable>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetConversionCustomVariable"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.GetConversionCustomVariableRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.resources.ConversionCustomVariable.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.MutateConversionCustomVariablesRequest,
      com.google.ads.googleads.v7.services.MutateConversionCustomVariablesResponse> getMutateConversionCustomVariablesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateConversionCustomVariables",
      requestType = com.google.ads.googleads.v7.services.MutateConversionCustomVariablesRequest.class,
      responseType = com.google.ads.googleads.v7.services.MutateConversionCustomVariablesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.MutateConversionCustomVariablesRequest,
      com.google.ads.googleads.v7.services.MutateConversionCustomVariablesResponse> getMutateConversionCustomVariablesMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.MutateConversionCustomVariablesRequest, com.google.ads.googleads.v7.services.MutateConversionCustomVariablesResponse> getMutateConversionCustomVariablesMethod;
      ...
      synchronized (ConversionCustomVariableServiceGrpc.class) {
        if ((getMutateConversionCustomVariablesMethod = ConversionCustomVariableServiceGrpc.getMutateConversionCustomVariablesMethod) == null) {
          ConversionCustomVariableServiceGrpc.getMutateConversionCustomVariablesMethod = getMutateConversionCustomVariablesMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v7.services.MutateConversionCustomVariablesRequest, com.google.ads.googleads.v7.services.MutateConversionCustomVariablesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateConversionCustomVariables"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.MutateConversionCustomVariablesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.MutateConversionCustomVariablesResponse.getDefaultInstance()))
  ...
  public static abstract class ConversionCustomVariableServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getConversionCustomVariable(com.google.ads.googleads.v7.services.GetConversionCustomVariableRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.resources.ConversionCustomVariable> responseObserver) {
     ...
     * </pre>
     */
    public void mutateConversionCustomVariables(com.google.ads.googleads.v7.services.MutateConversionCustomVariablesRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.services.MutateConversionCustomVariablesResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v7.services.GetConversionCustomVariableRequest,
                com.google.ads.googleads.v7.resources.ConversionCustomVariable>(
                  this, METHODID_GET_CONVERSION_CUSTOM_VARIABLE)))
          .addMethod(
            getMutateConversionCustomVariablesMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v7.services.MutateConversionCustomVariablesRequest,
                com.google.ads.googleads.v7.services.MutateConversionCustomVariablesResponse>(
  ...
  public static final class ConversionCustomVariableServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ConversionCustomVariableServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v7.resources.ConversionCustomVariable getConversionCustomVariable(com.google.ads.googleads.v7.services.GetConversionCustomVariableRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v7.services.MutateConversionCustomVariablesResponse mutateConversionCustomVariables(com.google.ads.googleads.v7.services.MutateConversionCustomVariablesRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ConversionCustomVariableServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ConversionCustomVariableServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v7.resources.ConversionCustomVariable> getConversionCustomVariable(
        com.google.ads.googleads.v7.services.GetConversionCustomVariableRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v7.services.MutateConversionCustomVariablesResponse> mutateConversionCustomVariables(
        com.google.ads.googleads.v7.services.MutateConversionCustomVariablesRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CONVERSION_CUSTOM_VARIABLE:
          serviceImpl.getConversionCustomVariable((com.google.ads.googleads.v7.services.GetConversionCustomVariableRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.resources.ConversionCustomVariable>) responseObserver);
          break;
        case METHODID_MUTATE_CONVERSION_CUSTOM_VARIABLES:
          serviceImpl.mutateConversionCustomVariables((com.google.ads.googleads.v7.services.MutateConversionCustomVariablesRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.services.MutateConversionCustomVariablesResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ConversionCustomVariableServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v7.services.ConversionCustomVariableServiceProto.getDescriptor();
    }
