...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/domain_category_service.proto")
public final class DomainCategoryServiceGrpc {

  private DomainCategoryServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.DomainCategoryService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  @java.lang.Deprecated // Use {@link #getGetDomainCategoryMethod()} instead. 
  public static final io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetDomainCategoryRequest,
      com.google.ads.googleads.v4.resources.DomainCategory> METHOD_GET_DOMAIN_CATEGORY = getGetDomainCategoryMethodHelper();

  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetDomainCategoryRequest,
      com.google.ads.googleads.v4.resources.DomainCategory> getGetDomainCategoryMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetDomainCategoryRequest,
      com.google.ads.googleads.v4.resources.DomainCategory> getGetDomainCategoryMethod() {
    return getGetDomainCategoryMethodHelper();
  }

  private static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetDomainCategoryRequest,
      com.google.ads.googleads.v4.resources.DomainCategory> getGetDomainCategoryMethodHelper() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetDomainCategoryRequest, com.google.ads.googleads.v4.resources.DomainCategory> getGetDomainCategoryMethod;
      ...
      synchronized (DomainCategoryServiceGrpc.class) {
        if ((getGetDomainCategoryMethod = DomainCategoryServiceGrpc.getGetDomainCategoryMethod) == null) {
          DomainCategoryServiceGrpc.getGetDomainCategoryMethod = getGetDomainCategoryMethod = 
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetDomainCategoryRequest, com.google.ads.googleads.v4.resources.DomainCategory>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "google.ads.googleads.v4.services.DomainCategoryService", "GetDomainCategory"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetDomainCategoryRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.DomainCategory.getDefaultInstance()))
  ...
  public static abstract class DomainCategoryServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getDomainCategory(com.google.ads.googleads.v4.services.GetDomainCategoryRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.DomainCategory> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetDomainCategoryRequest,
                com.google.ads.googleads.v4.resources.DomainCategory>(
  ...
  public static final class DomainCategoryServiceBlockingStub extends io.grpc.stub.AbstractStub<DomainCategoryServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.DomainCategory getDomainCategory(com.google.ads.googleads.v4.services.GetDomainCategoryRequest request) {
  ...
  public static final class DomainCategoryServiceFutureStub extends io.grpc.stub.AbstractStub<DomainCategoryServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.DomainCategory> getDomainCategory(
        com.google.ads.googleads.v4.services.GetDomainCategoryRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DOMAIN_CATEGORY:
          serviceImpl.getDomainCategory((com.google.ads.googleads.v4.services.GetDomainCategoryRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.DomainCategory>) responseObserver);
          break;
        default:
  ...
  private static abstract class DomainCategoryServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.DomainCategoryServiceProto.getDescriptor();
    }
