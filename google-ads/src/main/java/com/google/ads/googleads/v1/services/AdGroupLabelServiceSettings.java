...
import com.google.ads.googleads.v1.resources.AdGroupLabel;
import com.google.ads.googleads.v1.services.stub.AdGroupLabelServiceStubSettings;
 ...
 * example, to set the total timeout of getAdGroupLabel to 30 seconds:
 *
 * <pre>
 * <code>
...
public class AdGroupLabelServiceSettings extends ClientSettings<AdGroupLabelServiceSettings> {
  ...
  public static final AdGroupLabelServiceSettings create(AdGroupLabelServiceStubSettings stub)
      throws IOException {
    return new AdGroupLabelServiceSettings.Builder(stub.toBuilder()).build();
  }
  ...
  protected AdGroupLabelServiceSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends ClientSettings.Builder<AdGroupLabelServiceSettings, Builder> {
    ...
    protected Builder(AdGroupLabelServiceStubSettings.Builder stubSettings) {
      super(stubSettings);
    }
    ...
    @Override
    public AdGroupLabelServiceSettings build() throws IOException {
