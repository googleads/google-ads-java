...
public interface UserListOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v6.resources.UserList)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v6.enums.UserListMembershipStatusEnum.UserListMembershipStatus membership_status = 6;</code>
   ...
   */
  com.google.ads.googleads.v6.enums.UserListMembershipStatusEnum.UserListMembershipStatus getMembershipStatus();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v6.enums.UserListSizeRangeEnum.UserListSizeRange size_range_for_display = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v6.enums.UserListSizeRangeEnum.UserListSizeRange getSizeRangeForDisplay();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v6.enums.UserListSizeRangeEnum.UserListSizeRange size_range_for_search = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v6.enums.UserListSizeRangeEnum.UserListSizeRange getSizeRangeForSearch();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v6.enums.UserListTypeEnum.UserListType type = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The type.
   */
  com.google.ads.googleads.v6.enums.UserListTypeEnum.UserListType getType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v6.enums.UserListClosingReasonEnum.UserListClosingReason closing_reason = 14;</code>
   ...
   */
  com.google.ads.googleads.v6.enums.UserListClosingReasonEnum.UserListClosingReason getClosingReason();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v6.enums.AccessReasonEnum.AccessReason access_reason = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v6.enums.AccessReasonEnum.AccessReason getAccessReason();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v6.enums.UserListAccessStatusEnum.UserListAccessStatus account_user_list_status = 16;</code>
   ...
   */
  com.google.ads.googleads.v6.enums.UserListAccessStatusEnum.UserListAccessStatus getAccountUserListStatus();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v6.common.CrmBasedUserListInfo crm_based_user_list = 19;</code>
   ...
   */
  com.google.ads.googleads.v6.common.CrmBasedUserListInfo getCrmBasedUserList();
  /**
   * <pre>
   * User list of CRM users provided by the advertiser.
   * </pre>
   ...
   * <code>.google.ads.googleads.v6.common.CrmBasedUserListInfo crm_based_user_list = 19;</code>
   */
  com.google.ads.googleads.v6.common.CrmBasedUserListInfoOrBuilder getCrmBasedUserListOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v6.common.SimilarUserListInfo similar_user_list = 20 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v6.common.SimilarUserListInfo getSimilarUserList();
  /**
   * <pre>
   * Output only. User list which are similar to users from another UserList.
   * These lists are readonly and automatically created by google.
   ...
   * <code>.google.ads.googleads.v6.common.SimilarUserListInfo similar_user_list = 20 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v6.common.SimilarUserListInfoOrBuilder getSimilarUserListOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v6.common.RuleBasedUserListInfo rule_based_user_list = 21;</code>
   ...
   */
  com.google.ads.googleads.v6.common.RuleBasedUserListInfo getRuleBasedUserList();
  /**
   * <pre>
   * User list generated by a rule.
   * </pre>
   ...
   * <code>.google.ads.googleads.v6.common.RuleBasedUserListInfo rule_based_user_list = 21;</code>
   */
  com.google.ads.googleads.v6.common.RuleBasedUserListInfoOrBuilder getRuleBasedUserListOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v6.common.LogicalUserListInfo logical_user_list = 22;</code>
   ...
   */
  com.google.ads.googleads.v6.common.LogicalUserListInfo getLogicalUserList();
  /**
   * <pre>
   * User list that is a custom combination of user lists and user interests.
   * </pre>
   ...
   * <code>.google.ads.googleads.v6.common.LogicalUserListInfo logical_user_list = 22;</code>
   */
  com.google.ads.googleads.v6.common.LogicalUserListInfoOrBuilder getLogicalUserListOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v6.common.BasicUserListInfo basic_user_list = 23;</code>
   ...
   */
  com.google.ads.googleads.v6.common.BasicUserListInfo getBasicUserList();
  /**
   * <pre>
   * User list targeting as a collection of conversion or remarketing actions.
   * </pre>
   ...
   * <code>.google.ads.googleads.v6.common.BasicUserListInfo basic_user_list = 23;</code>
   */
  com.google.ads.googleads.v6.common.BasicUserListInfoOrBuilder getBasicUserListOrBuilder();

  public com.google.ads.googleads.v6.resources.UserList.UserListCase getUserListCase();
}
