...
import com.google.ads.googleads.v1.services.stub.UserListServiceStub;
import com.google.ads.googleads.v1.services.stub.UserListServiceStubSettings;
...
public class UserListServiceClient implements BackgroundResource {
   ...
   * </code></pre>
   *
   * @param resourceName The resource name of the user list to fetch.
