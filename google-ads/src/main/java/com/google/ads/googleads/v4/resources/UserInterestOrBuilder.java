...
public interface UserInterestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v4.resources.UserInterest)
   ...
   */
  com.google.ads.googleads.v4.enums.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType getTaxonomyType();
   ...
   */
  java.util.List<com.google.ads.googleads.v4.common.CriterionCategoryAvailability> 
   ...
   * <code>repeated .google.ads.googleads.v4.common.CriterionCategoryAvailability availabilities = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v4.common.CriterionCategoryAvailability getAvailabilities(int index);
  /**
   * <pre>
   * Output only. Availability information of the user interest.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v4.common.CriterionCategoryAvailability availabilities = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v4.common.CriterionCategoryAvailabilityOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v4.common.CriterionCategoryAvailability availabilities = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v4.common.CriterionCategoryAvailabilityOrBuilder getAvailabilitiesOrBuilder(
      int index);
}
