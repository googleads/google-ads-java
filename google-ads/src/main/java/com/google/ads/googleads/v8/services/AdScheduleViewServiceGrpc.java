...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v8/services/ad_schedule_view_service.proto")
public final class AdScheduleViewServiceGrpc {

  private AdScheduleViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v8.services.AdScheduleViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetAdScheduleViewRequest,
      com.google.ads.googleads.v8.resources.AdScheduleView> getGetAdScheduleViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAdScheduleView",
      requestType = com.google.ads.googleads.v8.services.GetAdScheduleViewRequest.class,
      responseType = com.google.ads.googleads.v8.resources.AdScheduleView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetAdScheduleViewRequest,
      com.google.ads.googleads.v8.resources.AdScheduleView> getGetAdScheduleViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetAdScheduleViewRequest, com.google.ads.googleads.v8.resources.AdScheduleView> getGetAdScheduleViewMethod;
      ...
      synchronized (AdScheduleViewServiceGrpc.class) {
        if ((getGetAdScheduleViewMethod = AdScheduleViewServiceGrpc.getGetAdScheduleViewMethod) == null) {
          AdScheduleViewServiceGrpc.getGetAdScheduleViewMethod = getGetAdScheduleViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v8.services.GetAdScheduleViewRequest, com.google.ads.googleads.v8.resources.AdScheduleView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAdScheduleView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.GetAdScheduleViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.resources.AdScheduleView.getDefaultInstance()))
  ...
  public static abstract class AdScheduleViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAdScheduleView(com.google.ads.googleads.v8.services.GetAdScheduleViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.AdScheduleView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v8.services.GetAdScheduleViewRequest,
                com.google.ads.googleads.v8.resources.AdScheduleView>(
  ...
  public static final class AdScheduleViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AdScheduleViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v8.resources.AdScheduleView getAdScheduleView(com.google.ads.googleads.v8.services.GetAdScheduleViewRequest request) {
  ...
  public static final class AdScheduleViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AdScheduleViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v8.resources.AdScheduleView> getAdScheduleView(
        com.google.ads.googleads.v8.services.GetAdScheduleViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AD_SCHEDULE_VIEW:
          serviceImpl.getAdScheduleView((com.google.ads.googleads.v8.services.GetAdScheduleViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.AdScheduleView>) responseObserver);
          break;
        default:
  ...
  private static abstract class AdScheduleViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v8.services.AdScheduleViewServiceProto.getDescriptor();
    }
