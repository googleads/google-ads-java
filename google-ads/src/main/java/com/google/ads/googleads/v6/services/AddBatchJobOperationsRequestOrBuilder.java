...
public interface AddBatchJobOperationsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v6.services.AddBatchJobOperationsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v6.services.MutateOperation> 
   ...
   * <code>repeated .google.ads.googleads.v6.services.MutateOperation mutate_operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v6.services.MutateOperation getMutateOperations(int index);
  /**
   * <pre>
   * Required. The list of mutates being added.
   * Operations can use negative integers as temp ids to signify dependencies
   ...
   * <code>repeated .google.ads.googleads.v6.services.MutateOperation mutate_operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v6.services.MutateOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v6.services.MutateOperation mutate_operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v6.services.MutateOperationOrBuilder getMutateOperationsOrBuilder(
      int index);
}
