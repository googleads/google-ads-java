...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/feed_service.proto")
public final class FeedServiceGrpc {

  private FeedServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.FeedService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetFeedRequest,
      com.google.ads.googleads.v5.resources.Feed> getGetFeedMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetFeed",
      requestType = com.google.ads.googleads.v5.services.GetFeedRequest.class,
      responseType = com.google.ads.googleads.v5.resources.Feed.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetFeedRequest,
      com.google.ads.googleads.v5.resources.Feed> getGetFeedMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetFeedRequest, com.google.ads.googleads.v5.resources.Feed> getGetFeedMethod;
      ...
      synchronized (FeedServiceGrpc.class) {
        if ((getGetFeedMethod = FeedServiceGrpc.getGetFeedMethod) == null) {
          FeedServiceGrpc.getGetFeedMethod = getGetFeedMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetFeedRequest, com.google.ads.googleads.v5.resources.Feed>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetFeed"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetFeedRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.Feed.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateFeedsRequest,
      com.google.ads.googleads.v5.services.MutateFeedsResponse> getMutateFeedsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateFeeds",
      requestType = com.google.ads.googleads.v5.services.MutateFeedsRequest.class,
      responseType = com.google.ads.googleads.v5.services.MutateFeedsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateFeedsRequest,
      com.google.ads.googleads.v5.services.MutateFeedsResponse> getMutateFeedsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateFeedsRequest, com.google.ads.googleads.v5.services.MutateFeedsResponse> getMutateFeedsMethod;
      ...
      synchronized (FeedServiceGrpc.class) {
        if ((getMutateFeedsMethod = FeedServiceGrpc.getMutateFeedsMethod) == null) {
          FeedServiceGrpc.getMutateFeedsMethod = getMutateFeedsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.MutateFeedsRequest, com.google.ads.googleads.v5.services.MutateFeedsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateFeeds"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateFeedsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateFeedsResponse.getDefaultInstance()))
  ...
  public static abstract class FeedServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getFeed(com.google.ads.googleads.v5.services.GetFeedRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.Feed> responseObserver) {
     ...
     * </pre>
     */
    public void mutateFeeds(com.google.ads.googleads.v5.services.MutateFeedsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateFeedsResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetFeedRequest,
                com.google.ads.googleads.v5.resources.Feed>(
                  this, METHODID_GET_FEED)))
          .addMethod(
            getMutateFeedsMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.MutateFeedsRequest,
                com.google.ads.googleads.v5.services.MutateFeedsResponse>(
  ...
  public static final class FeedServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<FeedServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.Feed getFeed(com.google.ads.googleads.v5.services.GetFeedRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.services.MutateFeedsResponse mutateFeeds(com.google.ads.googleads.v5.services.MutateFeedsRequest request) {
      return blockingUnaryCall(
  ...
  public static final class FeedServiceFutureStub extends io.grpc.stub.AbstractFutureStub<FeedServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.Feed> getFeed(
        com.google.ads.googleads.v5.services.GetFeedRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.services.MutateFeedsResponse> mutateFeeds(
        com.google.ads.googleads.v5.services.MutateFeedsRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_FEED:
          serviceImpl.getFeed((com.google.ads.googleads.v5.services.GetFeedRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.Feed>) responseObserver);
          break;
        case METHODID_MUTATE_FEEDS:
          serviceImpl.mutateFeeds((com.google.ads.googleads.v5.services.MutateFeedsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateFeedsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class FeedServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.FeedServiceProto.getDescriptor();
    }
