...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v3/services/parental_status_view_service.proto")
public final class ParentalStatusViewServiceGrpc {

  private ParentalStatusViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v3.services.ParentalStatusViewService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  @java.lang.Deprecated // Use {@link #getGetParentalStatusViewMethod()} instead. 
  public static final io.grpc.MethodDescriptor<com.google.ads.googleads.v3.services.GetParentalStatusViewRequest,
      com.google.ads.googleads.v3.resources.ParentalStatusView> METHOD_GET_PARENTAL_STATUS_VIEW = getGetParentalStatusViewMethodHelper();

  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v3.services.GetParentalStatusViewRequest,
      com.google.ads.googleads.v3.resources.ParentalStatusView> getGetParentalStatusViewMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v3.services.GetParentalStatusViewRequest,
      com.google.ads.googleads.v3.resources.ParentalStatusView> getGetParentalStatusViewMethod() {
    return getGetParentalStatusViewMethodHelper();
  }

  private static io.grpc.MethodDescriptor<com.google.ads.googleads.v3.services.GetParentalStatusViewRequest,
      com.google.ads.googleads.v3.resources.ParentalStatusView> getGetParentalStatusViewMethodHelper() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v3.services.GetParentalStatusViewRequest, com.google.ads.googleads.v3.resources.ParentalStatusView> getGetParentalStatusViewMethod;
      ...
      synchronized (ParentalStatusViewServiceGrpc.class) {
        if ((getGetParentalStatusViewMethod = ParentalStatusViewServiceGrpc.getGetParentalStatusViewMethod) == null) {
          ParentalStatusViewServiceGrpc.getGetParentalStatusViewMethod = getGetParentalStatusViewMethod = 
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v3.services.GetParentalStatusViewRequest, com.google.ads.googleads.v3.resources.ParentalStatusView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "google.ads.googleads.v3.services.ParentalStatusViewService", "GetParentalStatusView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v3.services.GetParentalStatusViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v3.resources.ParentalStatusView.getDefaultInstance()))
  ...
  public static abstract class ParentalStatusViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getParentalStatusView(com.google.ads.googleads.v3.services.GetParentalStatusViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v3.resources.ParentalStatusView> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v3.services.GetParentalStatusViewRequest,
                com.google.ads.googleads.v3.resources.ParentalStatusView>(
  ...
  public static final class ParentalStatusViewServiceBlockingStub extends io.grpc.stub.AbstractStub<ParentalStatusViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v3.resources.ParentalStatusView getParentalStatusView(com.google.ads.googleads.v3.services.GetParentalStatusViewRequest request) {
  ...
  public static final class ParentalStatusViewServiceFutureStub extends io.grpc.stub.AbstractStub<ParentalStatusViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v3.resources.ParentalStatusView> getParentalStatusView(
        com.google.ads.googleads.v3.services.GetParentalStatusViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_PARENTAL_STATUS_VIEW:
          serviceImpl.getParentalStatusView((com.google.ads.googleads.v3.services.GetParentalStatusViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v3.resources.ParentalStatusView>) responseObserver);
          break;
        default:
  ...
  private static abstract class ParentalStatusViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v3.services.ParentalStatusViewServiceProto.getDescriptor();
    }
