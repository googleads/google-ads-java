...
import com.google.ads.googleads.v0.services.stub.FeedItemServiceStub;
import com.google.ads.googleads.v0.services.stub.FeedItemServiceStubSettings;
...
public class FeedItemServiceClient implements BackgroundResource {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  private final FeedItem getFeedItem(GetFeedItemRequest request) {
