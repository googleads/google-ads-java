...
public class KeywordPlanCampaignKeywordName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("customers/{customer_id}/keywordPlanCampaignKeywords/{keyword_plan_campaign_keyword_id}");
  ...
  private KeywordPlanCampaignKeywordName(Builder builder) {
    ...
    keywordPlanCampaignKeywordId = Preconditions.checkNotNull(builder.getKeywordPlanCampaignKeywordId());
  }
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          fieldMapBuilder.put("keywordPlanCampaignKeywordId", keywordPlanCampaignKeywordId);
  ...
  public String toString() {
    return PATH_TEMPLATE.instantiate("customer_id", customerId, "keyword_plan_campaign_keyword_id", keywordPlanCampaignKeywordId);
  }
  ...
  public static class Builder {
    ...
    private Builder(KeywordPlanCampaignKeywordName keywordPlanCampaignKeywordName) {
      customerId = keywordPlanCampaignKeywordName.customerId;
      keywordPlanCampaignKeywordId = keywordPlanCampaignKeywordName.keywordPlanCampaignKeywordId;
    }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof KeywordPlanCampaignKeywordName) {
      ...
      return (this.customerId.equals(that.customerId))
          && (this.keywordPlanCampaignKeywordId.equals(that.keywordPlanCampaignKeywordId));
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= keywordPlanCampaignKeywordId.hashCode();
    return h;
  }
}
