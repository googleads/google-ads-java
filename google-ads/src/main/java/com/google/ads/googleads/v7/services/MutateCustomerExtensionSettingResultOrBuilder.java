...
public interface MutateCustomerExtensionSettingResultOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v7.services.MutateCustomerExtensionSettingResult)
   ...
   */
  com.google.ads.googleads.v7.resources.CustomerExtensionSetting getCustomerExtensionSetting();
  /**
   * <pre>
   * The mutated CustomerExtensionSetting with only mutable fields after mutate.
   * The field will only be returned when response_content_type is set to
   ...
   * <code>.google.ads.googleads.v7.resources.CustomerExtensionSetting customer_extension_setting = 2;</code>
   */
  com.google.ads.googleads.v7.resources.CustomerExtensionSettingOrBuilder getCustomerExtensionSettingOrBuilder();
}
