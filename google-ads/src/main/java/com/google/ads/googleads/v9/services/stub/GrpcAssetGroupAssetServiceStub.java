...
public class GrpcAssetGroupAssetServiceStub extends AssetGroupAssetServiceStub {
  private static final MethodDescriptor<GetAssetGroupAssetRequest, AssetGroupAsset>
      getAssetGroupAssetMethodDescriptor =
          MethodDescriptor.<GetAssetGroupAssetRequest, AssetGroupAsset>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.ads.googleads.v9.services.AssetGroupAssetService/GetAssetGroupAsset")
              .setRequestMarshaller(
                  ProtoUtils.marshaller(GetAssetGroupAssetRequest.getDefaultInstance()))
              .setResponseMarshaller(ProtoUtils.marshaller(AssetGroupAsset.getDefaultInstance()))
              .build();
  ...
  private final UnaryCallable<GetAssetGroupAssetRequest, AssetGroupAsset>
  ...
  protected GrpcAssetGroupAssetServiceStub(
    ...
    GrpcCallSettings<GetAssetGroupAssetRequest, AssetGroupAsset>
        getAssetGroupAssetTransportSettings =
            GrpcCallSettings.<GetAssetGroupAssetRequest, AssetGroupAsset>newBuilder()
                .setMethodDescriptor(getAssetGroupAssetMethodDescriptor)
                .setParamsExtractor(
                    request -> {
    ...
    this.getAssetGroupAssetCallable =
        callableFactory.createUnaryCallable(
            getAssetGroupAssetTransportSettings,
            settings.getAssetGroupAssetSettings(),
            clientContext);
  ...
  public UnaryCallable<GetAssetGroupAssetRequest, AssetGroupAsset> getAssetGroupAssetCallable() {
    return getAssetGroupAssetCallable;
  }
