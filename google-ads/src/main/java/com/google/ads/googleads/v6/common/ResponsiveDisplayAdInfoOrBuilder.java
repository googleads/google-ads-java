...
public interface ResponsiveDisplayAdInfoOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v6.common.ResponsiveDisplayAdInfo)
   ...
   * <code>repeated .google.ads.googleads.v6.common.AdImageAsset marketing_images = 1;</code>
   */
  com.google.ads.googleads.v6.common.AdImageAsset getMarketingImages(int index);
  /**
   * <pre>
   * Marketing images to be used in the ad. Valid image types are GIF,
   * JPEG, and PNG. The minimum size is 600x314 and the aspect ratio must
   ...
   * <code>repeated .google.ads.googleads.v6.common.AdImageAsset marketing_images = 1;</code>
   */
  com.google.ads.googleads.v6.common.AdImageAssetOrBuilder getMarketingImagesOrBuilder(
      int index);
   ...
   * <code>repeated .google.ads.googleads.v6.common.AdImageAsset square_marketing_images = 2;</code>
   */
  com.google.ads.googleads.v6.common.AdImageAsset getSquareMarketingImages(int index);
  /**
   * <pre>
   * Square marketing images to be used in the ad. Valid image types are GIF,
   * JPEG, and PNG. The minimum size is 300x300 and the aspect ratio must
   ...
   * <code>repeated .google.ads.googleads.v6.common.AdImageAsset square_marketing_images = 2;</code>
   */
  com.google.ads.googleads.v6.common.AdImageAssetOrBuilder getSquareMarketingImagesOrBuilder(
      int index);
   ...
   * <code>repeated .google.ads.googleads.v6.common.AdImageAsset logo_images = 3;</code>
   */
  com.google.ads.googleads.v6.common.AdImageAsset getLogoImages(int index);
  /**
   * <pre>
   * Logo images to be used in the ad. Valid image types are GIF,
   * JPEG, and PNG. The minimum size is 512x128 and the aspect ratio must
   ...
   * <code>repeated .google.ads.googleads.v6.common.AdImageAsset logo_images = 3;</code>
   */
  com.google.ads.googleads.v6.common.AdImageAssetOrBuilder getLogoImagesOrBuilder(
      int index);
   ...
   * <code>repeated .google.ads.googleads.v6.common.AdImageAsset square_logo_images = 4;</code>
   */
  com.google.ads.googleads.v6.common.AdImageAsset getSquareLogoImages(int index);
  /**
   * <pre>
   * Square logo images to be used in the ad. Valid image types are GIF,
   * JPEG, and PNG. The minimum size is 128x128 and the aspect ratio must
   ...
   * <code>repeated .google.ads.googleads.v6.common.AdImageAsset square_logo_images = 4;</code>
   */
  com.google.ads.googleads.v6.common.AdImageAssetOrBuilder getSquareLogoImagesOrBuilder(
      int index);
   ...
   */
  com.google.ads.googleads.v6.common.AdTextAsset getLongHeadline();
  /**
   * <pre>
   * A required long format headline. The maximum length is 90 characters.
   * </pre>
   ...
   * <code>.google.ads.googleads.v6.common.AdTextAsset long_headline = 6;</code>
   */
  com.google.ads.googleads.v6.common.AdTextAssetOrBuilder getLongHeadlineOrBuilder();
   ...
   */
  com.google.ads.googleads.v6.enums.DisplayAdFormatSettingEnum.DisplayAdFormatSetting getFormatSetting();
   ...
   */
  com.google.ads.googleads.v6.common.ResponsiveDisplayAdControlSpec getControlSpec();
  /**
   * <pre>
   * Specification for various creative controls.
   * </pre>
   ...
   * <code>.google.ads.googleads.v6.common.ResponsiveDisplayAdControlSpec control_spec = 24;</code>
   */
  com.google.ads.googleads.v6.common.ResponsiveDisplayAdControlSpecOrBuilder getControlSpecOrBuilder();
}
