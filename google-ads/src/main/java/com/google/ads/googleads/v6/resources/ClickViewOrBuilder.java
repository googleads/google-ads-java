...
public interface ClickViewOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v6.resources.ClickView)
   ...
   */
  com.google.ads.googleads.v6.common.ClickLocation getAreaOfInterest();
  /**
   * <pre>
   * Output only. The location criteria matching the area of interest associated with the
   * impression.
   ...
   * <code>.google.ads.googleads.v6.common.ClickLocation area_of_interest = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v6.common.ClickLocationOrBuilder getAreaOfInterestOrBuilder();
   ...
   */
  com.google.ads.googleads.v6.common.ClickLocation getLocationOfPresence();
  /**
   * <pre>
   * Output only. The location criteria matching the location of presence associated with the
   * impression.
   ...
   * <code>.google.ads.googleads.v6.common.ClickLocation location_of_presence = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v6.common.ClickLocationOrBuilder getLocationOfPresenceOrBuilder();
