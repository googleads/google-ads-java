...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v3/services/display_keyword_view_service.proto")
public final class DisplayKeywordViewServiceGrpc {

  private DisplayKeywordViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v3.services.DisplayKeywordViewService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  @java.lang.Deprecated // Use {@link #getGetDisplayKeywordViewMethod()} instead. 
  public static final io.grpc.MethodDescriptor<com.google.ads.googleads.v3.services.GetDisplayKeywordViewRequest,
      com.google.ads.googleads.v3.resources.DisplayKeywordView> METHOD_GET_DISPLAY_KEYWORD_VIEW = getGetDisplayKeywordViewMethodHelper();

  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v3.services.GetDisplayKeywordViewRequest,
      com.google.ads.googleads.v3.resources.DisplayKeywordView> getGetDisplayKeywordViewMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v3.services.GetDisplayKeywordViewRequest,
      com.google.ads.googleads.v3.resources.DisplayKeywordView> getGetDisplayKeywordViewMethod() {
    return getGetDisplayKeywordViewMethodHelper();
  }

  private static io.grpc.MethodDescriptor<com.google.ads.googleads.v3.services.GetDisplayKeywordViewRequest,
      com.google.ads.googleads.v3.resources.DisplayKeywordView> getGetDisplayKeywordViewMethodHelper() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v3.services.GetDisplayKeywordViewRequest, com.google.ads.googleads.v3.resources.DisplayKeywordView> getGetDisplayKeywordViewMethod;
      ...
      synchronized (DisplayKeywordViewServiceGrpc.class) {
        if ((getGetDisplayKeywordViewMethod = DisplayKeywordViewServiceGrpc.getGetDisplayKeywordViewMethod) == null) {
          DisplayKeywordViewServiceGrpc.getGetDisplayKeywordViewMethod = getGetDisplayKeywordViewMethod = 
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v3.services.GetDisplayKeywordViewRequest, com.google.ads.googleads.v3.resources.DisplayKeywordView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "google.ads.googleads.v3.services.DisplayKeywordViewService", "GetDisplayKeywordView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v3.services.GetDisplayKeywordViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v3.resources.DisplayKeywordView.getDefaultInstance()))
  ...
  public static abstract class DisplayKeywordViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getDisplayKeywordView(com.google.ads.googleads.v3.services.GetDisplayKeywordViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v3.resources.DisplayKeywordView> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v3.services.GetDisplayKeywordViewRequest,
                com.google.ads.googleads.v3.resources.DisplayKeywordView>(
  ...
  public static final class DisplayKeywordViewServiceBlockingStub extends io.grpc.stub.AbstractStub<DisplayKeywordViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v3.resources.DisplayKeywordView getDisplayKeywordView(com.google.ads.googleads.v3.services.GetDisplayKeywordViewRequest request) {
  ...
  public static final class DisplayKeywordViewServiceFutureStub extends io.grpc.stub.AbstractStub<DisplayKeywordViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v3.resources.DisplayKeywordView> getDisplayKeywordView(
        com.google.ads.googleads.v3.services.GetDisplayKeywordViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DISPLAY_KEYWORD_VIEW:
          serviceImpl.getDisplayKeywordView((com.google.ads.googleads.v3.services.GetDisplayKeywordViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v3.resources.DisplayKeywordView>) responseObserver);
          break;
        default:
  ...
  private static abstract class DisplayKeywordViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v3.services.DisplayKeywordViewServiceProto.getDescriptor();
    }
