...
import com.google.ads.googleads.v0.services.stub.ManagedPlacementViewServiceStub;
import com.google.ads.googleads.v0.services.stub.ManagedPlacementViewServiceStubSettings;
...
public class ManagedPlacementViewServiceClient implements BackgroundResource {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  private final ManagedPlacementView getManagedPlacementView(
      GetManagedPlacementViewRequest request) {
