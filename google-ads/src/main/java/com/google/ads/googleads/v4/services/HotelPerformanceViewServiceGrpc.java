...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/hotel_performance_view_service.proto")
public final class HotelPerformanceViewServiceGrpc {

  private HotelPerformanceViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.HotelPerformanceViewService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  @java.lang.Deprecated // Use {@link #getGetHotelPerformanceViewMethod()} instead. 
  public static final io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetHotelPerformanceViewRequest,
      com.google.ads.googleads.v4.resources.HotelPerformanceView> METHOD_GET_HOTEL_PERFORMANCE_VIEW = getGetHotelPerformanceViewMethodHelper();

  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetHotelPerformanceViewRequest,
      com.google.ads.googleads.v4.resources.HotelPerformanceView> getGetHotelPerformanceViewMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetHotelPerformanceViewRequest,
      com.google.ads.googleads.v4.resources.HotelPerformanceView> getGetHotelPerformanceViewMethod() {
    return getGetHotelPerformanceViewMethodHelper();
  }

  private static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetHotelPerformanceViewRequest,
      com.google.ads.googleads.v4.resources.HotelPerformanceView> getGetHotelPerformanceViewMethodHelper() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetHotelPerformanceViewRequest, com.google.ads.googleads.v4.resources.HotelPerformanceView> getGetHotelPerformanceViewMethod;
      ...
      synchronized (HotelPerformanceViewServiceGrpc.class) {
        if ((getGetHotelPerformanceViewMethod = HotelPerformanceViewServiceGrpc.getGetHotelPerformanceViewMethod) == null) {
          HotelPerformanceViewServiceGrpc.getGetHotelPerformanceViewMethod = getGetHotelPerformanceViewMethod = 
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetHotelPerformanceViewRequest, com.google.ads.googleads.v4.resources.HotelPerformanceView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "google.ads.googleads.v4.services.HotelPerformanceViewService", "GetHotelPerformanceView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetHotelPerformanceViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.HotelPerformanceView.getDefaultInstance()))
  ...
  public static abstract class HotelPerformanceViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getHotelPerformanceView(com.google.ads.googleads.v4.services.GetHotelPerformanceViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.HotelPerformanceView> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetHotelPerformanceViewRequest,
                com.google.ads.googleads.v4.resources.HotelPerformanceView>(
  ...
  public static final class HotelPerformanceViewServiceBlockingStub extends io.grpc.stub.AbstractStub<HotelPerformanceViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.HotelPerformanceView getHotelPerformanceView(com.google.ads.googleads.v4.services.GetHotelPerformanceViewRequest request) {
  ...
  public static final class HotelPerformanceViewServiceFutureStub extends io.grpc.stub.AbstractStub<HotelPerformanceViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.HotelPerformanceView> getHotelPerformanceView(
        com.google.ads.googleads.v4.services.GetHotelPerformanceViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_HOTEL_PERFORMANCE_VIEW:
          serviceImpl.getHotelPerformanceView((com.google.ads.googleads.v4.services.GetHotelPerformanceViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.HotelPerformanceView>) responseObserver);
          break;
        default:
  ...
  private static abstract class HotelPerformanceViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.HotelPerformanceViewServiceProto.getDescriptor();
    }
