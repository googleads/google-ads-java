...
public class CampaignAudienceViewName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("customers/{customer_id}/campaignAudienceViews/{campaign_id}~{criterion_id}");
  ...
  public static CampaignAudienceViewName of(String customerId, String campaignId, String criterionId) {
    return newBuilder()
  ...
  public static class Builder {
    ...
    private Builder(CampaignAudienceViewName campaignAudienceViewName) {
      customerId = campaignAudienceViewName.customerId;
      campaignId = campaignAudienceViewName.campaignId;
      criterionId = campaignAudienceViewName.criterionId;
    }
