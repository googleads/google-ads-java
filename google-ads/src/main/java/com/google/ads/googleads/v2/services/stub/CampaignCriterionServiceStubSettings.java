...
import com.google.ads.googleads.v2.services.GetCampaignCriterionRequest;
import com.google.ads.googleads.v2.services.MutateCampaignCriteriaRequest;
...
/**
 * Settings class to configure an instance of {@link CampaignCriterionServiceStub}.
 *
 ...
 * example, to set the total timeout of getCampaignCriterion to 30 seconds:
 *
 * <pre>
 * <code>
 * CampaignCriterionServiceStubSettings.Builder campaignCriterionServiceSettingsBuilder =
 *     CampaignCriterionServiceStubSettings.newBuilder();
 * campaignCriterionServiceSettingsBuilder.getCampaignCriterionSettings().getRetrySettings().toBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * CampaignCriterionServiceStubSettings campaignCriterionServiceSettings = campaignCriterionServiceSettingsBuilder.build();
 * </code>
 * </pre>
 */
...
public class CampaignCriterionServiceStubSettings
  ...
  private final UnaryCallSettings<GetCampaignCriterionRequest, CampaignCriterion>
      getCampaignCriterionSettings;
  private final UnaryCallSettings<MutateCampaignCriteriaRequest, MutateCampaignCriteriaResponse>
  ...
  public UnaryCallSettings<GetCampaignCriterionRequest, CampaignCriterion>
      getCampaignCriterionSettings() {
    return getCampaignCriterionSettings;
  }
  ...
  public UnaryCallSettings<MutateCampaignCriteriaRequest, MutateCampaignCriteriaResponse>
      mutateCampaignCriteriaSettings() {
    return mutateCampaignCriteriaSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(CampaignCriterionServiceStubSettings.class))
        .setTransportToken(
  ...
  protected CampaignCriterionServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    getCampaignCriterionSettings = settingsBuilder.getCampaignCriterionSettings().build();
    mutateCampaignCriteriaSettings = settingsBuilder.mutateCampaignCriteriaSettings().build();
  }
  ...
  public static class Builder
    ...
    private final UnaryCallSettings.Builder<GetCampaignCriterionRequest, CampaignCriterion>
        getCampaignCriterionSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      getCampaignCriterionSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      mutateCampaignCriteriaSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              getCampaignCriterionSettings, mutateCampaignCriteriaSettings);
    ...
    protected Builder(CampaignCriterionServiceStubSettings settings) {
      ...
      getCampaignCriterionSettings = settings.getCampaignCriterionSettings.toBuilder();
      mutateCampaignCriteriaSettings = settings.mutateCampaignCriteriaSettings.toBuilder();
