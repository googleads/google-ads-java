...
public interface CustomerOperationOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v4.services.CustomerOperation)
   ...
   * @return The update.
   */
  com.google.ads.googleads.v4.resources.Customer getUpdate();
  /**
   * <pre>
   * Mutate operation. Only updates are supported for customer.
   * </pre>
   ...
   * <code>.google.ads.googleads.v4.resources.Customer update = 1;</code>
   */
  com.google.ads.googleads.v4.resources.CustomerOrBuilder getUpdateOrBuilder();
