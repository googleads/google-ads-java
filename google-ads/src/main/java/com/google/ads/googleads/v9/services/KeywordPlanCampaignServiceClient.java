...
import com.google.ads.googleads.v9.services.stub.KeywordPlanCampaignServiceStub;
import com.google.ads.googleads.v9.services.stub.KeywordPlanCampaignServiceStubSettings;
...
public class KeywordPlanCampaignServiceClient implements BackgroundResource {
   ...
   *     KeywordPlanCampaignServiceClient.create()) {
   *   String resourceName =
   *       KeywordPlanCampaignName.of("[CUSTOMER_ID]", "[KEYWORD_PLAN_CAMPAIGN_ID]").toString();
   *   KeywordPlanCampaign response =
   *       keywordPlanCampaignServiceClient.getKeywordPlanCampaign(resourceName);
   * }
   * }</pre>
