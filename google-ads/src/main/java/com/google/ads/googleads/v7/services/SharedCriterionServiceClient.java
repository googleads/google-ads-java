...
import com.google.ads.googleads.v7.services.stub.SharedCriterionServiceStub;
import com.google.ads.googleads.v7.services.stub.SharedCriterionServiceStubSettings;
...
public class SharedCriterionServiceClient implements BackgroundResource {
   ...
   *     SharedCriterionServiceClient.create()) {
   *   String resourceName =
   *       SharedCriterionName.of("[CUSTOMER_ID]", "[SHARED_SET_ID]", "[CRITERION_ID]").toString();
   *   SharedCriterion response = sharedCriterionServiceClient.getSharedCriterion(resourceName);
   * }
   * }</pre>
   *
