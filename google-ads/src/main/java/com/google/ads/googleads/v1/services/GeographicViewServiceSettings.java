...
import com.google.ads.googleads.v1.resources.GeographicView;
import com.google.ads.googleads.v1.services.stub.GeographicViewServiceStubSettings;
 ...
 * example, to set the total timeout of getGeographicView to 30 seconds:
 *
 * <pre>
 * <code>
 * GeographicViewServiceSettings.Builder geographicViewServiceSettingsBuilder =
 *     GeographicViewServiceSettings.newBuilder();
 * geographicViewServiceSettingsBuilder.getGeographicViewSettings().getRetrySettings().toBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * GeographicViewServiceSettings geographicViewServiceSettings = geographicViewServiceSettingsBuilder.build();
 * </code>
 * </pre>
 */
