...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v7/services/customer_negative_criterion_service.proto")
public final class CustomerNegativeCriterionServiceGrpc {

  private CustomerNegativeCriterionServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v7.services.CustomerNegativeCriterionService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetCustomerNegativeCriterionRequest,
      com.google.ads.googleads.v7.resources.CustomerNegativeCriterion> getGetCustomerNegativeCriterionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCustomerNegativeCriterion",
      requestType = com.google.ads.googleads.v7.services.GetCustomerNegativeCriterionRequest.class,
      responseType = com.google.ads.googleads.v7.resources.CustomerNegativeCriterion.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetCustomerNegativeCriterionRequest,
      com.google.ads.googleads.v7.resources.CustomerNegativeCriterion> getGetCustomerNegativeCriterionMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetCustomerNegativeCriterionRequest, com.google.ads.googleads.v7.resources.CustomerNegativeCriterion> getGetCustomerNegativeCriterionMethod;
      ...
      synchronized (CustomerNegativeCriterionServiceGrpc.class) {
        if ((getGetCustomerNegativeCriterionMethod = CustomerNegativeCriterionServiceGrpc.getGetCustomerNegativeCriterionMethod) == null) {
          CustomerNegativeCriterionServiceGrpc.getGetCustomerNegativeCriterionMethod = getGetCustomerNegativeCriterionMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v7.services.GetCustomerNegativeCriterionRequest, com.google.ads.googleads.v7.resources.CustomerNegativeCriterion>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCustomerNegativeCriterion"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.GetCustomerNegativeCriterionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.resources.CustomerNegativeCriterion.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaRequest,
      com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaResponse> getMutateCustomerNegativeCriteriaMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCustomerNegativeCriteria",
      requestType = com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaRequest.class,
      responseType = com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaRequest,
      com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaResponse> getMutateCustomerNegativeCriteriaMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaRequest, com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaResponse> getMutateCustomerNegativeCriteriaMethod;
      ...
      synchronized (CustomerNegativeCriterionServiceGrpc.class) {
        if ((getMutateCustomerNegativeCriteriaMethod = CustomerNegativeCriterionServiceGrpc.getMutateCustomerNegativeCriteriaMethod) == null) {
          CustomerNegativeCriterionServiceGrpc.getMutateCustomerNegativeCriteriaMethod = getMutateCustomerNegativeCriteriaMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaRequest, com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCustomerNegativeCriteria"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaResponse.getDefaultInstance()))
  ...
  public static abstract class CustomerNegativeCriterionServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCustomerNegativeCriterion(com.google.ads.googleads.v7.services.GetCustomerNegativeCriterionRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.resources.CustomerNegativeCriterion> responseObserver) {
     ...
     * </pre>
     */
    public void mutateCustomerNegativeCriteria(com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v7.services.GetCustomerNegativeCriterionRequest,
                com.google.ads.googleads.v7.resources.CustomerNegativeCriterion>(
                  this, METHODID_GET_CUSTOMER_NEGATIVE_CRITERION)))
          .addMethod(
            getMutateCustomerNegativeCriteriaMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaRequest,
                com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaResponse>(
  ...
  public static final class CustomerNegativeCriterionServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CustomerNegativeCriterionServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v7.resources.CustomerNegativeCriterion getCustomerNegativeCriterion(com.google.ads.googleads.v7.services.GetCustomerNegativeCriterionRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaResponse mutateCustomerNegativeCriteria(com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CustomerNegativeCriterionServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CustomerNegativeCriterionServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v7.resources.CustomerNegativeCriterion> getCustomerNegativeCriterion(
        com.google.ads.googleads.v7.services.GetCustomerNegativeCriterionRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaResponse> mutateCustomerNegativeCriteria(
        com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CUSTOMER_NEGATIVE_CRITERION:
          serviceImpl.getCustomerNegativeCriterion((com.google.ads.googleads.v7.services.GetCustomerNegativeCriterionRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.resources.CustomerNegativeCriterion>) responseObserver);
          break;
        case METHODID_MUTATE_CUSTOMER_NEGATIVE_CRITERIA:
          serviceImpl.mutateCustomerNegativeCriteria((com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CustomerNegativeCriterionServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v7.services.CustomerNegativeCriterionServiceProto.getDescriptor();
    }
