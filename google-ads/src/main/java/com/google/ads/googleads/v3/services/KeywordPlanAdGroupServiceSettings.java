...
import com.google.ads.googleads.v3.services.stub.KeywordPlanAdGroupServiceStubSettings;
...
public class KeywordPlanAdGroupServiceSettings
  ...
  public UnaryCallSettings<GetKeywordPlanAdGroupRequest, KeywordPlanAdGroup>
    ...
    return ((KeywordPlanAdGroupServiceStubSettings) getStubSettings())
        .getKeywordPlanAdGroupSettings();
  }
  ...
  public static final KeywordPlanAdGroupServiceSettings create(
      KeywordPlanAdGroupServiceStubSettings stub) throws IOException {
    return new KeywordPlanAdGroupServiceSettings.Builder(stub.toBuilder()).build();
  }
  ...
  protected KeywordPlanAdGroupServiceSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder
    ...
    protected Builder(KeywordPlanAdGroupServiceStubSettings.Builder stubSettings) {
      super(stubSettings);
    }
    ...
    @Override
    public KeywordPlanAdGroupServiceSettings build() throws IOException {
