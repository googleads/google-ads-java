...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/merchant_center_link_service.proto")
public final class MerchantCenterLinkServiceGrpc {

  private MerchantCenterLinkServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.MerchantCenterLinkService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.ListMerchantCenterLinksRequest,
      com.google.ads.googleads.v6.services.ListMerchantCenterLinksResponse> getListMerchantCenterLinksMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListMerchantCenterLinks",
      requestType = com.google.ads.googleads.v6.services.ListMerchantCenterLinksRequest.class,
      responseType = com.google.ads.googleads.v6.services.ListMerchantCenterLinksResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.ListMerchantCenterLinksRequest,
      com.google.ads.googleads.v6.services.ListMerchantCenterLinksResponse> getListMerchantCenterLinksMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.ListMerchantCenterLinksRequest, com.google.ads.googleads.v6.services.ListMerchantCenterLinksResponse> getListMerchantCenterLinksMethod;
      ...
      synchronized (MerchantCenterLinkServiceGrpc.class) {
        if ((getListMerchantCenterLinksMethod = MerchantCenterLinkServiceGrpc.getListMerchantCenterLinksMethod) == null) {
          MerchantCenterLinkServiceGrpc.getListMerchantCenterLinksMethod = getListMerchantCenterLinksMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.ListMerchantCenterLinksRequest, com.google.ads.googleads.v6.services.ListMerchantCenterLinksResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListMerchantCenterLinks"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.ListMerchantCenterLinksRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.ListMerchantCenterLinksResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetMerchantCenterLinkRequest,
      com.google.ads.googleads.v6.resources.MerchantCenterLink> getGetMerchantCenterLinkMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetMerchantCenterLink",
      requestType = com.google.ads.googleads.v6.services.GetMerchantCenterLinkRequest.class,
      responseType = com.google.ads.googleads.v6.resources.MerchantCenterLink.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetMerchantCenterLinkRequest,
      com.google.ads.googleads.v6.resources.MerchantCenterLink> getGetMerchantCenterLinkMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetMerchantCenterLinkRequest, com.google.ads.googleads.v6.resources.MerchantCenterLink> getGetMerchantCenterLinkMethod;
      ...
      synchronized (MerchantCenterLinkServiceGrpc.class) {
        if ((getGetMerchantCenterLinkMethod = MerchantCenterLinkServiceGrpc.getGetMerchantCenterLinkMethod) == null) {
          MerchantCenterLinkServiceGrpc.getGetMerchantCenterLinkMethod = getGetMerchantCenterLinkMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetMerchantCenterLinkRequest, com.google.ads.googleads.v6.resources.MerchantCenterLink>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetMerchantCenterLink"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetMerchantCenterLinkRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.MerchantCenterLink.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateMerchantCenterLinkRequest,
      com.google.ads.googleads.v6.services.MutateMerchantCenterLinkResponse> getMutateMerchantCenterLinkMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateMerchantCenterLink",
      requestType = com.google.ads.googleads.v6.services.MutateMerchantCenterLinkRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateMerchantCenterLinkResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateMerchantCenterLinkRequest,
      com.google.ads.googleads.v6.services.MutateMerchantCenterLinkResponse> getMutateMerchantCenterLinkMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateMerchantCenterLinkRequest, com.google.ads.googleads.v6.services.MutateMerchantCenterLinkResponse> getMutateMerchantCenterLinkMethod;
      ...
      synchronized (MerchantCenterLinkServiceGrpc.class) {
        if ((getMutateMerchantCenterLinkMethod = MerchantCenterLinkServiceGrpc.getMutateMerchantCenterLinkMethod) == null) {
          MerchantCenterLinkServiceGrpc.getMutateMerchantCenterLinkMethod = getMutateMerchantCenterLinkMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateMerchantCenterLinkRequest, com.google.ads.googleads.v6.services.MutateMerchantCenterLinkResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateMerchantCenterLink"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateMerchantCenterLinkRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateMerchantCenterLinkResponse.getDefaultInstance()))
  ...
  public static abstract class MerchantCenterLinkServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void listMerchantCenterLinks(com.google.ads.googleads.v6.services.ListMerchantCenterLinksRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.ListMerchantCenterLinksResponse> responseObserver) {
     ...
     * </pre>
     */
    public void getMerchantCenterLink(com.google.ads.googleads.v6.services.GetMerchantCenterLinkRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.MerchantCenterLink> responseObserver) {
     ...
     * </pre>
     */
    public void mutateMerchantCenterLink(com.google.ads.googleads.v6.services.MutateMerchantCenterLinkRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateMerchantCenterLinkResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.ListMerchantCenterLinksRequest,
                com.google.ads.googleads.v6.services.ListMerchantCenterLinksResponse>(
                  this, METHODID_LIST_MERCHANT_CENTER_LINKS)))
          .addMethod(
            getGetMerchantCenterLinkMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetMerchantCenterLinkRequest,
                com.google.ads.googleads.v6.resources.MerchantCenterLink>(
                  this, METHODID_GET_MERCHANT_CENTER_LINK)))
          .addMethod(
            getMutateMerchantCenterLinkMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.MutateMerchantCenterLinkRequest,
                com.google.ads.googleads.v6.services.MutateMerchantCenterLinkResponse>(
  ...
  public static final class MerchantCenterLinkServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MerchantCenterLinkServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.ListMerchantCenterLinksResponse listMerchantCenterLinks(com.google.ads.googleads.v6.services.ListMerchantCenterLinksRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.MerchantCenterLink getMerchantCenterLink(com.google.ads.googleads.v6.services.GetMerchantCenterLinkRequest request) {
      return blockingUnaryCall(
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.MutateMerchantCenterLinkResponse mutateMerchantCenterLink(com.google.ads.googleads.v6.services.MutateMerchantCenterLinkRequest request) {
      return blockingUnaryCall(
  ...
  public static final class MerchantCenterLinkServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MerchantCenterLinkServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.ListMerchantCenterLinksResponse> listMerchantCenterLinks(
        com.google.ads.googleads.v6.services.ListMerchantCenterLinksRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.MerchantCenterLink> getMerchantCenterLink(
        com.google.ads.googleads.v6.services.GetMerchantCenterLinkRequest request) {
      return futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.MutateMerchantCenterLinkResponse> mutateMerchantCenterLink(
        com.google.ads.googleads.v6.services.MutateMerchantCenterLinkRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST_MERCHANT_CENTER_LINKS:
          serviceImpl.listMerchantCenterLinks((com.google.ads.googleads.v6.services.ListMerchantCenterLinksRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.ListMerchantCenterLinksResponse>) responseObserver);
          break;
        case METHODID_GET_MERCHANT_CENTER_LINK:
          serviceImpl.getMerchantCenterLink((com.google.ads.googleads.v6.services.GetMerchantCenterLinkRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.MerchantCenterLink>) responseObserver);
          break;
        case METHODID_MUTATE_MERCHANT_CENTER_LINK:
          serviceImpl.mutateMerchantCenterLink((com.google.ads.googleads.v6.services.MutateMerchantCenterLinkRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateMerchantCenterLinkResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class MerchantCenterLinkServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.MerchantCenterLinkServiceProto.getDescriptor();
    }
