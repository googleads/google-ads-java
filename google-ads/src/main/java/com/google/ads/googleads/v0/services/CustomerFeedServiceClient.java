...
import com.google.ads.googleads.v0.services.stub.CustomerFeedServiceStub;
import com.google.ads.googleads.v0.services.stub.CustomerFeedServiceStubSettings;
...
public class CustomerFeedServiceClient implements BackgroundResource {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  private final CustomerFeed getCustomerFeed(GetCustomerFeedRequest request) {
