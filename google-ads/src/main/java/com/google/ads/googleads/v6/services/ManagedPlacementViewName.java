...
public class ManagedPlacementViewName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("customers/{customer_id}/managedPlacementViews/{ad_group_id}~{criterion_id}");
  ...
  public static ManagedPlacementViewName of(String customerId, String adGroupId, String criterionId) {
    return newBuilder()
