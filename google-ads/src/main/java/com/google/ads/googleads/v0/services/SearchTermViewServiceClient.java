...
import com.google.ads.googleads.v0.services.stub.SearchTermViewServiceStub;
import com.google.ads.googleads.v0.services.stub.SearchTermViewServiceStubSettings;
...
public class SearchTermViewServiceClient implements BackgroundResource {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  private final SearchTermView getSearchTermView(GetSearchTermViewRequest request) {
