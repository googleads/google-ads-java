...
public class DisplayKeywordViewName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("customers/{customer_id}/displayKeywordViews/{ad_group_id}~{criterion_id}");
  ...
  public static DisplayKeywordViewName of(String customerId, String adGroupId, String criterionId) {
    return newBuilder()
