...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/feed_item_set_service.proto")
public final class FeedItemSetServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetFeedItemSetRequest,
      com.google.ads.googleads.v6.resources.FeedItemSet> getGetFeedItemSetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetFeedItemSet",
      requestType = com.google.ads.googleads.v6.services.GetFeedItemSetRequest.class,
      responseType = com.google.ads.googleads.v6.resources.FeedItemSet.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetFeedItemSetRequest,
      com.google.ads.googleads.v6.resources.FeedItemSet> getGetFeedItemSetMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetFeedItemSetRequest, com.google.ads.googleads.v6.resources.FeedItemSet> getGetFeedItemSetMethod;
      ...
      synchronized (FeedItemSetServiceGrpc.class) {
        if ((getGetFeedItemSetMethod = FeedItemSetServiceGrpc.getGetFeedItemSetMethod) == null) {
          FeedItemSetServiceGrpc.getGetFeedItemSetMethod = getGetFeedItemSetMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetFeedItemSetRequest, com.google.ads.googleads.v6.resources.FeedItemSet>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetFeedItemSet"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetFeedItemSetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.FeedItemSet.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateFeedItemSetsRequest,
      com.google.ads.googleads.v6.services.MutateFeedItemSetsResponse> getMutateFeedItemSetsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateFeedItemSets",
      requestType = com.google.ads.googleads.v6.services.MutateFeedItemSetsRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateFeedItemSetsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateFeedItemSetsRequest,
      com.google.ads.googleads.v6.services.MutateFeedItemSetsResponse> getMutateFeedItemSetsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateFeedItemSetsRequest, com.google.ads.googleads.v6.services.MutateFeedItemSetsResponse> getMutateFeedItemSetsMethod;
      ...
      synchronized (FeedItemSetServiceGrpc.class) {
        if ((getMutateFeedItemSetsMethod = FeedItemSetServiceGrpc.getMutateFeedItemSetsMethod) == null) {
          FeedItemSetServiceGrpc.getMutateFeedItemSetsMethod = getMutateFeedItemSetsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateFeedItemSetsRequest, com.google.ads.googleads.v6.services.MutateFeedItemSetsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateFeedItemSets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateFeedItemSetsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateFeedItemSetsResponse.getDefaultInstance()))
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_FEED_ITEM_SET:
          serviceImpl.getFeedItemSet((com.google.ads.googleads.v6.services.GetFeedItemSetRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.FeedItemSet>) responseObserver);
          break;
        case METHODID_MUTATE_FEED_ITEM_SETS:
          serviceImpl.mutateFeedItemSets((com.google.ads.googleads.v6.services.MutateFeedItemSetsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateFeedItemSetsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class FeedItemSetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.FeedItemSetServiceProto.getDescriptor();
    }
