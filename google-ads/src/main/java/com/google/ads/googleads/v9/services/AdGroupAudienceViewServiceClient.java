...
import com.google.ads.googleads.v9.resources.AdGroupAudienceView;
import com.google.ads.googleads.v9.resources.AdGroupAudienceViewName;
import com.google.ads.googleads.v9.services.stub.AdGroupAudienceViewServiceStub;
import com.google.ads.googleads.v9.services.stub.AdGroupAudienceViewServiceStubSettings;
...
public class AdGroupAudienceViewServiceClient implements BackgroundResource {
   ...
   *     AdGroupAudienceViewServiceClient.create()) {
   *   String resourceName =
   *       AdGroupAudienceViewName.of("[CUSTOMER_ID]", "[AD_GROUP_ID]", "[CRITERION_ID]").toString();
   *   AdGroupAudienceView response =
   *       adGroupAudienceViewServiceClient.getAdGroupAudienceView(resourceName);
   * }
   * }</pre>
