...
import com.google.ads.googleads.v0.services.stub.AdGroupAudienceViewServiceStub;
...
public class AdGroupAudienceViewServiceClient implements BackgroundResource {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  private final AdGroupAudienceView getAdGroupAudienceView(GetAdGroupAudienceViewRequest request) {
