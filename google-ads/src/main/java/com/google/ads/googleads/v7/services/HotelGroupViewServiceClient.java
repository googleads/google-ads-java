...
import com.google.ads.googleads.v7.services.stub.HotelGroupViewServiceStub;
import com.google.ads.googleads.v7.services.stub.HotelGroupViewServiceStubSettings;
...
public class HotelGroupViewServiceClient implements BackgroundResource {
   ...
   *     HotelGroupViewServiceClient.create()) {
   *   String resourceName =
   *       HotelGroupViewName.of("[CUSTOMER_ID]", "[AD_GROUP_ID]", "[CRITERION_ID]").toString();
   *   HotelGroupView response = hotelGroupViewServiceClient.getHotelGroupView(resourceName);
   * }
   * }</pre>
   *
