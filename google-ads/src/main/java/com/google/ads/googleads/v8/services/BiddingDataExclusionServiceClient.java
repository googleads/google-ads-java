...
import com.google.ads.googleads.v8.services.stub.BiddingDataExclusionServiceStub;
import com.google.ads.googleads.v8.services.stub.BiddingDataExclusionServiceStubSettings;
...
public class BiddingDataExclusionServiceClient implements BackgroundResource {
   ...
   * }</pre>
   *
   * @param resourceName Required. The resource name of the data exclusion to fetch.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final BiddingDataExclusion getBiddingDataExclusion(BiddingDataExclusionName resourceName) {
    GetBiddingDataExclusionRequest request =
        GetBiddingDataExclusionRequest.newBuilder()
            .setResourceName(resourceName == null ? null : resourceName.toString())
            .build();
    return getBiddingDataExclusion(request);
  }
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final BiddingDataExclusion getBiddingDataExclusion(String resourceName) {
    GetBiddingDataExclusionRequest request =
        GetBiddingDataExclusionRequest.newBuilder().setResourceName(resourceName).build();
    return getBiddingDataExclusion(request);
  }
   ...
   *           .build();
   *   BiddingDataExclusion response =
   *       biddingDataExclusionServiceClient.getBiddingDataExclusion(request);
   * }
   * }</pre>
   *
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final BiddingDataExclusion getBiddingDataExclusion(
      GetBiddingDataExclusionRequest request) {
    return getBiddingDataExclusionCallable().call(request);
  }
   ...
   *               BiddingDataExclusionName.of("[CUSTOMER_ID]", "[SEASONALITY_EVENT_ID]").toString())
   *           .build();
   *   ApiFuture<BiddingDataExclusion> future =
   *       biddingDataExclusionServiceClient.getBiddingDataExclusionCallable().futureCall(request);
   *   // Do something.
   *   BiddingDataExclusion response = future.get();
   * }
   * }</pre>
   */
  public final UnaryCallable<GetBiddingDataExclusionRequest, BiddingDataExclusion>
      getBiddingDataExclusionCallable() {
    return stub.getBiddingDataExclusionCallable();
  }
