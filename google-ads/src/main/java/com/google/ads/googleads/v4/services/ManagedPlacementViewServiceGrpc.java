...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/managed_placement_view_service.proto")
public final class ManagedPlacementViewServiceGrpc {

  private ManagedPlacementViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.ManagedPlacementViewService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  @java.lang.Deprecated // Use {@link #getGetManagedPlacementViewMethod()} instead. 
  public static final io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetManagedPlacementViewRequest,
      com.google.ads.googleads.v4.resources.ManagedPlacementView> METHOD_GET_MANAGED_PLACEMENT_VIEW = getGetManagedPlacementViewMethodHelper();

  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetManagedPlacementViewRequest,
      com.google.ads.googleads.v4.resources.ManagedPlacementView> getGetManagedPlacementViewMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetManagedPlacementViewRequest,
      com.google.ads.googleads.v4.resources.ManagedPlacementView> getGetManagedPlacementViewMethod() {
    return getGetManagedPlacementViewMethodHelper();
  }

  private static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetManagedPlacementViewRequest,
      com.google.ads.googleads.v4.resources.ManagedPlacementView> getGetManagedPlacementViewMethodHelper() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetManagedPlacementViewRequest, com.google.ads.googleads.v4.resources.ManagedPlacementView> getGetManagedPlacementViewMethod;
      ...
      synchronized (ManagedPlacementViewServiceGrpc.class) {
        if ((getGetManagedPlacementViewMethod = ManagedPlacementViewServiceGrpc.getGetManagedPlacementViewMethod) == null) {
          ManagedPlacementViewServiceGrpc.getGetManagedPlacementViewMethod = getGetManagedPlacementViewMethod = 
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetManagedPlacementViewRequest, com.google.ads.googleads.v4.resources.ManagedPlacementView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "google.ads.googleads.v4.services.ManagedPlacementViewService", "GetManagedPlacementView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetManagedPlacementViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.ManagedPlacementView.getDefaultInstance()))
  ...
  public static abstract class ManagedPlacementViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getManagedPlacementView(com.google.ads.googleads.v4.services.GetManagedPlacementViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.ManagedPlacementView> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetManagedPlacementViewRequest,
                com.google.ads.googleads.v4.resources.ManagedPlacementView>(
  ...
  public static final class ManagedPlacementViewServiceBlockingStub extends io.grpc.stub.AbstractStub<ManagedPlacementViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.ManagedPlacementView getManagedPlacementView(com.google.ads.googleads.v4.services.GetManagedPlacementViewRequest request) {
  ...
  public static final class ManagedPlacementViewServiceFutureStub extends io.grpc.stub.AbstractStub<ManagedPlacementViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.ManagedPlacementView> getManagedPlacementView(
        com.google.ads.googleads.v4.services.GetManagedPlacementViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MANAGED_PLACEMENT_VIEW:
          serviceImpl.getManagedPlacementView((com.google.ads.googleads.v4.services.GetManagedPlacementViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.ManagedPlacementView>) responseObserver);
          break;
        default:
  ...
  private static abstract class ManagedPlacementViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.ManagedPlacementViewServiceProto.getDescriptor();
    }
