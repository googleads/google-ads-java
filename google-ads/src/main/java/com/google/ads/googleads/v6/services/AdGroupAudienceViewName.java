...
public class AdGroupAudienceViewName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("customers/{customer_id}/adGroupAudienceViews/{ad_group_id}~{criterion_id}");
  ...
  public static AdGroupAudienceViewName of(String customerId, String adGroupId, String criterionId) {
    return newBuilder()
