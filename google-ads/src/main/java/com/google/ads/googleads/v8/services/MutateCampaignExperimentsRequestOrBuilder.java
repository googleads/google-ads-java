...
public interface MutateCampaignExperimentsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v8.services.MutateCampaignExperimentsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v8.services.CampaignExperimentOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign experiments.
   ...
   * <code>repeated .google.ads.googleads.v8.services.CampaignExperimentOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.CampaignExperimentOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign experiments.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v8.services.CampaignExperimentOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v8.services.CampaignExperimentOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v8.services.CampaignExperimentOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.CampaignExperimentOperationOrBuilder getOperationsOrBuilder(
      int index);
