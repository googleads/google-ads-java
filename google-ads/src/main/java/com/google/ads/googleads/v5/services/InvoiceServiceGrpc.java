...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/invoice_service.proto")
public final class InvoiceServiceGrpc {

  private InvoiceServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.InvoiceService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.ListInvoicesRequest,
      com.google.ads.googleads.v5.services.ListInvoicesResponse> getListInvoicesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListInvoices",
      requestType = com.google.ads.googleads.v5.services.ListInvoicesRequest.class,
      responseType = com.google.ads.googleads.v5.services.ListInvoicesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.ListInvoicesRequest,
      com.google.ads.googleads.v5.services.ListInvoicesResponse> getListInvoicesMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.ListInvoicesRequest, com.google.ads.googleads.v5.services.ListInvoicesResponse> getListInvoicesMethod;
      ...
      synchronized (InvoiceServiceGrpc.class) {
        if ((getListInvoicesMethod = InvoiceServiceGrpc.getListInvoicesMethod) == null) {
          InvoiceServiceGrpc.getListInvoicesMethod = getListInvoicesMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.ListInvoicesRequest, com.google.ads.googleads.v5.services.ListInvoicesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListInvoices"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.ListInvoicesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.ListInvoicesResponse.getDefaultInstance()))
  ...
  public static abstract class InvoiceServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void listInvoices(com.google.ads.googleads.v5.services.ListInvoicesRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.ListInvoicesResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.ListInvoicesRequest,
                com.google.ads.googleads.v5.services.ListInvoicesResponse>(
  ...
  public static final class InvoiceServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<InvoiceServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.services.ListInvoicesResponse listInvoices(com.google.ads.googleads.v5.services.ListInvoicesRequest request) {
  ...
  public static final class InvoiceServiceFutureStub extends io.grpc.stub.AbstractFutureStub<InvoiceServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.services.ListInvoicesResponse> listInvoices(
        com.google.ads.googleads.v5.services.ListInvoicesRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST_INVOICES:
          serviceImpl.listInvoices((com.google.ads.googleads.v5.services.ListInvoicesRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.ListInvoicesResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class InvoiceServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.InvoiceServiceProto.getDescriptor();
    }
