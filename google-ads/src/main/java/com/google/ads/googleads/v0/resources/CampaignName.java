...
public class CampaignName implements ResourceName {
  ...
  public ResourceNameType getType() {
    throw new UnsupportedOperationException("CampaignName.getType() not supported");
  }

  @Override
  public String toString() {
    return PATH_TEMPLATE.instantiate("customer", customer, "campaign", campaign);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof CampaignName) {
      ...
      return (this.customer.equals(that.customer))
          && (this.campaign.equals(that.campaign));
    }
    return false;
  }
