...
public interface SearchGoogleAdsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v4.services.SearchGoogleAdsResponse)
   ...
   */
  java.util.List<com.google.ads.googleads.v4.services.GoogleAdsRow> 
      getResultsList();
  /**
   * <pre>
   * The list of rows that matched the query.
   ...
   * <code>repeated .google.ads.googleads.v4.services.GoogleAdsRow results = 1;</code>
   */
  com.google.ads.googleads.v4.services.GoogleAdsRow getResults(int index);
  /**
   * <pre>
   * The list of rows that matched the query.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v4.services.GoogleAdsRow results = 1;</code>
   */
  java.util.List<? extends com.google.ads.googleads.v4.services.GoogleAdsRowOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v4.services.GoogleAdsRow results = 1;</code>
   */
  com.google.ads.googleads.v4.services.GoogleAdsRowOrBuilder getResultsOrBuilder(
      int index);
   ...
   */
  com.google.ads.googleads.v4.services.GoogleAdsRow getSummaryRow();
  /**
   * <pre>
   * Summary row that contains summary of metrics in results.
   * Summary of metrics means aggregation of metrics across all results,
   ...
   * <code>.google.ads.googleads.v4.services.GoogleAdsRow summary_row = 6;</code>
   */
  com.google.ads.googleads.v4.services.GoogleAdsRowOrBuilder getSummaryRowOrBuilder();
}
