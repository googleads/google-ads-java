...
import com.google.ads.googleads.v8.services.stub.BillingSetupServiceStub;
import com.google.ads.googleads.v8.services.stub.BillingSetupServiceStubSettings;
...
public class BillingSetupServiceClient implements BackgroundResource {
   ...
   * <pre>{@code
   * try (BillingSetupServiceClient billingSetupServiceClient = BillingSetupServiceClient.create()) {
   *   String resourceName = BillingSetupName.of("[CUSTOMER_ID]", "[BILLING_SETUP_ID]").toString();
   *   BillingSetup response = billingSetupServiceClient.getBillingSetup(resourceName);
   * }
   * }</pre>
   *
   ...
   *       GetBillingSetupRequest.newBuilder()
   *           .setResourceName(
   *               BillingSetupName.of("[CUSTOMER_ID]", "[BILLING_SETUP_ID]").toString())
   *           .build();
