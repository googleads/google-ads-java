...
public interface FeedItemTargetOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v5.resources.FeedItemTarget)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v5.enums.FeedItemTargetTypeEnum.FeedItemTargetType feed_item_target_type = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.ads.googleads.v5.enums.FeedItemTargetTypeEnum.FeedItemTargetType getFeedItemTargetType();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v5.enums.FeedItemTargetStatusEnum.FeedItemTargetStatus status = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v5.enums.FeedItemTargetStatusEnum.FeedItemTargetStatus getStatus();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v5.common.KeywordInfo keyword = 7 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v5.enums.FeedItemTargetDeviceEnum.FeedItemTargetDevice device = 9 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   * @return The device.
   */
  com.google.ads.googleads.v5.enums.FeedItemTargetDeviceEnum.FeedItemTargetDevice getDevice();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v5.common.AdScheduleInfo ad_schedule = 10 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   */
  com.google.ads.googleads.v5.common.AdScheduleInfo getAdSchedule();
  /**
   * <pre>
   * Immutable. The targeted schedule.
   * </pre>
   ...
   * <code>.google.ads.googleads.v5.common.AdScheduleInfo ad_schedule = 10 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.ads.googleads.v5.common.AdScheduleInfoOrBuilder getAdScheduleOrBuilder();

  public com.google.ads.googleads.v5.resources.FeedItemTarget.TargetCase getTargetCase();
}
