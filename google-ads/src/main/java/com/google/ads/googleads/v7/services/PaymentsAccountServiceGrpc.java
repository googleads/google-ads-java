...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v7/services/payments_account_service.proto")
public final class PaymentsAccountServiceGrpc {

  private PaymentsAccountServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v7.services.PaymentsAccountService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.ListPaymentsAccountsRequest,
      com.google.ads.googleads.v7.services.ListPaymentsAccountsResponse> getListPaymentsAccountsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListPaymentsAccounts",
      requestType = com.google.ads.googleads.v7.services.ListPaymentsAccountsRequest.class,
      responseType = com.google.ads.googleads.v7.services.ListPaymentsAccountsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.ListPaymentsAccountsRequest,
      com.google.ads.googleads.v7.services.ListPaymentsAccountsResponse> getListPaymentsAccountsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.ListPaymentsAccountsRequest, com.google.ads.googleads.v7.services.ListPaymentsAccountsResponse> getListPaymentsAccountsMethod;
      ...
      synchronized (PaymentsAccountServiceGrpc.class) {
        if ((getListPaymentsAccountsMethod = PaymentsAccountServiceGrpc.getListPaymentsAccountsMethod) == null) {
          PaymentsAccountServiceGrpc.getListPaymentsAccountsMethod = getListPaymentsAccountsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v7.services.ListPaymentsAccountsRequest, com.google.ads.googleads.v7.services.ListPaymentsAccountsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListPaymentsAccounts"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.ListPaymentsAccountsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.ListPaymentsAccountsResponse.getDefaultInstance()))
  ...
  public static abstract class PaymentsAccountServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void listPaymentsAccounts(com.google.ads.googleads.v7.services.ListPaymentsAccountsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.services.ListPaymentsAccountsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v7.services.ListPaymentsAccountsRequest,
                com.google.ads.googleads.v7.services.ListPaymentsAccountsResponse>(
  ...
  public static final class PaymentsAccountServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<PaymentsAccountServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v7.services.ListPaymentsAccountsResponse listPaymentsAccounts(com.google.ads.googleads.v7.services.ListPaymentsAccountsRequest request) {
  ...
  public static final class PaymentsAccountServiceFutureStub extends io.grpc.stub.AbstractFutureStub<PaymentsAccountServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v7.services.ListPaymentsAccountsResponse> listPaymentsAccounts(
        com.google.ads.googleads.v7.services.ListPaymentsAccountsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST_PAYMENTS_ACCOUNTS:
          serviceImpl.listPaymentsAccounts((com.google.ads.googleads.v7.services.ListPaymentsAccountsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.services.ListPaymentsAccountsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class PaymentsAccountServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v7.services.PaymentsAccountServiceProto.getDescriptor();
    }
