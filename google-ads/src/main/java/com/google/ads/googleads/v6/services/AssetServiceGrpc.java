...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/asset_service.proto")
public final class AssetServiceGrpc {

  private AssetServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.AssetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAssetRequest,
      com.google.ads.googleads.v6.resources.Asset> getGetAssetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAsset",
      requestType = com.google.ads.googleads.v6.services.GetAssetRequest.class,
      responseType = com.google.ads.googleads.v6.resources.Asset.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAssetRequest,
      com.google.ads.googleads.v6.resources.Asset> getGetAssetMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAssetRequest, com.google.ads.googleads.v6.resources.Asset> getGetAssetMethod;
      ...
      synchronized (AssetServiceGrpc.class) {
        if ((getGetAssetMethod = AssetServiceGrpc.getGetAssetMethod) == null) {
          AssetServiceGrpc.getGetAssetMethod = getGetAssetMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetAssetRequest, com.google.ads.googleads.v6.resources.Asset>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAsset"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetAssetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.Asset.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateAssetsRequest,
      com.google.ads.googleads.v6.services.MutateAssetsResponse> getMutateAssetsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAssets",
      requestType = com.google.ads.googleads.v6.services.MutateAssetsRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateAssetsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateAssetsRequest,
      com.google.ads.googleads.v6.services.MutateAssetsResponse> getMutateAssetsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateAssetsRequest, com.google.ads.googleads.v6.services.MutateAssetsResponse> getMutateAssetsMethod;
      ...
      synchronized (AssetServiceGrpc.class) {
        if ((getMutateAssetsMethod = AssetServiceGrpc.getMutateAssetsMethod) == null) {
          AssetServiceGrpc.getMutateAssetsMethod = getMutateAssetsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateAssetsRequest, com.google.ads.googleads.v6.services.MutateAssetsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAssets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateAssetsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateAssetsResponse.getDefaultInstance()))
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ASSET:
          serviceImpl.getAsset((com.google.ads.googleads.v6.services.GetAssetRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.Asset>) responseObserver);
          break;
        case METHODID_MUTATE_ASSETS:
          serviceImpl.mutateAssets((com.google.ads.googleads.v6.services.MutateAssetsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateAssetsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AssetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.AssetServiceProto.getDescriptor();
    }
