...
public interface MutateAdGroupAdsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v6.services.MutateAdGroupAdsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v6.services.AdGroupAdOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual ads.
   ...
   * <code>repeated .google.ads.googleads.v6.services.AdGroupAdOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v6.services.AdGroupAdOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual ads.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v6.services.AdGroupAdOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v6.services.AdGroupAdOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v6.services.AdGroupAdOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v6.services.AdGroupAdOperationOrBuilder getOperationsOrBuilder(
      int index);
