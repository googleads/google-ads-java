...
import com.google.ads.googleads.v9.resources.CurrencyConstant;
import com.google.ads.googleads.v9.resources.CurrencyConstantName;
import com.google.ads.googleads.v9.services.stub.CurrencyConstantServiceStub;
import com.google.ads.googleads.v9.services.stub.CurrencyConstantServiceStubSettings;
...
public class CurrencyConstantServiceClient implements BackgroundResource {
   ...
   * try (CurrencyConstantServiceClient currencyConstantServiceClient =
   *     CurrencyConstantServiceClient.create()) {
   *   String resourceName = CurrencyConstantName.of("[CODE]").toString();
   *   CurrencyConstant response = currencyConstantServiceClient.getCurrencyConstant(resourceName);
   * }
   * }</pre>
   *
