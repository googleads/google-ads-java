...
import com.google.ads.googleads.v0.services.stub.CarrierConstantServiceStub;
...
public class CarrierConstantServiceClient implements BackgroundResource {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  private final CarrierConstant getCarrierConstant(GetCarrierConstantRequest request) {
