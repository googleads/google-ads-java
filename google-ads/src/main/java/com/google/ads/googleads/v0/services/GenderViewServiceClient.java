...
import com.google.ads.googleads.v0.services.stub.GenderViewServiceStub;
import com.google.ads.googleads.v0.services.stub.GenderViewServiceStubSettings;
...
public class GenderViewServiceClient implements BackgroundResource {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  private final GenderView getGenderView(GetGenderViewRequest request) {
