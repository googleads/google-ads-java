...
public class KeywordPlanAdGroupKeywordName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("customers/{customer}/keywordPlanAdGroupKeywords/{keyword_plan_ad_group_keyword}");
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          fieldMapBuilder.put("keywordPlanAdGroupKeyword", keywordPlanAdGroupKeyword);
  ...
  public String toString() {
    return PATH_TEMPLATE.instantiate("customer", customer, "keyword_plan_ad_group_keyword", keywordPlanAdGroupKeyword);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof KeywordPlanAdGroupKeywordName) {
      ...
      return (this.customer.equals(that.customer))
          && (this.keywordPlanAdGroupKeyword.equals(that.keywordPlanAdGroupKeyword));
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h ^= customer.hashCode();
    h *= 1000003;
    h ^= keywordPlanAdGroupKeyword.hashCode();
    return h;
  }
}
