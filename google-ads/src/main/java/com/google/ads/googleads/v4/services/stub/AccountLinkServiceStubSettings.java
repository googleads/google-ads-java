...
import com.google.ads.googleads.v4.services.GetAccountLinkRequest;
import com.google.ads.googleads.v4.services.MutateAccountLinkRequest;
import com.google.ads.googleads.v4.services.MutateAccountLinkResponse;
 ...
 *     .setRetrySettings(
 *         accountLinkServiceSettingsBuilder.getAccountLinkSettings().getRetrySettings().toBuilder()
 *             .setTotalTimeout(Duration.ofSeconds(30))
 *             .build());
 * AccountLinkServiceStubSettings accountLinkServiceSettings = accountLinkServiceSettingsBuilder.build();
 * </code>
 * </pre>
 */
