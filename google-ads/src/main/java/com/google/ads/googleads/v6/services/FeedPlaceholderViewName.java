...
public class FeedPlaceholderViewName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("customers/{customer_id}/feedPlaceholderViews/{placeholder_type}");
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          fieldMapBuilder.put("placeholderType", placeholderType);
  ...
  public String toString() {
    return PATH_TEMPLATE.instantiate("customer_id", customerId, "placeholder_type", placeholderType);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof FeedPlaceholderViewName) {
      ...
      return (this.customerId.equals(that.customerId))
          && (this.placeholderType.equals(that.placeholderType));
    }
    return false;
  }
