...
import com.google.ads.googleads.v0.services.stub.ChangeStatusServiceStubSettings;
 ...
 * example, to set the total timeout of getChangeStatus to 30 seconds:
 *
 * <pre>
 * <code>
 * ChangeStatusServiceSettings.Builder changeStatusServiceSettingsBuilder =
 *     ChangeStatusServiceSettings.newBuilder();
 * changeStatusServiceSettingsBuilder.getChangeStatusSettings().getRetrySettings().toBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * ChangeStatusServiceSettings changeStatusServiceSettings = changeStatusServiceSettingsBuilder.build();
 * </code>
 * </pre>
 */
