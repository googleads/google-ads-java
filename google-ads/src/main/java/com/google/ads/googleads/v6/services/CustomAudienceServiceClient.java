...
public class CustomAudienceServiceClient implements BackgroundResource {
   ...
   *
   * @param resource_name Required. The resource name of the custom audience to fetch.
   ...
   *
   * @param customer_id Required. The ID of the customer whose custom audiences are being modified.
