...
public class CustomAudienceServiceClient implements BackgroundResource {
   ...
   * This is for advanced usage - prefer to use CustomAudienceServiceSettings}.
   */
   ...
   * try (CustomAudienceServiceClient customAudienceServiceClient = CustomAudienceServiceClient.create()) {
   *   CustomAudienceName resourceName = CustomAudienceName.of("[CUSTOMER_ID]", "[CUSTOM_AUDIENCE_ID]");
   *   CustomAudience response = customAudienceServiceClient.getCustomAudience(resourceName.toString());
   * }
   * </code></pre>
   *
   * @param resourceName Required. The resource name of the custom audience to fetch.
   ...
   * try (CustomAudienceServiceClient customAudienceServiceClient = CustomAudienceServiceClient.create()) {
   *   CustomAudienceName resourceName = CustomAudienceName.of("[CUSTOMER_ID]", "[CUSTOM_AUDIENCE_ID]");
   *   GetCustomAudienceRequest request = GetCustomAudienceRequest.newBuilder()
   ...
   *     .setResourceName(resourceName.toString())
   *     .build();
   *   ApiFuture&lt;CustomAudience&gt; future = customAudienceServiceClient.getCustomAudienceCallable().futureCall(request);
   *   // Do something
   ...
   *   String customerId = "";
   *   List&lt;CustomAudienceOperation&gt; operations = new ArrayList&lt;&gt;();
   *   MutateCustomAudiencesRequest request = MutateCustomAudiencesRequest.newBuilder()
   *     .setCustomerId(customerId)
   *     .addAllOperations(operations)
   *     .build();
   ...
   *     .addAllOperations(operations)
   *     .build();
   *   ApiFuture&lt;MutateCustomAudiencesResponse&gt; future = customAudienceServiceClient.mutateCustomAudiencesCallable().futureCall(request);
   *   // Do something
