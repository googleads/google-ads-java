...
import com.google.ads.googleads.v2.services.stub.MerchantCenterLinkServiceStub;
import com.google.ads.googleads.v2.services.stub.MerchantCenterLinkServiceStubSettings;
...
public class MerchantCenterLinkServiceClient implements BackgroundResource {
   ...
   * </code></pre>
   *
   * @param customerId The ID of the customer onto which to apply the Merchant Center link list
   *     operation.
   ...
   * </code></pre>
   *
   * @param resourceName Resource name of the Merchant Center link.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
   ...
   * @param operation The operation to perform on the link
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
