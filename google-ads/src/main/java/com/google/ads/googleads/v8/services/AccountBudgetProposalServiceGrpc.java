...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v8/services/account_budget_proposal_service.proto")
public final class AccountBudgetProposalServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetAccountBudgetProposalRequest,
      com.google.ads.googleads.v8.resources.AccountBudgetProposal> getGetAccountBudgetProposalMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAccountBudgetProposal",
      requestType = com.google.ads.googleads.v8.services.GetAccountBudgetProposalRequest.class,
      responseType = com.google.ads.googleads.v8.resources.AccountBudgetProposal.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetAccountBudgetProposalRequest,
      com.google.ads.googleads.v8.resources.AccountBudgetProposal> getGetAccountBudgetProposalMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetAccountBudgetProposalRequest, com.google.ads.googleads.v8.resources.AccountBudgetProposal> getGetAccountBudgetProposalMethod;
      ...
      synchronized (AccountBudgetProposalServiceGrpc.class) {
        if ((getGetAccountBudgetProposalMethod = AccountBudgetProposalServiceGrpc.getGetAccountBudgetProposalMethod) == null) {
          AccountBudgetProposalServiceGrpc.getGetAccountBudgetProposalMethod = getGetAccountBudgetProposalMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v8.services.GetAccountBudgetProposalRequest, com.google.ads.googleads.v8.resources.AccountBudgetProposal>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAccountBudgetProposal"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.GetAccountBudgetProposalRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.resources.AccountBudgetProposal.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateAccountBudgetProposalRequest,
      com.google.ads.googleads.v8.services.MutateAccountBudgetProposalResponse> getMutateAccountBudgetProposalMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAccountBudgetProposal",
      requestType = com.google.ads.googleads.v8.services.MutateAccountBudgetProposalRequest.class,
      responseType = com.google.ads.googleads.v8.services.MutateAccountBudgetProposalResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateAccountBudgetProposalRequest,
      com.google.ads.googleads.v8.services.MutateAccountBudgetProposalResponse> getMutateAccountBudgetProposalMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateAccountBudgetProposalRequest, com.google.ads.googleads.v8.services.MutateAccountBudgetProposalResponse> getMutateAccountBudgetProposalMethod;
      ...
      synchronized (AccountBudgetProposalServiceGrpc.class) {
        if ((getMutateAccountBudgetProposalMethod = AccountBudgetProposalServiceGrpc.getMutateAccountBudgetProposalMethod) == null) {
          AccountBudgetProposalServiceGrpc.getMutateAccountBudgetProposalMethod = getMutateAccountBudgetProposalMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v8.services.MutateAccountBudgetProposalRequest, com.google.ads.googleads.v8.services.MutateAccountBudgetProposalResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAccountBudgetProposal"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.MutateAccountBudgetProposalRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.MutateAccountBudgetProposalResponse.getDefaultInstance()))
  ...
  public static abstract class AccountBudgetProposalServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAccountBudgetProposal(com.google.ads.googleads.v8.services.GetAccountBudgetProposalRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.AccountBudgetProposal> responseObserver) {
     ...
     * </pre>
     */
    public void mutateAccountBudgetProposal(com.google.ads.googleads.v8.services.MutateAccountBudgetProposalRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.services.MutateAccountBudgetProposalResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v8.services.GetAccountBudgetProposalRequest,
                com.google.ads.googleads.v8.resources.AccountBudgetProposal>(
                  this, METHODID_GET_ACCOUNT_BUDGET_PROPOSAL)))
          .addMethod(
            getMutateAccountBudgetProposalMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v8.services.MutateAccountBudgetProposalRequest,
                com.google.ads.googleads.v8.services.MutateAccountBudgetProposalResponse>(
  ...
  public static final class AccountBudgetProposalServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AccountBudgetProposalServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v8.resources.AccountBudgetProposal getAccountBudgetProposal(com.google.ads.googleads.v8.services.GetAccountBudgetProposalRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v8.services.MutateAccountBudgetProposalResponse mutateAccountBudgetProposal(com.google.ads.googleads.v8.services.MutateAccountBudgetProposalRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AccountBudgetProposalServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AccountBudgetProposalServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v8.resources.AccountBudgetProposal> getAccountBudgetProposal(
        com.google.ads.googleads.v8.services.GetAccountBudgetProposalRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v8.services.MutateAccountBudgetProposalResponse> mutateAccountBudgetProposal(
        com.google.ads.googleads.v8.services.MutateAccountBudgetProposalRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ACCOUNT_BUDGET_PROPOSAL:
          serviceImpl.getAccountBudgetProposal((com.google.ads.googleads.v8.services.GetAccountBudgetProposalRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.AccountBudgetProposal>) responseObserver);
          break;
        case METHODID_MUTATE_ACCOUNT_BUDGET_PROPOSAL:
          serviceImpl.mutateAccountBudgetProposal((com.google.ads.googleads.v8.services.MutateAccountBudgetProposalRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.services.MutateAccountBudgetProposalResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AccountBudgetProposalServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v8.services.AccountBudgetProposalServiceProto.getDescriptor();
    }
