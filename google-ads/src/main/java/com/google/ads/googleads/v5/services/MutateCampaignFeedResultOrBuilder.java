...
public interface MutateCampaignFeedResultOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v5.services.MutateCampaignFeedResult)
   ...
   */
  com.google.ads.googleads.v5.resources.CampaignFeed getCampaignFeed();
  /**
   * <pre>
   * The mutated campaign feed with only mutable fields after mutate. The field
   * will only be returned when response_content_type is set to
   ...
   * <code>.google.ads.googleads.v5.resources.CampaignFeed campaign_feed = 2;</code>
   */
  com.google.ads.googleads.v5.resources.CampaignFeedOrBuilder getCampaignFeedOrBuilder();
}
