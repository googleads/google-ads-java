...
public interface FeedAttributeOperationOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v4.resources.FeedAttributeOperation)
   ...
   * @return The operator.
   */
  com.google.ads.googleads.v4.resources.FeedAttributeOperation.Operator getOperator();
   ...
   * @return The value.
   */
  com.google.ads.googleads.v4.resources.FeedAttribute getValue();
  /**
   * <pre>
   * Output only. The feed attribute being added to the list.
   * </pre>
   ...
   * <code>.google.ads.googleads.v4.resources.FeedAttribute value = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v4.resources.FeedAttributeOrBuilder getValueOrBuilder();
}
