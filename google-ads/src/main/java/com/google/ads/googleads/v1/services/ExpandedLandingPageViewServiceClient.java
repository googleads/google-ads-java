...
import com.google.ads.googleads.v1.services.stub.ExpandedLandingPageViewServiceStub;
...
public class ExpandedLandingPageViewServiceClient implements BackgroundResource {
   ...
   * </code></pre>
   *
   * @param resourceName The resource name of the expanded landing page view to fetch.
