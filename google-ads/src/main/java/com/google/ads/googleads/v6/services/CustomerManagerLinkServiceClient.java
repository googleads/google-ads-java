...
public class CustomerManagerLinkServiceClient implements BackgroundResource {
   ...
   *   String previousCustomerManagerLink = "";
   *   String newManager = "";
   *   MoveManagerLinkRequest request = MoveManagerLinkRequest.newBuilder()
   *     .setCustomerId(customerId)
   *     .setPreviousCustomerManagerLink(previousCustomerManagerLink)
   *     .setNewManager(newManager)
   *     .build();
   ...
   *     .setNewManager(newManager)
   *     .build();
   *   ApiFuture&lt;MoveManagerLinkResponse&gt; future = customerManagerLinkServiceClient.moveManagerLinkCallable().futureCall(request);
   *   // Do something
