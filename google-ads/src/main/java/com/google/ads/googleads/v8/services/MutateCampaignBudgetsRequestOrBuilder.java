...
public interface MutateCampaignBudgetsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v8.services.MutateCampaignBudgetsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v8.services.CampaignBudgetOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign budgets.
   ...
   * <code>repeated .google.ads.googleads.v8.services.CampaignBudgetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.CampaignBudgetOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign budgets.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v8.services.CampaignBudgetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v8.services.CampaignBudgetOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v8.services.CampaignBudgetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.CampaignBudgetOperationOrBuilder getOperationsOrBuilder(
      int index);
