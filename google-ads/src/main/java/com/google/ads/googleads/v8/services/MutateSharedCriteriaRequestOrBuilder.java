...
public interface MutateSharedCriteriaRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v8.services.MutateSharedCriteriaRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v8.services.SharedCriterionOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual shared criteria.
   ...
   * <code>repeated .google.ads.googleads.v8.services.SharedCriterionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.SharedCriterionOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual shared criteria.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v8.services.SharedCriterionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v8.services.SharedCriterionOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v8.services.SharedCriterionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.SharedCriterionOperationOrBuilder getOperationsOrBuilder(
      int index);
