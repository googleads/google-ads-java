...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/customer_extension_setting_service.proto")
public final class CustomerExtensionSettingServiceGrpc {

  private CustomerExtensionSettingServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.CustomerExtensionSettingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCustomerExtensionSettingRequest,
      com.google.ads.googleads.v6.resources.CustomerExtensionSetting> getGetCustomerExtensionSettingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCustomerExtensionSetting",
      requestType = com.google.ads.googleads.v6.services.GetCustomerExtensionSettingRequest.class,
      responseType = com.google.ads.googleads.v6.resources.CustomerExtensionSetting.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCustomerExtensionSettingRequest,
      com.google.ads.googleads.v6.resources.CustomerExtensionSetting> getGetCustomerExtensionSettingMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCustomerExtensionSettingRequest, com.google.ads.googleads.v6.resources.CustomerExtensionSetting> getGetCustomerExtensionSettingMethod;
      ...
      synchronized (CustomerExtensionSettingServiceGrpc.class) {
        if ((getGetCustomerExtensionSettingMethod = CustomerExtensionSettingServiceGrpc.getGetCustomerExtensionSettingMethod) == null) {
          CustomerExtensionSettingServiceGrpc.getGetCustomerExtensionSettingMethod = getGetCustomerExtensionSettingMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetCustomerExtensionSettingRequest, com.google.ads.googleads.v6.resources.CustomerExtensionSetting>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCustomerExtensionSetting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetCustomerExtensionSettingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.CustomerExtensionSetting.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsRequest,
      com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsResponse> getMutateCustomerExtensionSettingsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCustomerExtensionSettings",
      requestType = com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsRequest,
      com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsResponse> getMutateCustomerExtensionSettingsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsRequest, com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsResponse> getMutateCustomerExtensionSettingsMethod;
      ...
      synchronized (CustomerExtensionSettingServiceGrpc.class) {
        if ((getMutateCustomerExtensionSettingsMethod = CustomerExtensionSettingServiceGrpc.getMutateCustomerExtensionSettingsMethod) == null) {
          CustomerExtensionSettingServiceGrpc.getMutateCustomerExtensionSettingsMethod = getMutateCustomerExtensionSettingsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsRequest, com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCustomerExtensionSettings"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsResponse.getDefaultInstance()))
  ...
  public static abstract class CustomerExtensionSettingServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCustomerExtensionSetting(com.google.ads.googleads.v6.services.GetCustomerExtensionSettingRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.CustomerExtensionSetting> responseObserver) {
     ...
     * </pre>
     */
    public void mutateCustomerExtensionSettings(com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetCustomerExtensionSettingRequest,
                com.google.ads.googleads.v6.resources.CustomerExtensionSetting>(
                  this, METHODID_GET_CUSTOMER_EXTENSION_SETTING)))
          .addMethod(
            getMutateCustomerExtensionSettingsMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsRequest,
                com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsResponse>(
  ...
  public static final class CustomerExtensionSettingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CustomerExtensionSettingServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.CustomerExtensionSetting getCustomerExtensionSetting(com.google.ads.googleads.v6.services.GetCustomerExtensionSettingRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsResponse mutateCustomerExtensionSettings(com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsRequest request) {
      return blockingUnaryCall(
  ...
  public static final class CustomerExtensionSettingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CustomerExtensionSettingServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.CustomerExtensionSetting> getCustomerExtensionSetting(
        com.google.ads.googleads.v6.services.GetCustomerExtensionSettingRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsResponse> mutateCustomerExtensionSettings(
        com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CUSTOMER_EXTENSION_SETTING:
          serviceImpl.getCustomerExtensionSetting((com.google.ads.googleads.v6.services.GetCustomerExtensionSettingRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.CustomerExtensionSetting>) responseObserver);
          break;
        case METHODID_MUTATE_CUSTOMER_EXTENSION_SETTINGS:
          serviceImpl.mutateCustomerExtensionSettings((com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateCustomerExtensionSettingsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CustomerExtensionSettingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.CustomerExtensionSettingServiceProto.getDescriptor();
    }
