...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v9/services/ad_group_ad_asset_view_service.proto")
public final class AdGroupAdAssetViewServiceGrpc {

  private AdGroupAdAssetViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v9.services.AdGroupAdAssetViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetAdGroupAdAssetViewRequest,
      com.google.ads.googleads.v9.resources.AdGroupAdAssetView> getGetAdGroupAdAssetViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAdGroupAdAssetView",
      requestType = com.google.ads.googleads.v9.services.GetAdGroupAdAssetViewRequest.class,
      responseType = com.google.ads.googleads.v9.resources.AdGroupAdAssetView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetAdGroupAdAssetViewRequest,
      com.google.ads.googleads.v9.resources.AdGroupAdAssetView> getGetAdGroupAdAssetViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetAdGroupAdAssetViewRequest, com.google.ads.googleads.v9.resources.AdGroupAdAssetView> getGetAdGroupAdAssetViewMethod;
      ...
      synchronized (AdGroupAdAssetViewServiceGrpc.class) {
        if ((getGetAdGroupAdAssetViewMethod = AdGroupAdAssetViewServiceGrpc.getGetAdGroupAdAssetViewMethod) == null) {
          AdGroupAdAssetViewServiceGrpc.getGetAdGroupAdAssetViewMethod = getGetAdGroupAdAssetViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.GetAdGroupAdAssetViewRequest, com.google.ads.googleads.v9.resources.AdGroupAdAssetView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAdGroupAdAssetView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.GetAdGroupAdAssetViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.resources.AdGroupAdAssetView.getDefaultInstance()))
  ...
  public static abstract class AdGroupAdAssetViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAdGroupAdAssetView(com.google.ads.googleads.v9.services.GetAdGroupAdAssetViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.AdGroupAdAssetView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.GetAdGroupAdAssetViewRequest,
                com.google.ads.googleads.v9.resources.AdGroupAdAssetView>(
  ...
  public static final class AdGroupAdAssetViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AdGroupAdAssetViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.resources.AdGroupAdAssetView getAdGroupAdAssetView(com.google.ads.googleads.v9.services.GetAdGroupAdAssetViewRequest request) {
  ...
  public static final class AdGroupAdAssetViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AdGroupAdAssetViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.resources.AdGroupAdAssetView> getAdGroupAdAssetView(
        com.google.ads.googleads.v9.services.GetAdGroupAdAssetViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AD_GROUP_AD_ASSET_VIEW:
          serviceImpl.getAdGroupAdAssetView((com.google.ads.googleads.v9.services.GetAdGroupAdAssetViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.AdGroupAdAssetView>) responseObserver);
          break;
        default:
  ...
  private static abstract class AdGroupAdAssetViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v9.services.AdGroupAdAssetViewServiceProto.getDescriptor();
    }
