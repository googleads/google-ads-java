...
public interface CriterionCategoryChannelAvailabilityOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v6.common.CriterionCategoryChannelAvailability)
   ...
   */
  com.google.ads.googleads.v6.enums.CriterionCategoryChannelAvailabilityModeEnum.CriterionCategoryChannelAvailabilityMode getAvailabilityMode();
   ...
   */
  java.util.List<com.google.ads.googleads.v6.enums.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType> getAdvertisingChannelSubTypeList();
  /**
   * <pre>
   * Channel subtypes under the channel type the category is available to.
   * </pre>
   ...
   */
  com.google.ads.googleads.v6.enums.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType getAdvertisingChannelSubType(int index);
  /**
   * <pre>
   * Channel subtypes under the channel type the category is available to.
   * </pre>
