...
public class CustomerNegativeCriterionName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("customers/{customer_id}/customerNegativeCriteria/{criterion_id}");
  ...
  public String toString() {
    return PATH_TEMPLATE.instantiate("customer_id", customerId, "criterion_id", criterionId);
  }
