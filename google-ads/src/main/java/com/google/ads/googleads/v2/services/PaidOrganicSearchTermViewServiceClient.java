...
import com.google.ads.googleads.v2.services.stub.PaidOrganicSearchTermViewServiceStub;
...
public class PaidOrganicSearchTermViewServiceClient implements BackgroundResource {
   ...
   * </code></pre>
   *
   * @param resourceName The resource name of the paid organic search term view to fetch.
