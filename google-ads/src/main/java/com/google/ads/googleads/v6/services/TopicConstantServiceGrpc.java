...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/topic_constant_service.proto")
public final class TopicConstantServiceGrpc {

  private TopicConstantServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.TopicConstantService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetTopicConstantRequest,
      com.google.ads.googleads.v6.resources.TopicConstant> getGetTopicConstantMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetTopicConstant",
      requestType = com.google.ads.googleads.v6.services.GetTopicConstantRequest.class,
      responseType = com.google.ads.googleads.v6.resources.TopicConstant.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetTopicConstantRequest,
      com.google.ads.googleads.v6.resources.TopicConstant> getGetTopicConstantMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetTopicConstantRequest, com.google.ads.googleads.v6.resources.TopicConstant> getGetTopicConstantMethod;
      ...
      synchronized (TopicConstantServiceGrpc.class) {
        if ((getGetTopicConstantMethod = TopicConstantServiceGrpc.getGetTopicConstantMethod) == null) {
          TopicConstantServiceGrpc.getGetTopicConstantMethod = getGetTopicConstantMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetTopicConstantRequest, com.google.ads.googleads.v6.resources.TopicConstant>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetTopicConstant"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetTopicConstantRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.TopicConstant.getDefaultInstance()))
  ...
  public static abstract class TopicConstantServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getTopicConstant(com.google.ads.googleads.v6.services.GetTopicConstantRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.TopicConstant> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetTopicConstantRequest,
                com.google.ads.googleads.v6.resources.TopicConstant>(
  ...
  public static final class TopicConstantServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<TopicConstantServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.TopicConstant getTopicConstant(com.google.ads.googleads.v6.services.GetTopicConstantRequest request) {
  ...
  public static final class TopicConstantServiceFutureStub extends io.grpc.stub.AbstractFutureStub<TopicConstantServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.TopicConstant> getTopicConstant(
        com.google.ads.googleads.v6.services.GetTopicConstantRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_TOPIC_CONSTANT:
          serviceImpl.getTopicConstant((com.google.ads.googleads.v6.services.GetTopicConstantRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.TopicConstant>) responseObserver);
          break;
        default:
