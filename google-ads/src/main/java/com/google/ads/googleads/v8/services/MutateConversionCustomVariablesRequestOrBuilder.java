...
public interface MutateConversionCustomVariablesRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v8.services.MutateConversionCustomVariablesRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v8.services.ConversionCustomVariableOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual conversion custom
   ...
   * <code>repeated .google.ads.googleads.v8.services.ConversionCustomVariableOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.ConversionCustomVariableOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual conversion custom
   * variables.
   ...
   * <code>repeated .google.ads.googleads.v8.services.ConversionCustomVariableOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v8.services.ConversionCustomVariableOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v8.services.ConversionCustomVariableOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.ConversionCustomVariableOperationOrBuilder getOperationsOrBuilder(
      int index);
