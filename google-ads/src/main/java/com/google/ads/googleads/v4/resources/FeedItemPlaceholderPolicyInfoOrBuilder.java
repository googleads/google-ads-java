...
public interface FeedItemPlaceholderPolicyInfoOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v4.resources.FeedItemPlaceholderPolicyInfo)
   ...
   */
  com.google.ads.googleads.v4.enums.PlaceholderTypeEnum.PlaceholderType getPlaceholderTypeEnum();
   ...
   */
  com.google.ads.googleads.v4.enums.PolicyReviewStatusEnum.PolicyReviewStatus getReviewStatus();
   ...
   */
  com.google.ads.googleads.v4.enums.PolicyApprovalStatusEnum.PolicyApprovalStatus getApprovalStatus();
   ...
   */
  java.util.List<com.google.ads.googleads.v4.common.PolicyTopicEntry> 
   ...
   * <code>repeated .google.ads.googleads.v4.common.PolicyTopicEntry policy_topic_entries = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v4.common.PolicyTopicEntry getPolicyTopicEntries(int index);
  /**
   * <pre>
   * Output only. The list of policy findings for the placeholder type.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v4.common.PolicyTopicEntry policy_topic_entries = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v4.common.PolicyTopicEntryOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v4.common.PolicyTopicEntry policy_topic_entries = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v4.common.PolicyTopicEntryOrBuilder getPolicyTopicEntriesOrBuilder(
      int index);
   ...
   */
  com.google.ads.googleads.v4.enums.FeedItemValidationStatusEnum.FeedItemValidationStatus getValidationStatus();
   ...
   */
  java.util.List<com.google.ads.googleads.v4.resources.FeedItemValidationError> 
   ...
   * <code>repeated .google.ads.googleads.v4.resources.FeedItemValidationError validation_errors = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v4.resources.FeedItemValidationError getValidationErrors(int index);
  /**
   * <pre>
   * Output only. List of placeholder type validation errors.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v4.resources.FeedItemValidationError validation_errors = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v4.resources.FeedItemValidationErrorOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v4.resources.FeedItemValidationError validation_errors = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v4.resources.FeedItemValidationErrorOrBuilder getValidationErrorsOrBuilder(
      int index);
   ...
   */
  com.google.ads.googleads.v4.enums.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatus getQualityApprovalStatus();
   ...
   */
  java.util.List<com.google.ads.googleads.v4.enums.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason> getQualityDisapprovalReasonsList();
  /**
   * <pre>
   * Output only. List of placeholder type quality evaluation disapproval reasons.
   * </pre>
   ...
   */
  com.google.ads.googleads.v4.enums.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason getQualityDisapprovalReasons(int index);
  /**
   * <pre>
   * Output only. List of placeholder type quality evaluation disapproval reasons.
   * </pre>
