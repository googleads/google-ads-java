...
import com.google.ads.googleads.v9.services.stub.WebpageViewServiceStubSettings;
...
/**
 * Settings class to configure an instance of {@link WebpageViewServiceClient}.
 *
 ...
 *
 * <pre>{@code
 * WebpageViewServiceSettings.Builder webpageViewServiceSettingsBuilder =
...
public class WebpageViewServiceSettings extends ClientSettings<WebpageViewServiceSettings> {
  ...
  public static final WebpageViewServiceSettings create(WebpageViewServiceStubSettings stub)
      throws IOException {
    return new WebpageViewServiceSettings.Builder(stub.toBuilder()).build();
  }
  ...
  protected WebpageViewServiceSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);
  }

  /** Builder for WebpageViewServiceSettings. */
  public static class Builder extends ClientSettings.Builder<WebpageViewServiceSettings, Builder> {
    ...
    protected Builder(WebpageViewServiceSettings settings) {
      super(settings.getStubSettings().toBuilder());
    }

    protected Builder(WebpageViewServiceStubSettings.Builder stubSettings) {
      super(stubSettings);
    }
