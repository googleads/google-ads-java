...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/ad_group_audience_view_service.proto")
public final class AdGroupAudienceViewServiceGrpc {

  private AdGroupAudienceViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.AdGroupAudienceViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdGroupAudienceViewRequest,
      com.google.ads.googleads.v6.resources.AdGroupAudienceView> getGetAdGroupAudienceViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAdGroupAudienceView",
      requestType = com.google.ads.googleads.v6.services.GetAdGroupAudienceViewRequest.class,
      responseType = com.google.ads.googleads.v6.resources.AdGroupAudienceView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdGroupAudienceViewRequest,
      com.google.ads.googleads.v6.resources.AdGroupAudienceView> getGetAdGroupAudienceViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdGroupAudienceViewRequest, com.google.ads.googleads.v6.resources.AdGroupAudienceView> getGetAdGroupAudienceViewMethod;
      ...
      synchronized (AdGroupAudienceViewServiceGrpc.class) {
        if ((getGetAdGroupAudienceViewMethod = AdGroupAudienceViewServiceGrpc.getGetAdGroupAudienceViewMethod) == null) {
          AdGroupAudienceViewServiceGrpc.getGetAdGroupAudienceViewMethod = getGetAdGroupAudienceViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetAdGroupAudienceViewRequest, com.google.ads.googleads.v6.resources.AdGroupAudienceView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAdGroupAudienceView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetAdGroupAudienceViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.AdGroupAudienceView.getDefaultInstance()))
  ...
  public static abstract class AdGroupAudienceViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAdGroupAudienceView(com.google.ads.googleads.v6.services.GetAdGroupAudienceViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.AdGroupAudienceView> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetAdGroupAudienceViewRequest,
                com.google.ads.googleads.v6.resources.AdGroupAudienceView>(
  ...
  public static final class AdGroupAudienceViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AdGroupAudienceViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.AdGroupAudienceView getAdGroupAudienceView(com.google.ads.googleads.v6.services.GetAdGroupAudienceViewRequest request) {
  ...
  public static final class AdGroupAudienceViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AdGroupAudienceViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.AdGroupAudienceView> getAdGroupAudienceView(
        com.google.ads.googleads.v6.services.GetAdGroupAudienceViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AD_GROUP_AUDIENCE_VIEW:
          serviceImpl.getAdGroupAudienceView((com.google.ads.googleads.v6.services.GetAdGroupAudienceViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.AdGroupAudienceView>) responseObserver);
          break;
        default:
  ...
  private static abstract class AdGroupAudienceViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.AdGroupAudienceViewServiceProto.getDescriptor();
    }
