...
public interface FrequencyCapEntryOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v0.common.FrequencyCapEntry)
   ...
   * <code>.google.ads.googleads.v0.common.FrequencyCapKey key = 1;</code>
   */
  com.google.ads.googleads.v0.common.FrequencyCapKey getKey();
  /**
   * <pre>
   * The key of a particular frequency cap. There can be no more
   * than one frequency cap with the same key.
   ...
   * <code>.google.ads.googleads.v0.common.FrequencyCapKey key = 1;</code>
   */
  com.google.ads.googleads.v0.common.FrequencyCapKeyOrBuilder getKeyOrBuilder();
