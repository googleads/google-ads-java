...
public class CombinedAudienceServiceClient implements BackgroundResource {
   ...
   * This is for advanced usage - prefer to use CombinedAudienceServiceSettings}.
   */
   ...
   * try (CombinedAudienceServiceClient combinedAudienceServiceClient = CombinedAudienceServiceClient.create()) {
   *   CombinedAudienceName resourceName = CombinedAudienceName.of("[CUSTOMER_ID]", "[COMBINED_AUDIENCE_ID]");
   *   CombinedAudience response = combinedAudienceServiceClient.getCombinedAudience(resourceName.toString());
   * }
   * </code></pre>
   *
   * @param resourceName Required. The resource name of the combined audience to fetch.
   ...
   * try (CombinedAudienceServiceClient combinedAudienceServiceClient = CombinedAudienceServiceClient.create()) {
   *   CombinedAudienceName resourceName = CombinedAudienceName.of("[CUSTOMER_ID]", "[COMBINED_AUDIENCE_ID]");
   *   GetCombinedAudienceRequest request = GetCombinedAudienceRequest.newBuilder()
   ...
   *     .setResourceName(resourceName.toString())
   *     .build();
   *   ApiFuture&lt;CombinedAudience&gt; future = combinedAudienceServiceClient.getCombinedAudienceCallable().futureCall(request);
   *   // Do something
