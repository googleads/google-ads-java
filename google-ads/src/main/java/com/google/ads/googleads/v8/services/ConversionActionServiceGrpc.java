...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v8/services/conversion_action_service.proto")
public final class ConversionActionServiceGrpc {

  private ConversionActionServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v8.services.ConversionActionService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetConversionActionRequest,
      com.google.ads.googleads.v8.resources.ConversionAction> getGetConversionActionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetConversionAction",
      requestType = com.google.ads.googleads.v8.services.GetConversionActionRequest.class,
      responseType = com.google.ads.googleads.v8.resources.ConversionAction.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetConversionActionRequest,
      com.google.ads.googleads.v8.resources.ConversionAction> getGetConversionActionMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.GetConversionActionRequest, com.google.ads.googleads.v8.resources.ConversionAction> getGetConversionActionMethod;
      ...
      synchronized (ConversionActionServiceGrpc.class) {
        if ((getGetConversionActionMethod = ConversionActionServiceGrpc.getGetConversionActionMethod) == null) {
          ConversionActionServiceGrpc.getGetConversionActionMethod = getGetConversionActionMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v8.services.GetConversionActionRequest, com.google.ads.googleads.v8.resources.ConversionAction>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetConversionAction"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.GetConversionActionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.resources.ConversionAction.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateConversionActionsRequest,
      com.google.ads.googleads.v8.services.MutateConversionActionsResponse> getMutateConversionActionsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateConversionActions",
      requestType = com.google.ads.googleads.v8.services.MutateConversionActionsRequest.class,
      responseType = com.google.ads.googleads.v8.services.MutateConversionActionsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateConversionActionsRequest,
      com.google.ads.googleads.v8.services.MutateConversionActionsResponse> getMutateConversionActionsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v8.services.MutateConversionActionsRequest, com.google.ads.googleads.v8.services.MutateConversionActionsResponse> getMutateConversionActionsMethod;
      ...
      synchronized (ConversionActionServiceGrpc.class) {
        if ((getMutateConversionActionsMethod = ConversionActionServiceGrpc.getMutateConversionActionsMethod) == null) {
          ConversionActionServiceGrpc.getMutateConversionActionsMethod = getMutateConversionActionsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v8.services.MutateConversionActionsRequest, com.google.ads.googleads.v8.services.MutateConversionActionsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateConversionActions"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.MutateConversionActionsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v8.services.MutateConversionActionsResponse.getDefaultInstance()))
  ...
  public static abstract class ConversionActionServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getConversionAction(com.google.ads.googleads.v8.services.GetConversionActionRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.ConversionAction> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetConversionActionMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    public void mutateConversionActions(com.google.ads.googleads.v8.services.MutateConversionActionsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.services.MutateConversionActionsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v8.services.GetConversionActionRequest,
                com.google.ads.googleads.v8.resources.ConversionAction>(
                  this, METHODID_GET_CONVERSION_ACTION)))
          .addMethod(
            getMutateConversionActionsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v8.services.MutateConversionActionsRequest,
                com.google.ads.googleads.v8.services.MutateConversionActionsResponse>(
  ...
  public static final class ConversionActionServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ConversionActionServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v8.resources.ConversionAction getConversionAction(com.google.ads.googleads.v8.services.GetConversionActionRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v8.services.MutateConversionActionsResponse mutateConversionActions(com.google.ads.googleads.v8.services.MutateConversionActionsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ConversionActionServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ConversionActionServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v8.resources.ConversionAction> getConversionAction(
        com.google.ads.googleads.v8.services.GetConversionActionRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v8.services.MutateConversionActionsResponse> mutateConversionActions(
        com.google.ads.googleads.v8.services.MutateConversionActionsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CONVERSION_ACTION:
          serviceImpl.getConversionAction((com.google.ads.googleads.v8.services.GetConversionActionRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.resources.ConversionAction>) responseObserver);
          break;
        case METHODID_MUTATE_CONVERSION_ACTIONS:
          serviceImpl.mutateConversionActions((com.google.ads.googleads.v8.services.MutateConversionActionsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v8.services.MutateConversionActionsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ConversionActionServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v8.services.ConversionActionServiceProto.getDescriptor();
    }
