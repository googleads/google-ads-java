...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/hotel_group_view_service.proto")
public final class HotelGroupViewServiceGrpc {

  private HotelGroupViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.HotelGroupViewService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  @java.lang.Deprecated // Use {@link #getGetHotelGroupViewMethod()} instead. 
  public static final io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetHotelGroupViewRequest,
      com.google.ads.googleads.v4.resources.HotelGroupView> METHOD_GET_HOTEL_GROUP_VIEW = getGetHotelGroupViewMethodHelper();

  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetHotelGroupViewRequest,
      com.google.ads.googleads.v4.resources.HotelGroupView> getGetHotelGroupViewMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetHotelGroupViewRequest,
      com.google.ads.googleads.v4.resources.HotelGroupView> getGetHotelGroupViewMethod() {
    return getGetHotelGroupViewMethodHelper();
  }

  private static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetHotelGroupViewRequest,
      com.google.ads.googleads.v4.resources.HotelGroupView> getGetHotelGroupViewMethodHelper() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetHotelGroupViewRequest, com.google.ads.googleads.v4.resources.HotelGroupView> getGetHotelGroupViewMethod;
      ...
      synchronized (HotelGroupViewServiceGrpc.class) {
        if ((getGetHotelGroupViewMethod = HotelGroupViewServiceGrpc.getGetHotelGroupViewMethod) == null) {
          HotelGroupViewServiceGrpc.getGetHotelGroupViewMethod = getGetHotelGroupViewMethod = 
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetHotelGroupViewRequest, com.google.ads.googleads.v4.resources.HotelGroupView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "google.ads.googleads.v4.services.HotelGroupViewService", "GetHotelGroupView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetHotelGroupViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.HotelGroupView.getDefaultInstance()))
  ...
  public static abstract class HotelGroupViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getHotelGroupView(com.google.ads.googleads.v4.services.GetHotelGroupViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.HotelGroupView> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetHotelGroupViewRequest,
                com.google.ads.googleads.v4.resources.HotelGroupView>(
  ...
  public static final class HotelGroupViewServiceBlockingStub extends io.grpc.stub.AbstractStub<HotelGroupViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.HotelGroupView getHotelGroupView(com.google.ads.googleads.v4.services.GetHotelGroupViewRequest request) {
  ...
  public static final class HotelGroupViewServiceFutureStub extends io.grpc.stub.AbstractStub<HotelGroupViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.HotelGroupView> getHotelGroupView(
        com.google.ads.googleads.v4.services.GetHotelGroupViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_HOTEL_GROUP_VIEW:
          serviceImpl.getHotelGroupView((com.google.ads.googleads.v4.services.GetHotelGroupViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.HotelGroupView>) responseObserver);
          break;
        default:
  ...
  private static abstract class HotelGroupViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.HotelGroupViewServiceProto.getDescriptor();
    }
