...
import com.google.ads.googleads.v0.services.stub.ProductGroupViewServiceStub;
...
public class ProductGroupViewServiceClient implements BackgroundResource {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  private final ProductGroupView getProductGroupView(GetProductGroupViewRequest request) {
