...
import com.google.ads.googleads.v7.services.stub.AssetServiceStub;
import com.google.ads.googleads.v7.services.stub.AssetServiceStubSettings;
...
public class AssetServiceClient implements BackgroundResource {
   ...
   * <pre>{@code
   * try (AssetServiceClient assetServiceClient = AssetServiceClient.create()) {
   *   String resourceName = AssetName.of("[CUSTOMER_ID]", "[ASSET_ID]").toString();
   *   Asset response = assetServiceClient.getAsset(resourceName);
   * }
   * }</pre>
   *
