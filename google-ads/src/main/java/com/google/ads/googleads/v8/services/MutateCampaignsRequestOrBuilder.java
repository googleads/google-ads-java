...
public interface MutateCampaignsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v8.services.MutateCampaignsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v8.services.CampaignOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaigns.
   ...
   * <code>repeated .google.ads.googleads.v8.services.CampaignOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.CampaignOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaigns.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v8.services.CampaignOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v8.services.CampaignOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v8.services.CampaignOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.CampaignOperationOrBuilder getOperationsOrBuilder(
      int index);
