...
public class FeedItemTargetServiceClient implements BackgroundResource {
   ...
   * </code></pre>
   *
   * @param resourceName The resource name of the feed item targets to fetch.
   ...
   * </code></pre>
   *
   * @param customerId The ID of the customer whose feed item targets are being modified.
   * @param operations The list of operations to perform on individual feed item targets.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
