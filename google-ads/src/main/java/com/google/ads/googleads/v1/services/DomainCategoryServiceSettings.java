...
import com.google.ads.googleads.v1.resources.DomainCategory;
import com.google.ads.googleads.v1.services.stub.DomainCategoryServiceStubSettings;
 ...
 * example, to set the total timeout of getDomainCategory to 30 seconds:
 *
 * <pre>
 * <code>
 * DomainCategoryServiceSettings.Builder domainCategoryServiceSettingsBuilder =
 *     DomainCategoryServiceSettings.newBuilder();
 * domainCategoryServiceSettingsBuilder.getDomainCategorySettings().getRetrySettings().toBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * DomainCategoryServiceSettings domainCategoryServiceSettings = domainCategoryServiceSettingsBuilder.build();
 * </code>
 * </pre>
 */
