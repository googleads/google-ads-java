...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/ad_group_criterion_service.proto")
public final class AdGroupCriterionServiceGrpc {

  private AdGroupCriterionServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.AdGroupCriterionService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetAdGroupCriterionRequest,
      com.google.ads.googleads.v5.resources.AdGroupCriterion> getGetAdGroupCriterionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAdGroupCriterion",
      requestType = com.google.ads.googleads.v5.services.GetAdGroupCriterionRequest.class,
      responseType = com.google.ads.googleads.v5.resources.AdGroupCriterion.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetAdGroupCriterionRequest,
      com.google.ads.googleads.v5.resources.AdGroupCriterion> getGetAdGroupCriterionMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetAdGroupCriterionRequest, com.google.ads.googleads.v5.resources.AdGroupCriterion> getGetAdGroupCriterionMethod;
      ...
      synchronized (AdGroupCriterionServiceGrpc.class) {
        if ((getGetAdGroupCriterionMethod = AdGroupCriterionServiceGrpc.getGetAdGroupCriterionMethod) == null) {
          AdGroupCriterionServiceGrpc.getGetAdGroupCriterionMethod = getGetAdGroupCriterionMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetAdGroupCriterionRequest, com.google.ads.googleads.v5.resources.AdGroupCriterion>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAdGroupCriterion"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetAdGroupCriterionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.AdGroupCriterion.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateAdGroupCriteriaRequest,
      com.google.ads.googleads.v5.services.MutateAdGroupCriteriaResponse> getMutateAdGroupCriteriaMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAdGroupCriteria",
      requestType = com.google.ads.googleads.v5.services.MutateAdGroupCriteriaRequest.class,
      responseType = com.google.ads.googleads.v5.services.MutateAdGroupCriteriaResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateAdGroupCriteriaRequest,
      com.google.ads.googleads.v5.services.MutateAdGroupCriteriaResponse> getMutateAdGroupCriteriaMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateAdGroupCriteriaRequest, com.google.ads.googleads.v5.services.MutateAdGroupCriteriaResponse> getMutateAdGroupCriteriaMethod;
      ...
      synchronized (AdGroupCriterionServiceGrpc.class) {
        if ((getMutateAdGroupCriteriaMethod = AdGroupCriterionServiceGrpc.getMutateAdGroupCriteriaMethod) == null) {
          AdGroupCriterionServiceGrpc.getMutateAdGroupCriteriaMethod = getMutateAdGroupCriteriaMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.MutateAdGroupCriteriaRequest, com.google.ads.googleads.v5.services.MutateAdGroupCriteriaResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAdGroupCriteria"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateAdGroupCriteriaRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateAdGroupCriteriaResponse.getDefaultInstance()))
  ...
  public static abstract class AdGroupCriterionServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAdGroupCriterion(com.google.ads.googleads.v5.services.GetAdGroupCriterionRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.AdGroupCriterion> responseObserver) {
     ...
     * </pre>
     */
    public void mutateAdGroupCriteria(com.google.ads.googleads.v5.services.MutateAdGroupCriteriaRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateAdGroupCriteriaResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetAdGroupCriterionRequest,
                com.google.ads.googleads.v5.resources.AdGroupCriterion>(
                  this, METHODID_GET_AD_GROUP_CRITERION)))
          .addMethod(
            getMutateAdGroupCriteriaMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.MutateAdGroupCriteriaRequest,
                com.google.ads.googleads.v5.services.MutateAdGroupCriteriaResponse>(
  ...
  public static final class AdGroupCriterionServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AdGroupCriterionServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.AdGroupCriterion getAdGroupCriterion(com.google.ads.googleads.v5.services.GetAdGroupCriterionRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.services.MutateAdGroupCriteriaResponse mutateAdGroupCriteria(com.google.ads.googleads.v5.services.MutateAdGroupCriteriaRequest request) {
      return blockingUnaryCall(
  ...
  public static final class AdGroupCriterionServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AdGroupCriterionServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.AdGroupCriterion> getAdGroupCriterion(
        com.google.ads.googleads.v5.services.GetAdGroupCriterionRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.services.MutateAdGroupCriteriaResponse> mutateAdGroupCriteria(
        com.google.ads.googleads.v5.services.MutateAdGroupCriteriaRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AD_GROUP_CRITERION:
          serviceImpl.getAdGroupCriterion((com.google.ads.googleads.v5.services.GetAdGroupCriterionRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.AdGroupCriterion>) responseObserver);
          break;
        case METHODID_MUTATE_AD_GROUP_CRITERIA:
          serviceImpl.mutateAdGroupCriteria((com.google.ads.googleads.v5.services.MutateAdGroupCriteriaRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateAdGroupCriteriaResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AdGroupCriterionServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.AdGroupCriterionServiceProto.getDescriptor();
    }
