...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v9/services/asset_set_asset_service.proto")
public final class AssetSetAssetServiceGrpc {

  private AssetSetAssetServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v9.services.AssetSetAssetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateAssetSetAssetsRequest,
      com.google.ads.googleads.v9.services.MutateAssetSetAssetsResponse> getMutateAssetSetAssetsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAssetSetAssets",
      requestType = com.google.ads.googleads.v9.services.MutateAssetSetAssetsRequest.class,
      responseType = com.google.ads.googleads.v9.services.MutateAssetSetAssetsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateAssetSetAssetsRequest,
      com.google.ads.googleads.v9.services.MutateAssetSetAssetsResponse> getMutateAssetSetAssetsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.MutateAssetSetAssetsRequest, com.google.ads.googleads.v9.services.MutateAssetSetAssetsResponse> getMutateAssetSetAssetsMethod;
      ...
      synchronized (AssetSetAssetServiceGrpc.class) {
        if ((getMutateAssetSetAssetsMethod = AssetSetAssetServiceGrpc.getMutateAssetSetAssetsMethod) == null) {
          AssetSetAssetServiceGrpc.getMutateAssetSetAssetsMethod = getMutateAssetSetAssetsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.MutateAssetSetAssetsRequest, com.google.ads.googleads.v9.services.MutateAssetSetAssetsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAssetSetAssets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.MutateAssetSetAssetsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.MutateAssetSetAssetsResponse.getDefaultInstance()))
  ...
  public static abstract class AssetSetAssetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void mutateAssetSetAssets(com.google.ads.googleads.v9.services.MutateAssetSetAssetsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.MutateAssetSetAssetsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.MutateAssetSetAssetsRequest,
                com.google.ads.googleads.v9.services.MutateAssetSetAssetsResponse>(
  ...
  public static final class AssetSetAssetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AssetSetAssetServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.services.MutateAssetSetAssetsResponse mutateAssetSetAssets(com.google.ads.googleads.v9.services.MutateAssetSetAssetsRequest request) {
  ...
  public static final class AssetSetAssetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AssetSetAssetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.services.MutateAssetSetAssetsResponse> mutateAssetSetAssets(
        com.google.ads.googleads.v9.services.MutateAssetSetAssetsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MUTATE_ASSET_SET_ASSETS:
          serviceImpl.mutateAssetSetAssets((com.google.ads.googleads.v9.services.MutateAssetSetAssetsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.MutateAssetSetAssetsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AssetSetAssetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v9.services.AssetSetAssetServiceProto.getDescriptor();
    }
