...
import com.google.ads.googleads.v8.resources.CampaignSharedSet;
import com.google.ads.googleads.v8.resources.CampaignSharedSetName;
import com.google.ads.googleads.v8.services.stub.CampaignSharedSetServiceStub;
import com.google.ads.googleads.v8.services.stub.CampaignSharedSetServiceStubSettings;
...
public class CampaignSharedSetServiceClient implements BackgroundResource {
   ...
   *     CampaignSharedSetServiceClient.create()) {
   *   String resourceName =
   *       CampaignSharedSetName.of("[CUSTOMER_ID]", "[CAMPAIGN_ID]", "[SHARED_SET_ID]").toString();
   *   CampaignSharedSet response =
   *       campaignSharedSetServiceClient.getCampaignSharedSet(resourceName);
   * }
   * }</pre>
