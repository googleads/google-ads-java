...
public interface MutateCustomerUserAccessInvitationRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v8.services.MutateCustomerUserAccessInvitationRequest)
   ...
   */
  com.google.ads.googleads.v8.services.CustomerUserAccessInvitationOperation getOperation();
  /**
   * <pre>
   * Required. The operation to perform on the access invitation
   * </pre>
   ...
   * <code>.google.ads.googleads.v8.services.CustomerUserAccessInvitationOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.CustomerUserAccessInvitationOperationOrBuilder getOperationOrBuilder();
}
