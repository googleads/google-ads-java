...
public class AssetGroupServiceClient implements BackgroundResource {
   ...
   * }</pre>
   *
   * @param resourceName Required. The resource name of the asset group to fetch.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final AssetGroup getAssetGroup(AssetGroupName resourceName) {
    GetAssetGroupRequest request =
        GetAssetGroupRequest.newBuilder()
            .setResourceName(resourceName == null ? null : resourceName.toString())
            .build();
    return getAssetGroup(request);
  }
   ...
   * <pre>{@code
   * try (AssetGroupServiceClient assetGroupServiceClient = AssetGroupServiceClient.create()) {
   *   String resourceName = AssetGroupName.of("[CUSTOMER_ID]", "[ASSET_GROUP_ID]").toString();
   *   AssetGroup response = assetGroupServiceClient.getAssetGroup(resourceName);
   * }
   * }</pre>
   *
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final AssetGroup getAssetGroup(String resourceName) {
    GetAssetGroupRequest request =
        GetAssetGroupRequest.newBuilder().setResourceName(resourceName).build();
    return getAssetGroup(request);
  }
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final AssetGroup getAssetGroup(GetAssetGroupRequest request) {
    return getAssetGroupCallable().call(request);
  }
   ...
   *           .setResourceName(AssetGroupName.of("[CUSTOMER_ID]", "[ASSET_GROUP_ID]").toString())
   *           .build();
   *   ApiFuture<AssetGroup> future =
   *       assetGroupServiceClient.getAssetGroupCallable().futureCall(request);
   *   // Do something.
   *   AssetGroup response = future.get();
   * }
   * }</pre>
   */
  public final UnaryCallable<GetAssetGroupRequest, AssetGroup> getAssetGroupCallable() {
    return stub.getAssetGroupCallable();
  }
