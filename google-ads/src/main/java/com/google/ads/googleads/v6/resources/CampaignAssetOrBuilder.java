...
public interface CampaignAssetOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v6.resources.CampaignAsset)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v6.enums.AssetFieldTypeEnum.AssetFieldType field_type = 4 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v6.enums.AssetLinkStatusEnum.AssetLinkStatus status = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v6.enums.AssetLinkStatusEnum.AssetLinkStatus getStatus();
}
