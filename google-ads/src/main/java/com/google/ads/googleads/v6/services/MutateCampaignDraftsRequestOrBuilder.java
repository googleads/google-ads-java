...
public interface MutateCampaignDraftsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v6.services.MutateCampaignDraftsRequest)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v6.services.CampaignDraftOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.ads.googleads.v6.services.CampaignDraftOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign drafts.
   ...
   * <code>repeated .google.ads.googleads.v6.services.CampaignDraftOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v6.services.CampaignDraftOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual campaign drafts.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v6.services.CampaignDraftOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v6.services.CampaignDraftOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v6.services.CampaignDraftOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v6.services.CampaignDraftOperationOrBuilder getOperationsOrBuilder(
      int index);
