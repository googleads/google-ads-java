...
import com.google.ads.googleads.v1.services.stub.CustomerServiceStub;
import com.google.ads.googleads.v1.services.stub.CustomerServiceStubSettings;
...
public class CustomerServiceClient implements BackgroundResource {
   ...
   * </code></pre>
   *
   * @param customerId The ID of the Manager under whom client customer is being created.
   * @param customerClient The new client customer to create. The resource name on this customer
   *     will be ignored.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
