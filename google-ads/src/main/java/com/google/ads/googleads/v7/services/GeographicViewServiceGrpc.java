...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v7/services/geographic_view_service.proto")
public final class GeographicViewServiceGrpc {

  private GeographicViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v7.services.GeographicViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetGeographicViewRequest,
      com.google.ads.googleads.v7.resources.GeographicView> getGetGeographicViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetGeographicView",
      requestType = com.google.ads.googleads.v7.services.GetGeographicViewRequest.class,
      responseType = com.google.ads.googleads.v7.resources.GeographicView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetGeographicViewRequest,
      com.google.ads.googleads.v7.resources.GeographicView> getGetGeographicViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v7.services.GetGeographicViewRequest, com.google.ads.googleads.v7.resources.GeographicView> getGetGeographicViewMethod;
      ...
      synchronized (GeographicViewServiceGrpc.class) {
        if ((getGetGeographicViewMethod = GeographicViewServiceGrpc.getGetGeographicViewMethod) == null) {
          GeographicViewServiceGrpc.getGetGeographicViewMethod = getGetGeographicViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v7.services.GetGeographicViewRequest, com.google.ads.googleads.v7.resources.GeographicView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetGeographicView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.services.GetGeographicViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v7.resources.GeographicView.getDefaultInstance()))
  ...
  public static abstract class GeographicViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getGeographicView(com.google.ads.googleads.v7.services.GetGeographicViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.resources.GeographicView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v7.services.GetGeographicViewRequest,
                com.google.ads.googleads.v7.resources.GeographicView>(
  ...
  public static final class GeographicViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GeographicViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v7.resources.GeographicView getGeographicView(com.google.ads.googleads.v7.services.GetGeographicViewRequest request) {
  ...
  public static final class GeographicViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GeographicViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v7.resources.GeographicView> getGeographicView(
        com.google.ads.googleads.v7.services.GetGeographicViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_GEOGRAPHIC_VIEW:
          serviceImpl.getGeographicView((com.google.ads.googleads.v7.services.GetGeographicViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v7.resources.GeographicView>) responseObserver);
          break;
        default:
  ...
  private static abstract class GeographicViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v7.services.GeographicViewServiceProto.getDescriptor();
    }
