...
import com.google.ads.googleads.v8.services.GetConversionValueRuleRequest;
import com.google.ads.googleads.v8.services.MutateConversionValueRulesRequest;
import com.google.ads.googleads.v8.services.MutateConversionValueRulesResponse;
...
public class GrpcConversionValueRuleServiceStub extends ConversionValueRuleServiceStub {
  private static final MethodDescriptor<GetConversionValueRuleRequest, ConversionValueRule>
      getConversionValueRuleMethodDescriptor =
          MethodDescriptor.<GetConversionValueRuleRequest, ConversionValueRule>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.ads.googleads.v8.services.ConversionValueRuleService/GetConversionValueRule")
              .setRequestMarshaller(
                  ProtoUtils.marshaller(GetConversionValueRuleRequest.getDefaultInstance()))
              .setResponseMarshaller(
                  ProtoUtils.marshaller(ConversionValueRule.getDefaultInstance()))
              .build();
  ...
  private final UnaryCallable<GetConversionValueRuleRequest, ConversionValueRule>
  ...
  protected GrpcConversionValueRuleServiceStub(
    ...
    GrpcCallSettings<GetConversionValueRuleRequest, ConversionValueRule>
        getConversionValueRuleTransportSettings =
            GrpcCallSettings.<GetConversionValueRuleRequest, ConversionValueRule>newBuilder()
                .setMethodDescriptor(getConversionValueRuleMethodDescriptor)
                .setParamsExtractor(
                    request -> {
    ...
    this.getConversionValueRuleCallable =
        callableFactory.createUnaryCallable(
            getConversionValueRuleTransportSettings,
            settings.getConversionValueRuleSettings(),
            clientContext);
  ...
  @Override
  public UnaryCallable<GetConversionValueRuleRequest, ConversionValueRule>
      getConversionValueRuleCallable() {
    return getConversionValueRuleCallable;
  }
