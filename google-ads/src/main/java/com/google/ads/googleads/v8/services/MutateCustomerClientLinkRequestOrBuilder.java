...
public interface MutateCustomerClientLinkRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v8.services.MutateCustomerClientLinkRequest)
   ...
   */
  com.google.ads.googleads.v8.services.CustomerClientLinkOperation getOperation();
  /**
   * <pre>
   * Required. The operation to perform on the individual CustomerClientLink.
   * </pre>
   ...
   * <code>.google.ads.googleads.v8.services.CustomerClientLinkOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v8.services.CustomerClientLinkOperationOrBuilder getOperationOrBuilder();
