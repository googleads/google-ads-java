...
public interface MutateExtensionFeedItemResultOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v7.services.MutateExtensionFeedItemResult)
   ...
   */
  com.google.ads.googleads.v7.resources.ExtensionFeedItem getExtensionFeedItem();
  /**
   * <pre>
   * The mutated extension feed item with only mutable fields after mutate. The
   * field will only be returned when response_content_type is set to
   ...
   * <code>.google.ads.googleads.v7.resources.ExtensionFeedItem extension_feed_item = 2;</code>
   */
  com.google.ads.googleads.v7.resources.ExtensionFeedItemOrBuilder getExtensionFeedItemOrBuilder();
}
