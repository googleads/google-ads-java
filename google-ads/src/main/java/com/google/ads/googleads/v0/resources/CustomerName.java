...
public class CustomerName implements ResourceName {
  ...
  public static CustomerName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(formattedString, "CustomerName.parse: formattedString not in valid format");
  ...
  public ResourceNameType getType() {
    throw new UnsupportedOperationException("CustomerName.getType() not supported");
  }
