...
import com.google.ads.googleads.v0.services.GetFeedMappingRequest;
import com.google.ads.googleads.v0.services.MutateFeedMappingsRequest;
import com.google.ads.googleads.v0.services.MutateFeedMappingsResponse;
  ...
  private static final MethodDescriptor<GetFeedMappingRequest, FeedMapping>
      getFeedMappingMethodDescriptor =
          MethodDescriptor.<GetFeedMappingRequest, FeedMapping>newBuilder()
              ...
              .setFullMethodName(
                  "google.ads.googleads.v0.services.FeedMappingService/GetFeedMapping")
  ...
  private static final MethodDescriptor<MutateFeedMappingsRequest, MutateFeedMappingsResponse>
      mutateFeedMappingsMethodDescriptor =
          MethodDescriptor.<MutateFeedMappingsRequest, MutateFeedMappingsResponse>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.ads.googleads.v0.services.FeedMappingService/MutateFeedMappings")
              .setRequestMarshaller(
