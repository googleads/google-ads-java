...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v9/services/third_party_app_analytics_link_service.proto")
public final class ThirdPartyAppAnalyticsLinkServiceGrpc {

  private ThirdPartyAppAnalyticsLinkServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v9.services.ThirdPartyAppAnalyticsLinkService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetThirdPartyAppAnalyticsLinkRequest,
      com.google.ads.googleads.v9.resources.ThirdPartyAppAnalyticsLink> getGetThirdPartyAppAnalyticsLinkMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetThirdPartyAppAnalyticsLink",
      requestType = com.google.ads.googleads.v9.services.GetThirdPartyAppAnalyticsLinkRequest.class,
      responseType = com.google.ads.googleads.v9.resources.ThirdPartyAppAnalyticsLink.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetThirdPartyAppAnalyticsLinkRequest,
      com.google.ads.googleads.v9.resources.ThirdPartyAppAnalyticsLink> getGetThirdPartyAppAnalyticsLinkMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.GetThirdPartyAppAnalyticsLinkRequest, com.google.ads.googleads.v9.resources.ThirdPartyAppAnalyticsLink> getGetThirdPartyAppAnalyticsLinkMethod;
      ...
      synchronized (ThirdPartyAppAnalyticsLinkServiceGrpc.class) {
        if ((getGetThirdPartyAppAnalyticsLinkMethod = ThirdPartyAppAnalyticsLinkServiceGrpc.getGetThirdPartyAppAnalyticsLinkMethod) == null) {
          ThirdPartyAppAnalyticsLinkServiceGrpc.getGetThirdPartyAppAnalyticsLinkMethod = getGetThirdPartyAppAnalyticsLinkMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.GetThirdPartyAppAnalyticsLinkRequest, com.google.ads.googleads.v9.resources.ThirdPartyAppAnalyticsLink>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetThirdPartyAppAnalyticsLink"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.GetThirdPartyAppAnalyticsLinkRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.resources.ThirdPartyAppAnalyticsLink.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.RegenerateShareableLinkIdRequest,
      com.google.ads.googleads.v9.services.RegenerateShareableLinkIdResponse> getRegenerateShareableLinkIdMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RegenerateShareableLinkId",
      requestType = com.google.ads.googleads.v9.services.RegenerateShareableLinkIdRequest.class,
      responseType = com.google.ads.googleads.v9.services.RegenerateShareableLinkIdResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.RegenerateShareableLinkIdRequest,
      com.google.ads.googleads.v9.services.RegenerateShareableLinkIdResponse> getRegenerateShareableLinkIdMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v9.services.RegenerateShareableLinkIdRequest, com.google.ads.googleads.v9.services.RegenerateShareableLinkIdResponse> getRegenerateShareableLinkIdMethod;
      ...
      synchronized (ThirdPartyAppAnalyticsLinkServiceGrpc.class) {
        if ((getRegenerateShareableLinkIdMethod = ThirdPartyAppAnalyticsLinkServiceGrpc.getRegenerateShareableLinkIdMethod) == null) {
          ThirdPartyAppAnalyticsLinkServiceGrpc.getRegenerateShareableLinkIdMethod = getRegenerateShareableLinkIdMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v9.services.RegenerateShareableLinkIdRequest, com.google.ads.googleads.v9.services.RegenerateShareableLinkIdResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RegenerateShareableLinkId"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.RegenerateShareableLinkIdRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v9.services.RegenerateShareableLinkIdResponse.getDefaultInstance()))
  ...
  public static abstract class ThirdPartyAppAnalyticsLinkServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getThirdPartyAppAnalyticsLink(com.google.ads.googleads.v9.services.GetThirdPartyAppAnalyticsLinkRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.ThirdPartyAppAnalyticsLink> responseObserver) {
     ...
     * </pre>
     */
    public void regenerateShareableLinkId(com.google.ads.googleads.v9.services.RegenerateShareableLinkIdRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.RegenerateShareableLinkIdResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.GetThirdPartyAppAnalyticsLinkRequest,
                com.google.ads.googleads.v9.resources.ThirdPartyAppAnalyticsLink>(
                  this, METHODID_GET_THIRD_PARTY_APP_ANALYTICS_LINK)))
          .addMethod(
            getRegenerateShareableLinkIdMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v9.services.RegenerateShareableLinkIdRequest,
                com.google.ads.googleads.v9.services.RegenerateShareableLinkIdResponse>(
  ...
  public static final class ThirdPartyAppAnalyticsLinkServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ThirdPartyAppAnalyticsLinkServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.resources.ThirdPartyAppAnalyticsLink getThirdPartyAppAnalyticsLink(com.google.ads.googleads.v9.services.GetThirdPartyAppAnalyticsLinkRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v9.services.RegenerateShareableLinkIdResponse regenerateShareableLinkId(com.google.ads.googleads.v9.services.RegenerateShareableLinkIdRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ThirdPartyAppAnalyticsLinkServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ThirdPartyAppAnalyticsLinkServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.resources.ThirdPartyAppAnalyticsLink> getThirdPartyAppAnalyticsLink(
        com.google.ads.googleads.v9.services.GetThirdPartyAppAnalyticsLinkRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v9.services.RegenerateShareableLinkIdResponse> regenerateShareableLinkId(
        com.google.ads.googleads.v9.services.RegenerateShareableLinkIdRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_THIRD_PARTY_APP_ANALYTICS_LINK:
          serviceImpl.getThirdPartyAppAnalyticsLink((com.google.ads.googleads.v9.services.GetThirdPartyAppAnalyticsLinkRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.resources.ThirdPartyAppAnalyticsLink>) responseObserver);
          break;
        case METHODID_REGENERATE_SHAREABLE_LINK_ID:
          serviceImpl.regenerateShareableLinkId((com.google.ads.googleads.v9.services.RegenerateShareableLinkIdRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v9.services.RegenerateShareableLinkIdResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ThirdPartyAppAnalyticsLinkServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v9.services.ThirdPartyAppAnalyticsLinkServiceProto.getDescriptor();
    }
