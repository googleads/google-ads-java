...
public interface SearchTermViewOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v6.resources.SearchTermView)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v6.enums.SearchTermTargetingStatusEnum.SearchTermTargetingStatus status = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v6.enums.SearchTermTargetingStatusEnum.SearchTermTargetingStatus getStatus();
}
