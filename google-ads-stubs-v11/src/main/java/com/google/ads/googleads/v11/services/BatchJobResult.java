...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            com.google.ads.googleads.v11.services.MutateOperationResponse.Builder subBuilder = null;
            if (mutateOperationResponse_ != null) {
              subBuilder = mutateOperationResponse_.toBuilder();
            }
            mutateOperationResponse_ = input.readMessage(com.google.ads.googleads.v11.services.MutateOperationResponse.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.ads.googleads.v11.services.BatchJobResult parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.ads.googleads.v11.services.BatchJobResult) e.getUnfinishedMessage();
