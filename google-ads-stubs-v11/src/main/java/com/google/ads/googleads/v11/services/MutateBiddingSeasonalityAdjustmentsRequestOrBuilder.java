...
public interface MutateBiddingSeasonalityAdjustmentsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v11.services.MutateBiddingSeasonalityAdjustmentsRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v11.services.BiddingSeasonalityAdjustmentOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual seasonality adjustments.
   ...
   * <code>repeated .google.ads.googleads.v11.services.BiddingSeasonalityAdjustmentOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v11.services.BiddingSeasonalityAdjustmentOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v11.services.BiddingSeasonalityAdjustmentOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v11.services.BiddingSeasonalityAdjustmentOperationOrBuilder getOperationsOrBuilder(
      int index);
