...
import com.google.ads.googleads.v11.services.stub.AssetSetServiceStubSettings;
...
/**
 * Settings class to configure an instance of {@link AssetSetServiceClient}.
 *
 ...
 * AssetSetServiceSettings.Builder assetSetServiceSettingsBuilder =
...
public class AssetSetServiceSettings extends ClientSettings<AssetSetServiceSettings> {
  ...
  public static final AssetSetServiceSettings create(AssetSetServiceStubSettings stub)
      throws IOException {
    return new AssetSetServiceSettings.Builder(stub.toBuilder()).build();
  }
  ...
  protected AssetSetServiceSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends ClientSettings.Builder<AssetSetServiceSettings, Builder> {
    ...
    protected Builder(AssetSetServiceSettings settings) {
      super(settings.getStubSettings().toBuilder());
    }

    protected Builder(AssetSetServiceStubSettings.Builder stubSettings) {
      super(stubSettings);
    }
    ...
    @Override
    public AssetSetServiceSettings build() throws IOException {
