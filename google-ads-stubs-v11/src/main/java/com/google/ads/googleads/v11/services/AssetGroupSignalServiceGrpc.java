...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v11/services/asset_group_signal_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class AssetGroupSignalServiceGrpc {

  private AssetGroupSignalServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v11.services.AssetGroupSignalService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v11.services.MutateAssetGroupSignalsRequest,
      com.google.ads.googleads.v11.services.MutateAssetGroupSignalsResponse> getMutateAssetGroupSignalsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAssetGroupSignals",
      requestType = com.google.ads.googleads.v11.services.MutateAssetGroupSignalsRequest.class,
      responseType = com.google.ads.googleads.v11.services.MutateAssetGroupSignalsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v11.services.MutateAssetGroupSignalsRequest,
      com.google.ads.googleads.v11.services.MutateAssetGroupSignalsResponse> getMutateAssetGroupSignalsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v11.services.MutateAssetGroupSignalsRequest, com.google.ads.googleads.v11.services.MutateAssetGroupSignalsResponse> getMutateAssetGroupSignalsMethod;
      ...
      synchronized (AssetGroupSignalServiceGrpc.class) {
        if ((getMutateAssetGroupSignalsMethod = AssetGroupSignalServiceGrpc.getMutateAssetGroupSignalsMethod) == null) {
          AssetGroupSignalServiceGrpc.getMutateAssetGroupSignalsMethod = getMutateAssetGroupSignalsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v11.services.MutateAssetGroupSignalsRequest, com.google.ads.googleads.v11.services.MutateAssetGroupSignalsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAssetGroupSignals"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v11.services.MutateAssetGroupSignalsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v11.services.MutateAssetGroupSignalsResponse.getDefaultInstance()))
  ...
  public static abstract class AssetGroupSignalServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void mutateAssetGroupSignals(com.google.ads.googleads.v11.services.MutateAssetGroupSignalsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v11.services.MutateAssetGroupSignalsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v11.services.MutateAssetGroupSignalsRequest,
                com.google.ads.googleads.v11.services.MutateAssetGroupSignalsResponse>(
  ...
  public static final class AssetGroupSignalServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AssetGroupSignalServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v11.services.MutateAssetGroupSignalsResponse mutateAssetGroupSignals(com.google.ads.googleads.v11.services.MutateAssetGroupSignalsRequest request) {
  ...
  public static final class AssetGroupSignalServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AssetGroupSignalServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v11.services.MutateAssetGroupSignalsResponse> mutateAssetGroupSignals(
        com.google.ads.googleads.v11.services.MutateAssetGroupSignalsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MUTATE_ASSET_GROUP_SIGNALS:
          serviceImpl.mutateAssetGroupSignals((com.google.ads.googleads.v11.services.MutateAssetGroupSignalsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v11.services.MutateAssetGroupSignalsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AssetGroupSignalServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v11.services.AssetGroupSignalServiceProto.getDescriptor();
    }
