...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v11/services/ad_group_asset_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class AdGroupAssetServiceGrpc {

  private AdGroupAssetServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v11.services.AdGroupAssetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v11.services.MutateAdGroupAssetsRequest,
      com.google.ads.googleads.v11.services.MutateAdGroupAssetsResponse> getMutateAdGroupAssetsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAdGroupAssets",
      requestType = com.google.ads.googleads.v11.services.MutateAdGroupAssetsRequest.class,
      responseType = com.google.ads.googleads.v11.services.MutateAdGroupAssetsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v11.services.MutateAdGroupAssetsRequest,
      com.google.ads.googleads.v11.services.MutateAdGroupAssetsResponse> getMutateAdGroupAssetsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v11.services.MutateAdGroupAssetsRequest, com.google.ads.googleads.v11.services.MutateAdGroupAssetsResponse> getMutateAdGroupAssetsMethod;
      ...
      synchronized (AdGroupAssetServiceGrpc.class) {
        if ((getMutateAdGroupAssetsMethod = AdGroupAssetServiceGrpc.getMutateAdGroupAssetsMethod) == null) {
          AdGroupAssetServiceGrpc.getMutateAdGroupAssetsMethod = getMutateAdGroupAssetsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v11.services.MutateAdGroupAssetsRequest, com.google.ads.googleads.v11.services.MutateAdGroupAssetsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAdGroupAssets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v11.services.MutateAdGroupAssetsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v11.services.MutateAdGroupAssetsResponse.getDefaultInstance()))
  ...
  public static abstract class AdGroupAssetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void mutateAdGroupAssets(com.google.ads.googleads.v11.services.MutateAdGroupAssetsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v11.services.MutateAdGroupAssetsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v11.services.MutateAdGroupAssetsRequest,
                com.google.ads.googleads.v11.services.MutateAdGroupAssetsResponse>(
  ...
  public static final class AdGroupAssetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AdGroupAssetServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v11.services.MutateAdGroupAssetsResponse mutateAdGroupAssets(com.google.ads.googleads.v11.services.MutateAdGroupAssetsRequest request) {
  ...
  public static final class AdGroupAssetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AdGroupAssetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v11.services.MutateAdGroupAssetsResponse> mutateAdGroupAssets(
        com.google.ads.googleads.v11.services.MutateAdGroupAssetsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MUTATE_AD_GROUP_ASSETS:
          serviceImpl.mutateAdGroupAssets((com.google.ads.googleads.v11.services.MutateAdGroupAssetsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v11.services.MutateAdGroupAssetsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AdGroupAssetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v11.services.AdGroupAssetServiceProto.getDescriptor();
    }
