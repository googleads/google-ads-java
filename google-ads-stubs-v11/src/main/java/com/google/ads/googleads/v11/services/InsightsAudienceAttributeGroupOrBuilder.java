...
public interface InsightsAudienceAttributeGroupOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v11.services.InsightsAudienceAttributeGroup)
   ...
   */
  java.util.List<com.google.ads.googleads.v11.services.AudienceInsightsAttribute> 
      getAttributesList();
  /**
   * <pre>
   * Required. A collection of audience attributes to be combined with logical
   ...
   * <code>repeated .google.ads.googleads.v11.services.AudienceInsightsAttribute attributes = 1 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v11.services.AudienceInsightsAttributeOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v11.services.AudienceInsightsAttribute attributes = 1 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v11.services.AudienceInsightsAttributeOrBuilder getAttributesOrBuilder(
      int index);
}
