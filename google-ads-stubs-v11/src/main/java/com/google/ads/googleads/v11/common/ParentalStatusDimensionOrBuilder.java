...
public interface ParentalStatusDimensionOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v11.common.ParentalStatusDimension)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v11.enums.ParentalStatusTypeEnum.ParentalStatusType parental_statuses = 1;</code>
   * @return A list containing the parentalStatuses.
   */
  java.util.List<com.google.ads.googleads.v11.enums.ParentalStatusTypeEnum.ParentalStatusType> getParentalStatusesList();
  /**
   * <pre>
   * Included parental status demographic segments.
   * </pre>
   ...
   */
  com.google.ads.googleads.v11.enums.ParentalStatusTypeEnum.ParentalStatusType getParentalStatuses(int index);
  /**
   * <pre>
   * Included parental status demographic segments.
   * </pre>
