...
import com.google.ads.googleads.v11.services.MutateMediaFilesRequest;
 ...
 *
 * <p>For example, to set the total timeout of mutateMediaFiles to 30 seconds:
 *
 * <pre>{@code
  ...
  public static class Builder extends StubSettings.Builder<MediaFileServiceStubSettings, Builder> {
    ...
    protected Builder(ClientContext clientContext) {
      ...
      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(mutateMediaFilesSettings);
      initDefaults(this);
    }
