...
public interface AccessibleBiddingStrategyOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v11.resources.AccessibleBiddingStrategy)
   ...
   */
  com.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.MaximizeConversionValue getMaximizeConversionValue();
  /**
   * <pre>
   * Output only. An automated bidding strategy to help get the most conversion value for
   * your campaigns while spending your budget.
   ...
   * <code>.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.MaximizeConversionValue maximize_conversion_value = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.MaximizeConversionValueOrBuilder getMaximizeConversionValueOrBuilder();
   ...
   */
  com.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.MaximizeConversions getMaximizeConversions();
  /**
   * <pre>
   * Output only. An automated bidding strategy to help get the most conversions for your
   * campaigns while spending your budget.
   ...
   * <code>.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.MaximizeConversions maximize_conversions = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.MaximizeConversionsOrBuilder getMaximizeConversionsOrBuilder();
   ...
   */
  com.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.TargetCpa getTargetCpa();
  /**
   * <pre>
   * Output only. A bidding strategy that sets bids to help get as many conversions as
   * possible at the target cost-per-acquisition (CPA) you set.
   ...
   * <code>.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.TargetCpa target_cpa = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.TargetCpaOrBuilder getTargetCpaOrBuilder();
   ...
   */
  com.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.TargetImpressionShare getTargetImpressionShare();
  /**
   * <pre>
   * Output only. A bidding strategy that automatically optimizes towards a chosen
   * percentage of impressions.
   ...
   * <code>.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.TargetImpressionShare target_impression_share = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.TargetImpressionShareOrBuilder getTargetImpressionShareOrBuilder();
   ...
   */
  com.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.TargetRoas getTargetRoas();
  /**
   * <pre>
   * Output only. A bidding strategy that helps you maximize revenue while averaging a
   * specific target Return On Ad Spend (ROAS).
   ...
   * <code>.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.TargetRoas target_roas = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.TargetRoasOrBuilder getTargetRoasOrBuilder();
   ...
   */
  com.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.TargetSpend getTargetSpend();
  /**
   * <pre>
   * Output only. A bid strategy that sets your bids to help get as many clicks as
   * possible within your budget.
   ...
   * <code>.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.TargetSpend target_spend = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.TargetSpendOrBuilder getTargetSpendOrBuilder();

  public com.google.ads.googleads.v11.resources.AccessibleBiddingStrategy.SchemeCase getSchemeCase();
}
