...
public interface MutateConversionValueRulesRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v11.services.MutateConversionValueRulesRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v11.services.ConversionValueRuleOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual conversion value rules.
   ...
   * <code>repeated .google.ads.googleads.v11.services.ConversionValueRuleOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v11.services.ConversionValueRuleOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v11.services.ConversionValueRuleOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v11.services.ConversionValueRuleOperationOrBuilder getOperationsOrBuilder(
      int index);
