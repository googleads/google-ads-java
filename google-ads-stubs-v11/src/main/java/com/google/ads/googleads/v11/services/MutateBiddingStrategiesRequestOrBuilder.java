...
public interface MutateBiddingStrategiesRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v11.services.MutateBiddingStrategiesRequest)
   ...
   */
  java.util.List<com.google.ads.googleads.v11.services.BiddingStrategyOperation> 
      getOperationsList();
  /**
   * <pre>
   * Required. The list of operations to perform on individual bidding
   ...
   * <code>repeated .google.ads.googleads.v11.services.BiddingStrategyOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v11.services.BiddingStrategyOperation getOperations(int index);
  /**
   * <pre>
   * Required. The list of operations to perform on individual bidding
   * strategies.
   ...
   * <code>repeated .google.ads.googleads.v11.services.BiddingStrategyOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v11.services.BiddingStrategyOperationOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v11.services.BiddingStrategyOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.ads.googleads.v11.services.BiddingStrategyOperationOrBuilder getOperationsOrBuilder(
      int index);
