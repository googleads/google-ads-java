...
public interface CampaignFeedOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v11.resources.CampaignFeed)
   ...
   */
  java.util.List<com.google.ads.googleads.v11.enums.PlaceholderTypeEnum.PlaceholderType> getPlaceholderTypesList();
  /**
   * <pre>
   * Indicates which placeholder types the feed may populate under the connected
   * campaign. Required.
   ...
   */
  com.google.ads.googleads.v11.enums.PlaceholderTypeEnum.PlaceholderType getPlaceholderTypes(int index);
  /**
   * <pre>
   * Indicates which placeholder types the feed may populate under the connected
   * campaign. Required.
   ...
   * @return The status.
   */
  com.google.ads.googleads.v11.enums.FeedLinkStatusEnum.FeedLinkStatus getStatus();
}
