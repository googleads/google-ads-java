...
public interface ConversionValueRuleSetOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v11.resources.ConversionValueRuleSet)
   ...
   */
  java.util.List<com.google.ads.googleads.v11.enums.ValueRuleSetDimensionEnum.ValueRuleSetDimension> getDimensionsList();
  /**
   * <pre>
   * Defines dimensions for Value Rule conditions. The condition types of value
   * rules within this value rule set must be of these dimensions. The first
   ...
   */
  com.google.ads.googleads.v11.enums.ValueRuleSetDimensionEnum.ValueRuleSetDimension getDimensions(int index);
  /**
   * <pre>
   * Defines dimensions for Value Rule conditions. The condition types of value
   * rules within this value rule set must be of these dimensions. The first
   ...
   */
  com.google.ads.googleads.v11.enums.ValueRuleSetAttachmentTypeEnum.ValueRuleSetAttachmentType getAttachmentType();
   ...
   * @return The status.
   */
  com.google.ads.googleads.v11.enums.ConversionValueRuleSetStatusEnum.ConversionValueRuleSetStatus getStatus();
   ...
   */
  java.util.List<com.google.ads.googleads.v11.enums.ConversionActionCategoryEnum.ConversionActionCategory> getConversionActionCategoriesList();
  /**
   * <pre>
   * Immutable. The conversion action categories of the conversion value rule set.
   * </pre>
   ...
   */
  com.google.ads.googleads.v11.enums.ConversionActionCategoryEnum.ConversionActionCategory getConversionActionCategories(int index);
  /**
   * <pre>
   * Immutable. The conversion action categories of the conversion value rule set.
   * </pre>
